	...
	, Dova.JDK.org.xml.sax.EntityResolver
{
	...
	static XmlResolver()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XmlResolver", "()V"));
	...
	public XmlResolver() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
