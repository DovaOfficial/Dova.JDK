	...
	, Dova.JDK.javax.sql.rowset.Joinable
{
	...
	static JdbcRowSetImpl()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "ps", "Ljava/sql/PreparedStatement;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "rs", "Ljava/sql/ResultSet;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "rowsMD", "Ljavax/sql/rowset/RowSetMetaDataImpl;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "resMD", "Ljava/sql/ResultSetMetaData;"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/sql/ResultSet;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/sql/Connection;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setProperties", "(Ljava/sql/PreparedStatement;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "readObject", "(Ljava/io/ObjectInputStream;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "execute", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "connect", "()Ljava/sql/Connection;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "prepare", "()Ljava/sql/PreparedStatement;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "checkTypeConcurrency", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getDatabaseMetaData", "()Ljava/sql/DatabaseMetaData;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setConnection", "(Ljava/sql/Connection;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getPreparedStatement", "()Ljava/sql/PreparedStatement;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setPreparedStatement", "(Ljava/sql/PreparedStatement;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setResultSet", "(Ljava/sql/ResultSet;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "initMetaData", "(Ljavax/sql/RowSetMetaData;Ljava/sql/ResultSetMetaData;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getParameterMetaData", "()Ljava/sql/ParameterMetaData;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setParams", "()V"));
	...
	public JdbcRowSetImpl(Dova.JDK.java.sql.ResultSet arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "public")]
	public JdbcRowSetImpl(Dova.JDK.java.lang.String arg0, Dova.JDK.java.lang.String arg1, Dova.JDK.java.lang.String arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(Ljava/sql/Connection;)V", "public")]
	public JdbcRowSetImpl(Dova.JDK.java.sql.Connection arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[2], arg0))
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public JdbcRowSetImpl() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[3]))
	{
	}
