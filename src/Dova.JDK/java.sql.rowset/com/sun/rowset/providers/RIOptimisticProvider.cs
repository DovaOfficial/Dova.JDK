	...
	, Dova.JDK.java.io.Serializable
{
	...
	static RIOptimisticProvider()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "writer", "Lcom/sun/rowset/internal/CachedRowSetWriter;"));
	...
	public RIOptimisticProvider() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
