	...
	: IJavaObject
{
	...
	static MultiDoc()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "next", "()Ljavax/print/MultiDoc;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getDoc", "()Ljavax/print/Doc;"));
	}
