...
[JniSignatureAttribute("Ljavax/print/attribute/PrintRequestAttributeSet;", "public abstract interface")]
public partial interface PrintRequestAttributeSet
	: IJavaObject
	, Dova.JDK.javax.print.attribute.AttributeSet
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/print/attribute/PrintRequestAttributeSet;");
