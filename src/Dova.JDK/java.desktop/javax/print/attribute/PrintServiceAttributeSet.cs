...
[JniSignatureAttribute("Ljavax/print/attribute/PrintServiceAttributeSet;", "public abstract interface")]
public partial interface PrintServiceAttributeSet
	: IJavaObject
	, Dova.JDK.javax.print.attribute.AttributeSet
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/print/attribute/PrintServiceAttributeSet;");
