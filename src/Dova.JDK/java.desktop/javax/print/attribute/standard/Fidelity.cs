	...
	, Dova.JDK.javax.print.attribute.PrintRequestAttribute
{
	...
	static Fidelity()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "FIDELITY_TRUE", "Ljavax/print/attribute/standard/Fidelity;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "FIDELITY_FALSE", "Ljavax/print/attribute/standard/Fidelity;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "myStringTable", "[Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "myEnumValueTable", "[Ljavax/print/attribute/standard/Fidelity;"));
	...
	public Fidelity(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
