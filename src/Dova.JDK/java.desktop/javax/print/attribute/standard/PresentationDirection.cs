	...
	, Dova.JDK.javax.print.attribute.PrintRequestAttribute
{
	...
	static PresentationDirection()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TOBOTTOM_TORIGHT", "Ljavax/print/attribute/standard/PresentationDirection;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TOBOTTOM_TOLEFT", "Ljavax/print/attribute/standard/PresentationDirection;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TOTOP_TORIGHT", "Ljavax/print/attribute/standard/PresentationDirection;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TOTOP_TOLEFT", "Ljavax/print/attribute/standard/PresentationDirection;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TORIGHT_TOBOTTOM", "Ljavax/print/attribute/standard/PresentationDirection;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TORIGHT_TOTOP", "Ljavax/print/attribute/standard/PresentationDirection;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TOLEFT_TOBOTTOM", "Ljavax/print/attribute/standard/PresentationDirection;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TOLEFT_TOTOP", "Ljavax/print/attribute/standard/PresentationDirection;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "myStringTable", "[Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "myEnumValueTable", "[Ljavax/print/attribute/standard/PresentationDirection;"));
	...
	public PresentationDirection(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
