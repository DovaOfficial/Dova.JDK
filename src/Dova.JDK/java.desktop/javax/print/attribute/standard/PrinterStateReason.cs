	...
	, Dova.JDK.javax.print.attribute.Attribute
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/print/attribute/standard/PrinterStateReason;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "OTHER", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "MEDIA_NEEDED", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "MEDIA_JAM", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "MOVING_TO_PAUSED", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "PAUSED", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SHUTDOWN", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CONNECTING_TO_DEVICE", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TIMED_OUT", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "STOPPING", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "STOPPED_PARTLY", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TONER_LOW", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TONER_EMPTY", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SPOOL_AREA_FULL", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "COVER_OPEN", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "INTERLOCK_OPEN", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "DOOR_OPEN", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "INPUT_TRAY_MISSING", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "MEDIA_LOW", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "MEDIA_EMPTY", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "OUTPUT_TRAY_MISSING", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "OUTPUT_AREA_ALMOST_FULL", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "OUTPUT_AREA_FULL", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "MARKER_SUPPLY_LOW", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "MARKER_SUPPLY_EMPTY", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "MARKER_WASTE_ALMOST_FULL", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "MARKER_WASTE_FULL", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "FUSER_OVER_TEMP", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "FUSER_UNDER_TEMP", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "OPC_NEAR_EOL", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "OPC_LIFE_OVER", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "DEVELOPER_LOW", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "DEVELOPER_EMPTY", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "INTERPRETER_RESOURCE_UNAVAILABLE", "Ljavax/print/attribute/standard/PrinterStateReason;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "myStringTable", "[Ljava/lang/String;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "myEnumValueTable", "[Ljavax/print/attribute/standard/PrinterStateReason;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PrinterStateReason", "(I)V"));
	...
	public PrinterStateReason(int arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
