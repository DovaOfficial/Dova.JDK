	...
	, Dova.JDK.javax.print.attribute.PrintServiceAttribute
{
	...
	static PDLOverrideSupported()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "NOT_ATTEMPTED", "Ljavax/print/attribute/standard/PDLOverrideSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ATTEMPTED", "Ljavax/print/attribute/standard/PDLOverrideSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "myStringTable", "[Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "myEnumValueTable", "[Ljavax/print/attribute/standard/PDLOverrideSupported;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "PDLOverrideSupported", "(I)V"));
	...
	public PDLOverrideSupported(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
