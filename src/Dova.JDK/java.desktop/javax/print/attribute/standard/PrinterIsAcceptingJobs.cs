	...
	, Dova.JDK.javax.print.attribute.PrintServiceAttribute
{
	...
	static PrinterIsAcceptingJobs()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "NOT_ACCEPTING_JOBS", "Ljavax/print/attribute/standard/PrinterIsAcceptingJobs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ACCEPTING_JOBS", "Ljavax/print/attribute/standard/PrinterIsAcceptingJobs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "myStringTable", "[Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "myEnumValueTable", "[Ljavax/print/attribute/standard/PrinterIsAcceptingJobs;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "PrinterIsAcceptingJobs", "(I)V"));
	...
	public PrinterIsAcceptingJobs(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
