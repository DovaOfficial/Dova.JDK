	...
	, Dova.JDK.javax.print.attribute.Attribute
{
	...
	static ReferenceUriSchemesSupported()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "FTP", "Ljavax/print/attribute/standard/ReferenceUriSchemesSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HTTP", "Ljavax/print/attribute/standard/ReferenceUriSchemesSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HTTPS", "Ljavax/print/attribute/standard/ReferenceUriSchemesSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "GOPHER", "Ljavax/print/attribute/standard/ReferenceUriSchemesSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "NEWS", "Ljavax/print/attribute/standard/ReferenceUriSchemesSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "NNTP", "Ljavax/print/attribute/standard/ReferenceUriSchemesSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "WAIS", "Ljavax/print/attribute/standard/ReferenceUriSchemesSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "FILE", "Ljavax/print/attribute/standard/ReferenceUriSchemesSupported;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "myStringTable", "[Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "myEnumValueTable", "[Ljavax/print/attribute/standard/ReferenceUriSchemesSupported;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ReferenceUriSchemesSupported", "(I)V"));
	...
	public ReferenceUriSchemesSupported(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
