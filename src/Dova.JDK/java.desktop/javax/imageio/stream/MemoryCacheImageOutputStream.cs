	...
	: Dova.JDK.javax.imageio.stream.ImageOutputStreamImpl
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/imageio/stream/MemoryCacheImageOutputStream;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MemoryCacheImageOutputStream", "(Ljava/io/OutputStream;)V"));
	...
	public MemoryCacheImageOutputStream(Dova.JDK.java.io.OutputStream arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
