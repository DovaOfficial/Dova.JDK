	...
	: Dova.JDK.javax.imageio.stream.ImageOutputStreamImpl
{
	...
	public FileImageOutputStream(Dova.JDK.java.io.File arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/io/RandomAccessFile;)V", "public")]
	public FileImageOutputStream(Dova.JDK.java.io.RandomAccessFile arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
