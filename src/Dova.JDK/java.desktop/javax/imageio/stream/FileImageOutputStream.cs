...
[JniSignatureAttribute("Ljavax/imageio/stream/FileImageOutputStream;", "public")]
	...
	: Dova.JDK.javax.imageio.stream.ImageOutputStreamImpl
{
	...
	static FileImageOutputStream()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/imageio/stream/FileImageOutputStream;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "disposerRecord", "Lcom/sun/imageio/stream/CloseableDisposerRecord;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FileImageOutputStream", "(Ljava/io/File;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FileImageOutputStream", "(Ljava/io/RandomAccessFile;)V"));
	...
	public FileImageOutputStream(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/io/File;)V", "public")]
	public FileImageOutputStream(Dova.JDK.java.io.File arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/io/RandomAccessFile;)V", "public")]
	public FileImageOutputStream(Dova.JDK.java.io.RandomAccessFile arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/imageio/stream/FileImageOutputStream;";
