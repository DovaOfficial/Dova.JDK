	...
	: Dova.JDK.javax.imageio.stream.ImageOutputStreamImpl
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/imageio/stream/FileImageOutputStream;");
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "disposerRecord", "Lcom/sun/imageio/stream/CloseableDisposerRecord;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FileImageOutputStream", "(Ljava/io/File;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FileImageOutputStream", "(Ljava/io/RandomAccessFile;)V"));
	...
	public FileImageOutputStream(Dova.JDK.java.io.File arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/io/RandomAccessFile;)V", "public")]
	public FileImageOutputStream(Dova.JDK.java.io.RandomAccessFile arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}
