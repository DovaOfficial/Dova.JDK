	...
	: Dova.JDK.javax.swing.plaf.basic.BasicTextUI
{
	...
	static DefaultTextUI()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DefaultTextUI", "()V"));
	}
	...
	public DefaultTextUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
