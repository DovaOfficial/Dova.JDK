	...
	: Dova.JDK.javax.swing.text.GlyphView.GlyphPainter
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/text/GlyphPainter2;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "layout", "Ljava/awt/font/TextLayout;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "GlyphPainter2", "(Ljava/awt/font/TextLayout;)V"));
	...
	public GlyphPainter2(Dova.JDK.java.awt.font.TextLayout arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
