	...
	: Dova.JDK.java.io.PrintWriter
{
	...
	static NPrintWriter()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "numPrinted", "I"));
	...
	public NPrintWriter(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
