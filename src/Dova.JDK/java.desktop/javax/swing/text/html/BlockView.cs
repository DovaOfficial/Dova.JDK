	...
	: Dova.JDK.javax.swing.text.BoxView
{
	...
	static BlockView()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/text/html/BlockView;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "BlockView", "(Ljavax/swing/text/Element;I)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "spanSetFromAttributes", "(ILjavax/swing/SizeRequirements;Ljavax/swing/text/html/CSS$LengthValue;Ljavax/swing/text/html/CSS$LengthValue;)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "constrainSize", "(ILjavax/swing/SizeRequirements;Ljavax/swing/SizeRequirements;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isPercentage", "(ILjavax/swing/text/AttributeSet;)Z"));
	...
	public BlockView(Dova.JDK.javax.swing.text.Element arg0, int arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
