	...
	: Dova.JDK.java.lang.RuntimeException
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/undo/CannotUndoException;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CannotUndoException", "()V"));
	}
	...
	public CannotUndoException() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
