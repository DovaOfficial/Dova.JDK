	...
	: IJavaObject
{
	...
	static StateEditable()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "storeState", "(Ljava/util/Hashtable;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "restoreState", "(Ljava/util/Hashtable;)V"));
	}
