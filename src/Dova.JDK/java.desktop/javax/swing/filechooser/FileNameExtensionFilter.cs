	...
	: Dova.JDK.javax.swing.filechooser.FileFilter
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/filechooser/FileNameExtensionFilter;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "lowerCaseExtensions", "[Ljava/lang/String;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FileNameExtensionFilter", "(Ljava/lang/String;[Ljava/lang/String;)V"));
	...
	public FileNameExtensionFilter(Dova.JDK.java.lang.String arg0, JavaArray<Dova.JDK.java.lang.String> arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
