	...
	: Dova.JDK.javax.swing.filechooser.FileSystemView
{
	...
	static GenericFileSystemView()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "GenericFileSystemView", "()V"));
	...
	public GenericFileSystemView() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
