	...
	, Dova.JDK.java.io.Serializable
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/ViewportLayout;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHARED_INSTANCE", "Ljavax/swing/ViewportLayout;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ViewportLayout", "()V"));
	...
	public ViewportLayout() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
