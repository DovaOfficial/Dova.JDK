	...
	, Dova.JDK.javax.swing.@event.MouseInputListener
{
	...
	static MouseInputAdapter()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MouseInputAdapter", "()V"));
	}
	...
	public MouseInputAdapter() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
