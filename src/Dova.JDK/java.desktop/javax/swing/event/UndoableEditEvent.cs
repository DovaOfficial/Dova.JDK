	...
	: Dova.JDK.java.util.EventObject
{
	...
	static UndoableEditEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "myEdit", "Ljavax/swing/undo/UndoableEdit;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UndoableEditEvent", "(Ljava/lang/Object;Ljavax/swing/undo/UndoableEdit;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getEdit", "()Ljavax/swing/undo/UndoableEdit;"));
	}
	...
	public UndoableEditEvent(Dova.JDK.java.lang.Object arg0, Dova.JDK.javax.swing.undo.UndoableEdit arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
