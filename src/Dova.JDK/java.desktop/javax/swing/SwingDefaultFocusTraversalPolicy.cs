	...
	: Dova.JDK.java.awt.DefaultFocusTraversalPolicy
{
	...
	static SwingDefaultFocusTraversalPolicy()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SwingDefaultFocusTraversalPolicy", "()V"));
	...
	public SwingDefaultFocusTraversalPolicy() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
