	...
	: Dova.JDK.javax.swing.plaf.ComponentUI
{
	...
	static SeparatorUI()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/SeparatorUI;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SeparatorUI", "()V"));
	}
	...
	public SeparatorUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
