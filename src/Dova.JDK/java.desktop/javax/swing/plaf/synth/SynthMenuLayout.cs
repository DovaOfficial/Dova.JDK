	...
	: Dova.JDK.javax.swing.plaf.basic.DefaultMenuLayout
{
	...
	static SynthMenuLayout()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SynthMenuLayout", "(Ljava/awt/Container;I)V"));
	...
	public SynthMenuLayout(Dova.JDK.java.awt.Container arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
