	...
	: Dova.JDK.javax.swing.plaf.synth.SynthEditorPaneUI
{
	...
	static SynthTextPaneUI()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SynthTextPaneUI", "()V"));
	...
	public SynthTextPaneUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
