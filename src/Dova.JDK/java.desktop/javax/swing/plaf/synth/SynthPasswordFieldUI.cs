...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthPasswordFieldUI;", "public")]
	...
	: Dova.JDK.javax.swing.plaf.synth.SynthTextFieldUI
{
	...
	static SynthPasswordFieldUI()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthPasswordFieldUI;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SynthPasswordFieldUI", "()V"));
	...
	public SynthPasswordFieldUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthPasswordFieldUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthPasswordFieldUI;";
