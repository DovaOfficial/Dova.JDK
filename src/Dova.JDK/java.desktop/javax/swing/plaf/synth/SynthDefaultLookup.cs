	...
	: Dova.JDK.sun.swing.DefaultLookup
{
	...
	static SynthDefaultLookup()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SynthDefaultLookup", "()V"));
	...
	public SynthDefaultLookup() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
