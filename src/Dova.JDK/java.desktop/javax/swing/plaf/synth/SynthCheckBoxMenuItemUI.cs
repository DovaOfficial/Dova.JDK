...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthCheckBoxMenuItemUI;", "public")]
	...
	: Dova.JDK.javax.swing.plaf.synth.SynthMenuItemUI
{
	...
	static SynthCheckBoxMenuItemUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthCheckBoxMenuItemUI;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SynthCheckBoxMenuItemUI", "()V"));
	...
	public SynthCheckBoxMenuItemUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthCheckBoxMenuItemUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthCheckBoxMenuItemUI;";
