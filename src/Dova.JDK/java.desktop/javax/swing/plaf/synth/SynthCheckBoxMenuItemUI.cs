	...
	: Dova.JDK.javax.swing.plaf.synth.SynthMenuItemUI
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthCheckBoxMenuItemUI;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SynthCheckBoxMenuItemUI", "()V"));
	...
	public SynthCheckBoxMenuItemUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
