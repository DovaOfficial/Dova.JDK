...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthFormattedTextFieldUI;", "public")]
public partial class SynthFormattedTextFieldUI
	: Dova.JDK.javax.swing.plaf.synth.SynthTextFieldUI
{
	...
	static SynthFormattedTextFieldUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthFormattedTextFieldUI;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SynthFormattedTextFieldUI", "()V"));
	...
	public SynthFormattedTextFieldUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthFormattedTextFieldUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthFormattedTextFieldUI;";
