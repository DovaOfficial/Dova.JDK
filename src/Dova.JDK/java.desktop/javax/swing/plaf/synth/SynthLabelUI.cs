	...
	, Dova.JDK.javax.swing.plaf.synth.SynthUI
{
	...
	static SynthLabelUI()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "updateStyle", "(Ljavax/swing/JLabel;)V"));
	...
	public SynthLabelUI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
