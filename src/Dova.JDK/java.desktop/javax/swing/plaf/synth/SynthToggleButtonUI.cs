...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthToggleButtonUI;", "public")]
	...
	: Dova.JDK.javax.swing.plaf.synth.SynthButtonUI
{
	...
	static SynthToggleButtonUI()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthToggleButtonUI;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SynthToggleButtonUI", "()V"));
	...
	public SynthToggleButtonUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthToggleButtonUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthToggleButtonUI;";
