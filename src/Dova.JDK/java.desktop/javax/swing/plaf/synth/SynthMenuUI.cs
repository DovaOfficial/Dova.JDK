	...
	, Dova.JDK.javax.swing.plaf.synth.SynthUI
{
	...
	static SynthMenuUI()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthMenuUI;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SynthMenuUI", "()V"));
	...
	public SynthMenuUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
