	...
	, Dova.JDK.javax.swing.plaf.synth.SynthUI
{
	...
	static SynthMenuUI()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "updateStyle", "(Ljavax/swing/JMenuItem;)V"));
	...
	public SynthMenuUI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
