...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthMenuUI;", "public")]
	...
	, Dova.JDK.javax.swing.plaf.synth.SynthUI
{
	...
	static SynthMenuUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthMenuUI;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SynthMenuUI", "()V"));
	...
	public SynthMenuUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthMenuUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthMenuUI;";
