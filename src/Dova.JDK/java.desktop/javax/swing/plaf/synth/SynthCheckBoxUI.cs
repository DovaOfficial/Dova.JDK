...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthCheckBoxUI;", "public")]
public partial class SynthCheckBoxUI
	: Dova.JDK.javax.swing.plaf.synth.SynthRadioButtonUI
{
	...
	static SynthCheckBoxUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthCheckBoxUI;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SynthCheckBoxUI", "()V"));
	...
	public SynthCheckBoxUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthCheckBoxUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthCheckBoxUI;";
