...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthMenuItemUI;", "public")]
	...
	, Dova.JDK.javax.swing.plaf.synth.SynthUI
{
	...
	static SynthMenuItemUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthMenuItemUI;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SynthMenuItemUI", "()V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "updateStyle", "(Ljavax/swing/JMenuItem;)V"));
	...
	public SynthMenuItemUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthMenuItemUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthMenuItemUI;";
	...
	public void updateStyle(Dova.JDK.javax.swing.JMenuItem arg0)
	{
