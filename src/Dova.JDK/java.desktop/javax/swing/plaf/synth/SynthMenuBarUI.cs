...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthMenuBarUI;", "public")]
public partial class SynthMenuBarUI
	: Dova.JDK.javax.swing.plaf.basic.BasicMenuBarUI
	...
	, Dova.JDK.javax.swing.plaf.synth.SynthUI
{
	...
	static SynthMenuBarUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthMenuBarUI;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "style", "Ljavax/swing/plaf/synth/SynthStyle;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SynthMenuBarUI", "()V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "updateStyle", "(Ljavax/swing/JMenuBar;)V"));
	...
	public SynthMenuBarUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthMenuBarUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthMenuBarUI;";
	...
	public void updateStyle(Dova.JDK.javax.swing.JMenuBar arg0)
	{
