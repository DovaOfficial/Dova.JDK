...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthColorChooserUI;", "public")]
public partial class SynthColorChooserUI
	: Dova.JDK.javax.swing.plaf.basic.BasicColorChooserUI
	...
	, Dova.JDK.javax.swing.plaf.synth.SynthUI
{
	...
	static SynthColorChooserUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthColorChooserUI;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "style", "Ljavax/swing/plaf/synth/SynthStyle;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SynthColorChooserUI", "()V"));
	...
	public SynthColorChooserUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthColorChooserUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthColorChooserUI;";
