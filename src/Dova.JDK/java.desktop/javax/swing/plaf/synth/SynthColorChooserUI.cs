	...
	, Dova.JDK.javax.swing.plaf.synth.SynthUI
{
	...
	static SynthColorChooserUI()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "createDefaultChoosers", "()[Ljavax/swing/colorchooser/AbstractColorChooserPanel;"));
	...
	public SynthColorChooserUI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
