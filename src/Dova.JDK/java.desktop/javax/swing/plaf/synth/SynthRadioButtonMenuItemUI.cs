...
[JniSignatureAttribute("Ljavax/swing/plaf/synth/SynthRadioButtonMenuItemUI;", "public")]
public partial class SynthRadioButtonMenuItemUI
	: Dova.JDK.javax.swing.plaf.synth.SynthMenuItemUI
{
	...
	static SynthRadioButtonMenuItemUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/swing/plaf/synth/SynthRadioButtonMenuItemUI;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SynthRadioButtonMenuItemUI", "()V"));
	...
	public SynthRadioButtonMenuItemUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SynthRadioButtonMenuItemUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/synth/SynthRadioButtonMenuItemUI;";
