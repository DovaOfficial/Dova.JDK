	...
	: Dova.JDK.javax.swing.plaf.ComponentUI
{
	...
	static OptionPaneUI()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OptionPaneUI", "()V"));
	...
	public OptionPaneUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
