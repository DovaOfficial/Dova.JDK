	...
	: Dova.JDK.javax.swing.plaf.nimbus.ShadowEffect
{
	...
	static InnerShadowEffect()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "InnerShadowEffect", "()V"));
	...
	public InnerShadowEffect() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
