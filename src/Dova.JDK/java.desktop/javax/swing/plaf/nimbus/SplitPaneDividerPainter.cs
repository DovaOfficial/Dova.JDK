	...
	: Dova.JDK.javax.swing.plaf.nimbus.AbstractRegionPainter
{
	...
	static SplitPaneDividerPainter()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "FOREGROUND_ENABLED_VERTICAL", "I"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "paintForegroundEnabledAndVertical", "(Ljava/awt/Graphics2D;)V"));
	...
	public SplitPaneDividerPainter(Dova.JDK.javax.swing.plaf.nimbus.AbstractRegionPainter.PaintContext arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
