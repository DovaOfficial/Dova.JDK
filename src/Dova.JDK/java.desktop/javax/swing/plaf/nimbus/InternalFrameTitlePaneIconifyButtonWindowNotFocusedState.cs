	...
	: Dova.JDK.javax.swing.plaf.nimbus.State
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/nimbus/InternalFrameTitlePaneIconifyButtonWindowNotFocusedState;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "InternalFrameTitlePaneIconifyButtonWindowNotFocusedState", "()V"));
	...
	public InternalFrameTitlePaneIconifyButtonWindowNotFocusedState() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
