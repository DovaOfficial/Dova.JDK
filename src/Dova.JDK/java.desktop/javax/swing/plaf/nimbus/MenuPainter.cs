...
[JniSignatureAttribute("Ljavax/swing/plaf/nimbus/MenuPainter;", "final")]
public partial class MenuPainter
	: Dova.JDK.javax.swing.plaf.nimbus.AbstractRegionPainter
{
	...
	static MenuPainter()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/nimbus/MenuPainter;");
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ARROWICON_DISABLED", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ARROWICON_ENABLED", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ARROWICON_ENABLED_SELECTED", "I"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MenuPainter", "(Ljavax/swing/plaf/nimbus/AbstractRegionPainter$PaintContext;I)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "paintarrowIconDisabled", "(Ljava/awt/Graphics2D;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "paintarrowIconEnabled", "(Ljava/awt/Graphics2D;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "paintarrowIconEnabledAndSelected", "(Ljava/awt/Graphics2D;)V"));
	...
	[JniSignatureAttribute("I", "static final")]
	public static int ARROWICON_DISABLED_Property
	{
		get
		{
	...
	[JniSignatureAttribute("I", "static final")]
	public static int ARROWICON_ENABLED_Property
	{
		get
		{
	...
	[JniSignatureAttribute("I", "static final")]
	public static int ARROWICON_ENABLED_SELECTED_Property
	{
		get
		{
	...
	public MenuPainter(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljavax/swing/plaf/nimbus/AbstractRegionPainter$PaintContext;I)V", "public")]
	public MenuPainter(Dova.JDK.javax.swing.plaf.nimbus.AbstractRegionPainter.PaintContext arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/nimbus/MenuPainter;";
	...
	public void paintarrowIconDisabled(Dova.JDK.java.awt.Graphics2D arg0)
	{
		DovaVM.Runtime.CallVoidMethodA(CurrentRefPtr, MethodPtrs[2], arg0);
	}

	[JniSignatureAttribute("(Ljava/awt/Graphics2D;)V", "private")]
	public void paintarrowIconEnabled(Dova.JDK.java.awt.Graphics2D arg0)
	{
		DovaVM.Runtime.CallVoidMethodA(CurrentRefPtr, MethodPtrs[3], arg0);
	}

	[JniSignatureAttribute("(Ljava/awt/Graphics2D;)V", "private")]
	public void paintarrowIconEnabledAndSelected(Dova.JDK.java.awt.Graphics2D arg0)
	{
