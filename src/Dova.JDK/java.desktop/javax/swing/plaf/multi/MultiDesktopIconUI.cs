	...
	: Dova.JDK.javax.swing.plaf.DesktopIconUI
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/multi/MultiDesktopIconUI;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "uis", "Ljava/util/Vector;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MultiDesktopIconUI", "()V"));
	...
	public MultiDesktopIconUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
