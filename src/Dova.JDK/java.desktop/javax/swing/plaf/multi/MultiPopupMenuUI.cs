	...
	: Dova.JDK.javax.swing.plaf.PopupMenuUI
{
	...
	static MultiPopupMenuUI()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getPopup", "(Ljavax/swing/JPopupMenu;II)Ljavax/swing/Popup;"));
	...
	public MultiPopupMenuUI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
