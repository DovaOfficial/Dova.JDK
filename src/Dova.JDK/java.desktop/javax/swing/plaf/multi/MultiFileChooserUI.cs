	...
	: Dova.JDK.javax.swing.plaf.FileChooserUI
{
	...
	static MultiFileChooserUI()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MultiFileChooserUI", "()V"));
	...
	public MultiFileChooserUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
