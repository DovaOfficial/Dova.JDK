	...
	: Dova.JDK.javax.swing.plaf.basic.BasicMenuItemUI
{
	...
	static BasicRadioButtonMenuItemUI()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "processMouseEvent", "(Ljavax/swing/JMenuItem;Ljava/awt/event/MouseEvent;[Ljavax/swing/MenuElement;Ljavax/swing/MenuSelectionManager;)V"));
	}
	...
	public BasicRadioButtonMenuItemUI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
