...
[JniSignatureAttribute("Ljavax/swing/plaf/basic/BasicToolBarSeparatorUI;", "public")]
	...
	: Dova.JDK.javax.swing.plaf.basic.BasicSeparatorUI
{
	...
	static BasicToolBarSeparatorUI()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/basic/BasicToolBarSeparatorUI;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "BasicToolBarSeparatorUI", "()V"));
	...
	public BasicToolBarSeparatorUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public BasicToolBarSeparatorUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/swing/plaf/basic/BasicToolBarSeparatorUI;";
