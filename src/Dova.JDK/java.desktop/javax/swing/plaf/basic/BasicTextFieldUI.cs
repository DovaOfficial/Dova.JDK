	...
	: Dova.JDK.javax.swing.plaf.basic.BasicTextUI
{
	...
	public BasicTextFieldUI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.javax.swing.text.ParagraphView
	{
		...
		public I18nFieldView(Dova.JDK.javax.swing.text.Element arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
		{
		}
