	...
	: Dova.JDK.javax.swing.plaf.basic.BasicToggleButtonUI
{
	...
	static MetalToggleButtonUI()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "METAL_TOGGLE_BUTTON_UI_KEY", "Ljava/lang/Object;"));
	...
	public MetalToggleButtonUI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
