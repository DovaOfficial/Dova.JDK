	...
	: Dova.JDK.javax.swing.plaf.metal.MetalSeparatorUI
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/swing/plaf/metal/MetalPopupMenuSeparatorUI;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MetalPopupMenuSeparatorUI", "()V"));
	...
	public MetalPopupMenuSeparatorUI() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
