	...
	: Dova.JDK.java.io.FilterInputStream
{
	...
	static ProgressMonitorInputStream()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "monitor", "Ljavax/swing/ProgressMonitor;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "nread", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "size", "I"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/awt/Component;Ljava/lang/Object;Ljava/io/InputStream;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getProgressMonitor", "()Ljavax/swing/ProgressMonitor;"));
	}
	...
	public ProgressMonitorInputStream(Dova.JDK.java.awt.Component arg0, Dova.JDK.java.lang.Object arg1, Dova.JDK.java.io.InputStream arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
