	...
	: Dova.JDK.java.awt.FocusTraversalPolicy
{
	...
	static InternalFrameFocusTraversalPolicy()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getInitialComponent", "(Ljavax/swing/JInternalFrame;)Ljava/awt/Component;"));
	}
	...
	public InternalFrameFocusTraversalPolicy() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
