	...
	: IJavaObject
{
	...
	static AccessibleStreamable()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getStream", "(Ljava/awt/datatransfer/DataFlavor;)Ljava/io/InputStream;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getMimeTypes", "()[Ljava/awt/datatransfer/DataFlavor;"));
	}
