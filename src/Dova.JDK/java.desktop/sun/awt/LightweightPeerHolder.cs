	...
	: Dova.JDK.java.lang.Object
{
	...
	static LightweightPeerHolder()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "lightweightMarker", "Ljava/awt/peer/LightweightPeer;"));
	...
	public LightweightPeerHolder() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
