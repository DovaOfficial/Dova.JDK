	...
	, Dova.JDK.sun.awt.image.ImageFetchable
{
	...
	static InputStreamImageSource()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "consumers", "Lsun/awt/image/ImageConsumerQueue;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "decoder", "Lsun/awt/image/ImageDecoder;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "decoders", "Lsun/awt/image/ImageDecoder;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "awaitingFetch", "Z"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "countConsumers", "(Lsun/awt/image/ImageConsumerQueue;)I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "countConsumers", "()I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "printQueue", "(Lsun/awt/image/ImageConsumerQueue;Ljava/lang/String;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "errorConsumer", "(Lsun/awt/image/ImageConsumerQueue;Z)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "errorAllConsumers", "(Lsun/awt/image/ImageConsumerQueue;Z)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "badDecoder", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setDecoder", "(Lsun/awt/image/ImageDecoder;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "removeDecoder", "(Lsun/awt/image/ImageDecoder;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "doneDecoding", "(Lsun/awt/image/ImageDecoder;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "printQueues", "(Ljava/lang/String;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "stopProduction", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "decoderForType", "(Ljava/io/InputStream;Ljava/lang/String;)Lsun/awt/image/ImageDecoder;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "doFetch", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "latchConsumers", "(Lsun/awt/image/ImageDecoder;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getDecoder", "()Lsun/awt/image/ImageDecoder;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getDecoder", "(Ljava/io/InputStream;)Lsun/awt/image/ImageDecoder;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addConsumer", "(Ljava/awt/image/ImageConsumer;Z)V"));
	...
	public InputStreamImageSource() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
