	...
	: Dova.JDK.java.awt.GraphicsDevice
{
	...
	static BufferedImageDevice()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lsun/awt/image/BufferedImageGraphicsConfig;)V"));
	...
	public BufferedImageDevice(Dova.JDK.sun.awt.image.BufferedImageGraphicsConfig arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
