	...
	, Dova.JDK.sun.java2d.DestSurfaceProvider
{
	...
	static SunVolatileImage()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "volSurfaceManager", "Lsun/awt/image/VolatileSurfaceManager;"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "forcedAccelSurfaceType", "I"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SunVolatileImage", "(Ljava/awt/GraphicsConfiguration;IIILjava/awt/ImageCapabilities;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SunVolatileImage", "(Ljava/awt/Component;IILjava/lang/Object;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SunVolatileImage", "(Ljava/awt/Component;II)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SunVolatileImage", "(Ljava/awt/Component;Ljava/awt/GraphicsConfiguration;IILjava/lang/Object;Ljava/awt/ImageCapabilities;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SunVolatileImage", "(Ljava/awt/Component;Ljava/awt/GraphicsConfiguration;IILjava/lang/Object;ILjava/awt/ImageCapabilities;I)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getGraphicsConfig", "()Ljava/awt/GraphicsConfiguration;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "createSurfaceManager", "(Ljava/lang/Object;Ljava/awt/ImageCapabilities;)Lsun/awt/image/VolatileSurfaceManager;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getBackupImage", "(DD)Ljava/awt/image/BufferedImage;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getBackupImage", "()Ljava/awt/image/BufferedImage;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "updateGraphicsConfig", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getForcedAccelSurfaceType", "()I"));
	...
	public SunVolatileImage(Dova.JDK.java.awt.GraphicsConfiguration arg0, int arg1, int arg2, int arg3, Dova.JDK.java.awt.ImageCapabilities arg4) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4))
	{
	}

	[JniSignatureAttribute("(Ljava/awt/Component;IILjava/lang/Object;)V", "public")]
	public SunVolatileImage(Dova.JDK.java.awt.Component arg0, int arg1, int arg2, Dova.JDK.java.lang.Object arg3) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1, arg2, arg3))
	{
	}

	[JniSignatureAttribute("(Ljava/awt/Component;II)V", "public")]
	public SunVolatileImage(Dova.JDK.java.awt.Component arg0, int arg1, int arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[2], arg0, arg1, arg2))
	{
	}
	...
	public SunVolatileImage(Dova.JDK.java.awt.Component arg0, Dova.JDK.java.awt.GraphicsConfiguration arg1, int arg2, int arg3, Dova.JDK.java.lang.Object arg4, Dova.JDK.java.awt.ImageCapabilities arg5) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[3], arg0, arg1, arg2, arg3, arg4, arg5))
	{
	}
