	...
	: Dova.JDK.sun.awt.geom.Curve
{
	...
	static Order1()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/awt/geom/Order1;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Order1", "(DDDDI)V"));
	...
	public Order1(double arg0, double arg1, double arg2, double arg3, int arg4) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4))
	{
	}
	...
	{
		var ret = DovaVM.Runtime.CallDoubleMethodA(CurrentRefPtr, MethodPtrs[17], arg0, arg1);
		return ret;
	}
