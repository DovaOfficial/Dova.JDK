	...
	: Dova.JDK.sun.awt.geom.Curve
{
	...
	static Order1()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(DDDDI)V"));
	...
	public Order1(double arg0, double arg1, double arg2, double arg3, int arg4) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4))
	{
	}
