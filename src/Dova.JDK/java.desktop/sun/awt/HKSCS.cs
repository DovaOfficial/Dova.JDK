...
[JniSignatureAttribute("Lsun/awt/HKSCS;", "public")]
	...
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static HKSCS()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/awt/HKSCS;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "cs", "Ljava/nio/charset/Charset;"));
	...
	public static Dova.JDK.java.nio.charset.Charset cs_Property
	{
		get
		{
	...
	public override string GetJavaClassSignature() => "Lsun/awt/HKSCS;";
