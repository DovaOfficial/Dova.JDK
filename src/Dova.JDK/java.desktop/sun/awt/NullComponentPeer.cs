	...
	, Dova.JDK.java.awt.peer.PanelPeer
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/awt/NullComponentPeer;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "NullComponentPeer", "()V"));
	...
	public NullComponentPeer() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
