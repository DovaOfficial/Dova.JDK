	...
	: Dova.JDK.sun.awt.X11.XScrollbar
{
	...
	static XHorizontalScrollbar()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lsun/awt/X11/XScrollbarClient;)V"));
	...
	public XHorizontalScrollbar(Dova.JDK.sun.awt.X11.XScrollbarClient arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
