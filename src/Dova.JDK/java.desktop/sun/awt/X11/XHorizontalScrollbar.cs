	...
	: Dova.JDK.sun.awt.X11.XScrollbar
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/awt/X11/XHorizontalScrollbar;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XHorizontalScrollbar", "(Lsun/awt/X11/XScrollbarClient;)V"));
	...
	public XHorizontalScrollbar(Dova.JDK.sun.awt.X11.XScrollbarClient arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
