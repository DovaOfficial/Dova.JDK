...
public partial class XHorizontalScrollbar
	: Dova.JDK.sun.awt.X11.XScrollbar
{
	...
	static XHorizontalScrollbar()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/awt/X11/XHorizontalScrollbar;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XHorizontalScrollbar", "(Lsun/awt/X11/XScrollbarClient;)V"));
	...
	public XHorizontalScrollbar(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lsun/awt/X11/XScrollbarClient;)V", "public")]
	public XHorizontalScrollbar(Dova.JDK.sun.awt.X11.XScrollbarClient arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/awt/X11/XHorizontalScrollbar;";
