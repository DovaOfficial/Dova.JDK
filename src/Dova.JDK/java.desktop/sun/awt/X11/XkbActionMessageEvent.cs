	...
	: Dova.JDK.sun.awt.X11.XWrapperBase
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/awt/X11/XkbActionMessageEvent;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "get_press", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "get_key_event_follows", "()Z"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "get_message", "(I)B"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "get_message", "()J"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "set_press", "(Z)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "set_key_event_follows", "(Z)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "set_message", "(IB)V"));
	...
	public XkbActionMessageEvent(long arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XkbActionMessageEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1]))
	{
	}
	...
	{
		var ret = DovaVM.Runtime.CallByteMethodA(CurrentRefPtr, MethodPtrs[14], arg0);
		return ret;
	}
