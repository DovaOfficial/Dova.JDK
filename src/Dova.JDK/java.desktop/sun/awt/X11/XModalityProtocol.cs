	...
	: IJavaObject
{
	...
	static XModalityProtocol()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "isBlocked", "(Lsun/awt/X11/XDialogPeer;Lsun/awt/X11/XWindowPeer;)Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "setModal", "(Lsun/awt/X11/XDialogPeer;Z)Z"));
	}
