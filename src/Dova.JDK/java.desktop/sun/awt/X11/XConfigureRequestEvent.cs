	...
	: Dova.JDK.sun.awt.X11.XWrapperBase
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/awt/X11/XConfigureRequestEvent;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "get_above", "()J"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "set_above", "(J)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "get_value_mask", "()J"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "set_value_mask", "(J)V"));
	}
	...
	public XConfigureRequestEvent(long arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XConfigureRequestEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1]))
	{
	}
