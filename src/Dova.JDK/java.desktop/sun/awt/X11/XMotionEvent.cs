	...
	: Dova.JDK.sun.awt.X11.XWrapperBase
{
	...
	static XMotionEvent()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/awt/X11/XMotionEvent;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XMotionEvent", "(J)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XMotionEvent", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "get_is_hint", "()B"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "set_is_hint", "(B)V"));
	}
	...
	public XMotionEvent(long arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XMotionEvent() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1]))
	{
	}
	...
	{
		var ret = DovaVM.Runtime.CallByteMethodA(CurrentRefPtr, MethodPtrs[37]);
		return ret;
	}
