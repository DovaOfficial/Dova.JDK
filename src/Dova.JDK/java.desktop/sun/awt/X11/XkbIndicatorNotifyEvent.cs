	...
	: Dova.JDK.sun.awt.X11.XWrapperBase
{
	...
	public XkbIndicatorNotifyEvent(long arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XkbIndicatorNotifyEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1]))
	{
	}
