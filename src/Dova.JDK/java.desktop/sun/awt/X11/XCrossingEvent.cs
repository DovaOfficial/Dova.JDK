	...
	: Dova.JDK.sun.awt.X11.XWrapperBase
{
	...
	static XCrossingEvent()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "get_focus", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "set_focus", "(Z)V"));
	}
	...
	public XCrossingEvent(long arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XCrossingEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1]))
	{
	}
