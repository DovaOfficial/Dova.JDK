	...
	: Dova.JDK.sun.awt.X11.XWrapperBase
{
	...
	static XExposeEvent()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/awt/X11/XExposeEvent;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XExposeEvent", "(J)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XExposeEvent", "()V"));
	...
	public XExposeEvent(long arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XExposeEvent() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1]))
	{
	}
