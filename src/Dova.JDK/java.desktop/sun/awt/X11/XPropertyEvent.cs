	...
	: Dova.JDK.sun.awt.X11.XWrapperBase
{
	...
	static XPropertyEvent()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "get_atom", "()J"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "set_atom", "(J)V"));
	...
	public XPropertyEvent(long arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XPropertyEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1]))
	{
	}
