	...
	: Dova.JDK.java.net.ContentHandler
{
	...
	static x_aiff()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/awt/www/content/audio/x_aiff;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "x_aiff", "()V"));
	...
	public x_aiff() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
