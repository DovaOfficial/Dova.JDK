	...
	: Dova.JDK.java.net.ContentHandler
{
	...
	static png()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/awt/www/content/image/png;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "png", "()V"));
	...
	public png() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
