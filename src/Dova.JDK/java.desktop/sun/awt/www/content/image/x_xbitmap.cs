	...
	: Dova.JDK.java.net.ContentHandler
{
	...
	static x_xbitmap()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/awt/www/content/image/x_xbitmap;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "x_xbitmap", "()V"));
	...
	public x_xbitmap() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
