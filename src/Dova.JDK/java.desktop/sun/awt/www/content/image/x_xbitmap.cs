...
[JniSignatureAttribute("Lsun/awt/www/content/image/x_xbitmap;", "public")]
	...
	: Dova.JDK.java.net.ContentHandler
{
	...
	static x_xbitmap()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/awt/www/content/image/x_xbitmap;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "x_xbitmap", "()V"));
	...
	public x_xbitmap(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public x_xbitmap() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/awt/www/content/image/x_xbitmap;";
