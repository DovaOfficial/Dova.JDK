	...
	: Dova.JDK.java.lang.Object
{
	...
	static GTKKeybindings()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "GTKKeybindings", "()V"));
	...
	public GTKKeybindings() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
