	...
	, Dova.JDK.java.lang.Cloneable
{
	...
	static PeekGraphics()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "mDrawingArea", "Lsun/java2d/Spans;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "mPrintMetrics", "Lsun/print/PeekMetrics;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "mAWTDrawingOnly", "Z"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getAWTDrawingOnly", "()Z"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getMetrics", "()Lsun/print/PeekMetrics;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addStrokeShape", "(Ljava/awt/Shape;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addDrawingRect", "(FFFF)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addDrawingRect", "(Ljava/awt/geom/Rectangle2D;FF)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addDrawingRect", "(Ljava/awt/geom/Rectangle2D;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setAWTDrawingOnly", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getDrawingArea", "()Lsun/java2d/Spans;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getImageWidth", "(Ljava/awt/Image;)I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getImageHeight", "(Ljava/awt/Image;)I"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "hitsDrawingArea", "(Ljava/awt/Rectangle;)Z"));
	}
	...
	public PeekGraphics(Dova.JDK.java.awt.Graphics2D arg0, Dova.JDK.java.awt.print.PrinterJob arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
		...
		, Dova.JDK.java.awt.image.ImageObserver
	{
		...
		static ImageWaiter()
		{
			...
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "mWidth", "I"));
			FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "mHeight", "I"));
			FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "badImage", "Z"));
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lsun/print/PeekGraphics;Ljava/awt/Image;)V"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "waitForDimensions", "(Ljava/awt/Image;)V"));
		...
		public ImageWaiter(Dova.JDK.sun.print.PeekGraphics arg0, Dova.JDK.java.awt.Image arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
		{
		}
