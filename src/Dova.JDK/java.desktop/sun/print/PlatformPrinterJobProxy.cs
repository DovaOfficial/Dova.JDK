	...
	: Dova.JDK.java.lang.Object
{
	...
	static PlatformPrinterJobProxy()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "PlatformPrinterJobProxy", "()V"));
	...
	public PlatformPrinterJobProxy() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
