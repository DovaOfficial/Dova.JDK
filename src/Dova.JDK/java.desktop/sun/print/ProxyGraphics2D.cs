	...
	, Dova.JDK.java.awt.print.PrinterGraphics
{
	...
	static ProxyGraphics2D()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ProxyGraphics2D", "(Ljava/awt/Graphics2D;Ljava/awt/print/PrinterJob;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "needToCopyBgColorImage", "(Ljava/awt/Image;)Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getBufferedImageCopy", "(Ljava/awt/Image;Ljava/awt/Color;)Ljava/awt/image/BufferedImage;"));
	...
	public ProxyGraphics2D(Dova.JDK.java.awt.Graphics2D arg0, Dova.JDK.java.awt.print.PrinterJob arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
