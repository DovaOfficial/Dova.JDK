	...
	, Dova.JDK.javax.print.CancelablePrintJob
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/print/PSStreamPrintJob;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "service", "Lsun/print/PSStreamPrintService;"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PSStreamPrintJob", "(Lsun/print/PSStreamPrintService;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "printableJob", "(Ljava/awt/print/Printable;Ljavax/print/attribute/PrintRequestAttributeSet;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "pageableJob", "(Ljava/awt/print/Pageable;Ljavax/print/attribute/PrintRequestAttributeSet;)V"));
	...
	public PSStreamPrintJob(Dova.JDK.sun.print.PSStreamPrintService arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
