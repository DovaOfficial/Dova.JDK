	...
	, Dova.JDK.javax.print.attribute.PrintRequestAttribute
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/print/PrinterJobWrapper;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "job", "Ljava/awt/print/PrinterJob;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PrinterJobWrapper", "(Ljava/awt/print/PrinterJob;)V"));
	...
	public PrinterJobWrapper(Dova.JDK.java.awt.print.PrinterJob arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
