	...
	: Dova.JDK.java.awt.Graphics
{
	...
	static ProxyGraphics()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "g", "Ljava/awt/Graphics;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ProxyGraphics", "(Ljava/awt/Graphics;)V"));
	...
	public ProxyGraphics(Dova.JDK.java.awt.Graphics arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
