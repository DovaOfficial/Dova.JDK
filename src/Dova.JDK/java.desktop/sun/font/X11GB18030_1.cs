	...
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static X11GB18030_1()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/X11GB18030_1;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "X11GB18030_1", "()V"));
	...
	public X11GB18030_1() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.sun.font.DoubleByteEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/X11GB18030_1$Encoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			...
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "innerIndex10", "Ljava/lang/String;"));
