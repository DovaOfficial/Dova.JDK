	...
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static X11Johab()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/X11Johab;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "X11Johab", "()V"));
	...
	public X11Johab() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.sun.font.DoubleByteEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/X11Johab$Encoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			...
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "innerIndex9", "Ljava/lang/String;"));
