...
[JniSignatureAttribute("Lsun/font/X11Johab;", "public")]
public partial class X11Johab
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static X11Johab()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/font/X11Johab;");
	...
	public X11Johab(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public X11Johab() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/font/X11Johab;";
	...
	[JniSignatureAttribute("Lsun/font/X11Johab$Encoder;", "private static")]
		...
		: Dova.JDK.sun.font.DoubleByteEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/font/X11Johab$Encoder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			...
			FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "innerIndex8", "Ljava/lang/String;"));
			FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "innerIndex9", "Ljava/lang/String;"));
		...
		public override string GetJavaClassSignature() => "Lsun/font/X11Johab$Encoder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
