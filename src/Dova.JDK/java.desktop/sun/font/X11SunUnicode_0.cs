	...
	: Dova.JDK.java.nio.charset.Charset
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/font/X11SunUnicode_0;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "X11SunUnicode_0", "()V"));
	...
	public X11SunUnicode_0() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.sun.font.DoubleByteEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/font/X11SunUnicode_0$Encoder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
