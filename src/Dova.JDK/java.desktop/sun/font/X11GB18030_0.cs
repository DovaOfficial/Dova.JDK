	...
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static X11GB18030_0()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/font/X11GB18030_0;");
	...
	public X11GB18030_0() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.sun.font.DoubleByteEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/font/X11GB18030_0$Encoder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
