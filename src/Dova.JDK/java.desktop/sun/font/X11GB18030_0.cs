	...
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static X11GB18030_0()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "X11GB18030_0", "()V"));
	...
	public X11GB18030_0() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
