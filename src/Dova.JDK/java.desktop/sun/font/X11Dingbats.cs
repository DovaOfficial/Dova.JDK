	...
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static X11Dingbats()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/X11Dingbats;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "X11Dingbats", "()V"));
	...
	public X11Dingbats() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.nio.charset.CharsetEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/X11Dingbats$Encoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "table", "[B"));
