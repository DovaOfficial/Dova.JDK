...
[JniSignatureAttribute("Lsun/font/X11Dingbats;", "public")]
public partial class X11Dingbats
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static X11Dingbats()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/font/X11Dingbats;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "X11Dingbats", "()V"));
	...
	public X11Dingbats(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public X11Dingbats() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/font/X11Dingbats;";
	...
	[JniSignatureAttribute("Lsun/font/X11Dingbats$Encoder;", "private static")]
		...
		: Dova.JDK.java.nio.charset.CharsetEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/font/X11Dingbats$Encoder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "table", "[B"));
		...
		public static JavaArray<byte> table_Property
		{
			get
			{
		...
		public override string GetJavaClassSignature() => "Lsun/font/X11Dingbats$Encoder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
