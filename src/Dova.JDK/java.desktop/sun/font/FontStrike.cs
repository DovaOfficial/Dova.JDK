	...
	: Dova.JDK.java.lang.Object
{
	...
	static FontStrike()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "strikeMetrics", "Lsun/font/StrikeMetrics;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "algoStyle", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "boldness", "F"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "italic", "F"));
	...
	public FontStrike() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
