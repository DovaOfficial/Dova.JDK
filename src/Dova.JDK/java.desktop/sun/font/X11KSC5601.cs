	...
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static X11KSC5601()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/X11KSC5601;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "X11KSC5601", "()V"));
	...
	public X11KSC5601() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.nio.charset.CharsetEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/X11KSC5601$Encoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		...
		: Dova.JDK.java.nio.charset.CharsetDecoder
	{
		...
		static Decoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/X11KSC5601$Decoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
