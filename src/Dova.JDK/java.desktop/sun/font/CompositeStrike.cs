	...
	: Dova.JDK.sun.font.FontStrike
{
	...
	static CompositeStrike()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "strikes", "[Lsun/font/PhysicalStrike;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "numGlyphs", "I"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CompositeStrike", "(Lsun/font/CompositeFont;Lsun/font/FontStrikeDesc;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getStrikeForSlot", "(I)Lsun/font/PhysicalStrike;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getStrikeForGlyph", "(I)Lsun/font/PhysicalStrike;"));
	...
	public CompositeStrike(Dova.JDK.sun.font.CompositeFont arg0, Dova.JDK.sun.font.FontStrikeDesc arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
