	...
	: Dova.JDK.sun.font.FontStrike
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/font/CompositeStrike;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "strikes", "[Lsun/font/PhysicalStrike;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "numGlyphs", "I"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CompositeStrike", "(Lsun/font/CompositeFont;Lsun/font/FontStrikeDesc;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getStrikeForSlot", "(I)Lsun/font/PhysicalStrike;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getStrikeForGlyph", "(I)Lsun/font/PhysicalStrike;"));
	...
	public CompositeStrike(Dova.JDK.sun.font.CompositeFont arg0, Dova.JDK.sun.font.FontStrikeDesc arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
