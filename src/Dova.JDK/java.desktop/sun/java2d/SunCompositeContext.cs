	...
	, Dova.JDK.java.awt.CompositeContext
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/SunCompositeContext;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "comptype", "Lsun/java2d/loops/CompositeType;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SunCompositeContext", "(Ljava/awt/AlphaComposite;Ljava/awt/image/ColorModel;Ljava/awt/image/ColorModel;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SunCompositeContext", "(Lsun/java2d/loops/XORComposite;Ljava/awt/image/ColorModel;Ljava/awt/image/ColorModel;)V"));
	...
	public SunCompositeContext(Dova.JDK.java.awt.AlphaComposite arg0, Dova.JDK.java.awt.image.ColorModel arg1, Dova.JDK.java.awt.image.ColorModel arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(Lsun/java2d/loops/XORComposite;Ljava/awt/image/ColorModel;Ljava/awt/image/ColorModel;)V", "public")]
	public SunCompositeContext(Dova.JDK.sun.java2d.loops.XORComposite arg0, Dova.JDK.java.awt.image.ColorModel arg1, Dova.JDK.java.awt.image.ColorModel arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1, arg2))
	{
	}
