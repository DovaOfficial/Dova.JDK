...
[JniSignatureAttribute("Lsun/java2d/loops/XorCopyArgbToAny;", "")]
public partial class XorCopyArgbToAny
	: Dova.JDK.sun.java2d.loops.Blit
{
	...
	static XorCopyArgbToAny()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/loops/XorCopyArgbToAny;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XorCopyArgbToAny", "()V"));
	...
	public XorCopyArgbToAny(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public XorCopyArgbToAny() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/java2d/loops/XorCopyArgbToAny;";
