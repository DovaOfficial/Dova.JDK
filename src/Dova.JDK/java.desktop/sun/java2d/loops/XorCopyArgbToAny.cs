	...
	: Dova.JDK.sun.java2d.loops.Blit
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/java2d/loops/XorCopyArgbToAny;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XorCopyArgbToAny", "()V"));
	...
	public XorCopyArgbToAny() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
