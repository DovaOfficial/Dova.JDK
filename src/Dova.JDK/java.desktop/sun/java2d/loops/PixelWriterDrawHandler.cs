	...
	: Dova.JDK.sun.java2d.loops.ProcessPath.DrawHandler
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/loops/PixelWriterDrawHandler;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "pw", "Lsun/java2d/loops/PixelWriter;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "sData", "Lsun/java2d/SurfaceData;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "clip", "Lsun/java2d/pipe/Region;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PixelWriterDrawHandler", "(Lsun/java2d/SurfaceData;Lsun/java2d/loops/PixelWriter;Lsun/java2d/pipe/Region;I)V"));
	...
	public PixelWriterDrawHandler(Dova.JDK.sun.java2d.SurfaceData arg0, Dova.JDK.sun.java2d.loops.PixelWriter arg1, Dova.JDK.sun.java2d.pipe.Region arg2, int arg3) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3))
	{
	}
