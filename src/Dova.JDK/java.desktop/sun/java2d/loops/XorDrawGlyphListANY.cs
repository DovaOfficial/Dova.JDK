	...
	: Dova.JDK.sun.java2d.loops.DrawGlyphList
{
	...
	static XorDrawGlyphListANY()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XorDrawGlyphListANY", "()V"));
	...
	public XorDrawGlyphListANY() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
