	...
	: Dova.JDK.sun.java2d.loops.FillSpans
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/java2d/loops/SetFillSpansANY;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SetFillSpansANY", "()V"));
	...
	public SetFillSpansANY() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
