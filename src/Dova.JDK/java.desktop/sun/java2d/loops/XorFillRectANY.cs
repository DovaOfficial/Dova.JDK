	...
	: Dova.JDK.sun.java2d.loops.FillRect
{
	...
	static XorFillRectANY()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XorFillRectANY", "()V"));
	...
	public XorFillRectANY() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
