	...
	: Dova.JDK.sun.java2d.loops.Blit
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/java2d/loops/OpaqueCopyAnyToArgb;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OpaqueCopyAnyToArgb", "()V"));
	...
	public OpaqueCopyAnyToArgb() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
