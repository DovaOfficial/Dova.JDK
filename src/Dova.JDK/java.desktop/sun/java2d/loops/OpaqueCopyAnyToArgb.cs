...
[JniSignatureAttribute("Lsun/java2d/loops/OpaqueCopyAnyToArgb;", "")]
public partial class OpaqueCopyAnyToArgb
	: Dova.JDK.sun.java2d.loops.Blit
{
	...
	static OpaqueCopyAnyToArgb()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/loops/OpaqueCopyAnyToArgb;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "OpaqueCopyAnyToArgb", "()V"));
	...
	public OpaqueCopyAnyToArgb(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public OpaqueCopyAnyToArgb() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/java2d/loops/OpaqueCopyAnyToArgb;";
