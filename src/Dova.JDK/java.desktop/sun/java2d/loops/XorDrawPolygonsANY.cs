	...
	: Dova.JDK.sun.java2d.loops.DrawPolygons
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/java2d/loops/XorDrawPolygonsANY;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XorDrawPolygonsANY", "()V"));
	...
	public XorDrawPolygonsANY() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
