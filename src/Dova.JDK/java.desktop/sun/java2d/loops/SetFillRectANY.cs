	...
	: Dova.JDK.sun.java2d.loops.FillRect
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/java2d/loops/SetFillRectANY;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SetFillRectANY", "()V"));
	...
	public SetFillRectANY() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
