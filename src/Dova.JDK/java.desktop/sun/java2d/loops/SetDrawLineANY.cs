	...
	: Dova.JDK.sun.java2d.loops.DrawLine
{
	...
	static SetDrawLineANY()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SetDrawLineANY", "()V"));
	...
	public SetDrawLineANY() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
