	...
	, Dova.JDK.sun.java2d.pipe.ParallelogramPipe
{
	...
	static AlphaColorPipe()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AlphaColorPipe", "()V"));
	...
	public AlphaColorPipe() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
