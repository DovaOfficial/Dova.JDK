	...
	, Dova.JDK.sun.java2d.pipe.DrawImagePipe
{
	...
	static ValidatePipe()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ValidatePipe", "()V"));
	...
	public ValidatePipe() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
