	...
	: Dova.JDK.java.lang.Object
{
	...
	static CMMServiceProvider()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getModule", "()Lsun/java2d/cmm/PCMM;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getColorManagementModule", "()Lsun/java2d/cmm/PCMM;"));
	}
	...
	public CMMServiceProvider() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
