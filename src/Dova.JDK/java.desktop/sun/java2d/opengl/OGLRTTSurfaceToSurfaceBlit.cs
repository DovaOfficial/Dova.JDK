...
[JniSignatureAttribute("Lsun/java2d/opengl/OGLRTTSurfaceToSurfaceBlit;", "")]
public partial class OGLRTTSurfaceToSurfaceBlit
	: Dova.JDK.sun.java2d.loops.Blit
{
	...
	static OGLRTTSurfaceToSurfaceBlit()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/opengl/OGLRTTSurfaceToSurfaceBlit;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "OGLRTTSurfaceToSurfaceBlit", "()V"));
	...
	public OGLRTTSurfaceToSurfaceBlit(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public OGLRTTSurfaceToSurfaceBlit() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/java2d/opengl/OGLRTTSurfaceToSurfaceBlit;";
