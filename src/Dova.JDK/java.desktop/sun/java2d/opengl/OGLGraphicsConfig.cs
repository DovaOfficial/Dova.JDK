	...
	, Dova.JDK.sun.awt.image.SurfaceManager.ProxiedGraphicsConfig
{
	...
	static OGLGraphicsConfig()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getContext_0", "()Lsun/java2d/pipe/BufferedContext;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getContext_1", "()Lsun/java2d/opengl/OGLContext;"));
