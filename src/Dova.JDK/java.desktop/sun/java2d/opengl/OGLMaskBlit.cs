	...
	: Dova.JDK.sun.java2d.pipe.BufferedMaskBlit
{
	...
	static OGLMaskBlit()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OGLMaskBlit", "(Lsun/java2d/loops/SurfaceType;Lsun/java2d/loops/CompositeType;)V"));
	...
	public OGLMaskBlit(Dova.JDK.sun.java2d.loops.SurfaceType arg0, Dova.JDK.sun.java2d.loops.CompositeType arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
