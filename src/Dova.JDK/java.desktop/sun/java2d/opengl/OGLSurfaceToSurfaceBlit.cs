...
[JniSignatureAttribute("Lsun/java2d/opengl/OGLSurfaceToSurfaceBlit;", "")]
public partial class OGLSurfaceToSurfaceBlit
	: Dova.JDK.sun.java2d.loops.Blit
{
	...
	static OGLSurfaceToSurfaceBlit()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/opengl/OGLSurfaceToSurfaceBlit;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "OGLSurfaceToSurfaceBlit", "()V"));
	...
	public OGLSurfaceToSurfaceBlit(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public OGLSurfaceToSurfaceBlit() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/java2d/opengl/OGLSurfaceToSurfaceBlit;";
