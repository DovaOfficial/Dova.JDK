	...
	: Dova.JDK.sun.java2d.loops.TransformBlit
{
	...
	static OGLTextureToSurfaceTransform()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OGLTextureToSurfaceTransform", "()V"));
	...
	public OGLTextureToSurfaceTransform() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
