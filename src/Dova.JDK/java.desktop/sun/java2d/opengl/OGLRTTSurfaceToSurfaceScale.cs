	...
	: Dova.JDK.sun.java2d.loops.ScaledBlit
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/opengl/OGLRTTSurfaceToSurfaceScale;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "OGLRTTSurfaceToSurfaceScale", "()V"));
	...
	public OGLRTTSurfaceToSurfaceScale() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
