	...
	: Dova.JDK.sun.java2d.loops.ScaledBlit
{
	...
	static OGLRTTSurfaceToSurfaceScale()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OGLRTTSurfaceToSurfaceScale", "()V"));
	...
	public OGLRTTSurfaceToSurfaceScale() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
