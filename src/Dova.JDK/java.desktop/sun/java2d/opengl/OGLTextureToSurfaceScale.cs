	...
	: Dova.JDK.sun.java2d.loops.ScaledBlit
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/java2d/opengl/OGLTextureToSurfaceScale;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OGLTextureToSurfaceScale", "()V"));
	...
	public OGLTextureToSurfaceScale() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
