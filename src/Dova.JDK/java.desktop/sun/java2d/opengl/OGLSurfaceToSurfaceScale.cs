...
[JniSignatureAttribute("Lsun/java2d/opengl/OGLSurfaceToSurfaceScale;", "")]
public partial class OGLSurfaceToSurfaceScale
	: Dova.JDK.sun.java2d.loops.ScaledBlit
{
	...
	static OGLSurfaceToSurfaceScale()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/opengl/OGLSurfaceToSurfaceScale;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "OGLSurfaceToSurfaceScale", "()V"));
	...
	public OGLSurfaceToSurfaceScale(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public OGLSurfaceToSurfaceScale() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/java2d/opengl/OGLSurfaceToSurfaceScale;";
