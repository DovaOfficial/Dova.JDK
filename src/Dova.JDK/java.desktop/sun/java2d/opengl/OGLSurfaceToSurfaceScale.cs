	...
	: Dova.JDK.sun.java2d.loops.ScaledBlit
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/java2d/opengl/OGLSurfaceToSurfaceScale;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OGLSurfaceToSurfaceScale", "()V"));
	...
	public OGLSurfaceToSurfaceScale() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
