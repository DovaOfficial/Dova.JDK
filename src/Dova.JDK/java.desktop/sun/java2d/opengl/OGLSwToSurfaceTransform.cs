	...
	: Dova.JDK.sun.java2d.loops.TransformBlit
{
	...
	public OGLSwToSurfaceTransform(Dova.JDK.sun.java2d.loops.SurfaceType arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
