...
[JniSignatureAttribute("Lsun/java2d/opengl/OGLSwToTextureBlit;", "")]
public partial class OGLSwToTextureBlit
	: Dova.JDK.sun.java2d.loops.Blit
{
	...
	static OGLSwToTextureBlit()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/java2d/opengl/OGLSwToTextureBlit;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "typeval", "I"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OGLSwToTextureBlit", "(Lsun/java2d/loops/SurfaceType;I)V"));
	...
	public OGLSwToTextureBlit(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lsun/java2d/loops/SurfaceType;I)V", "")]
	public OGLSwToTextureBlit(Dova.JDK.sun.java2d.loops.SurfaceType arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/java2d/opengl/OGLSwToTextureBlit;";
