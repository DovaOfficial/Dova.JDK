	...
	: Dova.JDK.sun.java2d.loops.Blit
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/opengl/OGLSwToTextureBlit;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "typeval", "I"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "OGLSwToTextureBlit", "(Lsun/java2d/loops/SurfaceType;I)V"));
	...
	public OGLSwToTextureBlit(Dova.JDK.sun.java2d.loops.SurfaceType arg0, int arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
