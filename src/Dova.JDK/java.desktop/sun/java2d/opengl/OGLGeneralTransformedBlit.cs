	...
	: Dova.JDK.sun.java2d.loops.TransformBlit
{
	...
	static OGLGeneralTransformedBlit()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "performop", "Lsun/java2d/loops/TransformBlit;"));
	...
	public OGLGeneralTransformedBlit(Dova.JDK.sun.java2d.loops.TransformBlit arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
