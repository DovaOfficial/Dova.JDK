	...
	: Dova.JDK.sun.java2d.pipe.BufferedTextPipe
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/opengl/OGLTextRenderer;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "OGLTextRenderer", "(Lsun/java2d/pipe/RenderQueue;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "drawGlyphList", "(IZZZIFF[J[F)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "traceWrap", "()Lsun/java2d/opengl/OGLTextRenderer;"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "access$000", "(Lsun/java2d/opengl/OGLTextRenderer;)Lsun/java2d/pipe/RenderQueue;"));
	}
	...
	public OGLTextRenderer(Dova.JDK.sun.java2d.pipe.RenderQueue arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
		...
		: Dova.JDK.sun.java2d.opengl.OGLTextRenderer
	{
		...
		static Tracer()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/opengl/OGLTextRenderer$Tracer;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Tracer", "(Lsun/java2d/opengl/OGLTextRenderer;)V"));
		...
		public Tracer(Dova.JDK.sun.java2d.opengl.OGLTextRenderer arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}
