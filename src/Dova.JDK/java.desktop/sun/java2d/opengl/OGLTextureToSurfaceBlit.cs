...
[JniSignatureAttribute("Lsun/java2d/opengl/OGLTextureToSurfaceBlit;", "")]
public partial class OGLTextureToSurfaceBlit
	: Dova.JDK.sun.java2d.loops.Blit
{
	...
	static OGLTextureToSurfaceBlit()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/java2d/opengl/OGLTextureToSurfaceBlit;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "OGLTextureToSurfaceBlit", "()V"));
	...
	public OGLTextureToSurfaceBlit(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public OGLTextureToSurfaceBlit() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/java2d/opengl/OGLTextureToSurfaceBlit;";
