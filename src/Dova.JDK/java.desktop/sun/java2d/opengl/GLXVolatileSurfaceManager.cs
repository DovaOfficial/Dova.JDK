	...
	: Dova.JDK.sun.awt.image.VolatileSurfaceManager
{
	...
	static GLXVolatileSurfaceManager()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "accelerationEnabled", "Z"));
	...
	public GLXVolatileSurfaceManager(Dova.JDK.sun.awt.image.SunVolatileImage arg0, Dova.JDK.java.lang.Object arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
