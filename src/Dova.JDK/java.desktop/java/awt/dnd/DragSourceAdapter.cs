	...
	, Dova.JDK.java.awt.dnd.DragSourceMotionListener
{
	...
	static DragSourceAdapter()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DragSourceAdapter", "()V"));
	...
	public DragSourceAdapter() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
