	...
	: IJavaObject
{
	...
	static Autoscroll()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "autoscroll", "(Ljava/awt/Point;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getAutoscrollInsets", "()Ljava/awt/Insets;"));
	}
