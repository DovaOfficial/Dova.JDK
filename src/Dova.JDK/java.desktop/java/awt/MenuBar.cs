	...
	, Dova.JDK.javax.accessibility.Accessible
{
	...
	static MenuBar()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/awt/MenuBar;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "menus", "Ljava/util/Vector;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "helpMenu", "Ljava/awt/Menu;"));
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "menuBarSerializedDataVersion", "I"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MenuBar", "()V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "add", "(Ljava/awt/Menu;)Ljava/awt/Menu;"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "shortcuts", "()Ljava/util/Enumeration;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getMenu", "(I)Ljava/awt/Menu;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getMenuCount", "()I"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "setHelpMenu", "(Ljava/awt/Menu;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getHelpMenu", "()Ljava/awt/Menu;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "handleShortcut", "(Ljava/awt/event/KeyEvent;)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "countMenus", "()I"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getMenuCountImpl", "()I"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getMenuImpl", "(I)Ljava/awt/Menu;"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getAccessibleChildIndex", "(Ljava/awt/MenuComponent;)I"));
	...
	public Dova.JDK.java.util.Vector menus_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Ljava/awt/Menu;", "private volatile")]
	public Dova.JDK.java.awt.Menu helpMenu_Property
	{
		get
		{
	...
	public int menuBarSerializedDataVersion_Property
	{
		get
		{
	...
	public MenuBar(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public MenuBar() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/awt/MenuBar;";
	public override IntPtr GetJavaClassRaw() => ClassPtr;
	public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;

	[JniSignatureAttribute("(Ljava/awt/Menu;)Ljava/awt/Menu;", "public")]
	public Dova.JDK.java.awt.Menu add(Dova.JDK.java.awt.Menu arg0)
	{
	...
	[JniSignatureAttribute("(I)Ljava/awt/Menu;", "public")]
	public Dova.JDK.java.awt.Menu getMenu(int arg0)
	{
	...
	public void setHelpMenu(Dova.JDK.java.awt.Menu arg0)
	{
		DovaJvm.Vm.Runtime.CallVoidMethodA(CurrentRefPtr, MethodPtrs[9], arg0);
	}

	[JniSignatureAttribute("()Ljava/awt/Menu;", "public")]
	public Dova.JDK.java.awt.Menu getHelpMenu()
	{
	...
	public int getMenuCountImpl()
	{
		var ret = DovaJvm.Vm.Runtime.CallIntMethodA(CurrentRefPtr, MethodPtrs[13]);
		return ret;
	}

	[JniSignatureAttribute("(I)Ljava/awt/Menu;", "final")]
	public Dova.JDK.java.awt.Menu getMenuImpl(int arg0)
	{
		var ret = DovaJvm.Vm.Runtime.CallObjectMethodA(CurrentRefPtr, MethodPtrs[14], arg0);
		return DovaInterfaceFactory.Get<Dova.JDK.java.awt.Menu>(ret);
	}

	[JniSignatureAttribute("(Ljava/awt/MenuShortcut;)Ljava/awt/MenuItem;", "public")]
	...
	[JniSignatureAttribute("Ljava/awt/MenuBar$AccessibleAWTMenuBar;", "protected")]
	public partial class AccessibleAWTMenuBar
		: Dova.JDK.java.awt.MenuComponent.AccessibleAWTMenuComponent
	{
		...
		static AccessibleAWTMenuBar()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/awt/MenuBar$AccessibleAWTMenuBar;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "this$0", "Ljava/awt/MenuBar;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AccessibleAWTMenuBar", "(Ljava/awt/MenuBar;)V"));
		...
		[JniSignatureAttribute("Ljava/awt/MenuBar;", "final")]
		public Dova.JDK.java.awt.MenuBar this0_Property
		{
			get
			{
				var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[1]);
		...
		[JniSignatureAttribute("(System.IntPtr)V", "public")]
		public AccessibleAWTMenuBar(IntPtr currentRefPtr) : base(currentRefPtr)
		{
		}

		[JniSignatureAttribute("(Ljava/awt/MenuBar;)V", "protected")]
		public AccessibleAWTMenuBar(Dova.JDK.java.awt.MenuBar arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}

		public override string GetJavaClassSignature() => "Ljava/awt/MenuBar$AccessibleAWTMenuBar;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
