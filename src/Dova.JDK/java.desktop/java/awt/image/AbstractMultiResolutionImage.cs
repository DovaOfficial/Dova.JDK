	...
	, Dova.JDK.java.awt.image.MultiResolutionImage
{
	...
	static AbstractMultiResolutionImage()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AbstractMultiResolutionImage", "()V"));
	...
	public AbstractMultiResolutionImage() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
