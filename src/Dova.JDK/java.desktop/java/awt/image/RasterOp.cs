...
[JniSignatureAttribute("Ljava/awt/image/RasterOp;", "public abstract interface")]
public partial interface RasterOp
	: IJavaObject
{
	...
	static RasterOp()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/awt/image/RasterOp;");
	...
	[JniSignatureAttribute("(Ljava/awt/image/Raster;Ljava/awt/image/WritableRaster;)Ljava/awt/image/WritableRaster;", "public abstract")]
	Dova.JDK.java.awt.image.WritableRaster filter(Dova.JDK.java.awt.image.Raster arg0, Dova.JDK.java.awt.image.WritableRaster arg1)
	{
	...
	[JniSignatureAttribute("(Ljava/awt/image/Raster;)Ljava/awt/image/WritableRaster;", "public abstract")]
	Dova.JDK.java.awt.image.WritableRaster createCompatibleDestRaster(Dova.JDK.java.awt.image.Raster arg0)
	{
	...
	[JniSignatureAttribute("(Ljava/awt/image/Raster;)Ljava/awt/geom/Rectangle2D;", "public abstract")]
	Dova.JDK.java.awt.geom.Rectangle2D getBounds2D(Dova.JDK.java.awt.image.Raster arg0)
	{
