	...
	: Dova.JDK.java.lang.Object
{
	...
	static Queue()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "head", "Lsun/awt/EventQueueItem;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "tail", "Lsun/awt/EventQueueItem;"));
