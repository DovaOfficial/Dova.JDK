	...
	, Dova.JDK.java.awt.desktop.SystemEventListener
{
	...
	static AppForegroundListener()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "appRaisedToForeground", "(Ljava/awt/desktop/AppForegroundEvent;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "appMovedToBackground", "(Ljava/awt/desktop/AppForegroundEvent;)V"));
	}
