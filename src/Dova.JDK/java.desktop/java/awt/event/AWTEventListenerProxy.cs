	...
	, Dova.JDK.java.awt.@event.AWTEventListener
{
	...
	static AWTEventListenerProxy()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(JLjava/awt/event/AWTEventListener;)V"));
	...
	public AWTEventListenerProxy(long arg0, Dova.JDK.java.awt.@event.AWTEventListener arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
