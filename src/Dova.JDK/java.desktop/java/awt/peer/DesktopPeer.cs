	...
	: IJavaObject
{
	...
	static DesktopPeer()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/awt/peer/DesktopPeer;");
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "browseFileDirectory", "(Ljava/io/File;)Z"));
