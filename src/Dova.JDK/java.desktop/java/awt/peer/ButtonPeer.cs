...
[JniSignatureAttribute("Ljava/awt/peer/ButtonPeer;", "public abstract interface")]
public partial interface ButtonPeer
	: IJavaObject
	, Dova.JDK.java.awt.peer.ComponentPeer
{
	...
	static ButtonPeer()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/awt/peer/ButtonPeer;");
