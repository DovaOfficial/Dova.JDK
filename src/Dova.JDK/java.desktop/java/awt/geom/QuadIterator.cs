	...
	, Dova.JDK.java.awt.geom.PathIterator
{
	...
	static QuadIterator()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "quad", "Ljava/awt/geom/QuadCurve2D;"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "QuadIterator", "(Ljava/awt/geom/QuadCurve2D;Ljava/awt/geom/AffineTransform;)V"));
	...
	public QuadIterator(Dova.JDK.java.awt.geom.QuadCurve2D arg0, Dova.JDK.java.awt.geom.AffineTransform arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
