	...
	, Dova.JDK.java.awt.geom.PathIterator
{
	...
	static RectIterator()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/awt/geom/Rectangle2D;Ljava/awt/geom/AffineTransform;)V"));
	...
	public RectIterator(Dova.JDK.java.awt.geom.Rectangle2D arg0, Dova.JDK.java.awt.geom.AffineTransform arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
