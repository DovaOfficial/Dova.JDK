	...
	, Dova.JDK.java.awt.geom.PathIterator
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/awt/geom/CubicIterator;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "cubic", "Ljava/awt/geom/CubicCurve2D;"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CubicIterator", "(Ljava/awt/geom/CubicCurve2D;Ljava/awt/geom/AffineTransform;)V"));
	...
	public CubicIterator(Dova.JDK.java.awt.geom.CubicCurve2D arg0, Dova.JDK.java.awt.geom.AffineTransform arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
