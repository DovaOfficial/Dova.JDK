	...
	, Dova.JDK.java.awt.geom.PathIterator
{
	...
	static CubicIterator()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "cubic", "Ljava/awt/geom/CubicCurve2D;"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/awt/geom/CubicCurve2D;Ljava/awt/geom/AffineTransform;)V"));
	...
	public CubicIterator(Dova.JDK.java.awt.geom.CubicCurve2D arg0, Dova.JDK.java.awt.geom.AffineTransform arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
