	...
	: Dova.JDK.java.beans.SimpleBeanInfo
{
	...
	static GenericBeanInfo()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "beanDescriptor", "Ljava/beans/BeanDescriptor;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "events", "[Ljava/beans/EventSetDescriptor;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "defaultEvent", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "properties", "[Ljava/beans/PropertyDescriptor;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "defaultProperty", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "methods", "[Ljava/beans/MethodDescriptor;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "targetBeanInfoRef", "Ljava/lang/ref/Reference;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/beans/BeanDescriptor;[Ljava/beans/EventSetDescriptor;I[Ljava/beans/PropertyDescriptor;I[Ljava/beans/MethodDescriptor;Ljava/beans/BeanInfo;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/beans/GenericBeanInfo;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getTargetBeanInfo", "()Ljava/beans/BeanInfo;"));
	...
	public GenericBeanInfo(Dova.JDK.java.beans.BeanDescriptor arg0, JavaArray<Dova.JDK.java.beans.EventSetDescriptor> arg1, int arg2, JavaArray<Dova.JDK.java.beans.PropertyDescriptor> arg3, int arg4, JavaArray<Dova.JDK.java.beans.MethodDescriptor> arg5, Dova.JDK.java.beans.BeanInfo arg6) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6))
	{
	}

	[JniSignatureAttribute("(Ljava/beans/GenericBeanInfo;)V", "")]
	public GenericBeanInfo(Dova.JDK.java.beans.GenericBeanInfo arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
