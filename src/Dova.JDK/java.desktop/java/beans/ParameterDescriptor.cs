	...
	: Dova.JDK.java.beans.FeatureDescriptor
{
	...
	static ParameterDescriptor()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ParameterDescriptor", "()V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ParameterDescriptor", "(Ljava/beans/ParameterDescriptor;)V"));
	}
	...
	public ParameterDescriptor() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Ljava/beans/ParameterDescriptor;)V", "")]
	public ParameterDescriptor(Dova.JDK.java.beans.ParameterDescriptor arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}
