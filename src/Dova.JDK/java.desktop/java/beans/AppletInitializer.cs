	...
	: IJavaObject
{
	...
	static AppletInitializer()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "initialize", "(Ljava/applet/Applet;Ljava/beans/beancontext/BeanContext;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "activate", "(Ljava/applet/Applet;)V"));
	}
