	...
	: Dova.JDK.javax.imageio.spi.ImageReaderSpi
{
	...
	static PNGImageReaderSpi()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "PNGImageReaderSpi", "()V"));
	...
	public PNGImageReaderSpi() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
