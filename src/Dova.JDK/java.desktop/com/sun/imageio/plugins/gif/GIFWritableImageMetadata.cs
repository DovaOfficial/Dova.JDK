	...
	: Dova.JDK.com.sun.imageio.plugins.gif.GIFImageMetadata
{
	...
	static GIFWritableImageMetadata()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "fromISO8859", "(Ljava/lang/String;)[B"));
	...
	public GIFWritableImageMetadata() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
