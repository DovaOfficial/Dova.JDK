	...
	: Dova.JDK.javax.imageio.ImageWriter
{
	...
	static TIFFImageWriter()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "EXIF_JPEG_COMPRESSION_TYPE", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "DEFAULT_BYTES_PER_STRIP", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TIFFCompressionTypes", "[Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "compressionTypes", "[Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "isCompressionLossless", "[Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "compressionNumbers", "[I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "stream", "Ljavax/imageio/stream/ImageOutputStream;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "headerPosition", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "image", "Ljava/awt/image/RenderedImage;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "imageType", "Ljavax/imageio/ImageTypeSpecifier;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "byteOrder", "Ljava/nio/ByteOrder;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "param", "Ljavax/imageio/ImageWriteParam;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "compressor", "Lcom/sun/imageio/plugins/tiff/TIFFCompressor;"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "tileLength", "I"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "isRescaling", "Z"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "isTiled", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "nativePhotometricInterpretation", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "photometricInterpretation", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "bitsPerSample", "[C"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "nextIFDPointerPos", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "nextSpace", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "prevStreamPosition", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "prevHeaderPosition", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "prevNextSpace", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "isWritingSequence", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "isInsertingEmpty", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "isWritingEmpty", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "currentImage", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "replacePixelsLock", "Ljava/lang/Object;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "replacePixelsIndex", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "replacePixelsMetadata", "Lcom/sun/imageio/plugins/tiff/TIFFImageMetadata;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "replacePixelsTileOffsets", "[J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "replacePixelsByteCounts", "[J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "replacePixelsOffsetsPosition", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "replacePixelsByteCountsPosition", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "replacePixelsRegion", "Ljava/awt/Rectangle;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "inReplacePixelsNest", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "reader", "Lcom/sun/imageio/plugins/tiff/TIFFImageReader;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "insert", "(ILjavax/imageio/IIOImage;Ljavax/imageio/ImageWriteParam;Z)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "write", "(Ljavax/imageio/metadata/IIOMetadata;Ljavax/imageio/IIOImage;Ljavax/imageio/ImageWriteParam;ZZ)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "convertNativeImageMetadata", "(Ljavax/imageio/metadata/IIOMetadata;)Lcom/sun/imageio/plugins/tiff/TIFFImageMetadata;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "convertStandardImageMetadata", "(Ljavax/imageio/metadata/IIOMetadata;)Lcom/sun/imageio/plugins/tiff/TIFFImageMetadata;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setupMetadata", "(Ljava/awt/image/ColorModel;Ljava/awt/image/SampleModel;II)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "isEncodingEmpty", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "markPositions", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "resetPositions", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "initializeScaleTables", "([I)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "writeTile", "(Ljava/awt/Rectangle;Lcom/sun/imageio/plugins/tiff/TIFFCompressor;)I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "locateIFD", "(I[J[J)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "checkParamsEmpty", "(Ljavax/imageio/ImageTypeSpecifier;IILjava/util/List;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "readIFD", "(I)Lcom/sun/imageio/plugins/tiff/TIFFIFD;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "subsample", "(Ljava/awt/image/Raster;[IIIIIIILjava/awt/Rectangle;)Ljava/awt/image/Raster;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getImageType", "()Ljavax/imageio/ImageTypeSpecifier;"));
	...
	public long nextIFDPointerPos_Property
	{
		...
		set
		{
			DovaVM.Runtime.SetLongField(CurrentRefPtr, FieldPtrs[48], value);
		}
	}
	...
	public long nextSpace_Property
	{
		...
		set
		{
			DovaVM.Runtime.SetLongField(CurrentRefPtr, FieldPtrs[49], value);
		}
	}
	...
	public long prevStreamPosition_Property
	{
		...
		set
		{
			DovaVM.Runtime.SetLongField(CurrentRefPtr, FieldPtrs[50], value);
		}
	}
	...
	public long replacePixelsOffsetsPosition_Property
	{
		...
		set
		{
			DovaVM.Runtime.SetLongField(CurrentRefPtr, FieldPtrs[62], value);
		}
	}
	...
	public TIFFImageWriter(Dova.JDK.javax.imageio.spi.ImageWriterSpi arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
