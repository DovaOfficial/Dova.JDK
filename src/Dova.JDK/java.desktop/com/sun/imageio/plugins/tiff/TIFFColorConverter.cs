	...
	: Dova.JDK.java.lang.Object
{
	...
	static TIFFColorConverter()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TIFFColorConverter", "()V"));
	...
	public TIFFColorConverter() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
