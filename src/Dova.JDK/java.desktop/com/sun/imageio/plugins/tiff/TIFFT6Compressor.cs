	...
	: Dova.JDK.com.sun.imageio.plugins.tiff.TIFFFaxCompressor
{
	...
	static TIFFT6Compressor()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TIFFT6Compressor", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "encodeT6", "([BIIII[B)I"));
	...
	public TIFFT6Compressor() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
