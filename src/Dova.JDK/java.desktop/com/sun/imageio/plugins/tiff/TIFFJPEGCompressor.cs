	...
	: Dova.JDK.com.sun.imageio.plugins.tiff.TIFFBaseJPEGCompressor
{
	...
	static TIFFJPEGCompressor()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CHROMA_SUBSAMPLING", "I"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljavax/imageio/ImageWriteParam;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "getJPEGTablesReader", "()Ljavax/imageio/ImageReader;"));
	...
	public TIFFJPEGCompressor(Dova.JDK.javax.imageio.ImageWriteParam arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
		...
		, Dova.JDK.javax.imageio.spi.ServiceRegistry.Filter
	{
		...
		public JPEGSPIFilter() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
		{
		}
