	...
	: Dova.JDK.com.sun.imageio.plugins.tiff.TIFFMetadataFormat
{
	...
	static TIFFStreamMetadataFormat()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "theInstance", "Lcom/sun/imageio/plugins/tiff/TIFFStreamMetadataFormat;"));
	...
	public TIFFStreamMetadataFormat() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
