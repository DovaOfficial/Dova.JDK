	...
	: Dova.JDK.com.sun.imageio.plugins.tiff.TIFFDeflater
{
	...
	static TIFFDeflateCompressor()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljavax/imageio/ImageWriteParam;I)V"));
	}
	...
	public TIFFDeflateCompressor(Dova.JDK.javax.imageio.ImageWriteParam arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
