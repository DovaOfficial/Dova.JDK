	...
	: Dova.JDK.com.sun.imageio.plugins.common.I18NImpl
{
	...
	static I18N()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/imageio/plugins/common/I18N;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "resource_name", "Ljava/lang/String;"));
