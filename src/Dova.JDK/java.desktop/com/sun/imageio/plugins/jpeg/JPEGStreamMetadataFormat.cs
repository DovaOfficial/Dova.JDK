	...
	: Dova.JDK.com.sun.imageio.plugins.jpeg.JPEGMetadataFormat
{
	...
	static JPEGStreamMetadataFormat()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "theInstance", "Lcom/sun/imageio/plugins/jpeg/JPEGStreamMetadataFormat;"));
	...
	public JPEGStreamMetadataFormat() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
