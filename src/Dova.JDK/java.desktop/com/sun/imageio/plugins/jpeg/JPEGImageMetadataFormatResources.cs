	...
	: Dova.JDK.com.sun.imageio.plugins.jpeg.JPEGMetadataFormatResources
{
	...
	static JPEGImageMetadataFormatResources()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "imageContents", "[[Ljava/lang/Object;"));
	...
	public JPEGImageMetadataFormatResources() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
