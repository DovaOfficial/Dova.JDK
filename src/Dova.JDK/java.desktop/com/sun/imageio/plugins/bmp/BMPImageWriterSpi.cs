...
[JniSignatureAttribute("Lcom/sun/imageio/plugins/bmp/BMPImageWriterSpi;", "public")]
public partial class BMPImageWriterSpi
	: Dova.JDK.javax.imageio.spi.ImageWriterSpi
{
	...
	static BMPImageWriterSpi()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/imageio/plugins/bmp/BMPImageWriterSpi;");
	...
	public BMPImageWriterSpi(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public BMPImageWriterSpi() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/imageio/plugins/bmp/BMPImageWriterSpi;";
