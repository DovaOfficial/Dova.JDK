	...
	: Dova.JDK.javax.imageio.metadata.IIOMetadata
{
	...
	static WBMPMetadata()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "WBMPMetadata", "()V"));
	...
	public WBMPMetadata() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
