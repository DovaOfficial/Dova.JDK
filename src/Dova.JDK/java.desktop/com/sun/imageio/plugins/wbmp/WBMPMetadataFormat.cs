	...
	: Dova.JDK.javax.imageio.metadata.IIOMetadataFormatImpl
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/imageio/plugins/wbmp/WBMPMetadataFormat;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "WBMPMetadataFormat", "()V"));
	...
	public WBMPMetadataFormat() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
