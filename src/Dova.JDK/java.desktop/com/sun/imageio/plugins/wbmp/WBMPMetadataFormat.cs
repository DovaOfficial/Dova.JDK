	...
	: Dova.JDK.javax.imageio.metadata.IIOMetadataFormatImpl
{
	...
	static WBMPMetadataFormat()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "WBMPMetadataFormat", "()V"));
	...
	public WBMPMetadataFormat() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
