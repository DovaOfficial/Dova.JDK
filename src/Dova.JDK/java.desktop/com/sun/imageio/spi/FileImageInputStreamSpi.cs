	...
	: Dova.JDK.javax.imageio.spi.ImageInputStreamSpi
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/imageio/spi/FileImageInputStreamSpi;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FileImageInputStreamSpi", "()V"));
	...
	public FileImageInputStreamSpi() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
