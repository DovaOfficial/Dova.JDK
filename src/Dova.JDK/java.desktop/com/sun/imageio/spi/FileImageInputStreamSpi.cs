	...
	: Dova.JDK.javax.imageio.spi.ImageInputStreamSpi
{
	...
	static FileImageInputStreamSpi()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FileImageInputStreamSpi", "()V"));
	...
	public FileImageInputStreamSpi() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
