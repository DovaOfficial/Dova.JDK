	...
	: Dova.JDK.javax.imageio.spi.ImageInputStreamSpi
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/imageio/spi/InputStreamImageInputStreamSpi;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "InputStreamImageInputStreamSpi", "()V"));
	...
	public InputStreamImageInputStreamSpi() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
