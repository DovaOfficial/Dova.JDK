	...
	: Dova.JDK.javax.imageio.spi.ImageOutputStreamSpi
{
	...
	static OutputStreamImageOutputStreamSpi()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OutputStreamImageOutputStreamSpi", "()V"));
	...
	public OutputStreamImageOutputStreamSpi() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
