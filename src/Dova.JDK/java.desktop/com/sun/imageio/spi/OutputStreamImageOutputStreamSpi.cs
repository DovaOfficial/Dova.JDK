	...
	: Dova.JDK.javax.imageio.spi.ImageOutputStreamSpi
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/imageio/spi/OutputStreamImageOutputStreamSpi;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "OutputStreamImageOutputStreamSpi", "()V"));
	...
	public OutputStreamImageOutputStreamSpi() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
