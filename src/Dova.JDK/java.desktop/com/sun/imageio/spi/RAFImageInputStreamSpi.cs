...
[JniSignatureAttribute("Lcom/sun/imageio/spi/RAFImageInputStreamSpi;", "public")]
public partial class RAFImageInputStreamSpi
	: Dova.JDK.javax.imageio.spi.ImageInputStreamSpi
{
	...
	static RAFImageInputStreamSpi()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/imageio/spi/RAFImageInputStreamSpi;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "inputClass", "Ljava/lang/Class;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "RAFImageInputStreamSpi", "()V"));
	...
	public RAFImageInputStreamSpi(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public RAFImageInputStreamSpi() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/imageio/spi/RAFImageInputStreamSpi;";
