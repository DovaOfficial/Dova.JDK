	...
	: Dova.JDK.com.sun.beans.decoder.ObjectElementHandler
{
	...
	static VoidElementHandler()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "VoidElementHandler", "()V"));
	...
	public VoidElementHandler() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
