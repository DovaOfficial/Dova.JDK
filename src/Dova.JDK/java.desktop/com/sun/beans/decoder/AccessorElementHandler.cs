	...
	: Dova.JDK.com.sun.beans.decoder.ElementHandler
{
	...
	static AccessorElementHandler()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AccessorElementHandler", "()V"));
	...
	public AccessorElementHandler() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
