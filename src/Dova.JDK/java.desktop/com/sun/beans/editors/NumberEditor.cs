...
[JniSignatureAttribute("Lcom/sun/beans/editors/NumberEditor;", "public abstract")]
	...
	: Dova.JDK.java.beans.PropertyEditorSupport
{
	...
	static NumberEditor()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/beans/editors/NumberEditor;");
	...
	public override string GetJavaClassSignature() => "Lcom/sun/beans/editors/NumberEditor;";
