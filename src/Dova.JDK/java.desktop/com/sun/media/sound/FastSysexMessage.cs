	...
	: Dova.JDK.javax.sound.midi.SysexMessage
{
	...
	static FastSysexMessage()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getReadOnlyMessage", "()[B"));
	...
	public FastSysexMessage(JavaArray<byte> arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
