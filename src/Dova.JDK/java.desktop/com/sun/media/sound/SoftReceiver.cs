	...
	, Dova.JDK.javax.sound.midi.MidiDeviceReceiver
{
	...
	static SoftReceiver()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SoftReceiver", "(Lcom/sun/media/sound/SoftSynthesizer;)V"));
	...
	public SoftReceiver(Dova.JDK.com.sun.media.sound.SoftSynthesizer arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
