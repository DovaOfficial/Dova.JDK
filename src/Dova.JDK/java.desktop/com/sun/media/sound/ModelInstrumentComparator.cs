	...
	, Dova.JDK.java.util.Comparator
{
	...
	static ModelInstrumentComparator()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "compare", "(Ljavax/sound/midi/Instrument;Ljavax/sound/midi/Instrument;)I"));
	...
	public ModelInstrumentComparator() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
