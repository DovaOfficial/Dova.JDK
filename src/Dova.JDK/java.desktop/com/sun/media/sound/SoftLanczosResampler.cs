	...
	: Dova.JDK.com.sun.media.sound.SoftAbstractResampler
{
	...
	static SoftLanczosResampler()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "sincTable", "(IF)[F"));
	...
	public SoftLanczosResampler() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
