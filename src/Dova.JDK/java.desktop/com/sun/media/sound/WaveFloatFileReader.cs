...
[JniSignatureAttribute("Lcom/sun/media/sound/WaveFloatFileReader;", "public final")]
public partial class WaveFloatFileReader
	: Dova.JDK.com.sun.media.sound.SunFileReader
{
	...
	static WaveFloatFileReader()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/media/sound/WaveFloatFileReader;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "WaveFloatFileReader", "()V"));
	...
	public WaveFloatFileReader(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public WaveFloatFileReader() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/media/sound/WaveFloatFileReader;";
