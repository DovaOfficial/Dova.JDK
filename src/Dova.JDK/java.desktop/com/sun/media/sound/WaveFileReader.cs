	...
	: Dova.JDK.com.sun.media.sound.SunFileReader
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/media/sound/WaveFileReader;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "WaveFileReader", "()V"));
	...
	public WaveFileReader() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
