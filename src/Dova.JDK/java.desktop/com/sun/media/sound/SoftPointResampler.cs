	...
	: Dova.JDK.com.sun.media.sound.SoftAbstractResampler
{
	...
	static SoftPointResampler()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SoftPointResampler", "()V"));
	...
	public SoftPointResampler() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
