	...
	: Dova.JDK.com.sun.media.sound.SunFileReader
{
	...
	static AuFileReader()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AuFileReader", "()V"));
	...
	public AuFileReader() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
