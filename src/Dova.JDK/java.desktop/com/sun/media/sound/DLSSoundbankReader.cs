	...
	: Dova.JDK.javax.sound.midi.spi.SoundbankReader
{
	...
	static DLSSoundbankReader()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DLSSoundbankReader", "()V"));
	...
	public DLSSoundbankReader() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
