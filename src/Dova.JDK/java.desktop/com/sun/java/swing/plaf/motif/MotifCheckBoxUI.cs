	...
	: Dova.JDK.com.sun.java.swing.plaf.motif.MotifRadioButtonUI
{
	...
	static MotifCheckBoxUI()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "MOTIF_CHECK_BOX_UI_KEY", "Ljava/lang/Object;"));
	...
	public MotifCheckBoxUI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
