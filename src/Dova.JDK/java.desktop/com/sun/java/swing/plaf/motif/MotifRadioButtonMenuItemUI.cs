...
[JniSignatureAttribute("Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;", "public")]
public partial class MotifRadioButtonMenuItemUI
	: Dova.JDK.javax.swing.plaf.basic.BasicRadioButtonMenuItemUI
{
	...
	static MotifRadioButtonMenuItemUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "changeListener", "Ljavax/swing/event/ChangeListener;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MotifRadioButtonMenuItemUI", "()V"));
	...
	public MotifRadioButtonMenuItemUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public MotifRadioButtonMenuItemUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;";
	...
	[JniSignatureAttribute("Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI$ChangeHandler;", "protected")]
		...
		, Dova.JDK.java.io.Serializable
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI$ChangeHandler;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "this$0", "Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ChangeHandler", "(Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "stateChanged", "(Ljavax/swing/event/ChangeEvent;)V"));
		}

		[JniSignatureAttribute("Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;", "final")]
		public Dova.JDK.com.sun.java.swing.plaf.motif.MotifRadioButtonMenuItemUI this0_Property
		{
			get
			{
				var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[0]);
				return DovaInterfaceFactory.Get<Dova.JDK.com.sun.java.swing.plaf.motif.MotifRadioButtonMenuItemUI>(ret);
			}
			set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[0], value.CurrentRefPtr);
		}
		...
		[JniSignatureAttribute("(Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;)V", "protected")]
		public ChangeHandler(Dova.JDK.com.sun.java.swing.plaf.motif.MotifRadioButtonMenuItemUI arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}

		public override string GetJavaClassSignature() => "Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI$ChangeHandler;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
	...
	[JniSignatureAttribute("Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI$MouseInputHandler;", "protected")]
		...
		, Dova.JDK.javax.swing.@event.MouseInputListener
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI$MouseInputHandler;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "this$0", "Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MouseInputHandler", "(Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;)V"));
		...
		[JniSignatureAttribute("(Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI;)V", "protected")]
		public MouseInputHandler(Dova.JDK.com.sun.java.swing.plaf.motif.MotifRadioButtonMenuItemUI arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}

		public override string GetJavaClassSignature() => "Lcom/sun/java/swing/plaf/motif/MotifRadioButtonMenuItemUI$MouseInputHandler;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
