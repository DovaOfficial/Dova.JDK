	...
	: Dova.JDK.javax.swing.plaf.basic.BasicMenuItemUI
{
	...
	public MotifMenuItemUI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
		...
		, Dova.JDK.javax.swing.@event.ChangeListener
	{
		...
		static ChangeHandler()
		{
			...
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;)V"));
		...
		public ChangeHandler(Dova.JDK.com.sun.java.swing.plaf.motif.MotifMenuItemUI arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
		{
		}
		...
		, Dova.JDK.javax.swing.@event.MouseInputListener
	{
		...
		static MouseInputHandler()
		{
			...
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "this$0", "Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;"));
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;)V"));
		...
		[JniSignatureAttribute("(Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;)V", "protected")]
		public MouseInputHandler(Dova.JDK.com.sun.java.swing.plaf.motif.MotifMenuItemUI arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
		{
		}
