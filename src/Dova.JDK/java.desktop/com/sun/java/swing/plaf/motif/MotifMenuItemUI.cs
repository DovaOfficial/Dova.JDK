...
[JniSignatureAttribute("Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;", "public")]
public partial class MotifMenuItemUI
	: Dova.JDK.javax.swing.plaf.basic.BasicMenuItemUI
{
	...
	static MotifMenuItemUI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "changeListener", "Ljavax/swing/event/ChangeListener;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MotifMenuItemUI", "()V"));
	...
	public MotifMenuItemUI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public MotifMenuItemUI() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;";
	...
	[JniSignatureAttribute("Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI$ChangeHandler;", "protected")]
		...
		, Dova.JDK.javax.swing.@event.ChangeListener
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI$ChangeHandler;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ChangeHandler", "(Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;)V"));
		...
		[JniSignatureAttribute("(Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;)V", "protected")]
		public ChangeHandler(Dova.JDK.com.sun.java.swing.plaf.motif.MotifMenuItemUI arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}

		public override string GetJavaClassSignature() => "Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI$ChangeHandler;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
	...
	[JniSignatureAttribute("Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI$MouseInputHandler;", "protected")]
		...
		, Dova.JDK.javax.swing.@event.MouseInputListener
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI$MouseInputHandler;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "this$0", "Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MouseInputHandler", "(Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;)V"));
		...
		[JniSignatureAttribute("Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;", "final")]
		public Dova.JDK.com.sun.java.swing.plaf.motif.MotifMenuItemUI this0_Property
		{
			get
			{
				var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[0]);
				return DovaInterfaceFactory.Get<Dova.JDK.com.sun.java.swing.plaf.motif.MotifMenuItemUI>(ret);
			}
			set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[0], value.CurrentRefPtr);
		}
		...
		[JniSignatureAttribute("(Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI;)V", "protected")]
		public MouseInputHandler(Dova.JDK.com.sun.java.swing.plaf.motif.MotifMenuItemUI arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}

		public override string GetJavaClassSignature() => "Lcom/sun/java/swing/plaf/motif/MotifMenuItemUI$MouseInputHandler;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
