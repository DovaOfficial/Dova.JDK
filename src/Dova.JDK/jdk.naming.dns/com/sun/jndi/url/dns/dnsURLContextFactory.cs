...
[JniSignatureAttribute("Lcom/sun/jndi/url/dns/dnsURLContextFactory;", "public")]
public partial class dnsURLContextFactory
	...
	, Dova.JDK.javax.naming.spi.ObjectFactory
{
	...
	static dnsURLContextFactory()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/jndi/url/dns/dnsURLContextFactory;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "dnsURLContextFactory", "()V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getUsingURL", "(Ljava/lang/String;Ljava/util/Hashtable;)Ljava/lang/Object;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getUsingURLs", "([Ljava/lang/String;Ljava/util/Hashtable;)Ljava/lang/Object;"));
	}

	[JniSignatureAttribute("(System.IntPtr)V", "public")]
	public dnsURLContextFactory(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public dnsURLContextFactory() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/jndi/url/dns/dnsURLContextFactory;";
