...
[JniSignatureAttribute("Lorg/w3c/dom/html/HTMLCollection;", "public abstract interface")]
public partial interface HTMLCollection
	: IJavaObject
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/w3c/dom/html/HTMLCollection;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "namedItem", "(Ljava/lang/String;)Lorg/w3c/dom/Node;"));
	}
	...
	Dova.JDK.org.w3c.dom.Node namedItem(Dova.JDK.java.lang.String arg0)
	{
