	...
	, Dova.JDK.org.w3c.dom.html.HTMLElement
{
	...
	static HTMLParamElement()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setValueType", "(Ljava/lang/String;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getValueType", "()Ljava/lang/String;"));
