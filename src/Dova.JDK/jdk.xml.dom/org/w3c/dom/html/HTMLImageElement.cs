	...
	, Dova.JDK.org.w3c.dom.html.HTMLElement
{
	...
	static HTMLImageElement()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getLowSrc", "()Ljava/lang/String;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "setLowSrc", "(Ljava/lang/String;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getIsMap", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "setIsMap", "(Z)V"));
