	...
	: IJavaObject
{
	...
	static StyleSheet()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/w3c/dom/stylesheets/StyleSheet;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getParentStyleSheet", "()Lorg/w3c/dom/stylesheets/StyleSheet;"));
