...
[JniSignatureAttribute("Lorg/w3c/dom/css/ElementCSSInlineStyle;", "public abstract interface")]
	...
	: IJavaObject
{
	...
	static ElementCSSInlineStyle()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lorg/w3c/dom/css/ElementCSSInlineStyle;");
