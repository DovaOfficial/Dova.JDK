...
[JniSignatureAttribute("Lorg/w3c/dom/css/Counter;", "public abstract interface")]
	...
	: IJavaObject
{
	...
	static Counter()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/w3c/dom/css/Counter;");
	...
	Dova.JDK.java.lang.String getSeparator()
	{
	...
	[JniSignatureAttribute("()Ljava/lang/String;", "public abstract")]
	Dova.JDK.java.lang.String getIdentifier()
	{
