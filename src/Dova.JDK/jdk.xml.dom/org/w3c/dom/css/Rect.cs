	...
	: IJavaObject
{
	...
	static Rect()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getRight", "()Lorg/w3c/dom/css/CSSPrimitiveValue;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getBottom", "()Lorg/w3c/dom/css/CSSPrimitiveValue;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getLeft", "()Lorg/w3c/dom/css/CSSPrimitiveValue;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getTop", "()Lorg/w3c/dom/css/CSSPrimitiveValue;"));
	}
