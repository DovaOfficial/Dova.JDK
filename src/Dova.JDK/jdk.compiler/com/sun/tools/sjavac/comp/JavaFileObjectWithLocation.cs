	...
	: Dova.JDK.javax.tools.ForwardingJavaFileObject
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/tools/sjavac/comp/JavaFileObjectWithLocation;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "loc", "Ljavax/tools/JavaFileManager$Location;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "JavaFileObjectWithLocation", "(Ljavax/tools/JavaFileObject;Ljavax/tools/JavaFileManager$Location;)V"));
	...
	public JavaFileObjectWithLocation(Dova.JDK.java.lang.Object arg0, Dova.JDK.javax.tools.JavaFileManager.Location arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
