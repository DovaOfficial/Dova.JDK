	...
	, Dova.JDK.com.sun.source.util.DocTreeFactory
{
	...
	static DocTreeMaker()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/tools/javac/tree/DocTreeMaker;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "treeMakerKey", "Lcom/sun/tools/javac/util/Context$Key;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "sentenceBreakTags", "Ljava/util/Set;"));
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "referenceParser", "Lcom/sun/tools/javac/parser/ReferenceParser;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DocTreeMaker", "(Lcom/sun/tools/javac/util/Context;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "cast", "(Ljava/util/List;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "at_0", "(I)Lcom/sun/source/util/DocTreeFactory;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "at_1", "(I)Lcom/sun/tools/javac/tree/DocTreeMaker;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "instance", "(Lcom/sun/tools/javac/util/Context;)Lcom/sun/tools/javac/tree/DocTreeMaker;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "skipWhiteSpace", "(Ljava/lang/String;I)I"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getSentenceBreak", "(Ljava/lang/String;Lcom/sun/source/doctree/DocTree;)I"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newTextTree_0", "(Ljava/lang/String;)Lcom/sun/source/doctree/TextTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newTextTree_1", "(Ljava/lang/String;)Lcom/sun/tools/javac/tree/DCTree$DCText;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "defaultSentenceBreak", "(Ljava/lang/String;)I"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newReturnTree_0", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCReturn;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newReturnTree_1", "(Ljava/util/List;)Lcom/sun/source/doctree/ReturnTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newReturnTree_0", "(ZLjava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCReturn;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newReturnTree_1", "(ZLjava/util/List;)Lcom/sun/source/doctree/ReturnTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newProvidesTree_0", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCProvides;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newProvidesTree_1", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/source/doctree/ProvidesTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newParamTree_0", "(ZLcom/sun/source/doctree/IdentifierTree;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCParam;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newParamTree_1", "(ZLcom/sun/source/doctree/IdentifierTree;Ljava/util/List;)Lcom/sun/source/doctree/ParamTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newLiteralTree_0", "(Lcom/sun/source/doctree/TextTree;)Lcom/sun/tools/javac/tree/DCTree$DCLiteral;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newLiteralTree_1", "(Lcom/sun/source/doctree/TextTree;)Lcom/sun/source/doctree/LiteralTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newLinkPlainTree_0", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/source/doctree/LinkTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newLinkPlainTree_1", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCLink;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newLinkTree_0", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCLink;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newLinkTree_1", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/source/doctree/LinkTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newInheritDocTree_0", "()Lcom/sun/source/doctree/InheritDocTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newInheritDocTree_1", "()Lcom/sun/tools/javac/tree/DCTree$DCInheritDoc;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newIndexTree_0", "(Lcom/sun/source/doctree/DocTree;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCIndex;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newIndexTree_1", "(Lcom/sun/source/doctree/DocTree;Ljava/util/List;)Lcom/sun/source/doctree/IndexTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newIdentifierTree_0", "(Ljavax/lang/model/element/Name;)Lcom/sun/tools/javac/tree/DCTree$DCIdentifier;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newIdentifierTree_1", "(Ljavax/lang/model/element/Name;)Lcom/sun/source/doctree/IdentifierTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newUsesTree_0", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCUses;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newUsesTree_1", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/source/doctree/UsesTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newUnknownInlineTagTree_0", "(Ljavax/lang/model/element/Name;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCUnknownInlineTag;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newUnknownInlineTagTree_1", "(Ljavax/lang/model/element/Name;Ljava/util/List;)Lcom/sun/source/doctree/UnknownInlineTagTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newUnknownBlockTagTree_0", "(Ljavax/lang/model/element/Name;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCUnknownBlockTag;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newUnknownBlockTagTree_1", "(Ljavax/lang/model/element/Name;Ljava/util/List;)Lcom/sun/source/doctree/UnknownBlockTagTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newThrowsTree_0", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCThrows;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newThrowsTree_1", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/source/doctree/ThrowsTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSystemPropertyTree_0", "(Ljavax/lang/model/element/Name;)Lcom/sun/source/doctree/SystemPropertyTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSystemPropertyTree_1", "(Ljavax/lang/model/element/Name;)Lcom/sun/tools/javac/tree/DCTree$DCSystemProperty;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSummaryTree_0", "(Ljava/util/List;)Lcom/sun/source/doctree/SummaryTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSummaryTree_1", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCSummary;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newStartElementTree_0", "(Ljavax/lang/model/element/Name;Ljava/util/List;Z)Lcom/sun/source/doctree/StartElementTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newStartElementTree_1", "(Ljavax/lang/model/element/Name;Ljava/util/List;Z)Lcom/sun/tools/javac/tree/DCTree$DCStartElement;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSnippetTree_0", "(Ljava/util/List;Lcom/sun/source/doctree/TextTree;)Lcom/sun/source/doctree/SnippetTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSnippetTree_1", "(Ljava/util/List;Lcom/sun/source/doctree/TextTree;)Lcom/sun/tools/javac/tree/DCTree$DCSnippet;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSinceTree_0", "(Ljava/util/List;)Lcom/sun/source/doctree/SinceTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSinceTree_1", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCSince;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSerialFieldTree_0", "(Lcom/sun/source/doctree/IdentifierTree;Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCSerialField;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSerialFieldTree_1", "(Lcom/sun/source/doctree/IdentifierTree;Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/source/doctree/SerialFieldTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSerialDataTree_0", "(Ljava/util/List;)Lcom/sun/source/doctree/SerialDataTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSerialDataTree_1", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCSerialData;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSerialTree_0", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCSerial;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSerialTree_1", "(Ljava/util/List;)Lcom/sun/source/doctree/SerialTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSeeTree_0", "(Ljava/util/List;)Lcom/sun/source/doctree/SeeTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newSeeTree_1", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCSee;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newReferenceTree", "(Ljava/lang/String;Lcom/sun/tools/javac/tree/JCTree$JCExpression;Lcom/sun/tools/javac/tree/JCTree;Ljavax/lang/model/element/Name;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCReference;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newReferenceTree_0", "(Ljava/lang/String;)Lcom/sun/source/doctree/ReferenceTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newReferenceTree_1", "(Ljava/lang/String;)Lcom/sun/tools/javac/tree/DCTree$DCReference;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newHiddenTree_0", "(Ljava/util/List;)Lcom/sun/source/doctree/HiddenTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newHiddenTree_1", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCHidden;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newExceptionTree_0", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/source/doctree/ThrowsTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newExceptionTree_1", "(Lcom/sun/source/doctree/ReferenceTree;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCThrows;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newErroneousTree_0", "(Ljava/lang/String;Ljavax/tools/Diagnostic;)Lcom/sun/tools/javac/tree/DCTree$DCErroneous;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newErroneousTree_1", "(Ljava/lang/String;Ljavax/tools/Diagnostic;)Lcom/sun/source/doctree/ErroneousTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newEntityTree_0", "(Ljavax/lang/model/element/Name;)Lcom/sun/source/doctree/EntityTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newEntityTree_1", "(Ljavax/lang/model/element/Name;)Lcom/sun/tools/javac/tree/DCTree$DCEntity;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newEndElementTree_0", "(Ljavax/lang/model/element/Name;)Lcom/sun/source/doctree/EndElementTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newEndElementTree_1", "(Ljavax/lang/model/element/Name;)Lcom/sun/tools/javac/tree/DCTree$DCEndElement;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDocTypeTree_0", "(Ljava/lang/String;)Lcom/sun/tools/javac/tree/DCTree$DCDocType;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDocTypeTree_1", "(Ljava/lang/String;)Lcom/sun/source/doctree/DocTypeTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDocRootTree_0", "()Lcom/sun/source/doctree/DocRootTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDocRootTree_1", "()Lcom/sun/tools/javac/tree/DCTree$DCDocRoot;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDeprecatedTree_0", "(Ljava/util/List;)Lcom/sun/source/doctree/DeprecatedTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDeprecatedTree_1", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCDeprecated;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newCommentTree_0", "(Ljava/lang/String;)Lcom/sun/source/doctree/CommentTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newCommentTree_1", "(Ljava/lang/String;)Lcom/sun/tools/javac/tree/DCTree$DCComment;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "splitBody", "(Ljava/util/Collection;)Lcom/sun/tools/javac/util/Pair;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDocCommentTree", "(Lcom/sun/tools/javac/parser/Tokens$Comment;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCDocComment;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDocCommentTree_0", "(Ljava/util/List;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCDocComment;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDocCommentTree_1", "(Ljava/util/List;Ljava/util/List;)Lcom/sun/source/doctree/DocCommentTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDocCommentTree_0", "(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCDocComment;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newDocCommentTree_1", "(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Lcom/sun/source/doctree/DocCommentTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newCodeTree_0", "(Lcom/sun/source/doctree/TextTree;)Lcom/sun/source/doctree/LiteralTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newCodeTree_1", "(Lcom/sun/source/doctree/TextTree;)Lcom/sun/tools/javac/tree/DCTree$DCLiteral;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newAuthorTree_0", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCAuthor;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newAuthorTree_1", "(Ljava/util/List;)Lcom/sun/source/doctree/AuthorTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newAttributeTree_0", "(Ljavax/lang/model/element/Name;Lcom/sun/source/doctree/AttributeTree$ValueKind;Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCAttribute;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newAttributeTree_1", "(Ljavax/lang/model/element/Name;Lcom/sun/source/doctree/AttributeTree$ValueKind;Ljava/util/List;)Lcom/sun/source/doctree/AttributeTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isSentenceBreak", "(Lcom/sun/source/doctree/DocTree;Z)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isSentenceBreak", "(Ljavax/lang/model/element/Name;)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isTextTree", "(Lcom/sun/source/doctree/DocTree;)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newVersionTree_0", "(Ljava/util/List;)Lcom/sun/source/doctree/VersionTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newVersionTree_1", "(Ljava/util/List;)Lcom/sun/tools/javac/tree/DCTree$DCVersion;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newValueTree_0", "(Lcom/sun/source/doctree/ReferenceTree;)Lcom/sun/source/doctree/ValueTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "newValueTree_1", "(Lcom/sun/source/doctree/ReferenceTree;)Lcom/sun/tools/javac/tree/DCTree$DCValue;"));
	...
	public DocTreeMaker(Dova.JDK.com.sun.tools.javac.util.Context arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
	...
	{
		var ret = DovaJvm.Vm.Runtime.CallObjectMethodA(CurrentRefPtr, MethodPtrs[55], arg0, arg1, arg2, arg3, arg4);
