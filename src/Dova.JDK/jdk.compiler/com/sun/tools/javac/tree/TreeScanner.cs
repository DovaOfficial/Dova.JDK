...
[JniSignatureAttribute("Lcom/sun/tools/javac/tree/TreeScanner;", "public")]
	...
	: Dova.JDK.com.sun.tools.javac.tree.JCTree.Visitor
{
	...
	static TreeScanner()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/tools/javac/tree/TreeScanner;");
	...
	public TreeScanner() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/tools/javac/tree/TreeScanner;";
