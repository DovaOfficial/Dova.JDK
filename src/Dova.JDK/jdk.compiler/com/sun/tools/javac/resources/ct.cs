	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static ct()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/tools/javac/resources/ct;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ct", "()V"));
	...
	public ct() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
