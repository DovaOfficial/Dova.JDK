...
[JniSignatureAttribute("Lcom/sun/tools/javac/resources/ct;", "public final")]
	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static ct()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/tools/javac/resources/ct;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ct", "()V"));
	...
	public ct() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/tools/javac/resources/ct;";
