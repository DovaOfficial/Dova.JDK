	...
	: Dova.JDK.java.lang.Object
{
	...
	static Main()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/tools/javac/Main;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "compile", "([Ljava/lang/String;Ljava/io/PrintWriter;)I"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "compile", "([Ljava/lang/String;)I"));
	}
