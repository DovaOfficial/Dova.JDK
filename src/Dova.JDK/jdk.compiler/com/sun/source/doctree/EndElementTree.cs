...
[JniSignatureAttribute("Lcom/sun/source/doctree/EndElementTree;", "public abstract interface")]
public partial interface EndElementTree
	: IJavaObject
	, Dova.JDK.com.sun.source.doctree.DocTree
{
	...
	static EndElementTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/doctree/EndElementTree;");
