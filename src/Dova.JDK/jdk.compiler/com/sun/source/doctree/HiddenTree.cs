...
[JniSignatureAttribute("Lcom/sun/source/doctree/HiddenTree;", "public abstract interface")]
public partial interface HiddenTree
	: IJavaObject
	, Dova.JDK.com.sun.source.doctree.BlockTagTree
{
	...
	static HiddenTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/doctree/HiddenTree;");
