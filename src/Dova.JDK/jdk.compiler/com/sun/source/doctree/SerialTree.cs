...
[JniSignatureAttribute("Lcom/sun/source/doctree/SerialTree;", "public abstract interface")]
public partial interface SerialTree
	: IJavaObject
	, Dova.JDK.com.sun.source.doctree.BlockTagTree
{
	...
	static SerialTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/doctree/SerialTree;");
