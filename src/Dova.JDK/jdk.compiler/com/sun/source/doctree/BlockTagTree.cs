...
[JniSignatureAttribute("Lcom/sun/source/doctree/BlockTagTree;", "public abstract interface")]
public partial interface BlockTagTree
	: IJavaObject
	, Dova.JDK.com.sun.source.doctree.DocTree
{
	...
	static BlockTagTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/doctree/BlockTagTree;");
