...
[JniSignatureAttribute("Lcom/sun/source/doctree/VersionTree;", "public abstract interface")]
public partial interface VersionTree
	: IJavaObject
	, Dova.JDK.com.sun.source.doctree.BlockTagTree
{
	...
	static VersionTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/doctree/VersionTree;");
