...
[JniSignatureAttribute("Lcom/sun/source/doctree/SinceTree;", "public abstract interface")]
public partial interface SinceTree
	: IJavaObject
	, Dova.JDK.com.sun.source.doctree.BlockTagTree
{
	...
	static SinceTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/doctree/SinceTree;");
