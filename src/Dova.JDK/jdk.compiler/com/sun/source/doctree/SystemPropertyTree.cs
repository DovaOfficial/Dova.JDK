...
[JniSignatureAttribute("Lcom/sun/source/doctree/SystemPropertyTree;", "public abstract interface")]
public partial interface SystemPropertyTree
	: IJavaObject
	, Dova.JDK.com.sun.source.doctree.InlineTagTree
{
	...
	static SystemPropertyTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/doctree/SystemPropertyTree;");
	...
	Dova.JDK.javax.lang.model.element.Name getPropertyName()
	{
