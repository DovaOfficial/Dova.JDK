...
[JniSignatureAttribute("Lcom/sun/source/tree/UnaryTree;", "public abstract interface")]
public partial interface UnaryTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.ExpressionTree
{
	...
	static UnaryTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/tree/UnaryTree;");
