	...
	, Dova.JDK.com.sun.source.tree.ExpressionTree
{
	...
	static BinaryTree()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getRightOperand", "()Lcom/sun/source/tree/ExpressionTree;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getLeftOperand", "()Lcom/sun/source/tree/ExpressionTree;"));
	}
