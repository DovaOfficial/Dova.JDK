...
[JniSignatureAttribute("Lcom/sun/source/tree/GuardedPatternTree;", "public abstract interface")]
public partial interface GuardedPatternTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.PatternTree
{
	...
	static GuardedPatternTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/tree/GuardedPatternTree;");
