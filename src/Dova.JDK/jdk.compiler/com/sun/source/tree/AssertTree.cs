...
[JniSignatureAttribute("Lcom/sun/source/tree/AssertTree;", "public abstract interface")]
public partial interface AssertTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.StatementTree
{
	...
	static AssertTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/tree/AssertTree;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getCondition", "()Lcom/sun/source/tree/ExpressionTree;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getDetail", "()Lcom/sun/source/tree/ExpressionTree;"));
	}
	...
	[JniSignatureAttribute("()Lcom/sun/source/tree/ExpressionTree;", "public abstract")]
	Dova.JDK.com.sun.source.tree.ExpressionTree getDetail()
	{
