...
[JniSignatureAttribute("Lcom/sun/source/tree/WhileLoopTree;", "public abstract interface")]
public partial interface WhileLoopTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.StatementTree
{
	...
	static WhileLoopTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/tree/WhileLoopTree;");
