...
[JniSignatureAttribute("Lcom/sun/source/tree/VariableTree;", "public abstract interface")]
public partial interface VariableTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.StatementTree
{
	...
	static VariableTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/tree/VariableTree;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getName", "()Ljavax/lang/model/element/Name;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getModifiers", "()Lcom/sun/source/tree/ModifiersTree;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getType", "()Lcom/sun/source/tree/Tree;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getInitializer", "()Lcom/sun/source/tree/ExpressionTree;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getNameExpression", "()Lcom/sun/source/tree/ExpressionTree;"));
	}
	...
	Dova.JDK.com.sun.source.tree.ExpressionTree getInitializer()
	{
	...
	[JniSignatureAttribute("()Lcom/sun/source/tree/ExpressionTree;", "public abstract")]
	Dova.JDK.com.sun.source.tree.ExpressionTree getNameExpression()
	{
