	...
	, Dova.JDK.com.sun.source.tree.StatementTree
{
	...
	static VariableTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/tree/VariableTree;");
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getInitializer", "()Lcom/sun/source/tree/ExpressionTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getNameExpression", "()Lcom/sun/source/tree/ExpressionTree;"));
	}
