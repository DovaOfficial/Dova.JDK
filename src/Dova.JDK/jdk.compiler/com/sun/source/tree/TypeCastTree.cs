...
[JniSignatureAttribute("Lcom/sun/source/tree/TypeCastTree;", "public abstract interface")]
public partial interface TypeCastTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.ExpressionTree
{
	...
	static TypeCastTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/tree/TypeCastTree;");
