...
[JniSignatureAttribute("Lcom/sun/source/tree/ThrowTree;", "public abstract interface")]
public partial interface ThrowTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.StatementTree
{
	...
	static ThrowTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/tree/ThrowTree;");
