...
[JniSignatureAttribute("Lcom/sun/source/tree/MemberSelectTree;", "public abstract interface")]
public partial interface MemberSelectTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.ExpressionTree
{
	...
	static MemberSelectTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/tree/MemberSelectTree;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getExpression", "()Lcom/sun/source/tree/ExpressionTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getIdentifier", "()Ljavax/lang/model/element/Name;"));
	}
	...
	Dova.JDK.javax.lang.model.element.Name getIdentifier()
	{
