...
[JniSignatureAttribute("Lcom/sun/source/tree/ParenthesizedTree;", "public abstract interface")]
public partial interface ParenthesizedTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.ExpressionTree
{
	...
	static ParenthesizedTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/tree/ParenthesizedTree;");
