...
[JniSignatureAttribute("Lcom/sun/source/tree/DoWhileLoopTree;", "public abstract interface")]
public partial interface DoWhileLoopTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.StatementTree
{
	...
	static DoWhileLoopTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/tree/DoWhileLoopTree;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getStatement", "()Lcom/sun/source/tree/StatementTree;"));
