...
[JniSignatureAttribute("Lcom/sun/source/tree/SynchronizedTree;", "public abstract interface")]
public partial interface SynchronizedTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.StatementTree
{
	...
	static SynchronizedTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/tree/SynchronizedTree;");
