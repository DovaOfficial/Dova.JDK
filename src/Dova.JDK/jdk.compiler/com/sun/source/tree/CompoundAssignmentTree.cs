...
[JniSignatureAttribute("Lcom/sun/source/tree/CompoundAssignmentTree;", "public abstract interface")]
public partial interface CompoundAssignmentTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.ExpressionTree
{
	...
	static CompoundAssignmentTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/tree/CompoundAssignmentTree;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getExpression", "()Lcom/sun/source/tree/ExpressionTree;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getVariable", "()Lcom/sun/source/tree/ExpressionTree;"));
	}
