	...
	, Dova.JDK.com.sun.source.tree.ExpressionTree
{
	...
	static ConditionalExpressionTree()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getFalseExpression", "()Lcom/sun/source/tree/ExpressionTree;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getTrueExpression", "()Lcom/sun/source/tree/ExpressionTree;"));
	}
