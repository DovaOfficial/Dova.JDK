...
[JniSignatureAttribute("Lcom/sun/source/tree/PackageTree;", "public abstract interface")]
public partial interface PackageTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.Tree
{
	...
	static PackageTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/tree/PackageTree;");
