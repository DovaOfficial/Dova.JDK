...
[JniSignatureAttribute("Lcom/sun/source/tree/ExportsTree;", "public abstract interface")]
public partial interface ExportsTree
	: IJavaObject
	, Dova.JDK.com.sun.source.tree.DirectiveTree
{
	...
	static ExportsTree()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/source/tree/ExportsTree;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getPackageName", "()Lcom/sun/source/tree/ExpressionTree;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getModuleNames", "()Ljava/util/List;"));
	}
