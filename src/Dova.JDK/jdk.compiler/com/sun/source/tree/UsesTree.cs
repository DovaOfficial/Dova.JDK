	...
	, Dova.JDK.com.sun.source.tree.DirectiveTree
{
	...
	static UsesTree()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/tree/UsesTree;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getServiceName", "()Lcom/sun/source/tree/ExpressionTree;"));
	}
