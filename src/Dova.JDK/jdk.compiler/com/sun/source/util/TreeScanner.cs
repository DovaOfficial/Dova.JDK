	...
	, Dova.JDK.com.sun.source.tree.TreeVisitor
{
	...
	static TreeScanner()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/source/util/TreeScanner;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TreeScanner", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "scanAndReduce", "(Lcom/sun/source/tree/Tree;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"));
	...
	public TreeScanner() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
