	...
	: Dova.JDK.javax.swing.tree.DefaultTreeCellRenderer
{
	...
	static XTreeRenderer()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XTreeRenderer", "()V"));
	...
	public XTreeRenderer() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
