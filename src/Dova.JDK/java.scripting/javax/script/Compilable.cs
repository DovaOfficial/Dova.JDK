	...
	: IJavaObject
{
	...
	static Compilable()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "compile", "(Ljava/lang/String;)Ljavax/script/CompiledScript;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "compile", "(Ljava/io/Reader;)Ljavax/script/CompiledScript;"));
	}
