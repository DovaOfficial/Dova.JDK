	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/JIS_X_0212_MS5022X;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "JIS_X_0212_MS5022X", "()V"));
	...
	public JIS_X_0212_MS5022X() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static DecodeHolder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/JIS_X_0212_MS5022X$DecodeHolder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static EncodeHolder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/JIS_X_0212_MS5022X$EncodeHolder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
