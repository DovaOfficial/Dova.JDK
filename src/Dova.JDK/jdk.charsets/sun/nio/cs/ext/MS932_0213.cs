...
[JniSignatureAttribute("Lsun/nio/cs/ext/MS932_0213;", "public")]
public partial class MS932_0213
	: Dova.JDK.java.nio.charset.Charset
{
	...
	static MS932_0213()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/ext/MS932_0213;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MS932_0213", "()V"));
	...
	public MS932_0213(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public MS932_0213() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/nio/cs/ext/MS932_0213;";
	...
	[JniSignatureAttribute("Lsun/nio/cs/ext/MS932_0213$Decoder;", "protected static")]
	public partial class Decoder
		: Dova.JDK.sun.nio.cs.ext.SJIS_0213.Decoder
	{
		public new static CSharpSystem.IntPtr ClassPtr { get; }
		public new static CSharpSystem.IntPtr ClassRefPtr { get; }
		...
		static Decoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/ext/MS932_0213$Decoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "decMS932", "Lsun/nio/cs/DoubleByte$Decoder;"));
		...
		public static Dova.JDK.sun.nio.cs.DoubleByte.Decoder decMS932_Property
		{
			get
			{
		...
		public override string GetJavaClassSignature() => "Lsun/nio/cs/ext/MS932_0213$Decoder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
	...
	[JniSignatureAttribute("Lsun/nio/cs/ext/MS932_0213$Encoder;", "protected static")]
	public partial class Encoder
		: Dova.JDK.sun.nio.cs.ext.SJIS_0213.Encoder
	{
		public new static CSharpSystem.IntPtr ClassPtr { get; }
		public new static CSharpSystem.IntPtr ClassRefPtr { get; }
		...
		static Encoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/ext/MS932_0213$Encoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "encMS932", "Lsun/nio/cs/DoubleByte$Encoder;"));
		...
		public static Dova.JDK.sun.nio.cs.DoubleByte.Encoder encMS932_Property
		{
			get
			{
				var ret = DovaJvm.Vm.Runtime.GetStaticObjectField(ClassRefPtr, FieldPtrs[0]);
		...
		public override string GetJavaClassSignature() => "Lsun/nio/cs/ext/MS932_0213$Encoder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
