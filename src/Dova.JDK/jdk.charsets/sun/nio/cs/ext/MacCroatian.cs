	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static MacCroatian()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacCroatian;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MacCroatian", "()V"));
	...
	public MacCroatian() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacCroatian$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
