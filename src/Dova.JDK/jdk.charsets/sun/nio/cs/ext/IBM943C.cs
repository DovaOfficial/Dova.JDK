	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static IBM943C()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/IBM943C;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "IBM943C", "()V"));
	...
	public IBM943C() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/IBM943C$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
