	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacCentralEurope;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MacCentralEurope", "()V"));
	...
	public MacCentralEurope() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacCentralEurope$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "b2cTable", "Ljava/lang/String;"));
