...
[JniSignatureAttribute("Lsun/nio/cs/ext/IBM1124;", "public")]
public partial class IBM1124
	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static IBM1124()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/ext/IBM1124;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "IBM1124", "()V"));
	...
	public IBM1124(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public IBM1124() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/nio/cs/ext/IBM1124;";
	...
	[JniSignatureAttribute("Lsun/nio/cs/ext/IBM1124$Holder;", "private static")]
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/ext/IBM1124$Holder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		...
		public override string GetJavaClassSignature() => "Lsun/nio/cs/ext/IBM1124$Holder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
	}
}
