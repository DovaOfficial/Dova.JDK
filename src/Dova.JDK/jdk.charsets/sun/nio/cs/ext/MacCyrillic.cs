	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static MacCyrillic()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacCyrillic;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MacCyrillic", "()V"));
	...
	public MacCyrillic() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacCyrillic$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
