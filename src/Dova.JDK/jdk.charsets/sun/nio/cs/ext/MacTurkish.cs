	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static MacTurkish()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacTurkish;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MacTurkish", "()V"));
	...
	public MacTurkish() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacTurkish$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
