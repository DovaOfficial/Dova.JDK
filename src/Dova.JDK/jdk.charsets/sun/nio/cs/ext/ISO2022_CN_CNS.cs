...
[JniSignatureAttribute("Lsun/nio/cs/ext/ISO2022_CN_CNS;", "public")]
public partial class ISO2022_CN_CNS
	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static ISO2022_CN_CNS()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/ext/ISO2022_CN_CNS;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ISO2022_CN_CNS", "()V"));
	...
	public ISO2022_CN_CNS(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public ISO2022_CN_CNS() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/nio/cs/ext/ISO2022_CN_CNS;";
	...
	[JniSignatureAttribute("Lsun/nio/cs/ext/ISO2022_CN_CNS$Encoder;", "private static")]
		...
		: Dova.JDK.sun.nio.cs.ext.ISO2022.Encoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/ext/ISO2022_CN_CNS$Encoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "cns", "Ljava/nio/charset/Charset;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SOD", "[B"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SS2D", "[B"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SS3D", "[B"));
		...
		public static Dova.JDK.java.nio.charset.Charset cns_Property
		{
			get
			{
		...
		[JniSignatureAttribute("[B", "private static final")]
		public static JavaArray<byte> SS2D_Property
		{
			get
			{
		...
		[JniSignatureAttribute("[B", "private static final")]
		public static JavaArray<byte> SS3D_Property
		{
			get
			{
		...
		public override string GetJavaClassSignature() => "Lsun/nio/cs/ext/ISO2022_CN_CNS$Encoder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
