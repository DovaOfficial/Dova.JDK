...
[JniSignatureAttribute("Lsun/nio/cs/ext/IBM861;", "public")]
public partial class IBM861
	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static IBM861()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/ext/IBM861;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "IBM861", "()V"));
	...
	public IBM861(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public IBM861() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/nio/cs/ext/IBM861;";
	...
	[JniSignatureAttribute("Lsun/nio/cs/ext/IBM861$Holder;", "private static")]
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/ext/IBM861$Holder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		...
		public override string GetJavaClassSignature() => "Lsun/nio/cs/ext/IBM861$Holder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
	}
}
