	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static MacRomania()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacRomania;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MacRomania", "()V"));
	...
	public MacRomania() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacRomania$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
