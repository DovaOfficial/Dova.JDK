	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static MacThai()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacThai;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MacThai", "()V"));
	...
	public MacThai() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/MacThai$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
