	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static IBM860()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/IBM860;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "IBM860", "()V"));
	...
	public IBM860() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ext/IBM860$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
