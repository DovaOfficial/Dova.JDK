	...
	: Dova.JDK.javax.crypto.KeyGeneratorSpi
{
	...
	static P11KeyGenerator()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "significantKeySize", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "keyType", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "supportBothKeySizes", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "range", "Lsun/security/pkcs11/wrapper/CK_MECHANISM_INFO;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "getSupportedRange", "(Lsun/security/pkcs11/Token;J)Lsun/security/pkcs11/wrapper/CK_MECHANISM_INFO;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "checkKeySize", "(JILsun/security/pkcs11/Token;)I"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "checkKeySize", "(JILsun/security/pkcs11/wrapper/CK_MECHANISM_INFO;)I"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "adjustKeySize", "(ILsun/security/pkcs11/wrapper/CK_MECHANISM_INFO;)I"));
	...
	public P11KeyGenerator(Dova.JDK.sun.security.pkcs11.Token arg0, Dova.JDK.java.lang.String arg1, long arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
