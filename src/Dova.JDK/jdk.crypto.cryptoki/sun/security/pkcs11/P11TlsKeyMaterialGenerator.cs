	...
	: Dova.JDK.javax.crypto.KeyGeneratorSpi
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/pkcs11/P11TlsKeyMaterialGenerator;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "P11TlsKeyMaterialGenerator", "(Lsun/security/pkcs11/Token;Ljava/lang/String;J)V"));
	...
	public P11TlsKeyMaterialGenerator(Dova.JDK.sun.security.pkcs11.Token arg0, Dova.JDK.java.lang.String arg1, long arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
