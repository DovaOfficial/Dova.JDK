...
[JniSignatureAttribute("Lsun/security/pkcs11/P11TlsKeyMaterialGenerator;", "public final")]
public partial class P11TlsKeyMaterialGenerator
	: Dova.JDK.javax.crypto.KeyGeneratorSpi
{
	...
	static P11TlsKeyMaterialGenerator()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/pkcs11/P11TlsKeyMaterialGenerator;");
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "spec", "Lsun/security/internal/spec/TlsKeyMaterialParameterSpec;"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "P11TlsKeyMaterialGenerator", "(Lsun/security/pkcs11/Token;Ljava/lang/String;J)V"));
	...
	public P11TlsKeyMaterialGenerator(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lsun/security/pkcs11/Token;Ljava/lang/String;J)V", "")]
	public P11TlsKeyMaterialGenerator(Dova.JDK.sun.security.pkcs11.Token arg0, Dova.JDK.java.lang.String arg1, long arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/pkcs11/P11TlsKeyMaterialGenerator;";
