	...
	: Dova.JDK.javax.crypto.KeyAgreementSpi
{
	...
	static P11ECDHKeyAgreement()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "publicValue", "[B"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "secretLen", "I"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "P11ECDHKeyAgreement", "(Lsun/security/pkcs11/Token;Ljava/lang/String;J)V"));
	...
	public P11ECDHKeyAgreement(Dova.JDK.sun.security.pkcs11.Token arg0, Dova.JDK.java.lang.String arg1, long arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
