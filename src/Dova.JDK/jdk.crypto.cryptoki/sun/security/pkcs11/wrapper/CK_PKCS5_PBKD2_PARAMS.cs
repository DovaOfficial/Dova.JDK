	...
	: Dova.JDK.java.lang.Object
{
	...
	static CK_PKCS5_PBKD2_PARAMS()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "saltSource", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "pSaltSourceData", "[B"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "iterations", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "prf", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "pPrfData", "[B"));
	...
	public CK_PKCS5_PBKD2_PARAMS() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
