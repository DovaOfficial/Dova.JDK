	...
	: IJavaObject
{
	...
	static CK_LOCKMUTEX()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/pkcs11/wrapper/CK_LOCKMUTEX;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CK_LOCKMUTEX_0", "(Ljava/lang/Object;)V"));
	}
