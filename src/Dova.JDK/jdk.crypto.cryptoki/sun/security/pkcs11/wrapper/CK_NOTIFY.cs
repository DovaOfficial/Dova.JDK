	...
	: IJavaObject
{
	...
	static CK_NOTIFY()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/pkcs11/wrapper/CK_NOTIFY;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CK_NOTIFY_0", "(JJLjava/lang/Object;)V"));
	}
