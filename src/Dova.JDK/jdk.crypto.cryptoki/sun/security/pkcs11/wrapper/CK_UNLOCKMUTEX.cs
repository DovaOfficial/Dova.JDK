	...
	: IJavaObject
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/pkcs11/wrapper/CK_UNLOCKMUTEX;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CK_UNLOCKMUTEX_0", "(Ljava/lang/Object;)V"));
	}
