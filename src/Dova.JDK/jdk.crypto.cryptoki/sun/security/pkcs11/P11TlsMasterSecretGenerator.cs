...
[JniSignatureAttribute("Lsun/security/pkcs11/P11TlsMasterSecretGenerator;", "public final")]
public partial class P11TlsMasterSecretGenerator
	: Dova.JDK.javax.crypto.KeyGeneratorSpi
{
	...
	static P11TlsMasterSecretGenerator()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/pkcs11/P11TlsMasterSecretGenerator;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "tlsVersion", "I"));
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "ckVersion", "Lsun/security/pkcs11/wrapper/CK_VERSION;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "supportSSLv3", "Z"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "P11TlsMasterSecretGenerator", "(Lsun/security/pkcs11/Token;Ljava/lang/String;J)V"));
	...
	public int tlsVersion_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lsun/security/pkcs11/wrapper/CK_VERSION;", "")]
	public Dova.JDK.sun.security.pkcs11.wrapper.CK_VERSION ckVersion_Property
	{
		get
		{
	...
	public bool supportSSLv3_Property
	{
		get
		{
	...
	public P11TlsMasterSecretGenerator(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lsun/security/pkcs11/Token;Ljava/lang/String;J)V", "")]
	public P11TlsMasterSecretGenerator(Dova.JDK.sun.security.pkcs11.Token arg0, Dova.JDK.java.lang.String arg1, long arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/pkcs11/P11TlsMasterSecretGenerator;";
