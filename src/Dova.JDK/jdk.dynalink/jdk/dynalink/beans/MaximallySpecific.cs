	...
	: Dova.JDK.java.lang.Object
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/dynalink/beans/MaximallySpecific;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "$assertionsDisabled", "Z"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MaximallySpecific", "()V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "compare", "(Ljava/lang/Class;Ljava/lang/Class;[Ljava/lang/Class;ILjdk/dynalink/linker/LinkerServices;)Ljdk/dynalink/linker/ConversionComparator$Comparison;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getParameterClass", "(Ljava/lang/invoke/MethodType;IIZ)Ljava/lang/Class;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getMaximallySpecificMethodHandles", "(Ljava/util/List;Z[Ljava/lang/Class;Ljdk/dynalink/linker/LinkerServices;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getMaximallySpecificMethods", "(Ljava/util/List;Z)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getMaximallySpecificMethods", "(Ljava/util/List;Z[Ljava/lang/Class;Ljdk/dynalink/linker/LinkerServices;Ljava/util/function/Function;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "isMoreSpecific", "(Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Z[Ljava/lang/Class;Ljdk/dynalink/linker/LinkerServices;)Ljdk/dynalink/linker/ConversionComparator$Comparison;"));
	}
	...
	public MaximallySpecific() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
