	...
	: IJavaObject
{
	...
	static Operation()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "named", "(Ljava/lang/Object;)Ljdk/dynalink/NamedOperation;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "withNamespaces", "([Ljdk/dynalink/Namespace;)Ljdk/dynalink/NamespaceOperation;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "withNamespace", "(Ljdk/dynalink/Namespace;)Ljdk/dynalink/NamespaceOperation;"));
	}
