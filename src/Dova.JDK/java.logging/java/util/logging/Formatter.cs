	...
	: Dova.JDK.java.lang.Object
{
	...
	static Formatter()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/util/logging/Formatter;");
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "formatMessage", "(Ljava/util/logging/LogRecord;)Ljava/lang/String;"));
	}
