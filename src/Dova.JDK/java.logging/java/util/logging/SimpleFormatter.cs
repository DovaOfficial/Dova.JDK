	...
	: Dova.JDK.java.util.logging.Formatter
{
	...
	static SimpleFormatter()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "getLoggingProperty", "(Ljava/lang/String;)Ljava/lang/String;"));
	}
	...
	public SimpleFormatter() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
