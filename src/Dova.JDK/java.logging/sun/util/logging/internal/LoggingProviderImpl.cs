	...
	: Dova.JDK.jdk.@internal.logger.DefaultLoggerFinder
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/util/logging/internal/LoggingProviderImpl;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "LOGGING_CONTROL_PERMISSION", "Ljava/util/logging/LoggingPermission;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "logManagerAccess", "Lsun/util/logging/internal/LoggingProviderImpl$LogManagerAccess;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "LoggingProviderImpl", "()V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "setLogManagerAccess", "(Lsun/util/logging/internal/LoggingProviderImpl$LogManagerAccess;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "demandJULLoggerFor", "(Ljava/lang/String;Ljava/lang/Module;)Ljava/util/logging/Logger;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getLogManagerAccess", "()Lsun/util/logging/internal/LoggingProviderImpl$LogManagerAccess;"));
	}
	...
	public LoggingProviderImpl() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: IJavaObject
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/util/logging/internal/LoggingProviderImpl$LogManagerAccess;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		...
		, Dova.JDK.sun.util.logging.PlatformLogger.ConfigurableBridge
	{
		...
		static JULWrapper()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/util/logging/internal/LoggingProviderImpl$JULWrapper;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "spi2JulLevelMapping", "[Ljava/util/logging/Level;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "platform2JulLevelMapping", "[Ljava/util/logging/Level;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "julLogger", "Ljava/util/logging/Logger;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "$assertionsDisabled", "Z"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "JULWrapper", "(Ljava/util/logging/Logger;)V"));
			...
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "of", "(Ljava/util/logging/Logger;)Lsun/util/logging/internal/LoggingProviderImpl$JULWrapper;"));
			...
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "toJUL", "(Ljava/lang/System$Logger$Level;)Ljava/util/logging/Level;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "toJUL", "(Lsun/util/logging/PlatformLogger$Level;)Ljava/util/logging/Level;"));
		...
		public JULWrapper(Dova.JDK.java.util.logging.Logger arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}
