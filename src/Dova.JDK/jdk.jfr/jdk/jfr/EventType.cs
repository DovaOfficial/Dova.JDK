	...
	: Dova.JDK.java.lang.Object
{
	...
	static EventType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jfr/EventType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "UNCATEGORIZED", "Ljava/util/List;"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "EventType", "(Ljdk/jfr/internal/PlatformEventType;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getEventType", "(Ljava/lang/Class;)Ljdk/jfr/EventType;"));
	...
	public EventType(Dova.JDK.jdk.jfr.@internal.PlatformEventType arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
