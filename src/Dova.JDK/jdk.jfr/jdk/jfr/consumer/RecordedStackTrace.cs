	...
	: Dova.JDK.jdk.jfr.consumer.RecordedObject
{
	...
	static RecordedStackTrace()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "isTruncated", "()Z"));
	...
	public RecordedStackTrace(Dova.JDK.jdk.jfr.@internal.consumer.ObjectContext arg0, JavaArray<Dova.JDK.java.lang.Object> arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
