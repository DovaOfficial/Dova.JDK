	...
	: Dova.JDK.jdk.jfr.@internal.settings.JDKSettingControl
{
	...
	static ThrottleSetting()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OFF", "J"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "parseValueSafe", "(Ljava/lang/String;)J"));
	}
	...
	public ThrottleSetting(Dova.JDK.jdk.jfr.@internal.PlatformEventType arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
