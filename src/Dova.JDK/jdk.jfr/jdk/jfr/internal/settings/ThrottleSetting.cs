	...
	: Dova.JDK.jdk.jfr.@internal.settings.JDKSettingControl
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/jfr/internal/settings/ThrottleSetting;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "typeId", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OFF", "J"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ThrottleSetting", "(Ljdk/jfr/internal/PlatformEventType;)V"));
	...
	public ThrottleSetting(Dova.JDK.jdk.jfr.@internal.PlatformEventType arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
