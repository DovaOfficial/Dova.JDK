...
[JniSignatureAttribute("Ljdk/jfr/internal/settings/ThrottleSetting;", "public final")]
public partial class ThrottleSetting
	: Dova.JDK.jdk.jfr.@internal.settings.JDKSettingControl
{
	...
	static ThrottleSetting()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jfr/internal/settings/ThrottleSetting;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "typeId", "J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "OFF", "J"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ThrottleSetting", "(Ljdk/jfr/internal/PlatformEventType;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "parseValueSafe", "(Ljava/lang/String;)J"));
	}
	...
	[JniSignatureAttribute("J", "private static final")]
	public static long OFF_Property
	{
		get
		{
	...
	public ThrottleSetting(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljdk/jfr/internal/PlatformEventType;)V", "public")]
	public ThrottleSetting(Dova.JDK.jdk.jfr.@internal.PlatformEventType arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/jfr/internal/settings/ThrottleSetting;";
