...
[JniSignatureAttribute("Ljdk/jfr/internal/settings/ThresholdSetting;", "public final")]
public partial class ThresholdSetting
	: Dova.JDK.jdk.jfr.@internal.settings.JDKSettingControl
{
	...
	static ThresholdSetting()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jfr/internal/settings/ThresholdSetting;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ThresholdSetting", "(Ljdk/jfr/internal/PlatformEventType;)V"));
	...
	public ThresholdSetting(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljdk/jfr/internal/PlatformEventType;)V", "public")]
	public ThresholdSetting(Dova.JDK.jdk.jfr.@internal.PlatformEventType arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/jfr/internal/settings/ThresholdSetting;";
