	...
	: Dova.JDK.jdk.jfr.@internal.jfc.model.XmlElement
{
	...
	static XmlEvent()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getSetting", "(Ljava/lang/String;Z)Ljdk/jfr/internal/jfc/model/XmlSetting;"));
	...
	public XmlEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
