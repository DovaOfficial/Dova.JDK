	...
	: Dova.JDK.jdk.jfr.@internal.jfc.model.XmlElement
{
	...
	static XmlEvent()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/jfr/internal/jfc/model/XmlEvent;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XmlEvent", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getSetting", "(Ljava/lang/String;Z)Ljdk/jfr/internal/jfc/model/XmlSetting;"));
	...
	public XmlEvent() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
