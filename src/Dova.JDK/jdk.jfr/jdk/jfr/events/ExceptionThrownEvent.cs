...
[JniSignatureAttribute("Ljdk/jfr/events/ExceptionThrownEvent;", "public final")]
public partial class ExceptionThrownEvent
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ExceptionThrownEvent()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jfr/events/ExceptionThrownEvent;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "message", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "thrownClass", "Ljava/lang/Class;"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ExceptionThrownEvent", "()V"));
	...
	public Dova.JDK.java.lang.Class thrownClass_Property
	{
		get
		{
	...
	public ExceptionThrownEvent(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public ExceptionThrownEvent() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/jfr/events/ExceptionThrownEvent;";
