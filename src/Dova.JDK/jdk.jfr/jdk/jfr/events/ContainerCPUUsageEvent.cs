...
[JniSignatureAttribute("Ljdk/jfr/events/ContainerCPUUsageEvent;", "public")]
public partial class ContainerCPUUsageEvent
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ContainerCPUUsageEvent()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jfr/events/ContainerCPUUsageEvent;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "cpuTime", "J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "cpuUserTime", "J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "cpuSystemTime", "J"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ContainerCPUUsageEvent", "()V"));
	...
	[JniSignatureAttribute("J", "public")]
	public long cpuUserTime_Property
	{
		get
		{
	...
	[JniSignatureAttribute("J", "public")]
	public long cpuSystemTime_Property
	{
		get
		{
	...
	public ContainerCPUUsageEvent(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public ContainerCPUUsageEvent() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/jfr/events/ContainerCPUUsageEvent;";
