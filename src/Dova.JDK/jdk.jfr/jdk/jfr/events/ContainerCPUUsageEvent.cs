	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ContainerCPUUsageEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "cpuTime", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "cpuUserTime", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "cpuSystemTime", "J"));
	...
	public ContainerCPUUsageEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
