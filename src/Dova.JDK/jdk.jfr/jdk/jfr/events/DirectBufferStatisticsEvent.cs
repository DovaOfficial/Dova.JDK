	...
	: Dova.JDK.jdk.jfr.events.AbstractBufferStatisticsEvent
{
	...
	static DirectBufferStatisticsEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "DIRECT_BUFFER_POOL", "Ljdk/internal/misc/VM$BufferPool;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "maxCapacity", "J"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DirectBufferStatisticsEvent", "()V"));
	...
	public DirectBufferStatisticsEvent() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
