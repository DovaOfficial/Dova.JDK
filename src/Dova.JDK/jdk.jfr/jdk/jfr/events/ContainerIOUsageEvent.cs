...
[JniSignatureAttribute("Ljdk/jfr/events/ContainerIOUsageEvent;", "public")]
public partial class ContainerIOUsageEvent
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ContainerIOUsageEvent()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jfr/events/ContainerIOUsageEvent;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "serviceRequests", "J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "dataTransferred", "J"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ContainerIOUsageEvent", "()V"));
	...
	public long serviceRequests_Property
	{
		get
		{
	...
	[JniSignatureAttribute("J", "public")]
	public long dataTransferred_Property
	{
		get
		{
	...
	public ContainerIOUsageEvent(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public ContainerIOUsageEvent() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/jfr/events/ContainerIOUsageEvent;";
