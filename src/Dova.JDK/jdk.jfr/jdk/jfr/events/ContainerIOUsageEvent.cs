	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ContainerIOUsageEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "serviceRequests", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "dataTransferred", "J"));
	...
	public ContainerIOUsageEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
