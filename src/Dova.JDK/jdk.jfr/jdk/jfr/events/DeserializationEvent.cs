	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static DeserializationEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "filterConfigured", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "filterStatus", "Ljava/lang/String;"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "objectReferences", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "depth", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "bytesRead", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "exceptionType", "Ljava/lang/Class;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "exceptionMessage", "Ljava/lang/String;"));
	...
	public DeserializationEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
