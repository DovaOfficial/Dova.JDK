...
[JniSignatureAttribute("Ljdk/jfr/events/SocketWriteEvent;", "public final")]
public partial class SocketWriteEvent
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static SocketWriteEvent()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/jfr/events/SocketWriteEvent;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SocketWriteEvent", "()V"));
	...
	public SocketWriteEvent(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SocketWriteEvent() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/jfr/events/SocketWriteEvent;";
