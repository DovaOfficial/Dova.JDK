	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/jfr/events/SecurityPropertyModificationEvent;");
	...
	public SecurityPropertyModificationEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
