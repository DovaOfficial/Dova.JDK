...
[JniSignatureAttribute("Ljdk/jfr/events/SecurityPropertyModificationEvent;", "public final")]
	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jfr/events/SecurityPropertyModificationEvent;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SecurityPropertyModificationEvent", "()V"));
	...
	public SecurityPropertyModificationEvent() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/jfr/events/SecurityPropertyModificationEvent;";
