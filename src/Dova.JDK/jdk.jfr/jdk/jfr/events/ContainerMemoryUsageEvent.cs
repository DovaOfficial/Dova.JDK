	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ContainerMemoryUsageEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "memoryFailCount", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "memoryUsage", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "swapMemoryUsage", "J"));
	...
	public ContainerMemoryUsageEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
