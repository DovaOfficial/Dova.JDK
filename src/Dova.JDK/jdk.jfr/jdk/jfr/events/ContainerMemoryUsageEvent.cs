...
[JniSignatureAttribute("Ljdk/jfr/events/ContainerMemoryUsageEvent;", "public final")]
public partial class ContainerMemoryUsageEvent
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ContainerMemoryUsageEvent()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jfr/events/ContainerMemoryUsageEvent;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "memoryFailCount", "J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "memoryUsage", "J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "swapMemoryUsage", "J"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ContainerMemoryUsageEvent", "()V"));
	...
	public long memoryFailCount_Property
	{
		get
		{
	...
	[JniSignatureAttribute("J", "public")]
	public long memoryUsage_Property
	{
		get
		{
	...
	[JniSignatureAttribute("J", "public")]
	public long swapMemoryUsage_Property
	{
		get
		{
	...
	public ContainerMemoryUsageEvent(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public ContainerMemoryUsageEvent() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/jfr/events/ContainerMemoryUsageEvent;";
