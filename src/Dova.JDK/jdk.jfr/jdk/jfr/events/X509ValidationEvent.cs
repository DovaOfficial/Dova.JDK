	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static X509ValidationEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "certificatePosition", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "validationCounter", "J"));
	...
	public X509ValidationEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
