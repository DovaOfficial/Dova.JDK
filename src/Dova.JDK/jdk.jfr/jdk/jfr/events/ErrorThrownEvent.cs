	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ErrorThrownEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "thrownClass", "Ljava/lang/Class;"));
	...
	public ErrorThrownEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
