...
[JniSignatureAttribute("Ljdk/jfr/events/ErrorThrownEvent;", "public final")]
public partial class ErrorThrownEvent
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ErrorThrownEvent()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jfr/events/ErrorThrownEvent;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ErrorThrownEvent", "()V"));
	...
	public ErrorThrownEvent(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public ErrorThrownEvent() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/jfr/events/ErrorThrownEvent;";
