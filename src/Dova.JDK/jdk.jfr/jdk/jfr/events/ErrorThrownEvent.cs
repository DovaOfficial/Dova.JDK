	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/jfr/events/ErrorThrownEvent;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ErrorThrownEvent", "()V"));
	...
	public ErrorThrownEvent() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
