	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static X509CertificateEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "serialNumber", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "subject", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "issuer", "Ljava/lang/String;"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "validFrom", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "validUntil", "J"));
	...
	public X509CertificateEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
