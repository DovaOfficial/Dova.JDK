	...
	: Dova.JDK.jdk.jfr.events.AbstractJDKEvent
{
	...
	static ContainerCPUThrottlingEvent()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "cpuElapsedSlices", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "cpuThrottledSlices", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "cpuThrottledTime", "J"));
	...
	public ContainerCPUThrottlingEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
