	...
	: Dova.JDK.java.rmi.RemoteException
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/rmi/UnknownHostException;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UnknownHostException", "(Ljava/lang/String;Ljava/lang/Exception;)V"));
	}
	...
	public UnknownHostException(Dova.JDK.java.lang.String arg0, Dova.JDK.java.lang.Exception arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
