	...
	, Dova.JDK.java.rmi.server.Skeleton
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/rmi/registry/RegistryImpl_Skel;");
	...
	public RegistryImpl_Skel() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
