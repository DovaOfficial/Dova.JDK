	...
	, Dova.JDK.java.rmi.server.Skeleton
{
	...
	static RegistryImpl_Skel()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "RegistryImpl_Skel", "()V"));
	...
	public RegistryImpl_Skel() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
