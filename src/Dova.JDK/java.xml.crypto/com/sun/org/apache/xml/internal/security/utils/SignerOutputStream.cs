	...
	: Dova.JDK.java.io.ByteArrayOutputStream
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xml/internal/security/utils/SignerOutputStream;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "LOG", "Lcom/sun/org/slf4j/internal/Logger;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "sa", "Lcom/sun/org/apache/xml/internal/security/algorithms/SignatureAlgorithm;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SignerOutputStream", "(Lcom/sun/org/apache/xml/internal/security/algorithms/SignatureAlgorithm;)V"));
	...
	public SignerOutputStream(Dova.JDK.com.sun.org.apache.xml.@internal.security.algorithms.SignatureAlgorithm arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
