	...
	: Dova.JDK.com.sun.org.apache.xml.@internal.security.utils.XPathFactory
{
	...
	static JDKXPathFactory()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "JDKXPathFactory", "()V"));
	...
	public JDKXPathFactory() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
