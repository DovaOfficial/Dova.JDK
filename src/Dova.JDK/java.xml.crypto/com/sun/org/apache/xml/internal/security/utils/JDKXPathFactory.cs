	...
	: Dova.JDK.com.sun.org.apache.xml.@internal.security.utils.XPathFactory
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xml/internal/security/utils/JDKXPathFactory;");
	...
	public JDKXPathFactory() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
