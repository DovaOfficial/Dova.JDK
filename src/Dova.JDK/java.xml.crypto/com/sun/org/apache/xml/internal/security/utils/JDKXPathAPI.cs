	...
	, Dova.JDK.com.sun.org.apache.xml.@internal.security.utils.XPathAPI
{
	...
	static JDKXPathAPI()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "xpf", "Ljavax/xml/xpath/XPathFactory;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "xpathStr", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "xpathExpression", "Ljavax/xml/xpath/XPathExpression;"));
	...
	public JDKXPathAPI() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
