	...
	: Dova.JDK.org.jcp.xml.dsig.@internal.dom.ApacheTransform
{
	...
	static DOMXPathFilter2Transform()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DOMXPathFilter2Transform", "()V"));
	...
	public DOMXPathFilter2Transform() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
