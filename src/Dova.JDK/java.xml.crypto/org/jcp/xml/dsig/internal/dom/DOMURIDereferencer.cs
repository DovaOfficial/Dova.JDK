	...
	, Dova.JDK.javax.xml.crypto.URIDereferencer
{
	...
	static DOMURIDereferencer()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "INSTANCE", "Ljavax/xml/crypto/URIDereferencer;"));
	...
	public DOMURIDereferencer() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
