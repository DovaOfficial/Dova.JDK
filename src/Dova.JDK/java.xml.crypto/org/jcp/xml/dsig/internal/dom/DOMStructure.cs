	...
	, Dova.JDK.javax.xml.crypto.XMLStructure
{
	...
	static DOMStructure()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "equalsContent", "(Ljava/util/List;Ljava/util/List;)Z"));
	}
	...
	public DOMStructure() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
