	...
	: Dova.JDK.javax.xml.crypto.dsig.TransformService
{
	...
	static ApacheCanonicalizer()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "canonicalizer", "Lcom/sun/org/apache/xml/internal/security/c14n/Canonicalizer;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "apacheTransform", "Lcom/sun/org/apache/xml/internal/security/transforms/Transform;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "inclusiveNamespaces", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "params", "Ljavax/xml/crypto/dsig/spec/C14NMethodParameterSpec;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "ownerDoc", "Lorg/w3c/dom/Document;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "transformElem", "Lorg/w3c/dom/Element;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getC14nBytes", "(Ljava/io/OutputStream;Z)[B"));
	}
	...
	public ApacheCanonicalizer() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
