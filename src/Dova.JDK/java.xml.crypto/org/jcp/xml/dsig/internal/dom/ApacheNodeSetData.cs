	...
	, Dova.JDK.javax.xml.crypto.NodeSetData
{
	...
	static ApacheNodeSetData()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ApacheNodeSetData", "(Lcom/sun/org/apache/xml/internal/security/signature/XMLSignatureInput;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getNodeSet", "(Ljava/util/List;)Ljava/util/Set;"));
	}
	...
	public ApacheNodeSetData(Dova.JDK.com.sun.org.apache.xml.@internal.security.signature.XMLSignatureInput arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
