	...
	, Dova.JDK.javax.xml.crypto.NodeSetData
{
	...
	static DOMSubTreeData()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DOMSubTreeData", "(Lorg/w3c/dom/Node;Z)V"));
	...
	public DOMSubTreeData(Dova.JDK.org.w3c.dom.Node arg0, bool arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
