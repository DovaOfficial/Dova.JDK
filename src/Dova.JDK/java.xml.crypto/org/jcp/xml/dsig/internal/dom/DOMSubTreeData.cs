	...
	, Dova.JDK.javax.xml.crypto.NodeSetData
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lorg/jcp/xml/dsig/internal/dom/DOMSubTreeData;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DOMSubTreeData", "(Lorg/w3c/dom/Node;Z)V"));
	...
	public DOMSubTreeData(Dova.JDK.org.w3c.dom.Node arg0, bool arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
		...
		, Dova.JDK.java.util.Iterator
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lorg/jcp/xml/dsig/internal/dom/DOMSubTreeData$DelayedNodeIterator;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "root", "Lorg/w3c/dom/Node;"));
