...
[JniSignatureAttribute("Ljavax/xml/crypto/NodeSetData;", "public abstract interface")]
public partial interface NodeSetData
	: IJavaObject
	...
	, Dova.JDK.java.lang.Iterable
{
	...
	static NodeSetData()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/xml/crypto/NodeSetData;");
