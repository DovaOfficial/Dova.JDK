...
[JniSignatureAttribute("Ljavax/xml/crypto/URIReference;", "public abstract interface")]
public partial interface URIReference
	: IJavaObject
{
	...
	static URIReference()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/xml/crypto/URIReference;");
