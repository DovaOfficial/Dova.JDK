	...
	, Dova.JDK.com.sun.java.accessibility.util.TopLevelWindowListener
{
	...
	static TopLevelWindowMulticaster()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "add", "(Lcom/sun/java/accessibility/util/TopLevelWindowListener;Lcom/sun/java/accessibility/util/TopLevelWindowListener;)Lcom/sun/java/accessibility/util/TopLevelWindowListener;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "remove", "(Lcom/sun/java/accessibility/util/TopLevelWindowListener;Lcom/sun/java/accessibility/util/TopLevelWindowListener;)Lcom/sun/java/accessibility/util/TopLevelWindowListener;"));
	...
	public TopLevelWindowMulticaster(Dova.JDK.java.util.EventListener arg0, Dova.JDK.java.util.EventListener arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
