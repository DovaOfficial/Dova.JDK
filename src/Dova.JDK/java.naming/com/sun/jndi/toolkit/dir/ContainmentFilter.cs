	...
	, Dova.JDK.com.sun.jndi.toolkit.dir.AttrFilter
{
	...
	static ContainmentFilter()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "matchingAttrs", "Ljavax/naming/directory/Attributes;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljavax/naming/directory/Attributes;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "contains", "(Ljavax/naming/directory/Attributes;Ljavax/naming/directory/Attributes;)Z"));
	...
	public ContainmentFilter(Dova.JDK.javax.naming.directory.Attributes arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
