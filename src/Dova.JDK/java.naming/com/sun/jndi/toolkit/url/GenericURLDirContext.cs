	...
	, Dova.JDK.javax.naming.directory.DirContext
{
	...
	static GenericURLDirContext()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "GenericURLDirContext", "(Ljava/util/Hashtable;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getContinuationDirContext", "(Ljavax/naming/Name;)Ljavax/naming/directory/DirContext;"));
	}
	...
	public GenericURLDirContext(Dova.JDK.java.util.Hashtable arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
