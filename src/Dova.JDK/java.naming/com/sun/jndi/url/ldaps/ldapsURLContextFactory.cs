	...
	: Dova.JDK.com.sun.jndi.url.ldap.ldapURLContextFactory
{
	...
	static ldapsURLContextFactory()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ldapsURLContextFactory", "()V"));
	}
	...
	public ldapsURLContextFactory() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
