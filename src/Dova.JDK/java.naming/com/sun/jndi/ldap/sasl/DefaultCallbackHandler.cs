	...
	, Dova.JDK.javax.security.auth.callback.CallbackHandler
{
	...
	static DefaultCallbackHandler()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "authRealm", "Ljava/lang/String;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DefaultCallbackHandler", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V"));
	...
	public DefaultCallbackHandler(Dova.JDK.java.lang.String arg0, Dova.JDK.java.lang.Object arg1, Dova.JDK.java.lang.String arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
