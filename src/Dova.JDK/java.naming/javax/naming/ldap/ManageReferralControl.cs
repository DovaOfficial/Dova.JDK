	...
	: Dova.JDK.javax.naming.ldap.BasicControl
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/naming/ldap/ManageReferralControl;");
	...
	public ManageReferralControl() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Z)V", "public")]
	public ManageReferralControl(bool arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
