	...
	, Dova.JDK.javax.naming.@event.NamingListener
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/naming/ldap/UnsolicitedNotificationListener;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "notificationReceived", "(Ljavax/naming/ldap/UnsolicitedNotificationEvent;)V"));
	}
