	...
	: Dova.JDK.java.util.EventObject
{
	...
	static NamingExceptionEvent()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljavax/naming/event/EventContext;Ljavax/naming/NamingException;)V"));
	...
	public NamingExceptionEvent(Dova.JDK.javax.naming.@event.EventContext arg0, Dova.JDK.javax.naming.NamingException arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
