	...
	, Dova.JDK.javax.naming.@event.NamingListener
{
	...
	static NamespaceChangeListener()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "objectAdded", "(Ljavax/naming/event/NamingEvent;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "objectRemoved", "(Ljavax/naming/event/NamingEvent;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "objectRenamed", "(Ljavax/naming/event/NamingEvent;)V"));
	}
