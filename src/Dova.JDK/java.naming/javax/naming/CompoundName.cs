...
[JniSignatureAttribute("Ljavax/naming/CompoundName;", "public")]
	...
	, Dova.JDK.javax.naming.Name
{
	...
	static CompoundName()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/naming/CompoundName;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "impl", "Ljavax/naming/NameImpl;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "mySyntax", "Ljava/util/Properties;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CompoundName", "(Ljava/util/Enumeration;Ljava/util/Properties;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CompoundName", "(Ljava/lang/String;Ljava/util/Properties;)V"));
	...
	[JniSignatureAttribute("Ljava/util/Properties;", "protected transient")]
	public Dova.JDK.java.util.Properties mySyntax_Property
	{
		get
		{
	...
	public CompoundName(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/util/Enumeration;Ljava/util/Properties;)V", "protected")]
	public CompoundName(Dova.JDK.java.util.Enumeration arg0, Dova.JDK.java.util.Properties arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;Ljava/util/Properties;)V", "public")]
	public CompoundName(Dova.JDK.java.lang.String arg0, Dova.JDK.java.util.Properties arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/naming/CompoundName;";
