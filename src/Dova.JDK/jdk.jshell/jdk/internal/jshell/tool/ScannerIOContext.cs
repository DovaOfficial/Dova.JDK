	...
	: Dova.JDK.jdk.@internal.jshell.tool.NonInteractiveIOContext
{
	...
	static ScannerIOContext()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "scannerIn", "Ljava/util/Scanner;"));
	...
	public ScannerIOContext(Dova.JDK.java.util.Scanner arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/io/Reader;)V", "")]
	public ScannerIOContext(Dova.JDK.java.io.Reader arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
