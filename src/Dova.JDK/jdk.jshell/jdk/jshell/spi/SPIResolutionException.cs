	...
	: Dova.JDK.java.lang.RuntimeException
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/jshell/spi/SPIResolutionException;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "id", "I"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SPIResolutionException", "(I)V"));
	...
	public SPIResolutionException(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
