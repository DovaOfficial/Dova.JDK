	...
	: Dova.JDK.java.lang.Object
{
	...
	static KeyMap()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/KeyMap;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "methodMap", "Ljava/util/Map;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "varMap", "Ljava/util/Map;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "importMap", "Ljava/util/Map;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "KeyMap", "(Ljdk/jshell/JShell;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "keyForImport", "(Ljava/lang/String;Ljdk/jshell/Snippet$SubKind;)Ljdk/jshell/Key$ImportKey;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "keyForVariable", "(Ljava/lang/String;)Ljdk/jshell/Key$VarKey;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "doesVariableNameExist", "(Ljava/lang/String;)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "keyForExpression", "(Ljava/lang/String;Ljava/lang/String;)Ljdk/jshell/Key$ExpressionKey;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "keyForStatement", "()Ljdk/jshell/Key$StatementKey;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "keyForClass", "(Ljava/lang/String;)Ljdk/jshell/Key$TypeDeclKey;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "keyForMethod", "(Ljava/lang/String;Ljava/lang/String;)Ljdk/jshell/Key$MethodKey;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "keyForErroneous", "()Ljdk/jshell/Key$ErroneousKey;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "importKeys", "()Ljava/util/stream/Stream;"));
	}
	...
	public KeyMap(Dova.JDK.jdk.jshell.JShell arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
