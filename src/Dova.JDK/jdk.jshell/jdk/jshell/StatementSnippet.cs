	...
	: Dova.JDK.jdk.jshell.Snippet
{
	...
	static StatementSnippet()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljdk/jshell/Key$StatementKey;Ljava/lang/String;Ljdk/jshell/Wrap;)V"));
	}
	...
	public StatementSnippet(Dova.JDK.jdk.jshell.Key.StatementKey arg0, Dova.JDK.java.lang.String arg1, Dova.JDK.jdk.jshell.Wrap arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
