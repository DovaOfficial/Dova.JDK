	...
	: Dova.JDK.java.lang.Object
{
	...
	static Eval()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/Eval;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "IMPORT_PATTERN", "Ljava/util/regex/Pattern;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "DEFAULT_PREFIX", "Ljava/util/regex/Pattern;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "preserveState", "Z"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "varNumber", "I"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "anonCount", "I"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "state", "Ljdk/jshell/JShell;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "objectMethods", "Ljava/util/Set;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Eval", "(Ljdk/jshell/JShell;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "load", "(Ljava/util/Collection;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "events", "(Ljdk/jshell/Unit;Ljava/util/Collection;Ljava/lang/String;Ljdk/jshell/JShellException;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "eval", "(Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "interestingEvent", "(Ljdk/jshell/SnippetEvent;)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceToSnippets", "(Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "declare", "(Ljdk/jshell/Snippet;Ljdk/jshell/DiagList;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "trialCompile", "(Ljdk/jshell/Wrap;)Ljdk/jshell/DiagList;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "kindOfTree", "(Lcom/sun/source/tree/Tree;)Ljdk/jshell/Snippet$Kind;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "compileFailResult", "(Ljdk/jshell/DiagList;Ljava/lang/String;Ljdk/jshell/Snippet$Kind;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "compileFailResult", "(Ljdk/jshell/TaskFactory$BaseTask;Ljava/lang/String;Ljdk/jshell/Snippet$Kind;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "anonymous2Member", "(Ljdk/jshell/ExpressionToTypeInfo$ExpressionInfo;Ljava/lang/String;Ljdk/jshell/Wrap$Range;Ljdk/jshell/TreeDissector;Lcom/sun/source/tree/Tree;)Ljdk/jshell/Util$Pair;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "modifierDiagnostics", "(Lcom/sun/source/tree/ModifiersTree;Ljdk/jshell/TreeDissector;Z)Ljdk/jshell/DiagList;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "nameInUnicode", "(Ljavax/lang/model/element/Name;Z)Ljava/lang/String;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "shouldGenTempVar", "(Ljdk/jshell/Snippet$SubKind;)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "objectMethodNameDiag", "(Ljava/lang/String;J)Ljdk/jshell/Diag;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "compileAndLoad", "(Ljava/util/Set;)Ljava/util/Set;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "asUnresolvedReferenceException", "(Ljdk/jshell/spi/ExecutionControl$ResolutionException;)Ljdk/jshell/UnresolvedReferenceException;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "asEvalException", "(Ljdk/jshell/spi/ExecutionControl$UserException;)Ljdk/jshell/EvalException;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "translateExceptionStack", "(Ljava/lang/Exception;)[Ljava/lang/StackTraceElement;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "asJShellException", "(Ljava/lang/Throwable;)Ljdk/jshell/JShellException;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "outerWrapSet", "(Ljava/util/Collection;)Ljava/util/Set;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isWrap", "(Ljava/lang/StackTraceElement;)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "processImport", "(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "processVariables", "(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljdk/jshell/TaskFactory$ParseTask;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "processExpression", "(Ljava/lang/String;Lcom/sun/source/tree/Tree;Ljava/lang/String;Ljdk/jshell/TaskFactory$ParseTask;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "processClass", "(Ljava/lang/String;Lcom/sun/source/tree/Tree;Ljava/lang/String;Ljdk/jshell/Snippet$SubKind;Ljdk/jshell/TaskFactory$ParseTask;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "processMethod", "(Ljava/lang/String;Lcom/sun/source/tree/Tree;Ljava/lang/String;Ljdk/jshell/TaskFactory$ParseTask;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "processStatement", "(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceToSnippetsWithWrappers", "(Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "toScratchSnippets", "(Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "userReadableName", "(Ljavax/lang/model/element/Name;Ljava/lang/String;)Ljava/lang/String;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "computeDeclareName", "(Lcom/sun/tools/javac/code/Symbol$TypeSymbol;)Ljava/lang/String;"));
	...
	public Eval(Dova.JDK.jdk.jshell.JShell arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
		...
		: Dova.JDK.com.sun.tools.javac.tree.Pretty
	{
		...
		static EvalPretty()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/Eval$EvalPretty;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "out", "Ljava/io/Writer;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "EvalPretty", "(Ljava/io/Writer;Z)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "print", "(Ljava/lang/Object;)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "prettyExpr", "(Lcom/sun/tools/javac/tree/JCTree;Z)Ljava/lang/String;"));
		}
		...
		public EvalPretty(Dova.JDK.java.io.Writer arg0, bool arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
		{
		}
		...
		: Dova.JDK.java.lang.Enum
	{
		...
		static Result()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/Eval$Result;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SUCESS", "Ljdk/jshell/Eval$Result;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "FAILURE", "Ljdk/jshell/Eval$Result;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CONTINUE", "Ljdk/jshell/Eval$Result;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "$VALUES", "[Ljdk/jshell/Eval$Result;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Result", "(Ljava/lang/String;I)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "values", "()[Ljdk/jshell/Eval$Result;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "valueOf", "(Ljava/lang/String;)Ljdk/jshell/Eval$Result;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "$values", "()[Ljdk/jshell/Eval$Result;"));
		}
		...
		: Dova.JDK.jdk.jshell.Diag
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/Eval$ModifierDiagnostic;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "fatal", "Z"));
			...
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ModifierDiagnostic", "(Ljdk/jshell/Eval;ZLjava/lang/String;JJ)V"));
		...
		public ModifierDiagnostic(Dova.JDK.jdk.jshell.Eval arg0, bool arg1, Dova.JDK.java.lang.String arg2, long arg3, long arg4) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4))
		{
		}
