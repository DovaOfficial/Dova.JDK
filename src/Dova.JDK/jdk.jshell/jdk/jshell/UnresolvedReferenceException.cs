	...
	: Dova.JDK.jdk.jshell.JShellException
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/UnresolvedReferenceException;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "snippet", "Ljdk/jshell/DeclarationSnippet;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnresolvedReferenceException", "(Ljdk/jshell/DeclarationSnippet;[Ljava/lang/StackTraceElement;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getSnippet", "()Ljdk/jshell/DeclarationSnippet;"));
	}
	...
	public UnresolvedReferenceException(Dova.JDK.jdk.jshell.DeclarationSnippet arg0, JavaArray<Dova.JDK.java.lang.StackTraceElement> arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
