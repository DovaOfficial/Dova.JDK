	...
	: Dova.JDK.java.lang.Object
{
	...
	static TaskFactory()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "compiler", "Ljavax/tools/JavaCompiler;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "fileManager", "Ljdk/jshell/MemoryFileManager;"));
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "INITIAL_SUPPORTED_VER", "Ljava/lang/Runtime$Version;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "javacTaskPool", "Lcom/sun/tools/javac/api/JavacTaskPool;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "TaskFactory", "(Ljdk/jshell/JShell;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "compile", "(Ljava/util/Collection;Ljdk/jshell/TaskFactory$Worker;)Ljava/lang/Object;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "parse", "(Ljava/lang/String;Ljdk/jshell/TaskFactory$Worker;)Ljava/lang/Object;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "parse", "(Ljava/lang/String;ZLjdk/jshell/TaskFactory$Worker;)Ljava/lang/Object;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "addToClasspath", "(Ljava/lang/String;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "fileManager", "()Ljdk/jshell/MemoryFileManager;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "initTaskPool", "()V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "runTask", "(Ljava/util/stream/Stream;Ljdk/jshell/TaskFactory$SourceHandler;Ljava/util/List;Ljava/util/function/BiFunction;Ljdk/jshell/TaskFactory$Worker;)Ljava/lang/Object;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "analyze", "(Ljava/util/Collection;Ljava/util/List;Ljdk/jshell/TaskFactory$Worker;)Ljava/lang/Object;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "analyze", "(Ljdk/jshell/OuterWrap;Ljava/util/List;Ljdk/jshell/TaskFactory$Worker;)Ljava/lang/Object;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "analyze", "(Ljava/util/Collection;Ljdk/jshell/TaskFactory$Worker;)Ljava/lang/Object;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "analyze", "(Ljdk/jshell/OuterWrap;Ljdk/jshell/TaskFactory$Worker;)Ljava/lang/Object;"));
	}
	...
	public TaskFactory(Dova.JDK.jdk.jshell.JShell arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
		...
		, Dova.JDK.jdk.jshell.TaskFactory.SourceHandler
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$StringSourceHandler;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "file2Snippet", "Ljava/util/Map;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "StringSourceHandler", "(Ljdk/jshell/TaskFactory;)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "diag", "(Ljavax/tools/Diagnostic;)Ljdk/jshell/Diag;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceToFileObject", "(Ljdk/jshell/MemoryFileManager;Ljava/lang/Object;)Ljavax/tools/JavaFileObject;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceToFileObject", "(Ljdk/jshell/MemoryFileManager;Ljava/lang/String;)Ljavax/tools/JavaFileObject;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceForFileObject_0", "(Ljavax/tools/JavaFileObject;)Ljava/lang/String;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceForFileObject_1", "(Ljavax/tools/JavaFileObject;)Ljava/lang/Object;"));
		}
		...
		public StringSourceHandler(Dova.JDK.jdk.jshell.TaskFactory arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}
		...
		: IJavaObject
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$SourceHandler;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "diag", "(Ljavax/tools/Diagnostic;)Ljdk/jshell/Diag;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceToFileObject", "(Ljdk/jshell/MemoryFileManager;Ljava/lang/Object;)Ljavax/tools/JavaFileObject;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceForFileObject", "(Ljavax/tools/JavaFileObject;)Ljava/lang/Object;"));
		}
		...
		: IJavaObject
	{
		...
		static Worker()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$Worker;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "withTask", "(Ljdk/jshell/TaskFactory$BaseTask;)Ljava/lang/Object;"));
		}
		...
		, Dova.JDK.jdk.jshell.TaskFactory.SourceHandler
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$WrapSourceHandler;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "file2Snippet", "Ljava/util/Map;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "this$0", "Ljdk/jshell/TaskFactory;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "WrapSourceHandler", "(Ljdk/jshell/TaskFactory;)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "diag", "(Ljavax/tools/Diagnostic;)Ljdk/jshell/Diag;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceToFileObject", "(Ljdk/jshell/MemoryFileManager;Ljava/lang/Object;)Ljavax/tools/JavaFileObject;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceToFileObject", "(Ljdk/jshell/MemoryFileManager;Ljdk/jshell/OuterWrap;)Ljavax/tools/JavaFileObject;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceForFileObject_0", "(Ljavax/tools/JavaFileObject;)Ljdk/jshell/OuterWrap;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceForFileObject_1", "(Ljavax/tools/JavaFileObject;)Ljava/lang/Object;"));
		}
		...
		[JniSignatureAttribute("(Ljdk/jshell/TaskFactory;)V", "private")]
		public WrapSourceHandler(Dova.JDK.jdk.jshell.TaskFactory arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}
		...
		: Dova.JDK.jdk.jshell.TaskFactory.BaseTask
	{
		...
		static ParseTask()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$ParseTask;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "cuts", "Ljava/lang/Iterable;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "units", "Ljava/util/List;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ParseTask", "(Ljdk/jshell/TaskFactory;Ljdk/jshell/TaskFactory$SourceHandler;Lcom/sun/tools/javac/api/JavacTaskImpl;Ljavax/tools/DiagnosticCollector;Z)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "parse", "()Ljava/lang/Iterable;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "units", "()Ljava/util/List;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "cuTrees", "()Ljava/lang/Iterable;"));
		}
		...
		public ParseTask(Dova.JDK.jdk.jshell.TaskFactory arg0, Dova.JDK.jdk.jshell.TaskFactory.SourceHandler arg1, Dova.JDK.com.sun.tools.javac.api.JavacTaskImpl arg2, Dova.JDK.javax.tools.DiagnosticCollector arg3, bool arg4) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4))
		{
		}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static BaseTask()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$BaseTask;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "diagnostics", "Ljavax/tools/DiagnosticCollector;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "task", "Lcom/sun/tools/javac/api/JavacTaskImpl;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "diags", "Ljdk/jshell/DiagList;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "sourceHandler", "Ljdk/jshell/TaskFactory$SourceHandler;"));
			...
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "trees", "Lcom/sun/source/util/Trees;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "this$0", "Ljdk/jshell/TaskFactory;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "BaseTask", "(Ljdk/jshell/TaskFactory;Ljdk/jshell/TaskFactory$SourceHandler;Lcom/sun/tools/javac/api/JavacTaskImpl;Ljavax/tools/DiagnosticCollector;)V"));
			...
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "diag", "(Ljavax/tools/Diagnostic;)Ljdk/jshell/Diag;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "hasErrors", "()Z"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "messages", "()Lcom/sun/tools/javac/util/JavacMessages;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "firstCuTree", "()Lcom/sun/source/tree/CompilationUnitTree;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getDiagnostics", "()Ljdk/jshell/DiagList;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "cuTrees", "()Ljava/lang/Iterable;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "shortErrorMessage", "()Ljava/lang/String;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "debugPrintDiagnostics", "(Ljava/lang/String;)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "sourceForFile", "(Ljavax/tools/JavaFileObject;)Ljava/lang/Object;"));
		...
		public BaseTask(Dova.JDK.jdk.jshell.TaskFactory arg0, Dova.JDK.jdk.jshell.TaskFactory.SourceHandler arg1, Dova.JDK.com.sun.tools.javac.api.JavacTaskImpl arg2, Dova.JDK.javax.tools.DiagnosticCollector arg3) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3))
		{
		}
		...
		: Dova.JDK.com.sun.tools.javac.comp.Resolve
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$DisableAccessibilityResolve;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "noAccessChecks", "Z"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DisableAccessibilityResolve", "(Lcom/sun/tools/javac/util/Context;)V"));
			...
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "runWithoutAccessChecks", "(Ljava/lang/Runnable;)V"));
		}
		...
		public DisableAccessibilityResolve(Dova.JDK.com.sun.tools.javac.util.Context arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}
			...
			: Dova.JDK.java.lang.Object
		{
			...
			static Marker()
			{
				ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$DisableAccessibilityResolve$Marker;");
				ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
				ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Marker", "()V"));
			}
			...
			[JniSignatureAttribute("()V", "private")]
			public Marker() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
			{
			}
		...
		, Dova.JDK.com.sun.source.util.TaskListener
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$TaskListenerImpl;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "context", "Lcom/sun/tools/javac/util/Context;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "state", "Ljdk/jshell/JShell;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "var2OriginalType", "Ljava/util/Map;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "variablesSet", "Z"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "TaskListenerImpl", "(Lcom/sun/tools/javac/util/Context;Ljdk/jshell/JShell;)V"));
			...
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "setVariableType", "(Ljdk/jshell/VarSnippet;)V"));
		}
		...
		public TaskListenerImpl(Dova.JDK.com.sun.tools.javac.util.Context arg0, Dova.JDK.jdk.jshell.JShell arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
		{
		}
		...
		: Dova.JDK.jdk.jshell.TaskFactory.BaseTask
	{
		...
		static CompileTask()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$CompileTask;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "classObjs", "Ljava/util/Map;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "this$0", "Ljdk/jshell/TaskFactory;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CompileTask", "(Ljdk/jshell/TaskFactory;Ljdk/jshell/TaskFactory$SourceHandler;Lcom/sun/tools/javac/api/JavacTaskImpl;Ljavax/tools/DiagnosticCollector;)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "compile", "()Z"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "cuTrees", "()Ljava/lang/Iterable;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "listenForNewClassFile", "(Ljdk/jshell/MemoryFileManager$OutputMemoryJavaFileObject;Ljavax/tools/JavaFileManager$Location;Ljava/lang/String;Ljavax/tools/JavaFileObject$Kind;Ljavax/tools/FileObject;)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "classList", "(Ljdk/jshell/OuterWrap;)Ljava/util/List;"));
		}
		...
		public CompileTask(Dova.JDK.jdk.jshell.TaskFactory arg0, Dova.JDK.jdk.jshell.TaskFactory.SourceHandler arg1, Dova.JDK.com.sun.tools.javac.api.JavacTaskImpl arg2, Dova.JDK.javax.tools.DiagnosticCollector arg3) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3))
		{
		}
		...
		: Dova.JDK.jdk.jshell.TaskFactory.BaseTask
	{
		...
		static AnalyzeTask()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/jshell/TaskFactory$AnalyzeTask;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "cuts", "Ljava/lang/Iterable;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AnalyzeTask", "(Ljdk/jshell/TaskFactory;Ljdk/jshell/TaskFactory$SourceHandler;Lcom/sun/tools/javac/api/JavacTaskImpl;Ljavax/tools/DiagnosticCollector;)V"));
		...
		[JniSignatureAttribute("(Ljdk/jshell/TaskFactory;Ljdk/jshell/TaskFactory$SourceHandler;Lcom/sun/tools/javac/api/JavacTaskImpl;Ljavax/tools/DiagnosticCollector;)V", "private")]
		public AnalyzeTask(Dova.JDK.jdk.jshell.TaskFactory arg0, Dova.JDK.jdk.jshell.TaskFactory.SourceHandler arg1, Dova.JDK.com.sun.tools.javac.api.JavacTaskImpl arg2, Dova.JDK.javax.tools.DiagnosticCollector arg3) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3))
		{
		}
