	...
	: Dova.JDK.java.lang.Object
{
	...
	static Versions()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "shortVersionStringOf", "(Ljava/lang/Runtime$Version;)Ljava/lang/String;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "fullVersionStringOf", "(Ljava/lang/Runtime$Version;)Ljava/lang/String;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "javadocVersion", "()Ljava/lang/Runtime$Version;"));
	}
	...
	public Versions() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
