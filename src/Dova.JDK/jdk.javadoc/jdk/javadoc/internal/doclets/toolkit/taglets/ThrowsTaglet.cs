	...
	, Dova.JDK.jdk.javadoc.@internal.doclets.toolkit.taglets.InheritableTaglet
{
	...
	static ThrowsTaglet()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ThrowsTaglet", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "inheritThrowsDocumentation", "(Ljavax/lang/model/element/Element;Ljava/util/List;Ljava/util/Set;Ljava/util/Map;Ljdk/javadoc/internal/doclets/toolkit/taglets/TagletWriter;)Ljdk/javadoc/internal/doclets/toolkit/Content;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getSubstitutedThrownTypes", "(Ljava/util/List;Ljava/util/List;)Ljava/util/Map;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "throwsTagsOutput", "(Ljava/util/Map;Ljdk/javadoc/internal/doclets/toolkit/taglets/TagletWriter;Ljava/util/Set;Ljava/util/Map;Z)Ljdk/javadoc/internal/doclets/toolkit/Content;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "linkToUndocumentedDeclaredExceptions", "(Ljava/util/List;Ljava/util/Set;Ljdk/javadoc/internal/doclets/toolkit/taglets/TagletWriter;)Ljdk/javadoc/internal/doclets/toolkit/Content;"));
	...
	public ThrowsTaglet() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
