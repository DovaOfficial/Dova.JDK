	...
	: Dova.JDK.sun.jvmstat.monitor.MonitoredHost
{
	...
	static MonitoredHostProvider()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "task", "Lsun/jvmstat/perfdata/monitor/protocol/local/MonitoredHostProvider$NotifierTask;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "activeVms", "Ljava/util/HashSet;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "vmManager", "Lsun/jvmstat/perfdata/monitor/protocol/local/LocalVmManager;"));
		...
		: Dova.JDK.sun.jvmstat.perfdata.monitor.CountedTimerTask
	{
		...
		static NotifierTask()
		{
			...
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "this$0", "Lsun/jvmstat/perfdata/monitor/protocol/local/MonitoredHostProvider;"));
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "NotifierTask", "(Lsun/jvmstat/perfdata/monitor/protocol/local/MonitoredHostProvider;)V"));
		...
		public NotifierTask(Dova.JDK.sun.jvmstat.perfdata.monitor.protocol.local.MonitoredHostProvider arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}
