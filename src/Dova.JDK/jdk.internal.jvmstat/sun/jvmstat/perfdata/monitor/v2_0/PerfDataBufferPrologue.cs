	...
	: Dova.JDK.sun.jvmstat.perfdata.monitor.AbstractPerfDataBufferPrologue
{
	...
	static PerfDataBufferPrologue()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PERFDATA_PROLOG_ACCESSIBLE_OFFSET", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PERFDATA_PROLOG_ACCESSIBLE_SIZE", "I"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PERFDATA_PROLOG_ENTRYOFFSET_OFFSET", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PERFDATA_PROLOG_ENTRYOFFSET_SIZE", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PERFDATA_PROLOG_NUMENTRIES_OFFSET", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PERFDATA_PROLOG_NUMENTRIES_SIZE", "I"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PERFDATA_NUMENTRIES_NAME", "Ljava/lang/String;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "numEntriesBuffer", "()Ljava/nio/IntBuffer;"));
	}
