	...
	: Dova.JDK.java.util.EventObject
{
	...
	static HostEvent()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lsun/jvmstat/monitor/MonitoredHost;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getMonitoredHost", "()Lsun/jvmstat/monitor/MonitoredHost;"));
	}
	...
	public HostEvent(Dova.JDK.sun.jvmstat.monitor.MonitoredHost arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
