...
[JniSignatureAttribute("Lsun/text/resources/cldr/ext/FormatData_es_HN;", "public")]
	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/text/resources/cldr/ext/FormatData_es_HN;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FormatData_es_HN", "()V"));
	...
	public FormatData_es_HN() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/text/resources/cldr/ext/FormatData_es_HN;";
