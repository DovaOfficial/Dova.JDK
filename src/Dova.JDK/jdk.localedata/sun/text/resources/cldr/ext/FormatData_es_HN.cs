	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/text/resources/cldr/ext/FormatData_es_HN;");
	...
	public FormatData_es_HN() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
