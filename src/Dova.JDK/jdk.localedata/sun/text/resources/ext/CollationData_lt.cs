	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/text/resources/ext/CollationData_lt;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CollationData_lt", "()V"));
	...
	public CollationData_lt() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
