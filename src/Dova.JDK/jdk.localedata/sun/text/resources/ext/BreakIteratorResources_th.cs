	...
	: Dova.JDK.sun.util.resources.BreakIteratorResourceBundle
{
	...
	static BreakIteratorResources_th()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "BreakIteratorResources_th", "()V"));
	...
	public BreakIteratorResources_th() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
