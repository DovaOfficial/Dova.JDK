	...
	, Dova.JDK.sun.util.locale.provider.LocaleDataMetaInfo
{
	...
	static NonBaseLocaleDataMetaInfo()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "NonBaseLocaleDataMetaInfo", "()V"));
	...
	public NonBaseLocaleDataMetaInfo() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
