	...
	: Dova.JDK.sun.util.resources.OpenListResourceBundle
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/util/resources/cldr/ext/LocaleNames_mzn;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "LocaleNames_mzn", "()V"));
	...
	public LocaleNames_mzn() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
