	...
	: Dova.JDK.sun.util.resources.OpenListResourceBundle
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/util/resources/cldr/ext/CurrencyNames_en_MY;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CurrencyNames_en_MY", "()V"));
	...
	public CurrencyNames_en_MY() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
