	...
	: Dova.JDK.sun.util.resources.OpenListResourceBundle
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/util/resources/cldr/ext/CurrencyNames_bg;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CurrencyNames_bg", "()V"));
	...
	public CurrencyNames_bg() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
