	...
	: Dova.JDK.sun.util.resources.OpenListResourceBundle
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/util/resources/cldr/ext/LocaleNames_os;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "LocaleNames_os", "()V"));
	...
	public LocaleNames_os() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
