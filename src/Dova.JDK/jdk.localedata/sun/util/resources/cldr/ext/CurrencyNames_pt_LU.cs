	...
	: Dova.JDK.sun.util.resources.OpenListResourceBundle
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/util/resources/cldr/ext/CurrencyNames_pt_LU;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CurrencyNames_pt_LU", "()V"));
	...
	public CurrencyNames_pt_LU() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
