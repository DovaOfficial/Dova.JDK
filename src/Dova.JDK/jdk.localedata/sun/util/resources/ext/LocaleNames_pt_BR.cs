	...
	: Dova.JDK.sun.util.resources.LocaleNamesBundle
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/util/resources/ext/LocaleNames_pt_BR;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "LocaleNames_pt_BR", "()V"));
	...
	public LocaleNames_pt_BR() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
