	...
	: Dova.JDK.sun.util.resources.LocaleNamesBundle
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/util/resources/ext/CalendarData_hr;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CalendarData_hr", "()V"));
	...
	public CalendarData_hr() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
