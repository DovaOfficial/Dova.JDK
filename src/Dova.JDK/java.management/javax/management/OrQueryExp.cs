	...
	, Dova.JDK.javax.management.QueryExp
{
	...
	static OrQueryExp()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OrQueryExp", "()V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OrQueryExp", "(Ljavax/management/QueryExp;Ljavax/management/QueryExp;)V"));
	...
	public OrQueryExp() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Ljavax/management/QueryExp;Ljavax/management/QueryExp;)V", "public")]
	public OrQueryExp(Dova.JDK.javax.management.QueryExp arg0, Dova.JDK.javax.management.QueryExp arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
