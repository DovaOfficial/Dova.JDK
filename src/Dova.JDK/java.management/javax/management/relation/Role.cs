	...
	, Dova.JDK.java.io.Serializable
{
	...
	static Role()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "objectNameList", "Ljava/util/List;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "roleValueToString", "(Ljava/util/List;)Ljava/lang/String;"));
	}
	...
	public Role(Dova.JDK.java.lang.String arg0, Dova.JDK.java.util.List arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
