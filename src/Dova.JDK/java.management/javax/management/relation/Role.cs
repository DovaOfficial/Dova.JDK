	...
	, Dova.JDK.java.io.Serializable
{
	...
	static Role()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/management/relation/Role;");
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "objectNameList", "Ljava/util/List;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Role", "(Ljava/lang/String;Ljava/util/List;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "roleValueToString", "(Ljava/util/List;)Ljava/lang/String;"));
	}
	...
	public Role(Dova.JDK.java.lang.String arg0, Dova.JDK.java.util.List arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
