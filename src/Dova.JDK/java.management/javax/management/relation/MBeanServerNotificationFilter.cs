...
[JniSignatureAttribute("Ljavax/management/relation/MBeanServerNotificationFilter;", "public")]
public partial class MBeanServerNotificationFilter
	: Dova.JDK.javax.management.NotificationFilterSupport
{
	...
	static MBeanServerNotificationFilter()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/management/relation/MBeanServerNotificationFilter;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "selectedNames", "Ljava/util/List;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "deselectedNames", "Ljava/util/List;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MBeanServerNotificationFilter", "()V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "readObject", "(Ljava/io/ObjectInputStream;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "writeObject", "(Ljava/io/ObjectOutputStream;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "disableAllObjectNames", "()V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "disableObjectName", "(Ljavax/management/ObjectName;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "enableAllObjectNames", "()V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "enableObjectName", "(Ljavax/management/ObjectName;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getEnabledObjectNames", "()Ljava/util/Vector;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getDisabledObjectNames", "()Ljava/util/Vector;"));
	...
	public Dova.JDK.java.util.List selectedNames_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Ljava/util/List;", "private")]
	public Dova.JDK.java.util.List deselectedNames_Property
	{
		get
		{
	...
	public MBeanServerNotificationFilter(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public MBeanServerNotificationFilter() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/management/relation/MBeanServerNotificationFilter;";
	...
	public void disableObjectName(Dova.JDK.javax.management.ObjectName arg0)
	{
	...
	[JniSignatureAttribute("(Ljavax/management/ObjectName;)V", "public synchronized")]
	public void enableObjectName(Dova.JDK.javax.management.ObjectName arg0)
	{
		DovaJvm.Vm.Runtime.CallVoidMethodA(CurrentRefPtr, MethodPtrs[5], arg0);
	}

	[JniSignatureAttribute("()Ljava/util/Vector;", "public synchronized")]
	public Dova.JDK.java.util.Vector getEnabledObjectNames()
	{
	...
	[JniSignatureAttribute("()Ljava/util/Vector;", "public synchronized")]
	public Dova.JDK.java.util.Vector getDisabledObjectNames()
	{
