	...
	: Dova.JDK.javax.management.JMRuntimeException
{
	...
	public RuntimeOperationsException(Dova.JDK.java.lang.RuntimeException arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/RuntimeException;Ljava/lang/String;)V", "public")]
	public RuntimeOperationsException(Dova.JDK.java.lang.RuntimeException arg0, Dova.JDK.java.lang.String arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
