	...
	: Dova.JDK.javax.management.Notification
{
	...
	static TimerAlarmClockNotification()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljavax/management/timer/TimerAlarmClock;)V"));
	}
	...
	public TimerAlarmClockNotification(Dova.JDK.javax.management.timer.TimerAlarmClock arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
