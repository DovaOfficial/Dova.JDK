	...
	: Dova.JDK.javax.management.Notification
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/management/timer/TimerAlarmClockNotification;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "TimerAlarmClockNotification", "(Ljavax/management/timer/TimerAlarmClock;)V"));
	}
	...
	public TimerAlarmClockNotification(Dova.JDK.javax.management.timer.TimerAlarmClock arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
