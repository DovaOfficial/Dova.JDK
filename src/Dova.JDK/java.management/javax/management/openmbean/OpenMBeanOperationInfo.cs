...
[JniSignatureAttribute("Ljavax/management/openmbean/OpenMBeanOperationInfo;", "public abstract interface")]
public partial interface OpenMBeanOperationInfo
	: IJavaObject
{
	...
	static OpenMBeanOperationInfo()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/management/openmbean/OpenMBeanOperationInfo;");
	...
	[JniSignatureAttribute("()Ljava/lang/String;", "public abstract")]
	Dova.JDK.java.lang.String getReturnType()
	{
		var ret = DovaVM.Runtime.CallObjectMethodA(CurrentRefPtr, MethodPtrs[4]);
		return DovaInterfaceFactory.Get<Dova.JDK.java.lang.String>(ret);
	}

	[JniSignatureAttribute("()[Ljavax/management/MBeanParameterInfo;", "public abstract")]
	JavaArray<Dova.JDK.javax.management.MBeanParameterInfo> getSignature()
	{
	...
	Dova.JDK.javax.management.openmbean.OpenType getReturnOpenType()
	{
