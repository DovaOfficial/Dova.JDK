...
[JniSignatureAttribute("Ljavax/management/NumericValueExp;", "")]
public partial class NumericValueExp
	...
	, Dova.JDK.javax.management.ValueExp
{
	...
	static NumericValueExp()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/management/NumericValueExp;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "val", "Ljava/lang/Number;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "compat", "Z"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "NumericValueExp", "()V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "NumericValueExp", "(Ljava/lang/Number;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isLong", "()Z"));
	...
	public Dova.JDK.java.lang.Number val_Property
	{
		get
		{
	...
	public NumericValueExp(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public NumericValueExp() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/Number;)V", "")]
	public NumericValueExp(Dova.JDK.java.lang.Number arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/management/NumericValueExp;";
