	...
	: Dova.JDK.java.security.PermissionCollection
{
	...
	static MBeanServerPermissionCollection()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "collectionPermission", "Ljavax/management/MBeanServerPermission;"));
	...
	public MBeanServerPermissionCollection() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
