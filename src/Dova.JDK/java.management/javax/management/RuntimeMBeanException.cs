	...
	: Dova.JDK.javax.management.JMRuntimeException
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/management/RuntimeMBeanException;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "RuntimeMBeanException", "(Ljava/lang/RuntimeException;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "RuntimeMBeanException", "(Ljava/lang/RuntimeException;Ljava/lang/String;)V"));
	...
	public RuntimeMBeanException(Dova.JDK.java.lang.RuntimeException arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/RuntimeException;Ljava/lang/String;)V", "public")]
	public RuntimeMBeanException(Dova.JDK.java.lang.RuntimeException arg0, Dova.JDK.java.lang.String arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
