	...
	: Dova.JDK.java.lang.Object
{
	...
	static MXBeanMappingFactory()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "DEFAULT", "Lcom/sun/jmx/mbeanserver/MXBeanMappingFactory;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MXBeanMappingFactory", "()V"));
	...
	public MXBeanMappingFactory() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
