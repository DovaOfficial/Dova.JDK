	...
	, Dova.JDK.sun.management.counter.StringCounter
{
	...
	static PerfStringCounter()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "PerfStringCounter", "(Ljava/lang/String;Lsun/management/counter/Variability;ILjava/nio/ByteBuffer;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "PerfStringCounter", "(Ljava/lang/String;Lsun/management/counter/Variability;IILjava/nio/ByteBuffer;)V"));
	...
	public PerfStringCounter(Dova.JDK.java.lang.String arg0, Dova.JDK.sun.management.counter.Variability arg1, int arg2, Dova.JDK.java.nio.ByteBuffer arg3) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;Lsun/management/counter/Variability;IILjava/nio/ByteBuffer;)V", "")]
	public PerfStringCounter(Dova.JDK.java.lang.String arg0, Dova.JDK.sun.management.counter.Variability arg1, int arg2, int arg3, Dova.JDK.java.nio.ByteBuffer arg4) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1, arg2, arg3, arg4))
	{
	}
