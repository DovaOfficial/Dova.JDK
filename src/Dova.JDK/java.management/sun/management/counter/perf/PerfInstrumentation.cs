	...
	: Dova.JDK.java.lang.Object
{
	...
	static PerfInstrumentation()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "prologue", "Lsun/management/counter/perf/Prologue;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "lastModificationTime", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "lastUsed", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "nextEntry", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "map", "Ljava/util/SortedMap;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getNextCounter", "()Lsun/management/counter/Counter;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getAllCounters", "()Ljava/util/List;"));
	}
	...
	public PerfInstrumentation(Dova.JDK.java.nio.ByteBuffer arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
