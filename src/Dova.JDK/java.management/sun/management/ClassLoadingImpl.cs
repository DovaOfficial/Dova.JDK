	...
	, Dova.JDK.java.lang.management.ClassLoadingMXBean
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/management/ClassLoadingImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "jvm", "Lsun/management/VMManagement;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ClassLoadingImpl", "(Lsun/management/VMManagement;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "setVerboseClass", "(Z)V"));
	...
	public ClassLoadingImpl(Dova.JDK.sun.management.VMManagement arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
