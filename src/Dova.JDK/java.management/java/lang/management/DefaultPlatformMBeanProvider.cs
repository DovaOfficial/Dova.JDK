	...
	: Dova.JDK.sun.management.spi.PlatformMBeanProvider
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/lang/management/DefaultPlatformMBeanProvider;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "mxbeanList", "Ljava/util/List;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DefaultPlatformMBeanProvider", "()V"));
	...
	public DefaultPlatformMBeanProvider() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
