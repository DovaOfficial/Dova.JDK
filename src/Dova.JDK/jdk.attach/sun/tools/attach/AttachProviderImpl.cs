	...
	: Dova.JDK.sun.tools.attach.HotSpotAttachProvider
{
	...
	static AttachProviderImpl()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AttachProviderImpl", "()V"));
	...
	public AttachProviderImpl() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
