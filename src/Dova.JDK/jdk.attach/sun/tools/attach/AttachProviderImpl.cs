	...
	: Dova.JDK.sun.tools.attach.HotSpotAttachProvider
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/tools/attach/AttachProviderImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "$assertionsDisabled", "Z"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AttachProviderImpl", "()V"));
	...
	public AttachProviderImpl() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
