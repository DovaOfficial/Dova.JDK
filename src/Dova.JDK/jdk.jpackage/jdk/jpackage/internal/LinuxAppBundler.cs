	...
	: Dova.JDK.jdk.jpackage.@internal.AppImageBundler
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/jpackage/internal/LinuxAppBundler;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "LinuxAppBundler", "()V"));
	...
	public LinuxAppBundler() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
