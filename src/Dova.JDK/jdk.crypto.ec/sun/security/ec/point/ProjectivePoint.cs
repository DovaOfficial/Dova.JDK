	...
	, Dova.JDK.sun.security.ec.point.Point
{
	...
	static ProjectivePoint()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lsun/security/util/math/IntegerModuloP;Lsun/security/util/math/IntegerModuloP;Lsun/security/util/math/IntegerModuloP;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "fixed_1", "()Lsun/security/ec/point/ProjectivePoint$Immutable;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "asAffine", "()Lsun/security/ec/point/AffinePoint;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "mutable_0", "()Lsun/security/ec/point/MutablePoint;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "mutable_1", "()Lsun/security/ec/point/ProjectivePoint$Mutable;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "affineEquals", "(Lsun/security/ec/point/Point;)Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "affineEquals", "(Lsun/security/ec/point/ProjectivePoint;Lsun/security/ec/point/ProjectivePoint;)Z"));
	...
	public ProjectivePoint(Dova.JDK.java.lang.Object arg0, Dova.JDK.java.lang.Object arg1, Dova.JDK.java.lang.Object arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
		...
		, Dova.JDK.sun.security.ec.point.ImmutablePoint
	{
		...
		static Immutable()
		{
			...
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lsun/security/util/math/ImmutableIntegerModuloP;Lsun/security/util/math/ImmutableIntegerModuloP;Lsun/security/util/math/ImmutableIntegerModuloP;)V"));
		...
		public Immutable(Dova.JDK.sun.security.util.math.ImmutableIntegerModuloP arg0, Dova.JDK.sun.security.util.math.ImmutableIntegerModuloP arg1, Dova.JDK.sun.security.util.math.ImmutableIntegerModuloP arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
		{
		}
		...
		, Dova.JDK.sun.security.ec.point.MutablePoint
	{
		...
		static Mutable()
		{
			...
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lsun/security/util/math/MutableIntegerModuloP;Lsun/security/util/math/MutableIntegerModuloP;Lsun/security/util/math/MutableIntegerModuloP;)V"));
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lsun/security/util/math/IntegerFieldModuloP;)V"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setValue", "(Lsun/security/ec/point/ProjectivePoint;)Lsun/security/ec/point/ProjectivePoint$Mutable;"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setValue_0", "(Lsun/security/ec/point/Point;)Lsun/security/ec/point/ProjectivePoint$Mutable;"));
			...
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setValue_1", "(Lsun/security/ec/point/AffinePoint;)Lsun/security/ec/point/ProjectivePoint$Mutable;"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "fixed", "()Lsun/security/ec/point/ImmutablePoint;"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "mutable", "()Lsun/security/ec/point/MutablePoint;"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "conditionalSet_0", "(Lsun/security/ec/point/Point;I)Lsun/security/ec/point/ProjectivePoint$Mutable;"));
			...
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "conditionalSet", "(Lsun/security/ec/point/ProjectivePoint;I)Lsun/security/ec/point/ProjectivePoint$Mutable;"));
		}
		...
		public Mutable(Dova.JDK.sun.security.util.math.MutableIntegerModuloP arg0, Dova.JDK.sun.security.util.math.MutableIntegerModuloP arg1, Dova.JDK.sun.security.util.math.MutableIntegerModuloP arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
		{
		}

		[JniSignatureAttribute("(Lsun/security/util/math/IntegerFieldModuloP;)V", "public")]
		public Mutable(Dova.JDK.sun.security.util.math.IntegerFieldModuloP arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
		{
		}
