	...
	, Dova.JDK.jdk.tools.jlink.@internal.Archive
{
	...
	static JmodArchive()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "JMOD_EXT", "Ljava/lang/String;"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "jmodFile", "Ljdk/internal/jmod/JmodFile;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/lang/String;Ljava/nio/file/Path;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "toEntryType", "(Ljdk/internal/jmod/JmodFile$Section;)Ljdk/tools/jlink/internal/Archive$Entry$EntryType;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "toEntry", "(Ljdk/internal/jmod/JmodFile$Entry;)Ljdk/tools/jlink/internal/Archive$Entry;"));
	}
	...
	public JmodArchive(Dova.JDK.java.lang.String arg0, Dova.JDK.java.nio.file.Path arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
		...
		: Dova.JDK.jdk.tools.jlink.@internal.Archive.Entry
	{
		...
		static JmodEntry()
		{
			...
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "entry", "Ljdk/internal/jmod/JmodFile$Entry;"));
			FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "this$0", "Ljdk/tools/jlink/internal/JmodArchive;"));
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljdk/tools/jlink/internal/JmodArchive;Ljava/lang/String;Ljava/lang/String;Ljdk/tools/jlink/internal/Archive$Entry$EntryType;Ljdk/internal/jmod/JmodFile$Entry;)V"));
