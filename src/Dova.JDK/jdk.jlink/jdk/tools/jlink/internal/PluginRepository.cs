	...
	: Dova.JDK.java.lang.Object
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/tools/jlink/internal/PluginRepository;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "registeredPlugins", "Ljava/util/Map;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PluginRepository", "()V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "newPlugin", "(Ljava/util/Map;Ljava/lang/String;Ljava/lang/ModuleLayer;)Ljdk/tools/jlink/plugin/Plugin;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getPlugin", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/ModuleLayer;)Ljdk/tools/jlink/plugin/Plugin;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getPlugin", "(Ljava/lang/String;Ljava/lang/ModuleLayer;)Ljdk/tools/jlink/plugin/Plugin;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "registerPlugin", "(Ljdk/tools/jlink/plugin/Plugin;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "unregisterPlugin", "(Ljava/lang/String;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getPlugins", "(Ljava/lang/ModuleLayer;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getPlugins", "(Ljava/lang/Class;Ljava/lang/ModuleLayer;)Ljava/util/List;"));
	}
	...
	public PluginRepository() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
