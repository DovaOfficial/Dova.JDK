	...
	: Dova.JDK.jdk.tools.jlink.@internal.plugins.VersionPropsPlugin
{
	...
	static VendorVersionPlugin()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "VendorVersionPlugin", "()V"));
	...
	public VendorVersionPlugin() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
