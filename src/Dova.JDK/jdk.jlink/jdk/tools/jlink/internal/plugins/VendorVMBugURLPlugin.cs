	...
	: Dova.JDK.jdk.tools.jlink.@internal.plugins.VersionPropsPlugin
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/tools/jlink/internal/plugins/VendorVMBugURLPlugin;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "VendorVMBugURLPlugin", "()V"));
	...
	public VendorVMBugURLPlugin() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
