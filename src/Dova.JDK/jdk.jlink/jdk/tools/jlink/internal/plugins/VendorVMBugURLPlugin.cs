...
[JniSignatureAttribute("Ljdk/tools/jlink/internal/plugins/VendorVMBugURLPlugin;", "public final")]
public partial class VendorVMBugURLPlugin
	: Dova.JDK.jdk.tools.jlink.@internal.plugins.VersionPropsPlugin
{
	...
	static VendorVMBugURLPlugin()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/tools/jlink/internal/plugins/VendorVMBugURLPlugin;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "VendorVMBugURLPlugin", "()V"));
	...
	public VendorVMBugURLPlugin(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public VendorVMBugURLPlugin() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/tools/jlink/internal/plugins/VendorVMBugURLPlugin;";
