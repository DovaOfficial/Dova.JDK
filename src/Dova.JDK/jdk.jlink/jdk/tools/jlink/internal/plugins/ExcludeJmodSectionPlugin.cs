...
[JniSignatureAttribute("Ljdk/tools/jlink/internal/plugins/ExcludeJmodSectionPlugin;", "public final")]
public partial class ExcludeJmodSectionPlugin
	: Dova.JDK.jdk.tools.jlink.@internal.plugins.AbstractPlugin
{
	...
	static ExcludeJmodSectionPlugin()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/tools/jlink/internal/plugins/ExcludeJmodSectionPlugin;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "MAN_PAGES", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "INCLUDE_HEADER_FILES", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "filters", "Ljava/util/Set;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ExcludeJmodSectionPlugin", "()V"));
	...
	public static Dova.JDK.java.lang.String MAN_PAGES_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Ljava/lang/String;", "public static final")]
	public static Dova.JDK.java.lang.String INCLUDE_HEADER_FILES_Property
	{
		get
		{
	...
	public Dova.JDK.java.util.Set filters_Property
	{
		get
		{
	...
	public ExcludeJmodSectionPlugin(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public ExcludeJmodSectionPlugin() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/tools/jlink/internal/plugins/ExcludeJmodSectionPlugin;";
