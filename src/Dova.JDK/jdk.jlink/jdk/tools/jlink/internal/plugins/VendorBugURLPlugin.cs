	...
	: Dova.JDK.jdk.tools.jlink.@internal.plugins.VersionPropsPlugin
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/tools/jlink/internal/plugins/VendorBugURLPlugin;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "VendorBugURLPlugin", "()V"));
	...
	public VendorBugURLPlugin() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
