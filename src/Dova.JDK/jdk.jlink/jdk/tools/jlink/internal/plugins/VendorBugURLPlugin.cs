...
[JniSignatureAttribute("Ljdk/tools/jlink/internal/plugins/VendorBugURLPlugin;", "public final")]
public partial class VendorBugURLPlugin
	: Dova.JDK.jdk.tools.jlink.@internal.plugins.VersionPropsPlugin
{
	...
	static VendorBugURLPlugin()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/tools/jlink/internal/plugins/VendorBugURLPlugin;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "VendorBugURLPlugin", "()V"));
	...
	public VendorBugURLPlugin(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public VendorBugURLPlugin() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/tools/jlink/internal/plugins/VendorBugURLPlugin;";
