...
[JniSignatureAttribute("Lcom/sun/jndi/rmi/registry/RegistryContext;", "public")]
public partial class RegistryContext
	: Dova.JDK.java.lang.Object
	, Dova.JDK.javax.naming.Context
	, Dova.JDK.javax.naming.Referenceable
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/jndi/rmi/registry/RegistryContext;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "environment", "Ljava/util/Hashtable;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "registry", "Ljava/rmi/registry/Registry;"));
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "trustURLCodebase", "Z"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "reference", "Ljavax/naming/Reference;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SECURITY_MGR", "Ljava/lang/String;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "RegistryContext", "(Ljava/lang/String;ILjava/util/Hashtable;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "RegistryContext", "(Lcom/sun/jndi/rmi/registry/RegistryContext;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "installSecurityMgr", "()V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "wrapRemoteException", "(Ljava/rmi/RemoteException;)Ljavax/naming/NamingException;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "decodeObject", "(Ljava/rmi/Remote;Ljavax/naming/Name;)Ljava/lang/Object;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "encodeObject", "(Ljava/lang/Object;Ljavax/naming/Name;)Ljava/rmi/Remote;"));
	}
	...
	[JniSignatureAttribute("Ljava/rmi/registry/Registry;", "private")]
	public Dova.JDK.java.rmi.registry.Registry registry_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Ljavax/naming/Reference;", "")]
	public Dova.JDK.javax.naming.Reference reference_Property
	{
		get
		{
	...
	public static Dova.JDK.java.lang.String SECURITY_MGR_Property
	{
		get
		{
	...
	public RegistryContext(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;ILjava/util/Hashtable;)V", "public")]
	public RegistryContext(Dova.JDK.java.lang.String arg0, int arg1, Dova.JDK.java.util.Hashtable arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(Lcom/sun/jndi/rmi/registry/RegistryContext;)V", "")]
	public RegistryContext(Dova.JDK.com.sun.jndi.rmi.registry.RegistryContext arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/jndi/rmi/registry/RegistryContext;";
	...
	public static void installSecurityMgr()
	{
		DovaJvm.Vm.Runtime.CallStaticVoidMethodA(ClassRefPtr, MethodPtrs[31]);
	}

	[JniSignatureAttribute("(Ljava/lang/String;ILjava/rmi/server/RMIClientSocketFactory;)Ljava/rmi/registry/Registry;", "private static")]
	...
	[JniSignatureAttribute("(Ljava/rmi/RemoteException;)Ljavax/naming/NamingException;", "public static")]
	public static Dova.JDK.javax.naming.NamingException wrapRemoteException(Dova.JDK.java.rmi.RemoteException arg0)
	{
	...
	[JniSignatureAttribute("(Ljava/rmi/Remote;Ljavax/naming/Name;)Ljava/lang/Object;", "private")]
	public Dova.JDK.java.lang.Object decodeObject(Dova.JDK.java.rmi.Remote arg0, Dova.JDK.javax.naming.Name arg1)
	{
		var ret = DovaJvm.Vm.Runtime.CallObjectMethodA(CurrentRefPtr, MethodPtrs[34], arg0, arg1);
		return DovaInterfaceFactory.Get<Dova.JDK.java.lang.Object>(ret);
	}

	[JniSignatureAttribute("(Ljava/lang/Object;Ljavax/naming/Name;)Ljava/rmi/Remote;", "private")]
	public Dova.JDK.java.rmi.Remote encodeObject(Dova.JDK.java.lang.Object arg0, Dova.JDK.javax.naming.Name arg1)
	{
