	...
	, Dova.JDK.java.rmi.Remote
{
	...
	static ReferenceWrapper_Stub()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "$method_getReference_0", "Ljava/lang/reflect/Method;"));
	...
	public ReferenceWrapper_Stub(Dova.JDK.java.rmi.server.RemoteRef arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
