	...
	: Dova.JDK.com.sun.org.apache.xml.@internal.serializer.ToSAXHandler
{
	...
	static ToHTMLSAXHandler()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "m_dtdHandled", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "m_escapeSetting", "Z"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "resetToHTMLSAXHandler", "()V"));
	...
	public ToHTMLSAXHandler(Dova.JDK.org.xml.sax.ContentHandler arg0, Dova.JDK.org.xml.sax.ext.LexicalHandler arg1, Dova.JDK.java.lang.String arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(Lorg/xml/sax/ContentHandler;Ljava/lang/String;)V", "public")]
	public ToHTMLSAXHandler(Dova.JDK.org.xml.sax.ContentHandler arg0, Dova.JDK.java.lang.String arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
