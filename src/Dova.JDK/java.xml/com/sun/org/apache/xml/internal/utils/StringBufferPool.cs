	...
	: Dova.JDK.java.lang.Object
{
	...
	static StringBufferPool()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "m_stringBufPool", "Lcom/sun/org/apache/xml/internal/utils/ObjectPool;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "get", "()Lcom/sun/org/apache/xml/internal/utils/FastStringBuffer;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "free", "(Lcom/sun/org/apache/xml/internal/utils/FastStringBuffer;)V"));
	}
	...
	public StringBufferPool() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
