	...
	, Dova.JDK.com.sun.org.apache.xml.@internal.dtm.DTMAxisIterator
{
	...
	static EmptyIterator()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "INSTANCE", "Lcom/sun/org/apache/xml/internal/dtm/ref/EmptyIterator;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "next", "()I"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "getInstance", "()Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;"));
