...
[JniSignatureAttribute("Lcom/sun/org/apache/xml/internal/serializer/WriterToASCI;", "")]
public partial class WriterToASCI
	...
	, Dova.JDK.com.sun.org.apache.xml.@internal.serializer.WriterChain
{
	...
	static WriterToASCI()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xml/internal/serializer/WriterToASCI;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "m_os", "Ljava/io/OutputStream;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "WriterToASCI", "(Ljava/io/OutputStream;)V"));
	...
	public WriterToASCI(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/io/OutputStream;)V", "public")]
	public WriterToASCI(Dova.JDK.java.io.OutputStream arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xml/internal/serializer/WriterToASCI;";
