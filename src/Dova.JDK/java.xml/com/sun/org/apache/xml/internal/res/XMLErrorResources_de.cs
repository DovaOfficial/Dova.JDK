	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static XMLErrorResources_de()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XMLErrorResources_de", "()V"));
	...
	public XMLErrorResources_de() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
