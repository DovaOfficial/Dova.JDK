	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static XMLErrorResources_zh_CN()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XMLErrorResources_zh_CN", "()V"));
	...
	public XMLErrorResources_zh_CN() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
