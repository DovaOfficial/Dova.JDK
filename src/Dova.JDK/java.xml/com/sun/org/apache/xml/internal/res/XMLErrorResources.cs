...
[JniSignatureAttribute("Lcom/sun/org/apache/xml/internal/res/XMLErrorResources;", "public")]
public partial class XMLErrorResources
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static XMLErrorResources()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xml/internal/res/XMLErrorResources;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XMLErrorResources", "()V"));
	...
	public XMLErrorResources(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XMLErrorResources() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xml/internal/res/XMLErrorResources;";
