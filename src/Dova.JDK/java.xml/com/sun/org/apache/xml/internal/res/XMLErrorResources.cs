	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static XMLErrorResources()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XMLErrorResources", "()V"));
	...
	public XMLErrorResources() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
