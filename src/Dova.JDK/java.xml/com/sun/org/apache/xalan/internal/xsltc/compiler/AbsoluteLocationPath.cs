...
[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/AbsoluteLocationPath;", "final")]
public partial class AbsoluteLocationPath
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression
{
	...
	static AbsoluteLocationPath()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/AbsoluteLocationPath;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AbsoluteLocationPath", "()V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AbsoluteLocationPath", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;)V"));
	...
	public AbsoluteLocationPath(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public AbsoluteLocationPath() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;)V", "public")]
	public AbsoluteLocationPath(Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/AbsoluteLocationPath;";
