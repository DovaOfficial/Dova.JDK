...
[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/UnparsedEntityUriCall;", "final")]
public partial class UnparsedEntityUriCall
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.FunctionCall
{
	...
	static UnparsedEntityUriCall()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/UnparsedEntityUriCall;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_entity", "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnparsedEntityUriCall", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;Ljava/util/List;)V"));
	...
	public Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression _entity_Property
	{
		get
		{
	...
	public UnparsedEntityUriCall(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;Ljava/util/List;)V", "public")]
	public UnparsedEntityUriCall(Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.QName arg0, Dova.JDK.java.util.List arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/UnparsedEntityUriCall;";
