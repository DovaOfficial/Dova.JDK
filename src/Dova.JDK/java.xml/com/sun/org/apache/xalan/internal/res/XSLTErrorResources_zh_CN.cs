	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static XSLTErrorResources_zh_CN()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XSLTErrorResources_zh_CN", "()V"));
	...
	public XSLTErrorResources_zh_CN() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
