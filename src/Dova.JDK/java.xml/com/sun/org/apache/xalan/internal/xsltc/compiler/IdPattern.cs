	...
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.IdKeyPattern
{
	...
	static IdPattern()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "IdPattern", "(Ljava/lang/String;)V"));
	}
	...
	public IdPattern(Dova.JDK.java.lang.String arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
