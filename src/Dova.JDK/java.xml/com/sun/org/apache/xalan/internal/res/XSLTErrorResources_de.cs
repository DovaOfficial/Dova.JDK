	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static XSLTErrorResources_de()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XSLTErrorResources_de", "()V"));
	...
	public XSLTErrorResources_de() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
