...
[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/CastExpr;", "final")]
	...
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression
{
	...
	static CastExpr()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/CastExpr;");
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "InternalTypeMap", "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MultiHashtable;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "_typeTest", "Z"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CastExpr", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;)V"));
	...
	public static Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.util.MultiHashtable InternalTypeMap_Property
	{
		get
		{
	...
	public bool _typeTest_Property
	{
		get
		{
	...
	public CastExpr(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;)V", "public")]
	public CastExpr(Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression arg0, Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.util.Type arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/CastExpr;";
