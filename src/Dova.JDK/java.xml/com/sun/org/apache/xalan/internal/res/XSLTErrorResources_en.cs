	...
	: Dova.JDK.com.sun.org.apache.xalan.@internal.res.XSLTErrorResources
{
	...
	static XSLTErrorResources_en()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XSLTErrorResources_en", "()V"));
	}
	...
	public XSLTErrorResources_en() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
