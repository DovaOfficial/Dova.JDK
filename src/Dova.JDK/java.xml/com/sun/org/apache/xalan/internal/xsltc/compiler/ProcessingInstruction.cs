	...
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Instruction
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/ProcessingInstruction;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ProcessingInstruction", "()V"));
	...
	public ProcessingInstruction() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
