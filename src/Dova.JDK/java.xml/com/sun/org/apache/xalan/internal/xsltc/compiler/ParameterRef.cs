...
[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/ParameterRef;", "final")]
	...
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.VariableRefBase
{
	...
	static ParameterRef()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/ParameterRef;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ParameterRef", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Param;)V"));
	...
	[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;", "")]
	...
	public ParameterRef(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Param;)V", "public")]
	public ParameterRef(Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Param arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/ParameterRef;";
