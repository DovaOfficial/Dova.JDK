	...
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.util.MarkerInstruction
{
	...
	static OutlineableChunkEnd()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OUTLINEABLECHUNKEND", "Lcom/sun/org/apache/bcel/internal/generic/Instruction;"));
	...
	public OutlineableChunkEnd() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
