	...
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.LocationPathPattern
{
	...
	static RelativePathPattern()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "RelativePathPattern", "()V"));
	}
	...
	public RelativePathPattern() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
