	...
	: Dova.JDK.java.lang.Object
{
	...
	static ExsltCommon()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ExsltCommon", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "objectType", "(Ljava/lang/Object;)Ljava/lang/String;"));
	...
	public ExsltCommon() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
