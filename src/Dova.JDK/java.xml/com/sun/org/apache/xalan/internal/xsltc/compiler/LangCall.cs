...
[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/LangCall;", "final")]
public partial class LangCall
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.FunctionCall
{
	...
	static LangCall()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/LangCall;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_lang", "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_langType", "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "LangCall", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;Ljava/util/List;)V"));
	...
	public Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression _lang_Property
	{
		get
		{
	...
	public Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.util.Type _langType_Property
	{
		get
		{
	...
	public LangCall(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;Ljava/util/List;)V", "public")]
	public LangCall(Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.QName arg0, Dova.JDK.java.util.List arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/LangCall;";
