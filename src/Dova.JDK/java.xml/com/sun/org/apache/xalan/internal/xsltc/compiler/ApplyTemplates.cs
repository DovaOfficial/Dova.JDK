...
[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/ApplyTemplates;", "final")]
public partial class ApplyTemplates
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Instruction
{
	...
	static ApplyTemplates()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/ApplyTemplates;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_modeName", "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_functionName", "Ljava/lang/String;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ApplyTemplates", "()V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "hasWithParams", "()Z"));
	...
	public Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.QName _modeName_Property
	{
		get
		{
	...
	public Dova.JDK.java.lang.String _functionName_Property
	{
		get
		{
	...
	public ApplyTemplates(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public ApplyTemplates() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/ApplyTemplates;";
