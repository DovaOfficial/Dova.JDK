	...
	, Dova.JDK.org.xml.sax.ext.DeclHandler
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/trax/TransformerHandlerImpl;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_dtdHandler", "Lorg/xml/sax/DTDHandler;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_declHandler", "Lorg/xml/sax/ext/DeclHandler;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_result", "Ljavax/xml/transform/Result;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_locator", "Lorg/xml/sax/Locator;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_done", "Z"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_isIdentity", "Z"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "TransformerHandlerImpl", "(Lcom/sun/org/apache/xalan/internal/xsltc/trax/TransformerImpl;)V"));
	...
	public TransformerHandlerImpl(Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.trax.TransformerImpl arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
