	...
	, Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.runtime.output.OutputBuffer
{
	...
	static WriterOutputBuffer()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "KB", "I"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "WriterOutputBuffer", "(Ljava/io/Writer;)V"));
	...
	public WriterOutputBuffer(Dova.JDK.java.io.Writer arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
