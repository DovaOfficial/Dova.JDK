	...
	, Dova.JDK.org.xml.sax.Locator
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/trax/StAXEvent2SAX;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "staxEventReader", "Ljavax/xml/stream/XMLEventReader;"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "StAXEvent2SAX", "(Ljavax/xml/stream/XMLEventReader;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getAttributes", "(Ljavax/xml/stream/events/StartElement;)Lorg/xml/sax/Attributes;"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "handlePI", "(Ljavax/xml/stream/events/ProcessingInstruction;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "handleStartDocument", "(Ljavax/xml/stream/events/XMLEvent;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "handleCharacters", "(Ljavax/xml/stream/events/Characters;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "handleStartElement", "(Ljavax/xml/stream/events/StartElement;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "handleEndElement", "(Ljavax/xml/stream/events/EndElement;)V"));
	...
	public StAXEvent2SAX(Dova.JDK.javax.xml.stream.XMLEventReader arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
