...
[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/FilterParentPath;", "final")]
public partial class FilterParentPath
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression
{
	...
	static FilterParentPath()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/FilterParentPath;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_filterExpr", "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_path", "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_hasDescendantAxis", "Z"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FilterParentPath", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "setDescendantAxis", "()V"));
	...
	public Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression _filterExpr_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;", "private")]
	public Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression _path_Property
	{
		get
		{
	...
	public bool _hasDescendantAxis_Property
	{
		get
		{
	...
	public FilterParentPath(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}
	...
	public FilterParentPath(Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression arg0, Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/FilterParentPath;";
