	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static XSLTErrorResources_ja()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XSLTErrorResources_ja", "()V"));
	...
	public XSLTErrorResources_ja() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
