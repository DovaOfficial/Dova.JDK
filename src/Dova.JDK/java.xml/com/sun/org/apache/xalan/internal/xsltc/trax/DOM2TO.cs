	...
	, Dova.JDK.org.xml.sax.ext.Locator2
{
	...
	static DOM2TO()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/trax/DOM2TO;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "_handler", "Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DOM2TO", "(Lorg/w3c/dom/Node;Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "setDocumentInfo", "(Lorg/w3c/dom/Document;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getNodeTypeFromCode", "(S)Ljava/lang/String;"));
	...
	public DOM2TO(Dova.JDK.org.w3c.dom.Node arg0, Dova.JDK.com.sun.org.apache.xml.@internal.serializer.SerializationHandler arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
