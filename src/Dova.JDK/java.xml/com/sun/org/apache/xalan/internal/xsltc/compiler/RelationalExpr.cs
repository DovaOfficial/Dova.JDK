...
[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/RelationalExpr;", "final")]
public partial class RelationalExpr
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression
{
	...
	static RelationalExpr()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/RelationalExpr;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "RelationalExpr", "(ILcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "hasReferenceArgs", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "hasNodeSetArgs", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "hasNodeArgs", "()Z"));
	...
	public RelationalExpr(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}
	...
	public RelationalExpr(int arg0, Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression arg1, Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Expression arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/RelationalExpr;";
