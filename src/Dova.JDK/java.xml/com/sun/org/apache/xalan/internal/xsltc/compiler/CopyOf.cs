...
[JniSignatureAttribute("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/CopyOf;", "final")]
public partial class CopyOf
	: Dova.JDK.com.sun.org.apache.xalan.@internal.xsltc.compiler.Instruction
{
	...
	static CopyOf()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xalan/internal/xsltc/compiler/CopyOf;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CopyOf", "()V"));
	...
	public CopyOf(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public CopyOf() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xalan/internal/xsltc/compiler/CopyOf;";
