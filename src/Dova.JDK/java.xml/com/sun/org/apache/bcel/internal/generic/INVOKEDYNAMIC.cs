	...
	: Dova.JDK.com.sun.org.apache.bcel.@internal.generic.InvokeInstruction
{
	...
	public INVOKEDYNAMIC() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(I)V", "public")]
	public INVOKEDYNAMIC(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
