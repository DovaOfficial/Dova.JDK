	...
	: Dova.JDK.com.sun.org.apache.bcel.@internal.generic.Instruction
{
	...
	static BREAKPOINT()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/bcel/internal/generic/BREAKPOINT;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "BREAKPOINT", "()V"));
	...
	public BREAKPOINT() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
