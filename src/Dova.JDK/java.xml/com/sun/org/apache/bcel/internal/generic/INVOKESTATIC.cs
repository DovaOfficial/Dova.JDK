	...
	: Dova.JDK.com.sun.org.apache.bcel.@internal.generic.InvokeInstruction
{
	...
	public INVOKESTATIC() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(I)V", "public")]
	public INVOKESTATIC(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
