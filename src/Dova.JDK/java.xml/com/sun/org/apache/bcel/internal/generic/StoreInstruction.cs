	...
	, Dova.JDK.com.sun.org.apache.bcel.@internal.generic.PopInstruction
{
	...
	public StoreInstruction(short arg0, short arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(SSI)V", "protected")]
	public StoreInstruction(short arg0, short arg1, int arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1, arg2))
	{
	}
