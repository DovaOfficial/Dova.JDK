...
[JniSignatureAttribute("Lcom/sun/org/apache/bcel/internal/generic/IF_ICMPLE;", "public")]
public partial class IF_ICMPLE
	: Dova.JDK.com.sun.org.apache.bcel.@internal.generic.IfInstruction
{
	...
	static IF_ICMPLE()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/bcel/internal/generic/IF_ICMPLE;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "IF_ICMPLE", "()V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "IF_ICMPLE", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V"));
	...
	public IF_ICMPLE(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public IF_ICMPLE() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", "public")]
	public IF_ICMPLE(Dova.JDK.com.sun.org.apache.bcel.@internal.generic.InstructionHandle arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/bcel/internal/generic/IF_ICMPLE;";
