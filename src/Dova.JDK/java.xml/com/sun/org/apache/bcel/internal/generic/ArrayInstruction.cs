	...
	, Dova.JDK.com.sun.org.apache.bcel.@internal.generic.TypedInstruction
{
	...
	public ArrayInstruction() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(S)V", "protected")]
	public ArrayInstruction(short arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
