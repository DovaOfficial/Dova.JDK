	...
	, Dova.JDK.com.sun.org.apache.bcel.@internal.generic.TypedInstruction
{
	...
	static RET()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "wide", "Z"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setWide", "()V"));
	}
	...
	public RET() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(I)V", "public")]
	public RET(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
