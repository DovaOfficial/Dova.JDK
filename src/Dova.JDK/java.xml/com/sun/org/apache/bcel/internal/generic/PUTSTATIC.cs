	...
	, Dova.JDK.com.sun.org.apache.bcel.@internal.generic.PopInstruction
{
	...
	public PUTSTATIC() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(I)V", "public")]
	public PUTSTATIC(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
