	...
	, Dova.JDK.com.sun.org.apache.bcel.@internal.generic.StackProducer
{
	...
	static NEWARRAY()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lcom/sun/org/apache/bcel/internal/generic/BasicType;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getTypecode", "()B"));
	...
	public NEWARRAY(Dova.JDK.com.sun.org.apache.bcel.@internal.generic.BasicType arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(B)V", "public")]
	public NEWARRAY(byte arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}

	[JniSignatureAttribute("()V", "")]
	public NEWARRAY() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[2]))
	{
	}
