	...
	: Dova.JDK.com.sun.org.apache.bcel.@internal.generic.StoreInstruction
{
	...
	public FSTORE() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(I)V", "public")]
	public FSTORE(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
