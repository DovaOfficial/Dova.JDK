	...
	, Dova.JDK.com.sun.org.apache.bcel.@internal.generic.ExceptionThrower
{
	...
	public GETSTATIC() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(I)V", "public")]
	public GETSTATIC(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
