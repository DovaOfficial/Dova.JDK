...
[JniSignatureAttribute("Lcom/sun/org/apache/bcel/internal/generic/DCMPL;", "public")]
public partial class DCMPL
	...
	, Dova.JDK.com.sun.org.apache.bcel.@internal.generic.StackConsumer
{
	...
	static DCMPL()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/bcel/internal/generic/DCMPL;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DCMPL", "()V"));
	...
	public DCMPL(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public DCMPL() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/bcel/internal/generic/DCMPL;";
