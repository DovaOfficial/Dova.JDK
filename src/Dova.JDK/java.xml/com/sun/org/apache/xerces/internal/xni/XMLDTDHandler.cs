	...
	: IJavaObject
{
	...
	static XMLDTDHandler()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CONDITIONAL_INCLUDE", "S"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CONDITIONAL_IGNORE", "S"));
