	...
	, Dova.JDK.org.w3c.dom.Document
{
	...
	static DefaultDocument()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DefaultDocument", "()V"));
	...
	public DefaultDocument() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
