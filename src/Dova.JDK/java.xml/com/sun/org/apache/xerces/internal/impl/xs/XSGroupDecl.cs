...
[JniSignatureAttribute("Lcom/sun/org/apache/xerces/internal/impl/xs/XSGroupDecl;", "public")]
public partial class XSGroupDecl
	: Dova.JDK.java.lang.Object
	, Dova.JDK.com.sun.org.apache.xerces.@internal.xs.XSModelGroupDefinition
{
	...
	static XSGroupDecl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/impl/xs/XSGroupDecl;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XSGroupDecl", "()V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getModelGroup", "()Lcom/sun/org/apache/xerces/internal/xs/XSModelGroup;"));
	}
	...
	public Dova.JDK.com.sun.org.apache.xerces.@internal.impl.xs.XSModelGroupImpl fModelGroup_Property
	{
		get
		{
	...
	public XSGroupDecl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XSGroupDecl() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xerces/internal/impl/xs/XSGroupDecl;";
	...
	[JniSignatureAttribute("()Lcom/sun/org/apache/xerces/internal/xs/XSModelGroup;", "public")]
	public Dova.JDK.com.sun.org.apache.xerces.@internal.xs.XSModelGroup getModelGroup()
	{
