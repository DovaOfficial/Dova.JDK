	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.xni.grammars.XMLGrammarPool
{
	...
	static SimpleXMLSchema()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "fGrammar", "Lcom/sun/org/apache/xerces/internal/xni/grammars/Grammar;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "fGrammars", "[Lcom/sun/org/apache/xerces/internal/xni/grammars/Grammar;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "fGrammarDescription", "Lcom/sun/org/apache/xerces/internal/xni/grammars/XMLGrammarDescription;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SimpleXMLSchema", "(Lcom/sun/org/apache/xerces/internal/xni/grammars/Grammar;)V"));
	...
	public SimpleXMLSchema(Dova.JDK.com.sun.org.apache.xerces.@internal.xni.grammars.Grammar arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
