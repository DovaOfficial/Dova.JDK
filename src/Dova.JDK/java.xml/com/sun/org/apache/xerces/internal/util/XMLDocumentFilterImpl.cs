...
[JniSignatureAttribute("Lcom/sun/org/apache/xerces/internal/util/XMLDocumentFilterImpl;", "public")]
public partial class XMLDocumentFilterImpl
	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.xni.parser.XMLDocumentFilter
{
	...
	static XMLDocumentFilterImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/util/XMLDocumentFilterImpl;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XMLDocumentFilterImpl", "()V"));
	...
	public XMLDocumentFilterImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XMLDocumentFilterImpl() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xerces/internal/util/XMLDocumentFilterImpl;";
