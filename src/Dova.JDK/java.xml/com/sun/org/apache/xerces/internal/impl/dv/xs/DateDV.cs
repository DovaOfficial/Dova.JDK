...
[JniSignatureAttribute("Lcom/sun/org/apache/xerces/internal/impl/dv/xs/DateDV;", "public")]
public partial class DateDV
	: Dova.JDK.com.sun.org.apache.xerces.@internal.impl.dv.xs.DateTimeDV
{
	...
	static DateDV()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/impl/dv/xs/DateDV;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DateDV", "()V"));
	...
	public DateDV(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public DateDV() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xerces/internal/impl/dv/xs/DateDV;";
