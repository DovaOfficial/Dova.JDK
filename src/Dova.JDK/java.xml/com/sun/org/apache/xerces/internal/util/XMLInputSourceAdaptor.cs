	...
	, Dova.JDK.javax.xml.transform.Source
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/util/XMLInputSourceAdaptor;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XMLInputSourceAdaptor", "(Lcom/sun/org/apache/xerces/internal/xni/parser/XMLInputSource;)V"));
	...
	public XMLInputSourceAdaptor(Dova.JDK.com.sun.org.apache.xerces.@internal.xni.parser.XMLInputSource arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
