	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.util.MessageFormatter
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/impl/msg/XMLMessageFormatter_de;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XMLMessageFormatter_de", "()V"));
	...
	public XMLMessageFormatter_de() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
