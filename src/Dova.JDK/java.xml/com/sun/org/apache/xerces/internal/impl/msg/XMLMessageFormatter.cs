	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.util.MessageFormatter
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/impl/msg/XMLMessageFormatter;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XMLMessageFormatter", "()V"));
	...
	public XMLMessageFormatter() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
