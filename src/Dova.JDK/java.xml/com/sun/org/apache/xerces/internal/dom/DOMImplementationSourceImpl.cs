	...
	, Dova.JDK.org.w3c.dom.DOMImplementationSource
{
	...
	static DOMImplementationSourceImpl()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DOMImplementationSourceImpl", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "testImpl", "(Lorg/w3c/dom/DOMImplementation;Ljava/lang/String;)Z"));
	...
	public DOMImplementationSourceImpl() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
