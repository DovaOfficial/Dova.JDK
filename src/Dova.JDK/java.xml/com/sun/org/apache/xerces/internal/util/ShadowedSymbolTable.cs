	...
	: Dova.JDK.com.sun.org.apache.xerces.@internal.util.SymbolTable
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/util/ShadowedSymbolTable;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ShadowedSymbolTable", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;)V"));
	...
	public ShadowedSymbolTable(Dova.JDK.com.sun.org.apache.xerces.@internal.util.SymbolTable arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
