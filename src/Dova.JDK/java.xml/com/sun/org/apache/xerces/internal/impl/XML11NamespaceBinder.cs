	...
	: Dova.JDK.com.sun.org.apache.xerces.@internal.impl.XMLNamespaceBinder
{
	...
	static XML11NamespaceBinder()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "prefixBoundToNullURI", "(Ljava/lang/String;Ljava/lang/String;)Z"));
	}
	...
	public XML11NamespaceBinder() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
