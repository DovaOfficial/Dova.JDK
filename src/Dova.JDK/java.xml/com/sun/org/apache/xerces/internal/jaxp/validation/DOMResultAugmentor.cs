	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.jaxp.validation.DOMDocumentHandler
{
	...
	static DOMResultAugmentor()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "fDOMValidatorHelper", "Lcom/sun/org/apache/xerces/internal/jaxp/validation/DOMValidatorHelper;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "processAttributePSVI", "(Lcom/sun/org/apache/xerces/internal/dom/AttrImpl;Lcom/sun/org/apache/xerces/internal/xs/AttributePSVI;)Z"));
	...
	public DOMResultAugmentor(Dova.JDK.com.sun.org.apache.xerces.@internal.jaxp.validation.DOMValidatorHelper arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
