	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.xs.ElementPSVI
{
	...
	static ElementPSVImpl()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ElementPSVImpl", "()V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ElementPSVImpl", "(ZLcom/sun/org/apache/xerces/internal/xs/ElementPSVI;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "copySchemaInformationTo", "(Lcom/sun/org/apache/xerces/internal/impl/xs/ElementPSVImpl;)V"));
	...
	public ElementPSVImpl() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(ZLcom/sun/org/apache/xerces/internal/xs/ElementPSVI;)V", "public")]
	public ElementPSVImpl(bool arg0, Dova.JDK.com.sun.org.apache.xerces.@internal.xs.ElementPSVI arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
