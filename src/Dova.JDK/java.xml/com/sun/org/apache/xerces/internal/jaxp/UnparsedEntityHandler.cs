	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.impl.validation.EntityState
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/jaxp/UnparsedEntityHandler;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnparsedEntityHandler", "(Lcom/sun/org/apache/xerces/internal/impl/validation/ValidationManager;)V"));
	...
	public UnparsedEntityHandler(Dova.JDK.com.sun.org.apache.xerces.@internal.impl.validation.ValidationManager arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
	...
	{
		DovaJvm.Vm.Runtime.CallVoidMethodA(CurrentRefPtr, MethodPtrs[13], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
	}
