	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.impl.validation.EntityState
{
	...
	static UnparsedEntityHandler()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lcom/sun/org/apache/xerces/internal/impl/validation/ValidationManager;)V"));
	...
	public UnparsedEntityHandler(Dova.JDK.com.sun.org.apache.xerces.@internal.impl.validation.ValidationManager arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
