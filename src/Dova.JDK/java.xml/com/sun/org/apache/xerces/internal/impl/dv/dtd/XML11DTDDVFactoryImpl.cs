	...
	: Dova.JDK.com.sun.org.apache.xerces.@internal.impl.dv.dtd.DTDDVFactoryImpl
{
	...
	static XML11DTDDVFactoryImpl()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "XML11BUILTINTYPES", "Ljava/util/Map;"));
	...
	public XML11DTDDVFactoryImpl() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
