	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.util.MessageFormatter
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/impl/msg/XMLMessageFormatter_zh_CN;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XMLMessageFormatter_zh_CN", "()V"));
	...
	public XMLMessageFormatter_zh_CN() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
