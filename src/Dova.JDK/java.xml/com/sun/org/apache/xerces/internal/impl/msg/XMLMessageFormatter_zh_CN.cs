...
[JniSignatureAttribute("Lcom/sun/org/apache/xerces/internal/impl/msg/XMLMessageFormatter_zh_CN;", "public")]
public partial class XMLMessageFormatter_zh_CN
	...
	, Dova.JDK.com.sun.org.apache.xerces.@internal.util.MessageFormatter
{
	...
	static XMLMessageFormatter_zh_CN()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/impl/msg/XMLMessageFormatter_zh_CN;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "XML_DOMAIN", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "XMLNS_DOMAIN", "Ljava/lang/String;"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XMLMessageFormatter_zh_CN", "()V"));
	...
	public XMLMessageFormatter_zh_CN(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XMLMessageFormatter_zh_CN() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xerces/internal/impl/msg/XMLMessageFormatter_zh_CN;";
