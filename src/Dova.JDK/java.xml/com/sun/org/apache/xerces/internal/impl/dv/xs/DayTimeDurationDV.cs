...
[JniSignatureAttribute("Lcom/sun/org/apache/xerces/internal/impl/dv/xs/DayTimeDurationDV;", "")]
public partial class DayTimeDurationDV
	: Dova.JDK.com.sun.org.apache.xerces.@internal.impl.dv.xs.DurationDV
{
	...
	static DayTimeDurationDV()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/impl/dv/xs/DayTimeDurationDV;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DayTimeDurationDV", "()V"));
	...
	public DayTimeDurationDV(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public DayTimeDurationDV() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xerces/internal/impl/dv/xs/DayTimeDurationDV;";
