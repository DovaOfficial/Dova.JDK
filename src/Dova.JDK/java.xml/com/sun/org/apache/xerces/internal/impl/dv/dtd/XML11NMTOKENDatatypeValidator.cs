	...
	: Dova.JDK.com.sun.org.apache.xerces.@internal.impl.dv.dtd.NMTOKENDatatypeValidator
{
	...
	static XML11NMTOKENDatatypeValidator()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XML11NMTOKENDatatypeValidator", "()V"));
	...
	public XML11NMTOKENDatatypeValidator() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
