	...
	: Dova.JDK.com.sun.org.apache.xerces.@internal.impl.dtd.XML11DTDValidator
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xerces/internal/impl/dtd/XML11NSDTDValidator;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XML11NSDTDValidator", "()V"));
	...
	public XML11NSDTDValidator() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
