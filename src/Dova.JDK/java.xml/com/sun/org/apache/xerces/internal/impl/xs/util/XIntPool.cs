	...
	: Dova.JDK.java.lang.Object
{
	...
	static XIntPool()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "POOL_SIZE", "S"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "fXIntPool", "[Lcom/sun/org/apache/xerces/internal/impl/xs/util/XInt;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getXInt", "(I)Lcom/sun/org/apache/xerces/internal/impl/xs/util/XInt;"));
	}
	...
	public XIntPool() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
