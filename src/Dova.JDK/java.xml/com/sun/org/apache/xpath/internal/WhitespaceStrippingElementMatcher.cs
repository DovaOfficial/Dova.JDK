	...
	: IJavaObject
{
	...
	static WhitespaceStrippingElementMatcher()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "shouldStripWhiteSpace", "(Lcom/sun/org/apache/xpath/internal/XPathContext;Lorg/w3c/dom/Element;)Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "canStripWhiteSpace", "()Z"));
	}
