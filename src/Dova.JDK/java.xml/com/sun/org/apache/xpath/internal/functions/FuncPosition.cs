...
[JniSignatureAttribute("Lcom/sun/org/apache/xpath/internal/functions/FuncPosition;", "public")]
public partial class FuncPosition
	: Dova.JDK.com.sun.org.apache.xpath.@internal.functions.Function
{
	...
	static FuncPosition()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/functions/FuncPosition;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "postCompileStep", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getPositionInContextNodeList", "(Lcom/sun/org/apache/xpath/internal/XPathContext;)I"));
	}
	...
	public FuncPosition(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public FuncPosition() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xpath/internal/functions/FuncPosition;";
	...
	public int getPositionInContextNodeList(Dova.JDK.com.sun.org.apache.xpath.@internal.XPathContext arg0)
	{
