	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.functions.FunctionOneArg
{
	...
	static FuncSystemProperty()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "XSLT_PROPERTIES", "Ljava/lang/String;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FuncSystemProperty", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "loadPropertyFile", "(Ljava/util/Properties;)V"));
	}
	...
	public FuncSystemProperty() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
