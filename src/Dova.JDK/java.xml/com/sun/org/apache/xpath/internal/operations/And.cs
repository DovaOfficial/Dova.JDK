...
[JniSignatureAttribute("Lcom/sun/org/apache/xpath/internal/operations/And;", "public")]
	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.operations.Operation
{
	...
	static And()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/operations/And;");
	...
	public And(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public And() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xpath/internal/operations/And;";
