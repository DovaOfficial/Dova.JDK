	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.axes.BasicTestIterator
{
	...
	static ChildTestIterator()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ChildTestIterator", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;II)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ChildTestIterator", "(Lcom/sun/org/apache/xml/internal/dtm/DTMAxisTraverser;)V"));
	...
	public ChildTestIterator(Dova.JDK.com.sun.org.apache.xpath.@internal.compiler.Compiler arg0, int arg1, int arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(Lcom/sun/org/apache/xml/internal/dtm/DTMAxisTraverser;)V", "public")]
	public ChildTestIterator(Dova.JDK.com.sun.org.apache.xml.@internal.dtm.DTMAxisTraverser arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}
