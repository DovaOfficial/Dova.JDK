...
[JniSignatureAttribute("Lcom/sun/org/apache/xpath/internal/functions/FuncGenerateId;", "public")]
public partial class FuncGenerateId
	: Dova.JDK.com.sun.org.apache.xpath.@internal.functions.FunctionDef1Arg
{
	...
	static FuncGenerateId()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/functions/FuncGenerateId;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FuncGenerateId", "()V"));
	...
	public FuncGenerateId(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public FuncGenerateId() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xpath/internal/functions/FuncGenerateId;";
