	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.operations.UnaryOperation
{
	...
	static Bool()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/operations/Bool;");
	...
	public Bool() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
