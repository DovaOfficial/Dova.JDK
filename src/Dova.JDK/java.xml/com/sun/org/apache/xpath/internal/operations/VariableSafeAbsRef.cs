	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.operations.Variable
{
	...
	static VariableSafeAbsRef()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "VariableSafeAbsRef", "()V"));
	...
	public VariableSafeAbsRef() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
