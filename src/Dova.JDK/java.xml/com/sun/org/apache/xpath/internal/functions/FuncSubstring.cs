	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.functions.Function3Args
{
	...
	static FuncSubstring()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FuncSubstring", "()V"));
	...
	public FuncSubstring() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
