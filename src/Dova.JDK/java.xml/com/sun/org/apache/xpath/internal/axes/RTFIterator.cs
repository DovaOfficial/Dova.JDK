	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.NodeSetDTM
{
	...
	static RTFIterator()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "RTFIterator", "(ILcom/sun/org/apache/xml/internal/dtm/DTMManager;)V"));
	}
	...
	public RTFIterator(int arg0, Dova.JDK.com.sun.org.apache.xml.@internal.dtm.DTMManager arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
