...
[JniSignatureAttribute("Lcom/sun/org/apache/xpath/internal/operations/String;", "public")]
	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.operations.UnaryOperation
{
	...
	static String()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/operations/String;");
	...
	public String() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xpath/internal/operations/String;";
