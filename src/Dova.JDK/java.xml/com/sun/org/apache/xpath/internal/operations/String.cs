	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.operations.UnaryOperation
{
	...
	static String()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/operations/String;");
	...
	public String() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
