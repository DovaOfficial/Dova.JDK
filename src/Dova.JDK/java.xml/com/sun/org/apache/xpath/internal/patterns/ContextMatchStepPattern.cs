	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.patterns.StepPattern
{
	...
	static ContextMatchStepPattern()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "executeRelativePathPattern", "(Lcom/sun/org/apache/xpath/internal/XPathContext;Lcom/sun/org/apache/xpath/internal/patterns/StepPattern;)Lcom/sun/org/apache/xpath/internal/objects/XObject;"));
	}
	...
	public ContextMatchStepPattern(int arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
