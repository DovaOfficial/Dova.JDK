...
[JniSignatureAttribute("Lcom/sun/org/apache/xpath/internal/functions/FuncHere;", "public final")]
	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.functions.Function
{
	...
	static FuncHere()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/functions/FuncHere;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FuncHere", "()V"));
	...
	public FuncHere() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xpath/internal/functions/FuncHere;";
	...
	[JniSignatureAttribute("(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Document;", "private static")]
