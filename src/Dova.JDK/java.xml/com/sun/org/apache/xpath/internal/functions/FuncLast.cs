	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.functions.Function
{
	...
	static FuncLast()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/functions/FuncLast;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getCountOfContextNodeList", "(Lcom/sun/org/apache/xpath/internal/XPathContext;)I"));
	}
	...
	public FuncLast() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
