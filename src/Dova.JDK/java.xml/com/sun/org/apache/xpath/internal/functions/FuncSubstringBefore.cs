...
[JniSignatureAttribute("Lcom/sun/org/apache/xpath/internal/functions/FuncSubstringBefore;", "public")]
public partial class FuncSubstringBefore
	: Dova.JDK.com.sun.org.apache.xpath.@internal.functions.Function2Args
{
	...
	static FuncSubstringBefore()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/functions/FuncSubstringBefore;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FuncSubstringBefore", "()V"));
	...
	public FuncSubstringBefore(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public FuncSubstringBefore() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xpath/internal/functions/FuncSubstringBefore;";
