...
[JniSignatureAttribute("Lcom/sun/org/apache/xpath/internal/functions/FuncStartsWith;", "public")]
public partial class FuncStartsWith
	: Dova.JDK.com.sun.org.apache.xpath.@internal.functions.Function2Args
{
	...
	static FuncStartsWith()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/functions/FuncStartsWith;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FuncStartsWith", "()V"));
	...
	public FuncStartsWith(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public FuncStartsWith() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xpath/internal/functions/FuncStartsWith;";
