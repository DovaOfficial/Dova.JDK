...
[JniSignatureAttribute("Lcom/sun/org/apache/xpath/internal/objects/GreaterThanOrEqualComparator;", "")]
public partial class GreaterThanOrEqualComparator
	: Dova.JDK.com.sun.org.apache.xpath.@internal.objects.Comparator
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/objects/GreaterThanOrEqualComparator;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "GreaterThanOrEqualComparator", "()V"));
	...
	public GreaterThanOrEqualComparator(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public GreaterThanOrEqualComparator() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xpath/internal/objects/GreaterThanOrEqualComparator;";
