	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.objects.Comparator
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/objects/GreaterThanOrEqualComparator;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "GreaterThanOrEqualComparator", "()V"));
	...
	public GreaterThanOrEqualComparator() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
