	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.axes.ChildTestIterator
{
	...
	static UnionChildIterator()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "m_nodeTests", "[Lcom/sun/org/apache/xpath/internal/axes/PredicatedNodeTest;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addNodeTest", "(Lcom/sun/org/apache/xpath/internal/axes/PredicatedNodeTest;)V"));
	}
	...
	public UnionChildIterator() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
