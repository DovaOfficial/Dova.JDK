...
[JniSignatureAttribute("Lcom/sun/org/apache/xpath/internal/functions/FuncSubstringAfter;", "public")]
public partial class FuncSubstringAfter
	: Dova.JDK.com.sun.org.apache.xpath.@internal.functions.Function2Args
{
	...
	static FuncSubstringAfter()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/functions/FuncSubstringAfter;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FuncSubstringAfter", "()V"));
	...
	public FuncSubstringAfter(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public FuncSubstringAfter() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/org/apache/xpath/internal/functions/FuncSubstringAfter;";
