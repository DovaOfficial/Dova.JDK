	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.axes.AxesWalker
{
	...
	static FilterExprWalker()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lcom/sun/org/apache/xpath/internal/axes/WalkingIterator;)V"));
	...
	public FilterExprWalker(Dova.JDK.com.sun.org.apache.xpath.@internal.axes.WalkingIterator arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
		...
		, Dova.JDK.com.sun.org.apache.xpath.@internal.ExpressionOwner
	{
		...
		static filterExprOwner()
		{
			...
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "this$0", "Lcom/sun/org/apache/xpath/internal/axes/FilterExprWalker;"));
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lcom/sun/org/apache/xpath/internal/axes/FilterExprWalker;)V"));
		...
		public filterExprOwner(Dova.JDK.com.sun.org.apache.xpath.@internal.axes.FilterExprWalker arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
		{
		}
