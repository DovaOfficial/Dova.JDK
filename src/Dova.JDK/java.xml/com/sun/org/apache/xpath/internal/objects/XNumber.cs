	...
	: Dova.JDK.com.sun.org.apache.xpath.@internal.objects.XObject
{
	...
	static XNumber()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "m_val", "D"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "zeros", "(I)Ljava/lang/String;"));
	...
	public XNumber(double arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/Number;)V", "public")]
	public XNumber(Dova.JDK.java.lang.Number arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}
