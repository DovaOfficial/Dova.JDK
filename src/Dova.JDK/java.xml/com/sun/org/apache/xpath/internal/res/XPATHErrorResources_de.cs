	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/org/apache/xpath/internal/res/XPATHErrorResources_de;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "XPATHErrorResources_de", "()V"));
	...
	public XPATHErrorResources_de() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
