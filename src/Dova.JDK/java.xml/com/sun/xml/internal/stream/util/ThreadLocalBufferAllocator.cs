	...
	: Dova.JDK.java.lang.Object
{
	...
	static ThreadLocalBufferAllocator()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TL", "Ljava/lang/ThreadLocal;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "getBufferAllocator", "()Lcom/sun/xml/internal/stream/util/BufferAllocator;"));
	}
	...
	public ThreadLocalBufferAllocator() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
