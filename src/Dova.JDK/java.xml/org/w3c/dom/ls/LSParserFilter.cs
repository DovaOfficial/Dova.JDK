	...
	: IJavaObject
{
	...
	static LSParserFilter()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "FILTER_INTERRUPT", "S"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "startElement", "(Lorg/w3c/dom/Element;)S"));
	}
