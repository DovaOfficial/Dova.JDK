	...
	, Dova.JDK.org.w3c.dom.events.Event
{
	...
	static UIEvent()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getView", "()Lorg/w3c/dom/views/AbstractView;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "initUIEvent", "(Ljava/lang/String;ZZLorg/w3c/dom/views/AbstractView;I)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getDetail", "()I"));
	}
