	...
	: IJavaObject
{
	...
	static NameList()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lorg/w3c/dom/NameList;");
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "containsNS", "(Ljava/lang/String;Ljava/lang/String;)Z"));
	}
