...
[JniSignatureAttribute("Lorg/w3c/dom/Notation;", "public abstract interface")]
public partial interface Notation
	: IJavaObject
	, Dova.JDK.org.w3c.dom.Node
{
	...
	static Notation()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/w3c/dom/Notation;");
