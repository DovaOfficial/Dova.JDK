	...
	, Dova.JDK.org.xml.sax.ErrorHandler
{
	...
	static HandlerBase()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "HandlerBase", "()V"));
	...
	public HandlerBase() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
