	...
	: IJavaObject
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/xml/sax/ContentHandler;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "declaration", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"));
	}
