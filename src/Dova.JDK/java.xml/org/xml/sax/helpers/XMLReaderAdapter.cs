...
[JniSignatureAttribute("Lorg/xml/sax/helpers/XMLReaderAdapter;", "public")]
	...
	, Dova.JDK.org.xml.sax.ContentHandler
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lorg/xml/sax/helpers/XMLReaderAdapter;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "xmlReader", "Lorg/xml/sax/XMLReader;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "documentHandler", "Lorg/xml/sax/DocumentHandler;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "qAtts", "Lorg/xml/sax/helpers/XMLReaderAdapter$AttributesAdapter;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XMLReaderAdapter", "()V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "XMLReaderAdapter", "(Lorg/xml/sax/XMLReader;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "setup", "(Lorg/xml/sax/XMLReader;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "setupXMLReader", "()V"));
	}

	[JniSignatureAttribute("Lorg/xml/sax/XMLReader;", "")]
	public Dova.JDK.org.xml.sax.XMLReader xmlReader_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lorg/xml/sax/DocumentHandler;", "")]
	public Dova.JDK.org.xml.sax.DocumentHandler documentHandler_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lorg/xml/sax/helpers/XMLReaderAdapter$AttributesAdapter;", "")]
	public Dova.JDK.org.xml.sax.helpers.XMLReaderAdapter.AttributesAdapter qAtts_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[2]);
			return DovaInterfaceFactory.Get<Dova.JDK.org.xml.sax.helpers.XMLReaderAdapter.AttributesAdapter>(ret);
		}
		set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[2], value.CurrentRefPtr);
	}

	[JniSignatureAttribute("(System.IntPtr)V", "public")]
	public XMLReaderAdapter(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public XMLReaderAdapter() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Lorg/xml/sax/XMLReader;)V", "public")]
	public XMLReaderAdapter(Dova.JDK.org.xml.sax.XMLReader arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/xml/sax/helpers/XMLReaderAdapter;";
	public override IntPtr GetJavaClassRaw() => ClassPtr;
	public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;

	[JniSignatureAttribute("(Lorg/xml/sax/XMLReader;)V", "private")]
	public void setup(Dova.JDK.org.xml.sax.XMLReader arg0)
	{
	...
	[JniSignatureAttribute("Lorg/xml/sax/helpers/XMLReaderAdapter$AttributesAdapter;", "final")]
	public partial class AttributesAdapter
		: Dova.JDK.java.lang.Object
		, Dova.JDK.org.xml.sax.AttributeList
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lorg/xml/sax/helpers/XMLReaderAdapter$AttributesAdapter;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "attributes", "Lorg/xml/sax/Attributes;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AttributesAdapter", "(Lorg/xml/sax/helpers/XMLReaderAdapter;)V"));
		...
		public Dova.JDK.org.xml.sax.Attributes attributes_Property
		{
			get
			{
				var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[0]);
		...
		[JniSignatureAttribute("(System.IntPtr)V", "public")]
		public AttributesAdapter(IntPtr currentRefPtr) : base(currentRefPtr)
		{
		}

		[JniSignatureAttribute("(Lorg/xml/sax/helpers/XMLReaderAdapter;)V", "")]
		public AttributesAdapter(Dova.JDK.org.xml.sax.helpers.XMLReaderAdapter arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
		{
		}

		public override string GetJavaClassSignature() => "Lorg/xml/sax/helpers/XMLReaderAdapter$AttributesAdapter;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
		...
		[JniSignatureAttribute("(Lorg/xml/sax/Attributes;)V", "")]
