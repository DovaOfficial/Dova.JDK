...
[JniSignatureAttribute("Lorg/xml/sax/ext/Locator2;", "public abstract interface")]
public partial interface Locator2
	: IJavaObject
	, Dova.JDK.org.xml.sax.Locator
{
	...
	static Locator2()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/xml/sax/ext/Locator2;");
