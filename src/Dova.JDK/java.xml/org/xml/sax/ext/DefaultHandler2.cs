	...
	, Dova.JDK.org.xml.sax.ext.EntityResolver2
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lorg/xml/sax/ext/DefaultHandler2;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DefaultHandler2", "()V"));
	...
	public DefaultHandler2() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
