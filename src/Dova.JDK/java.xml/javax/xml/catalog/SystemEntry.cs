	...
	: Dova.JDK.javax.xml.catalog.BaseEntry
{
	...
	static SystemEntry()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/xml/catalog/SystemEntry;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SystemEntry", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"));
	...
	public SystemEntry(Dova.JDK.java.lang.String arg0, Dova.JDK.java.lang.String arg1, Dova.JDK.java.lang.String arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
