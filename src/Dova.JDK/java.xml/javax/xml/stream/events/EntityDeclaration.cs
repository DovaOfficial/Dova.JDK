...
[JniSignatureAttribute("Ljavax/xml/stream/events/EntityDeclaration;", "public abstract interface")]
public partial interface EntityDeclaration
	: IJavaObject
	, Dova.JDK.javax.xml.stream.events.XMLEvent
{
	...
	static EntityDeclaration()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/xml/stream/events/EntityDeclaration;");
	...
	[JniSignatureAttribute("()Ljava/lang/String;", "public abstract")]
	Dova.JDK.java.lang.String getReplacementText()
	{
	...
	[JniSignatureAttribute("()Ljava/lang/String;", "public abstract")]
	Dova.JDK.java.lang.String getNotationName()
	{
