...
[JniSignatureAttribute("Ljavax/xml/stream/events/NotationDeclaration;", "public abstract interface")]
public partial interface NotationDeclaration
	: IJavaObject
	, Dova.JDK.javax.xml.stream.events.XMLEvent
{
	...
	static NotationDeclaration()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/xml/stream/events/NotationDeclaration;");
