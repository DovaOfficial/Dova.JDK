	...
	: Dova.JDK.java.lang.Object
{
	...
	static Transformer()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Transformer", "()V"));
	...
	public Transformer() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
