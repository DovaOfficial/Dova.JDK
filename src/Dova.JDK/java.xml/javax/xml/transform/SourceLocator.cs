...
[JniSignatureAttribute("Ljavax/xml/transform/SourceLocator;", "public abstract interface")]
public partial interface SourceLocator
	: IJavaObject
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/xml/transform/SourceLocator;");
