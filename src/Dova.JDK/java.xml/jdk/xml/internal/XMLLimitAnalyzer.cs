	...
	: Dova.JDK.java.lang.Object
{
	...
	static XMLLimitAnalyzer()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getValue", "(Ljdk/xml/internal/XMLSecurityManager$Limit;)I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getValue", "(I)I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "reset", "(Ljdk/xml/internal/XMLSecurityManager$Limit;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "debugPrint", "(Ljdk/xml/internal/XMLSecurityManager;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addValue", "(Ljdk/xml/internal/XMLSecurityManager$Limit;Ljava/lang/String;I)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getTotalValue", "(Ljdk/xml/internal/XMLSecurityManager$Limit;)I"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "endEntity", "(Ljdk/xml/internal/XMLSecurityManager$Limit;Ljava/lang/String;)V"));
	}
		...
		: Dova.JDK.java.lang.Enum
	{
		...
		static NameMap()
		{
			...
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ENTITY_EXPANSION_LIMIT", "Ljdk/xml/internal/XMLLimitAnalyzer$NameMap;"));
			FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "MAX_OCCUR_NODE_LIMIT", "Ljdk/xml/internal/XMLLimitAnalyzer$NameMap;"));
			FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ELEMENT_ATTRIBUTE_LIMIT", "Ljdk/xml/internal/XMLLimitAnalyzer$NameMap;"));
			...
			FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "$VALUES", "[Ljdk/xml/internal/XMLLimitAnalyzer$NameMap;"));
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V"));
			MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "values", "()[Ljdk/xml/internal/XMLLimitAnalyzer$NameMap;"));
			MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "valueOf", "(Ljava/lang/String;)Ljdk/xml/internal/XMLLimitAnalyzer$NameMap;"));
			MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "$values", "()[Ljdk/xml/internal/XMLLimitAnalyzer$NameMap;"));
