	...
	: IJavaObject
{
	...
	static ShardingKeyBuilder()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "build", "()Ljava/sql/ShardingKey;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "subkey", "(Ljava/lang/Object;Ljava/sql/SQLType;)Ljava/sql/ShardingKeyBuilder;"));
	}
