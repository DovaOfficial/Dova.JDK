	...
	: IJavaObject
{
	...
	static SQLData()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "writeSQL", "(Ljava/sql/SQLOutput;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getSQLTypeName", "()Ljava/lang/String;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "readSQL", "(Ljava/sql/SQLInput;Ljava/lang/String;)V"));
	}
