	...
	: IJavaObject
{
	...
	static SQLXML()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setResult", "(Ljava/lang/Class;)Ljavax/xml/transform/Result;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getSource", "(Ljava/lang/Class;)Ljavax/xml/transform/Source;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setCharacterStream", "()Ljava/io/Writer;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setBinaryStream", "()Ljava/io/OutputStream;"));
