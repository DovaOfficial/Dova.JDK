...
[JniSignatureAttribute("Ljava/sql/DriverInfo;", "")]
	...
	: Dova.JDK.java.lang.Object
{
	...
	public Dova.JDK.java.sql.Driver driver_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Ljava/sql/DriverAction;", "")]
	public Dova.JDK.java.sql.DriverAction da_Property
	{
		get
		{
			var ret = DovaVM.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[1]);
			return DovaInterfaceFactory.Get<Dova.JDK.java.sql.DriverAction>(ret);
		}
		set
		{
	...
	public DriverInfo(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}
	...
	public override string GetJavaClassSignature() => "Ljava/sql/DriverInfo;";
	...
	[JniSignatureAttribute("()Ljava/sql/DriverAction;", "")]
	public Dova.JDK.java.sql.DriverAction action()
	{
