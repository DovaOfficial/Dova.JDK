	...
	: IJavaObject
{
	...
	static XAConnectionBuilder()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "build", "()Ljavax/sql/XAConnection;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "user", "(Ljava/lang/String;)Ljavax/sql/XAConnectionBuilder;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "password", "(Ljava/lang/String;)Ljavax/sql/XAConnectionBuilder;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "shardingKey", "(Ljava/sql/ShardingKey;)Ljavax/sql/XAConnectionBuilder;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "superShardingKey", "(Ljava/sql/ShardingKey;)Ljavax/sql/XAConnectionBuilder;"));
	}
