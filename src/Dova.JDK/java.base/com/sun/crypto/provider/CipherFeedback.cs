	...
	: Dova.JDK.com.sun.crypto.provider.FeedbackCipher
{
	...
	public CipherFeedback(Dova.JDK.com.sun.crypto.provider.SymmetricCipher arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
