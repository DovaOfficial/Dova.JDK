	...
	: Dova.JDK.com.sun.crypto.provider.FeedbackCipher
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/crypto/provider/CipherFeedback;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CipherFeedback", "(Lcom/sun/crypto/provider/SymmetricCipher;I)V"));
	...
	public CipherFeedback(Dova.JDK.com.sun.crypto.provider.SymmetricCipher arg0, int arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
