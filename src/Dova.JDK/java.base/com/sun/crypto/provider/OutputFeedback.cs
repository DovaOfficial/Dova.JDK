	...
	: Dova.JDK.com.sun.crypto.provider.FeedbackCipher
{
	...
	static OutputFeedback()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "OutputFeedback", "(Lcom/sun/crypto/provider/SymmetricCipher;I)V"));
	...
	public OutputFeedback(Dova.JDK.com.sun.crypto.provider.SymmetricCipher arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
