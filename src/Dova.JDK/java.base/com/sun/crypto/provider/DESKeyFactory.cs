...
[JniSignatureAttribute("Lcom/sun/crypto/provider/DESKeyFactory;", "public final")]
public partial class DESKeyFactory
	: Dova.JDK.javax.crypto.SecretKeyFactorySpi
{
	...
	static DESKeyFactory()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/crypto/provider/DESKeyFactory;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DESKeyFactory", "()V"));
	...
	public DESKeyFactory(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public DESKeyFactory() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/crypto/provider/DESKeyFactory;";
