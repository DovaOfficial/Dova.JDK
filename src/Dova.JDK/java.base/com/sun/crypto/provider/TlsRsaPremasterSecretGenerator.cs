	...
	: Dova.JDK.javax.crypto.KeyGeneratorSpi
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/crypto/provider/TlsRsaPremasterSecretGenerator;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TlsRsaPremasterSecretGenerator", "()V"));
	...
	public TlsRsaPremasterSecretGenerator() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
