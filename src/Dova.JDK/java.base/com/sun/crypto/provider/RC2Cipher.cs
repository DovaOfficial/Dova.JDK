	...
	: Dova.JDK.javax.crypto.CipherSpi
{
	...
	static RC2Cipher()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "embeddedCipher", "Lcom/sun/crypto/provider/RC2Crypt;"));
	...
	public RC2Cipher() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
