	...
	, Dova.JDK.javax.crypto.SecretKey
{
	...
	static PBEKey()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/crypto/provider/PBEKey;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PBEKey", "(Ljavax/crypto/spec/PBEKeySpec;Ljava/lang/String;Z)V"));
	...
	public PBEKey(Dova.JDK.javax.crypto.spec.PBEKeySpec arg0, Dova.JDK.java.lang.String arg1, bool arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
