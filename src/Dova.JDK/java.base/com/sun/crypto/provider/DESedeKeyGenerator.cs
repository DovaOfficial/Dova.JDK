	...
	: Dova.JDK.javax.crypto.KeyGeneratorSpi
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/crypto/provider/DESedeKeyGenerator;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DESedeKeyGenerator", "()V"));
	...
	public DESedeKeyGenerator() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
