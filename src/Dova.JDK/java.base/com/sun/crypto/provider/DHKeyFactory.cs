	...
	: Dova.JDK.java.security.KeyFactorySpi
{
	...
	static DHKeyFactory()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DHKeyFactory", "()V"));
	...
	public DHKeyFactory() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
