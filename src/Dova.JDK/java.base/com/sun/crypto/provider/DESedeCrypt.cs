	...
	, Dova.JDK.com.sun.crypto.provider.DESConstants
{
	...
	static DESedeCrypt()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "key1", "[B"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "key2", "[B"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "key3", "[B"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "buf1", "[B"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "buf2", "[B"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "keyEquals", "([BI[BII)Z"));
	}
	...
	public DESedeCrypt() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
