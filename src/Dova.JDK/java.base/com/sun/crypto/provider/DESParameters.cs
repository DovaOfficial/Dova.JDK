	...
	: Dova.JDK.java.security.AlgorithmParametersSpi
{
	...
	static DESParameters()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DESParameters", "()V"));
	...
	public DESParameters() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
