...
[JniSignatureAttribute("Lcom/sun/crypto/provider/HmacSHA1KeyGenerator;", "public final")]
public partial class HmacSHA1KeyGenerator
	: Dova.JDK.javax.crypto.KeyGeneratorSpi
{
	...
	static HmacSHA1KeyGenerator()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/crypto/provider/HmacSHA1KeyGenerator;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "HmacSHA1KeyGenerator", "()V"));
	...
	public HmacSHA1KeyGenerator(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public HmacSHA1KeyGenerator() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/crypto/provider/HmacSHA1KeyGenerator;";
