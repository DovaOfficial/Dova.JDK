...
[JniSignatureAttribute("Lcom/sun/crypto/provider/PBEWithMD5AndDESCipher;", "public final")]
public partial class PBEWithMD5AndDESCipher
	: Dova.JDK.javax.crypto.CipherSpi
{
	...
	static PBEWithMD5AndDESCipher()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/crypto/provider/PBEWithMD5AndDESCipher;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "core", "Lcom/sun/crypto/provider/PBES1Core;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "PBEWithMD5AndDESCipher", "()V"));
	...
	public PBEWithMD5AndDESCipher(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public PBEWithMD5AndDESCipher() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/crypto/provider/PBEWithMD5AndDESCipher;";
