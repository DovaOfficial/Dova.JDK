	...
	: Dova.JDK.javax.crypto.CipherSpi
{
	...
	static PBEWithMD5AndDESCipher()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "core", "Lcom/sun/crypto/provider/PBES1Core;"));
	...
	public PBEWithMD5AndDESCipher() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
