	...
	: Dova.JDK.com.sun.crypto.provider.FeedbackCipher
{
	...
	static PCBC()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "kSave", "[B"));
	...
	public PCBC(Dova.JDK.com.sun.crypto.provider.SymmetricCipher arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
