...
[JniSignatureAttribute("Lcom/sun/crypto/provider/AESKeyGenerator;", "public final")]
public partial class AESKeyGenerator
	: Dova.JDK.javax.crypto.KeyGeneratorSpi
{
	...
	static AESKeyGenerator()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/crypto/provider/AESKeyGenerator;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AESKeyGenerator", "()V"));
	...
	public AESKeyGenerator(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public AESKeyGenerator() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/crypto/provider/AESKeyGenerator;";
