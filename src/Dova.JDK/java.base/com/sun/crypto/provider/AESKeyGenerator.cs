	...
	: Dova.JDK.javax.crypto.KeyGeneratorSpi
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/crypto/provider/AESKeyGenerator;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AESKeyGenerator", "()V"));
	...
	public AESKeyGenerator() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
