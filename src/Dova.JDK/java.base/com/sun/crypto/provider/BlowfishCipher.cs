	...
	: Dova.JDK.javax.crypto.CipherSpi
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/crypto/provider/BlowfishCipher;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "core", "Lcom/sun/crypto/provider/CipherCore;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "BlowfishCipher", "()V"));
	...
	public BlowfishCipher() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
