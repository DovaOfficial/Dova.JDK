	...
	, Dova.JDK.jdk.@internal.jimage.decompressor.ResourceDecompressor
{
	...
	static ZipDecompressor()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "decompress", "([BI)[B"));
	}
	...
	public ZipDecompressor() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
