	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.tree.AnnotationNode
{
	...
	static TypeAnnotationNode()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "typeRef", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "typePath", "Ljdk/internal/org/objectweb/asm/TypePath;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TypeAnnotationNode", "(ILjdk/internal/org/objectweb/asm/TypePath;Ljava/lang/String;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TypeAnnotationNode", "(IILjdk/internal/org/objectweb/asm/TypePath;Ljava/lang/String;)V"));
	}
	...
	public TypeAnnotationNode(int arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.TypePath arg1, Dova.JDK.java.lang.String arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(IILjdk/internal/org/objectweb/asm/TypePath;Ljava/lang/String;)V", "public")]
	public TypeAnnotationNode(int arg0, int arg1, Dova.JDK.jdk.@internal.org.objectweb.asm.TypePath arg2, Dova.JDK.java.lang.String arg3) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1, arg2, arg3))
	{
	}
