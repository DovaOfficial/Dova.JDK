...
[JniSignatureAttribute("Ljdk/internal/org/objectweb/asm/tree/LineNumberNode;", "public")]
	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.tree.AbstractInsnNode
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/org/objectweb/asm/tree/LineNumberNode;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "LineNumberNode", "(ILjdk/internal/org/objectweb/asm/tree/LabelNode;)V"));
	...
	public LineNumberNode(int arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.tree.LabelNode arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/org/objectweb/asm/tree/LineNumberNode;";
