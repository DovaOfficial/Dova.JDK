	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.tree.AbstractInsnNode
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/org/objectweb/asm/tree/LineNumberNode;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "LineNumberNode", "(ILjdk/internal/org/objectweb/asm/tree/LabelNode;)V"));
	...
	public LineNumberNode(int arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.tree.LabelNode arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
