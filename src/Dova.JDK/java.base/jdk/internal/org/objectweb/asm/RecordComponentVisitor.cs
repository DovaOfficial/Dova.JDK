	...
	: Dova.JDK.java.lang.Object
{
	...
	static RecordComponentVisitor()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "delegate", "Ljdk/internal/org/objectweb/asm/RecordComponentVisitor;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(I)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(ILjdk/internal/org/objectweb/asm/RecordComponentVisitor;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getDelegate", "()Ljdk/internal/org/objectweb/asm/RecordComponentVisitor;"));
	}
	...
	public RecordComponentVisitor(int arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.RecordComponentVisitor arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
