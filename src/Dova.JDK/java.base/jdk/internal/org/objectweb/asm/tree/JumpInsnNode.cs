	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.tree.AbstractInsnNode
{
	...
	static JumpInsnNode()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "label", "Ljdk/internal/org/objectweb/asm/tree/LabelNode;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "JumpInsnNode", "(ILjdk/internal/org/objectweb/asm/tree/LabelNode;)V"));
	...
	public JumpInsnNode(int arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.tree.LabelNode arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
