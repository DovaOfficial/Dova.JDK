	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.AnnotationVisitor
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/org/objectweb/asm/util/CheckAnnotationAdapter;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "useNamedValue", "Z"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "visitEndCalled", "Z"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CheckAnnotationAdapter", "(Ljdk/internal/org/objectweb/asm/AnnotationVisitor;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CheckAnnotationAdapter", "(Ljdk/internal/org/objectweb/asm/AnnotationVisitor;Z)V"));
	...
	public CheckAnnotationAdapter(Dova.JDK.jdk.@internal.org.objectweb.asm.AnnotationVisitor arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljdk/internal/org/objectweb/asm/AnnotationVisitor;Z)V", "")]
	public CheckAnnotationAdapter(Dova.JDK.jdk.@internal.org.objectweb.asm.AnnotationVisitor arg0, bool arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
