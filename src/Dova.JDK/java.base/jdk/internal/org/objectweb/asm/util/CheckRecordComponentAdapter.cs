	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.RecordComponentVisitor
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/org/objectweb/asm/util/CheckRecordComponentAdapter;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "visitEndCalled", "Z"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CheckRecordComponentAdapter", "(Ljdk/internal/org/objectweb/asm/RecordComponentVisitor;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CheckRecordComponentAdapter", "(ILjdk/internal/org/objectweb/asm/RecordComponentVisitor;)V"));
	...
	public CheckRecordComponentAdapter(Dova.JDK.jdk.@internal.org.objectweb.asm.RecordComponentVisitor arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(ILjdk/internal/org/objectweb/asm/RecordComponentVisitor;)V", "protected")]
	public CheckRecordComponentAdapter(int arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.RecordComponentVisitor arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
