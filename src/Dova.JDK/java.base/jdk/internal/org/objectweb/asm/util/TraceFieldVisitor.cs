	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.FieldVisitor
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/org/objectweb/asm/util/TraceFieldVisitor;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "p", "Ljdk/internal/org/objectweb/asm/util/Printer;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "TraceFieldVisitor", "(Ljdk/internal/org/objectweb/asm/util/Printer;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "TraceFieldVisitor", "(Ljdk/internal/org/objectweb/asm/FieldVisitor;Ljdk/internal/org/objectweb/asm/util/Printer;)V"));
	...
	public TraceFieldVisitor(Dova.JDK.jdk.@internal.org.objectweb.asm.util.Printer arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljdk/internal/org/objectweb/asm/FieldVisitor;Ljdk/internal/org/objectweb/asm/util/Printer;)V", "public")]
	public TraceFieldVisitor(Dova.JDK.jdk.@internal.org.objectweb.asm.FieldVisitor arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.util.Printer arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
