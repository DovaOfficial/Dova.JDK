...
[JniSignatureAttribute("Ljdk/internal/org/objectweb/asm/util/TraceFieldVisitor;", "public final")]
	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.FieldVisitor
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/org/objectweb/asm/util/TraceFieldVisitor;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "p", "Ljdk/internal/org/objectweb/asm/util/Printer;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TraceFieldVisitor", "(Ljdk/internal/org/objectweb/asm/util/Printer;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TraceFieldVisitor", "(Ljdk/internal/org/objectweb/asm/FieldVisitor;Ljdk/internal/org/objectweb/asm/util/Printer;)V"));
	...
	public TraceFieldVisitor(Dova.JDK.jdk.@internal.org.objectweb.asm.util.Printer arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljdk/internal/org/objectweb/asm/FieldVisitor;Ljdk/internal/org/objectweb/asm/util/Printer;)V", "public")]
	public TraceFieldVisitor(Dova.JDK.jdk.@internal.org.objectweb.asm.FieldVisitor arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.util.Printer arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/org/objectweb/asm/util/TraceFieldVisitor;";
