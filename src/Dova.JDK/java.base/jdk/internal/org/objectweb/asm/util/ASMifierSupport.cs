	...
	: IJavaObject
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/org/objectweb/asm/util/ASMifierSupport;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "asmify", "(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/util/Map;)V"));
	}
