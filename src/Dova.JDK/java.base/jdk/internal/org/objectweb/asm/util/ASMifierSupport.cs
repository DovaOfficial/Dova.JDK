...
[JniSignatureAttribute("Ljdk/internal/org/objectweb/asm/util/ASMifierSupport;", "public abstract interface")]
	...
	: IJavaObject
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/org/objectweb/asm/util/ASMifierSupport;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "asmify", "(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/util/Map;)V"));
	}
