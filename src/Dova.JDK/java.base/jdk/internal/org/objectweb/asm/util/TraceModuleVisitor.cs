...
[JniSignatureAttribute("Ljdk/internal/org/objectweb/asm/util/TraceModuleVisitor;", "public final")]
	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.ModuleVisitor
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/org/objectweb/asm/util/TraceModuleVisitor;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "p", "Ljdk/internal/org/objectweb/asm/util/Printer;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TraceModuleVisitor", "(Ljdk/internal/org/objectweb/asm/util/Printer;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TraceModuleVisitor", "(Ljdk/internal/org/objectweb/asm/ModuleVisitor;Ljdk/internal/org/objectweb/asm/util/Printer;)V"));
	...
	public TraceModuleVisitor(Dova.JDK.jdk.@internal.org.objectweb.asm.util.Printer arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljdk/internal/org/objectweb/asm/ModuleVisitor;Ljdk/internal/org/objectweb/asm/util/Printer;)V", "public")]
	public TraceModuleVisitor(Dova.JDK.jdk.@internal.org.objectweb.asm.ModuleVisitor arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.util.Printer arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/org/objectweb/asm/util/TraceModuleVisitor;";
