	...
	: Dova.JDK.jdk.@internal.org.objectweb.asm.ModuleVisitor
{
	...
	static TraceModuleVisitor()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljdk/internal/org/objectweb/asm/ModuleVisitor;Ljdk/internal/org/objectweb/asm/util/Printer;)V"));
	...
	public TraceModuleVisitor(Dova.JDK.jdk.@internal.org.objectweb.asm.util.Printer arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
	...
	public TraceModuleVisitor(Dova.JDK.jdk.@internal.org.objectweb.asm.ModuleVisitor arg0, Dova.JDK.jdk.@internal.org.objectweb.asm.util.Printer arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
