	...
	: IJavaObject
{
	...
	static JavaIOFilePermissionAccess()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "newPermUsingAltPath", "(Ljava/io/FilePermission;)Ljava/io/FilePermission;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "newPermPlusAltPath", "(Ljava/io/FilePermission;)Ljava/io/FilePermission;"));
	}
