...
[JniSignatureAttribute("Ljdk/internal/reflect/UnsafeQualifiedStaticObjectFieldAccessorImpl;", "")]
public partial class UnsafeQualifiedStaticObjectFieldAccessorImpl
	: Dova.JDK.jdk.@internal.reflect.UnsafeQualifiedStaticFieldAccessorImpl
{
	...
	static UnsafeQualifiedStaticObjectFieldAccessorImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/reflect/UnsafeQualifiedStaticObjectFieldAccessorImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnsafeQualifiedStaticObjectFieldAccessorImpl", "(Ljava/lang/reflect/Field;Z)V"));
	...
	public UnsafeQualifiedStaticObjectFieldAccessorImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/reflect/Field;Z)V", "")]
	public UnsafeQualifiedStaticObjectFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0, bool arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/reflect/UnsafeQualifiedStaticObjectFieldAccessorImpl;";
