...
[JniSignatureAttribute("Ljdk/internal/reflect/UnsafeStaticLongFieldAccessorImpl;", "")]
public partial class UnsafeStaticLongFieldAccessorImpl
	: Dova.JDK.jdk.@internal.reflect.UnsafeStaticFieldAccessorImpl
{
	...
	static UnsafeStaticLongFieldAccessorImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/reflect/UnsafeStaticLongFieldAccessorImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnsafeStaticLongFieldAccessorImpl", "(Ljava/lang/reflect/Field;)V"));
	...
	public UnsafeStaticLongFieldAccessorImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/reflect/Field;)V", "")]
	public UnsafeStaticLongFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/reflect/UnsafeStaticLongFieldAccessorImpl;";
