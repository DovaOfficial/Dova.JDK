...
[JniSignatureAttribute("Ljdk/internal/reflect/UnsafeQualifiedIntegerFieldAccessorImpl;", "")]
public partial class UnsafeQualifiedIntegerFieldAccessorImpl
	: Dova.JDK.jdk.@internal.reflect.UnsafeQualifiedFieldAccessorImpl
{
	...
	static UnsafeQualifiedIntegerFieldAccessorImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/reflect/UnsafeQualifiedIntegerFieldAccessorImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnsafeQualifiedIntegerFieldAccessorImpl", "(Ljava/lang/reflect/Field;Z)V"));
	...
	public UnsafeQualifiedIntegerFieldAccessorImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/reflect/Field;Z)V", "")]
	public UnsafeQualifiedIntegerFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0, bool arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/reflect/UnsafeQualifiedIntegerFieldAccessorImpl;";
