	...
	: Dova.JDK.jdk.@internal.reflect.UnsafeFieldAccessorImpl
{
	...
	static UnsafeStaticFieldAccessorImpl()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UnsafeStaticFieldAccessorImpl", "(Ljava/lang/reflect/Field;)V"));
	}
	...
	public UnsafeStaticFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
