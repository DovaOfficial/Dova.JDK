	...
	: Dova.JDK.jdk.@internal.reflect.UnsafeQualifiedStaticFieldAccessorImpl
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/reflect/UnsafeQualifiedStaticByteFieldAccessorImpl;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UnsafeQualifiedStaticByteFieldAccessorImpl", "(Ljava/lang/reflect/Field;Z)V"));
	...
	public UnsafeQualifiedStaticByteFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0, bool arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
