...
[JniSignatureAttribute("Ljdk/internal/reflect/UnsafeStaticDoubleFieldAccessorImpl;", "")]
public partial class UnsafeStaticDoubleFieldAccessorImpl
	: Dova.JDK.jdk.@internal.reflect.UnsafeStaticFieldAccessorImpl
{
	...
	static UnsafeStaticDoubleFieldAccessorImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/reflect/UnsafeStaticDoubleFieldAccessorImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnsafeStaticDoubleFieldAccessorImpl", "(Ljava/lang/reflect/Field;)V"));
	...
	public UnsafeStaticDoubleFieldAccessorImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/reflect/Field;)V", "")]
	public UnsafeStaticDoubleFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/reflect/UnsafeStaticDoubleFieldAccessorImpl;";
