	...
	: Dova.JDK.java.lang.Object
{
	...
	static ByteVectorFactory()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "create", "()Ljdk/internal/reflect/ByteVector;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "create", "(I)Ljdk/internal/reflect/ByteVector;"));
	}
	...
	public ByteVectorFactory() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
