...
[JniSignatureAttribute("Ljdk/internal/reflect/UnsafeStaticShortFieldAccessorImpl;", "")]
public partial class UnsafeStaticShortFieldAccessorImpl
	: Dova.JDK.jdk.@internal.reflect.UnsafeStaticFieldAccessorImpl
{
	...
	static UnsafeStaticShortFieldAccessorImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/reflect/UnsafeStaticShortFieldAccessorImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnsafeStaticShortFieldAccessorImpl", "(Ljava/lang/reflect/Field;)V"));
	...
	public UnsafeStaticShortFieldAccessorImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/reflect/Field;)V", "")]
	public UnsafeStaticShortFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/reflect/UnsafeStaticShortFieldAccessorImpl;";
