	...
	: Dova.JDK.jdk.@internal.reflect.UnsafeFieldAccessorImpl
{
	...
	static UnsafeIntegerFieldAccessorImpl()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UnsafeIntegerFieldAccessorImpl", "(Ljava/lang/reflect/Field;)V"));
	...
	public UnsafeIntegerFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
