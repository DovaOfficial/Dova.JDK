...
[JniSignatureAttribute("Ljdk/internal/reflect/UnsafeQualifiedBooleanFieldAccessorImpl;", "")]
public partial class UnsafeQualifiedBooleanFieldAccessorImpl
	: Dova.JDK.jdk.@internal.reflect.UnsafeQualifiedFieldAccessorImpl
{
	...
	static UnsafeQualifiedBooleanFieldAccessorImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/reflect/UnsafeQualifiedBooleanFieldAccessorImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnsafeQualifiedBooleanFieldAccessorImpl", "(Ljava/lang/reflect/Field;Z)V"));
	...
	public UnsafeQualifiedBooleanFieldAccessorImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/reflect/Field;Z)V", "")]
	public UnsafeQualifiedBooleanFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0, bool arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/reflect/UnsafeQualifiedBooleanFieldAccessorImpl;";
