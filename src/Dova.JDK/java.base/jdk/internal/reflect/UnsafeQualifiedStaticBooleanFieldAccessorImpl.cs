...
[JniSignatureAttribute("Ljdk/internal/reflect/UnsafeQualifiedStaticBooleanFieldAccessorImpl;", "")]
public partial class UnsafeQualifiedStaticBooleanFieldAccessorImpl
	: Dova.JDK.jdk.@internal.reflect.UnsafeQualifiedStaticFieldAccessorImpl
{
	...
	static UnsafeQualifiedStaticBooleanFieldAccessorImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/reflect/UnsafeQualifiedStaticBooleanFieldAccessorImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnsafeQualifiedStaticBooleanFieldAccessorImpl", "(Ljava/lang/reflect/Field;Z)V"));
	...
	public UnsafeQualifiedStaticBooleanFieldAccessorImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/reflect/Field;Z)V", "")]
	public UnsafeQualifiedStaticBooleanFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0, bool arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/reflect/UnsafeQualifiedStaticBooleanFieldAccessorImpl;";
