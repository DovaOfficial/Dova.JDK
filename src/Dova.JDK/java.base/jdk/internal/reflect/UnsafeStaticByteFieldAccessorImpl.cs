	...
	: Dova.JDK.jdk.@internal.reflect.UnsafeStaticFieldAccessorImpl
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/reflect/UnsafeStaticByteFieldAccessorImpl;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UnsafeStaticByteFieldAccessorImpl", "(Ljava/lang/reflect/Field;)V"));
	...
	public UnsafeStaticByteFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
