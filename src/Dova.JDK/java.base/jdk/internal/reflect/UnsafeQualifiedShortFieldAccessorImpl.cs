...
[JniSignatureAttribute("Ljdk/internal/reflect/UnsafeQualifiedShortFieldAccessorImpl;", "")]
public partial class UnsafeQualifiedShortFieldAccessorImpl
	: Dova.JDK.jdk.@internal.reflect.UnsafeQualifiedFieldAccessorImpl
{
	...
	static UnsafeQualifiedShortFieldAccessorImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljdk/internal/reflect/UnsafeQualifiedShortFieldAccessorImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UnsafeQualifiedShortFieldAccessorImpl", "(Ljava/lang/reflect/Field;Z)V"));
	...
	public UnsafeQualifiedShortFieldAccessorImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/reflect/Field;Z)V", "")]
	public UnsafeQualifiedShortFieldAccessorImpl(Dova.JDK.java.lang.reflect.Field arg0, bool arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/reflect/UnsafeQualifiedShortFieldAccessorImpl;";
