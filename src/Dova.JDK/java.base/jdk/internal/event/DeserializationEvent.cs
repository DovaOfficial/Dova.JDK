	...
	: Dova.JDK.jdk.@internal.@event.Event
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/event/DeserializationEvent;");
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "eventHandler", "Ljava/lang/Object;"));
