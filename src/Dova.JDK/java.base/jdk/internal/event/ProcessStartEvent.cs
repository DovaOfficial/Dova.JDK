	...
	: Dova.JDK.jdk.@internal.@event.Event
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/event/ProcessStartEvent;");
	...
	public ProcessStartEvent() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
