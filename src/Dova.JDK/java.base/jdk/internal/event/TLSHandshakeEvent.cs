...
[JniSignatureAttribute("Ljdk/internal/event/TLSHandshakeEvent;", "public final")]
	...
	: Dova.JDK.jdk.@internal.@event.Event
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljdk/internal/event/TLSHandshakeEvent;");
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "protocolVersion", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "cipherSuite", "Ljava/lang/String;"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TLSHandshakeEvent", "()V"));
	...
	public TLSHandshakeEvent() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljdk/internal/event/TLSHandshakeEvent;";
