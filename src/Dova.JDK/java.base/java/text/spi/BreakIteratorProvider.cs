	...
	: Dova.JDK.java.util.spi.LocaleServiceProvider
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/text/spi/BreakIteratorProvider;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "BreakIteratorProvider", "()V"));
	...
	public BreakIteratorProvider() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
