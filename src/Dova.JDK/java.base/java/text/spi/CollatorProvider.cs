	...
	: Dova.JDK.java.util.spi.LocaleServiceProvider
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/text/spi/CollatorProvider;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CollatorProvider", "()V"));
	...
	public CollatorProvider() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
