	...
	: Dova.JDK.java.lang.Object
{
	...
	static CacheRequest()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getBody", "()Ljava/io/OutputStream;"));
	}
	...
	public CacheRequest() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
