	...
	, Dova.JDK.java.net.InetAddressImpl
{
	...
	static Inet6AddressImpl()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Inet6AddressImpl", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "lookupAllHostAddr", "(Ljava/lang/String;I)[Ljava/net/InetAddress;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "isReachable0", "([BII[BII)Z"));
	...
	public Inet6AddressImpl() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
