...
[JniSignatureAttribute("Ljava/net/SocketPermissionCollection;", "final")]
public partial class SocketPermissionCollection
	...
	, Dova.JDK.java.io.Serializable
{
	...
	static SocketPermissionCollection()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/net/SocketPermissionCollection;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "perms", "Ljava/util/Map;"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SocketPermissionCollection", "()V"));
	...
	public Dova.JDK.java.util.Map perms_Property
	{
		get
		{
	...
	public SocketPermissionCollection(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SocketPermissionCollection() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/net/SocketPermissionCollection;";
