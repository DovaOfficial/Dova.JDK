	...
	, Dova.JDK.java.io.Serializable
{
	...
	static SocketPermissionCollection()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "perms", "Ljava/util/Map;"));
	...
	public SocketPermissionCollection() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
