	...
	, Dova.JDK.java.io.Serializable
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/net/SocketPermissionCollection;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "perms", "Ljava/util/Map;"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SocketPermissionCollection", "()V"));
	...
	public SocketPermissionCollection() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
