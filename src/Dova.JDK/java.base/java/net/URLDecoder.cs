	...
	: Dova.JDK.java.lang.Object
{
	...
	static URLDecoder()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "decode", "(Ljava/lang/String;Ljava/nio/charset/Charset;)Ljava/lang/String;"));
	...
	public URLDecoder() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
