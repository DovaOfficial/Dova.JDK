	...
	, Dova.JDK.java.net.InetAddressImpl
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/net/Inet4AddressImpl;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Inet4AddressImpl", "()V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "lookupAllHostAddr", "(Ljava/lang/String;)[Ljava/net/InetAddress;"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isReachable0", "([BI[BI)Z"));
	...
	public Inet4AddressImpl() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
