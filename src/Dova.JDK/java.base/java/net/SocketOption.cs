...
[JniSignatureAttribute("Ljava/net/SocketOption;", "public abstract interface")]
public partial interface SocketOption
	: IJavaObject
{
	...
	static SocketOption()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/net/SocketOption;");
