	...
	: Dova.JDK.java.io.FilterOutputStream
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/security/DigestOutputStream;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DigestOutputStream", "(Ljava/io/OutputStream;Ljava/security/MessageDigest;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "on", "(Z)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "setMessageDigest", "(Ljava/security/MessageDigest;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getMessageDigest", "()Ljava/security/MessageDigest;"));
	}
	...
	public DigestOutputStream(Dova.JDK.java.io.OutputStream arg0, Dova.JDK.java.security.MessageDigest arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
