	...
	: Dova.JDK.java.io.FilterOutputStream
{
	...
	static DigestOutputStream()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/io/OutputStream;Ljava/security/MessageDigest;)V"));
	...
	public DigestOutputStream(Dova.JDK.java.io.OutputStream arg0, Dova.JDK.java.security.MessageDigest arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
