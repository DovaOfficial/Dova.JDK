	...
	: IJavaObject
{
	...
	static Certificate()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getGuarantor", "()Ljava/security/Principal;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getPrincipal", "()Ljava/security/Principal;"));
	}
