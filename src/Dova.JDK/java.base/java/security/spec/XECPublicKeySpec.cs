	...
	, Dova.JDK.java.security.spec.KeySpec
{
	...
	static XECPublicKeySpec()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)V"));
	...
	public XECPublicKeySpec(Dova.JDK.java.security.spec.AlgorithmParameterSpec arg0, Dova.JDK.java.math.BigInteger arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
