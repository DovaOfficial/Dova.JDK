	...
	, Dova.JDK.java.io.Serializable
{
	...
	static UnresolvedPermissionCollection()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getUnresolvedPermissions", "(Ljava/security/Permission;)Ljava/util/List;"));
	}
	...
	public UnresolvedPermissionCollection() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
