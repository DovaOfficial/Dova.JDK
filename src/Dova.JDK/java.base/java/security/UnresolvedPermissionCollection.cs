	...
	, Dova.JDK.java.io.Serializable
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/security/UnresolvedPermissionCollection;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UnresolvedPermissionCollection", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getUnresolvedPermissions", "(Ljava/security/Permission;)Ljava/util/List;"));
	}
	...
	public UnresolvedPermissionCollection() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
