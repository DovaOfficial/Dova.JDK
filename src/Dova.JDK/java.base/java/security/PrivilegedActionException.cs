...
[JniSignatureAttribute("Ljava/security/PrivilegedActionException;", "public")]
	...
	: Dova.JDK.java.lang.Exception
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/security/PrivilegedActionException;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PrivilegedActionException", "(Ljava/lang/Exception;)V"));
	...
	public PrivilegedActionException(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/Exception;)V", "public")]
	public PrivilegedActionException(Dova.JDK.java.lang.Exception arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/security/PrivilegedActionException;";
