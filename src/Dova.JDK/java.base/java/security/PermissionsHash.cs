...
[JniSignatureAttribute("Ljava/security/PermissionsHash;", "final")]
public partial class PermissionsHash
	...
	, Dova.JDK.java.io.Serializable
{
	...
	static PermissionsHash()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/security/PermissionsHash;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "PermissionsHash", "()V"));
	...
	public PermissionsHash(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "")]
	public PermissionsHash() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/security/PermissionsHash;";
