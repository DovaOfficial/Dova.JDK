	...
	, Dova.JDK.java.io.Serializable
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/security/PermissionsHash;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PermissionsHash", "()V"));
	...
	public PermissionsHash() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
