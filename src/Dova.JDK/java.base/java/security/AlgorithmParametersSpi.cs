	...
	: Dova.JDK.java.lang.Object
{
	...
	static AlgorithmParametersSpi()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AlgorithmParametersSpi", "()V"));
	...
	public AlgorithmParametersSpi() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
