...
[JniSignatureAttribute("Ljava/security/interfaces/DSAPrivateKey;", "public abstract interface")]
public partial interface DSAPrivateKey
	: IJavaObject
	, Dova.JDK.java.security.interfaces.DSAKey
	, Dova.JDK.java.security.PrivateKey
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/security/interfaces/DSAPrivateKey;");
	...
	Dova.JDK.java.math.BigInteger getX()
	{
