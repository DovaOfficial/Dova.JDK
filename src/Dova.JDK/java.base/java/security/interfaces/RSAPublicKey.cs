...
[JniSignatureAttribute("Ljava/security/interfaces/RSAPublicKey;", "public abstract interface")]
public partial interface RSAPublicKey
	: IJavaObject
	...
	, Dova.JDK.java.security.interfaces.RSAKey
{
	...
	static RSAPublicKey()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/security/interfaces/RSAPublicKey;");
