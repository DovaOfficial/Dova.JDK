...
[JniSignatureAttribute("Ljava/security/BasicPermissionCollection;", "final")]
public partial class BasicPermissionCollection
	...
	, Dova.JDK.java.io.Serializable
{
	...
	static BasicPermissionCollection()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/security/BasicPermissionCollection;");
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "all_allowed", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "permClass", "Ljava/lang/Class;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "serialPersistentFields", "[Ljava/io/ObjectStreamField;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "BasicPermissionCollection", "(Ljava/lang/Class;)V"));
	...
	public bool all_allowed_Property
	{
		get
		{
	...
	public Dova.JDK.java.lang.Class permClass_Property
	{
		get
		{
	...
	public BasicPermissionCollection(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/Class;)V", "public")]
	public BasicPermissionCollection(Dova.JDK.java.lang.Class arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/security/BasicPermissionCollection;";
