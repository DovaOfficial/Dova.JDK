	...
	, Dova.JDK.java.io.Serializable
{
	...
	static BasicPermissionCollection()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "all_allowed", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "permClass", "Ljava/lang/Class;"));
	...
	public BasicPermissionCollection(Dova.JDK.java.lang.Class arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
