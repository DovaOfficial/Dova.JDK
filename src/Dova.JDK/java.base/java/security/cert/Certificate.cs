	...
	, Dova.JDK.java.io.Serializable
{
	...
	static Certificate()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/security/cert/Certificate;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Certificate", "(Ljava/lang/String;)V"));
	...
	public Certificate(Dova.JDK.java.lang.String arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/security/cert/Certificate;";
	...
	[JniSignatureAttribute("Ljava/security/cert/Certificate$CertificateRep;", "protected static")]
	public partial class CertificateRep
		: Dova.JDK.java.lang.Object
		, Dova.JDK.java.io.Serializable
	{
		public new static CSharpSystem.IntPtr ClassPtr { get; }
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/security/cert/Certificate$CertificateRep;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "type", "Ljava/lang/String;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "data", "[B"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CertificateRep", "(Ljava/lang/String;[B)V"));
		...
		[JniSignatureAttribute("(System.IntPtr)V", "public")]
		public CertificateRep(IntPtr currentRefPtr) : base(currentRefPtr)
		{
		}

		[JniSignatureAttribute("(Ljava/lang/String;[B)V", "protected")]
		public CertificateRep(Dova.JDK.java.lang.String arg0, JavaArray<byte> arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
		{
		}

		public override string GetJavaClassSignature() => "Ljava/security/cert/Certificate$CertificateRep;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
