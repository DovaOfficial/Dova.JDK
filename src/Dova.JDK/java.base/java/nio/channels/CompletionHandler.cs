	...
	: IJavaObject
{
	...
	static CompletionHandler()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "completed", "(Ljava/lang/Object;Ljava/lang/Object;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "failed", "(Ljava/lang/Throwable;Ljava/lang/Object;)V"));
	}
