	...
	: Dova.JDK.java.io.IOException
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/nio/channels/FileLockInterruptionException;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FileLockInterruptionException", "()V"));
	}
	...
	public FileLockInterruptionException() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
