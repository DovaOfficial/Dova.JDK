	...
	: IJavaObject
{
	...
	static WatchKey()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/nio/file/WatchKey;");
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "watchable", "()Ljava/nio/file/Watchable;"));
	}
