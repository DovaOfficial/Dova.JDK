	...
	: IJavaObject
{
	...
	static PathMatcher()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/nio/file/PathMatcher;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "matches", "(Ljava/nio/file/Path;)Z"));
	}
