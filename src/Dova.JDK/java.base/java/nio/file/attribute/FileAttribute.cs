...
[JniSignatureAttribute("Ljava/nio/file/attribute/FileAttribute;", "public abstract interface")]
public partial interface FileAttribute
	: IJavaObject
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/nio/file/attribute/FileAttribute;");
