	...
	, Dova.JDK.java.nio.file.FileVisitor
{
	...
	static SimpleFileVisitor()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SimpleFileVisitor", "()V"));
	...
	public SimpleFileVisitor() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
