	...
	: Dova.JDK.java.lang.IllegalStateException
{
	...
	static ClosedFileSystemException()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ClosedFileSystemException", "()V"));
	}
	...
	public ClosedFileSystemException() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
