	...
	: Dova.JDK.java.lang.Object
{
	...
	static EmojiData()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "isExtendedPictographic", "(I)Z"));
	}
	...
	public EmojiData() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
