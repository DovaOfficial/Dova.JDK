...
[JniSignatureAttribute("Ljava/util/regex/PatternSyntaxException;", "public")]
	...
	: Dova.JDK.java.lang.IllegalArgumentException
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/util/regex/PatternSyntaxException;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PatternSyntaxException", "(Ljava/lang/String;Ljava/lang/String;I)V"));
	...
	public PatternSyntaxException(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;Ljava/lang/String;I)V", "public")]
	public PatternSyntaxException(Dova.JDK.java.lang.String arg0, Dova.JDK.java.lang.String arg1, int arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/util/regex/PatternSyntaxException;";
