	...
	, Dova.JDK.java.util.Queue
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/util/AbstractQueue;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AbstractQueue", "()V"));
	...
	public AbstractQueue() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
