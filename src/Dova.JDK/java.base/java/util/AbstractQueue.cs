...
[JniSignatureAttribute("Ljava/util/AbstractQueue;", "public abstract")]
	...
	, Dova.JDK.java.util.Queue
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/util/AbstractQueue;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AbstractQueue", "()V"));
	...
	public AbstractQueue(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "protected")]
	public AbstractQueue() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/util/AbstractQueue;";
