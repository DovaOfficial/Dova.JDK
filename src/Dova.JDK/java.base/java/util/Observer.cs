	...
	: IJavaObject
{
	...
	static Observer()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/util/Observer;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "update", "(Ljava/util/Observable;Ljava/lang/Object;)V"));
	}
