	...
	: IJavaObject
{
	...
	static DoubleUnaryOperator()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "identity", "()Ljava/util/function/DoubleUnaryOperator;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "applyAsDouble", "(D)D"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "compose", "(Ljava/util/function/DoubleUnaryOperator;)Ljava/util/function/DoubleUnaryOperator;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "andThen", "(Ljava/util/function/DoubleUnaryOperator;)Ljava/util/function/DoubleUnaryOperator;"));
	}
