	...
	: IJavaObject
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/util/function/ObjLongConsumer;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "accept", "(Ljava/lang/Object;J)V"));
	}
