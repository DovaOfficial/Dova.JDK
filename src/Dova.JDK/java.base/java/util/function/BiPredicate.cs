	...
	: IJavaObject
{
	...
	static BiPredicate()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "or", "(Ljava/util/function/BiPredicate;)Ljava/util/function/BiPredicate;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "negate", "()Ljava/util/function/BiPredicate;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "and", "(Ljava/util/function/BiPredicate;)Ljava/util/function/BiPredicate;"));
	}
