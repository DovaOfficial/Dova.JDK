	...
	: IJavaObject
{
	...
	static LongPredicate()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "test", "(J)Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "or", "(Ljava/util/function/LongPredicate;)Ljava/util/function/LongPredicate;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "negate", "()Ljava/util/function/LongPredicate;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "and", "(Ljava/util/function/LongPredicate;)Ljava/util/function/LongPredicate;"));
	}
