	...
	: IJavaObject
{
	...
	static BiFunction()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/util/function/BiFunction;");
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "andThen", "(Ljava/util/function/Function;)Ljava/util/function/BiFunction;"));
	}
