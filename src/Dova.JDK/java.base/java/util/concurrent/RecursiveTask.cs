...
[JniSignatureAttribute("Ljava/util/concurrent/RecursiveTask;", "public abstract")]
	...
	: Dova.JDK.java.util.concurrent.ForkJoinTask
{
	...
	static RecursiveTask()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/util/concurrent/RecursiveTask;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "result", "Ljava/lang/Object;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "RecursiveTask", "()V"));
	...
	public RecursiveTask(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public RecursiveTask() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/util/concurrent/RecursiveTask;";
