...
[JniSignatureAttribute("Ljava/util/concurrent/CopyOnWriteArraySet;", "public")]
	...
	, Dova.JDK.java.io.Serializable
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/util/concurrent/CopyOnWriteArraySet;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "al", "Ljava/util/concurrent/CopyOnWriteArrayList;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CopyOnWriteArraySet", "()V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CopyOnWriteArraySet", "(Ljava/util/Collection;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "compareSets", "([Ljava/lang/Object;Ljava/util/Set;)I"));
	}
	...
	public Dova.JDK.java.util.concurrent.CopyOnWriteArrayList al_Property
	{
		get
		{
	...
	public CopyOnWriteArraySet(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public CopyOnWriteArraySet() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Ljava/util/Collection;)V", "public")]
	public CopyOnWriteArraySet(Dova.JDK.java.util.Collection arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/util/concurrent/CopyOnWriteArraySet;";
	...
	[JniSignatureAttribute("([Ljava/lang/Object;Ljava/util/Set;)I", "private static")]
	public static int compareSets(JavaArray<Dova.JDK.java.lang.Object> arg0, Dova.JDK.java.util.Set arg1)
	{
