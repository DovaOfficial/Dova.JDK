	...
	: Dova.JDK.java.util.concurrent.ForkJoinTask
{
	...
	static CountedCompleter()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "completer", "Ljava/util/concurrent/CountedCompleter;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "pending", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PENDING", "Ljava/lang/invoke/VarHandle;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "()V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/util/concurrent/CountedCompleter;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/util/concurrent/CountedCompleter;I)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "compute", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getRoot", "()Ljava/util/concurrent/CountedCompleter;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "weakCompareAndSetPendingCount", "(II)Z"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "tryComplete", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "firstComplete", "()Ljava/util/concurrent/CountedCompleter;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "helpComplete", "(I)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "onExceptionalCompletion", "(Ljava/lang/Throwable;Ljava/util/concurrent/CountedCompleter;)Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getCompleter", "()Ljava/util/concurrent/CountedCompleter;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getPendingCount", "()I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "setPendingCount", "(I)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addToPendingCount", "(I)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "compareAndSetPendingCount", "(II)Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "decrementPendingCountUnlessZero", "()I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "propagateCompletion", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "nextComplete", "()Ljava/util/concurrent/CountedCompleter;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "quietlyCompleteRoot", "()V"));
	...
	public CountedCompleter() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Ljava/util/concurrent/CountedCompleter;)V", "protected")]
	public CountedCompleter(Dova.JDK.java.util.concurrent.CountedCompleter arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/util/concurrent/CountedCompleter;I)V", "protected")]
	public CountedCompleter(Dova.JDK.java.util.concurrent.CountedCompleter arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[2], arg0, arg1))
	{
	}
