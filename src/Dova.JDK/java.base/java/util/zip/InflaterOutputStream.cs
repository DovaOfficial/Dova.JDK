	...
	: Dova.JDK.java.io.FilterOutputStream
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/util/zip/InflaterOutputStream;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "wbuf", "[B"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "InflaterOutputStream", "(Ljava/io/OutputStream;Ljava/util/zip/Inflater;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "InflaterOutputStream", "(Ljava/io/OutputStream;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "InflaterOutputStream", "(Ljava/io/OutputStream;Ljava/util/zip/Inflater;I)V"));
	...
	public InflaterOutputStream(Dova.JDK.java.io.OutputStream arg0, Dova.JDK.java.util.zip.Inflater arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Ljava/io/OutputStream;)V", "public")]
	public InflaterOutputStream(Dova.JDK.java.io.OutputStream arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/io/OutputStream;Ljava/util/zip/Inflater;I)V", "public")]
	public InflaterOutputStream(Dova.JDK.java.io.OutputStream arg0, Dova.JDK.java.util.zip.Inflater arg1, int arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[2], arg0, arg1, arg2))
	{
	}
