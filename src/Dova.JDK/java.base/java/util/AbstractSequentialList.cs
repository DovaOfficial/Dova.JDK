	...
	: Dova.JDK.java.util.AbstractList
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/util/AbstractSequentialList;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AbstractSequentialList", "()V"));
	...
	public AbstractSequentialList() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
