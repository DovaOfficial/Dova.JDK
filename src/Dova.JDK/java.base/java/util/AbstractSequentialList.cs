	...
	: Dova.JDK.java.util.AbstractList
{
	...
	static AbstractSequentialList()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AbstractSequentialList", "()V"));
	...
	public AbstractSequentialList() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
