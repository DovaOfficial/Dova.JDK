	...
	: Dova.JDK.java.lang.CharacterData
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/lang/CharacterDataUndefined;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "instance", "Ljava/lang/CharacterData;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CharacterDataUndefined", "()V"));
	...
	public CharacterDataUndefined() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
