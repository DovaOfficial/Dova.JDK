	...
	: Dova.JDK.java.lang.CharacterData
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/lang/CharacterData03;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CharacterData03", "()V"));
	...
	public CharacterData03() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
