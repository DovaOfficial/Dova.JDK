	...
	: Dova.JDK.java.lang.invoke.VarHandleByteArrayBase
{
	...
	public VarHandleByteArrayAsDoubles() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.invoke.VarHandleByteArrayAsDoubles.ByteArrayViewVarHandle
	{
		...
		static ByteBufferHandle()
		{
			...
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "withInvokeExactBehavior_0", "()Ljava/lang/invoke/VarHandleByteArrayAsDoubles$ByteBufferHandle;"));
			...
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "withInvokeBehavior_1", "()Ljava/lang/invoke/VarHandleByteArrayAsDoubles$ByteBufferHandle;"));
		...
		: Dova.JDK.java.lang.invoke.VarHandleByteArrayAsDoubles.ByteArrayViewVarHandle
	{
		...
		static ArrayHandle()
		{
			...
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "withInvokeExactBehavior_1", "()Ljava/lang/invoke/VarHandleByteArrayAsDoubles$ArrayHandle;"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "withInvokeBehavior_0", "()Ljava/lang/invoke/VarHandle;"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "withInvokeBehavior_1", "()Ljava/lang/invoke/VarHandleByteArrayAsDoubles$ArrayHandle;"));
