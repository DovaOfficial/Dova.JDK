	...
	: Dova.JDK.java.lang.CharacterData
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/lang/CharacterData0E;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CharacterData0E", "()V"));
	...
	public CharacterData0E() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
