	...
	, Dova.JDK.java.lang.constant.MethodHandleDesc
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/lang/constant/AsTypeMethodHandleDesc;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "underlying", "Ljava/lang/constant/MethodHandleDesc;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "type", "Ljava/lang/constant/MethodTypeDesc;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AsTypeMethodHandleDesc", "(Ljava/lang/constant/MethodHandleDesc;Ljava/lang/constant/MethodTypeDesc;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "resolveConstantDesc_1", "(Ljava/lang/invoke/MethodHandles$Lookup;)Ljava/lang/invoke/MethodHandle;"));
	...
	public AsTypeMethodHandleDesc(Dova.JDK.java.lang.constant.MethodHandleDesc arg0, Dova.JDK.java.lang.constant.MethodTypeDesc arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
