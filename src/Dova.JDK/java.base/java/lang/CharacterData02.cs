	...
	: Dova.JDK.java.lang.CharacterData
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljava/lang/CharacterData02;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CharacterData02", "()V"));
	...
	public CharacterData02() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
