	...
	: Dova.JDK.java.lang.Object
{
	...
	static Math()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "negativeZeroFloatBits", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "negativeZeroDoubleBits", "J"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "twoToTheDoubleScaleUp", "D"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "twoToTheDoubleScaleDown", "D"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "powerOfTwoD", "(I)D"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "powerOfTwoF", "(I)F"));
	...
	public Math() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
