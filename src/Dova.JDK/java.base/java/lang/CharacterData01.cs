	...
	: Dova.JDK.java.lang.CharacterData
{
	...
	static CharacterData01()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CharacterData01", "()V"));
	...
	public CharacterData01() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
