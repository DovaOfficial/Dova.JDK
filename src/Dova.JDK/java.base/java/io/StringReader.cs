	...
	: Dova.JDK.java.io.Reader
{
	...
	static StringReader()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/io/StringReader;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "StringReader", "(Ljava/lang/String;)V"));
	...
	public StringReader(Dova.JDK.java.lang.String arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
