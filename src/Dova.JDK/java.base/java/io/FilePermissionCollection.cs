	...
	, Dova.JDK.java.io.Serializable
{
	...
	static FilePermissionCollection()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FilePermissionCollection", "()V"));
	...
	public FilePermissionCollection() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
