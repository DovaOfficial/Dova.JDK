...
[JniSignatureAttribute("Ljava/io/FilePermissionCollection;", "final")]
public partial class FilePermissionCollection
	...
	, Dova.JDK.java.io.Serializable
{
	...
	static FilePermissionCollection()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/io/FilePermissionCollection;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FilePermissionCollection", "()V"));
	...
	public FilePermissionCollection(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public FilePermissionCollection() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljava/io/FilePermissionCollection;";
