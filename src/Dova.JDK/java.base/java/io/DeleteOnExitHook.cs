	...
	: Dova.JDK.java.lang.Object
{
	...
	static DeleteOnExitHook()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "files", "Ljava/util/LinkedHashSet;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DeleteOnExitHook", "()V"));
	...
	public DeleteOnExitHook() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
