	...
	: Dova.JDK.java.io.OutputStream
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/io/FilterOutputStream;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "FilterOutputStream", "(Ljava/io/OutputStream;)V"));
	...
	public FilterOutputStream(Dova.JDK.java.io.OutputStream arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
