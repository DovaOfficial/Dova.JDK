...
[JniSignatureAttribute("Ljava/io/ObjectInput;", "public abstract interface")]
public partial interface ObjectInput
	: IJavaObject
	...
	, Dova.JDK.java.lang.AutoCloseable
{
	...
	static ObjectInput()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljava/io/ObjectInput;");
