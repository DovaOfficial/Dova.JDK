	...
	: Dova.JDK.sun.util.calendar.BaseCalendar.Date
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/util/calendar/ImmutableGregorianDate;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "date", "Lsun/util/calendar/BaseCalendar$Date;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ImmutableGregorianDate", "(Lsun/util/calendar/BaseCalendar$Date;)V"));
	...
	public ImmutableGregorianDate(Dova.JDK.sun.util.calendar.BaseCalendar.Date arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
