...
[JniSignatureAttribute("Lsun/util/locale/provider/DecimalFormatSymbolsProviderImpl;", "public")]
	...
	, Dova.JDK.sun.util.locale.provider.AvailableLanguageTags
{
	...
	static DecimalFormatSymbolsProviderImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/util/locale/provider/DecimalFormatSymbolsProviderImpl;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DecimalFormatSymbolsProviderImpl", "(Lsun/util/locale/provider/LocaleProviderAdapter$Type;Ljava/util/Set;)V"));
	...
	public DecimalFormatSymbolsProviderImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lsun/util/locale/provider/LocaleProviderAdapter$Type;Ljava/util/Set;)V", "public")]
	public DecimalFormatSymbolsProviderImpl(Dova.JDK.sun.util.locale.provider.LocaleProviderAdapter.Type arg0, Dova.JDK.java.util.Set arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/util/locale/provider/DecimalFormatSymbolsProviderImpl;";
