	...
	, Dova.JDK.sun.security.x509.CertAttrSet
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/x509/AuthorityKeyIdentifierExtension;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "AUTH_NAME", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SERIAL_NUMBER", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TAG_ID", "B"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TAG_NAMES", "B"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TAG_SERIAL_NUM", "B"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "id", "Lsun/security/x509/KeyIdentifier;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "names", "Lsun/security/x509/GeneralNames;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "serialNum", "Lsun/security/x509/SerialNumber;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AuthorityKeyIdentifierExtension", "(Ljava/lang/Boolean;Ljava/lang/Object;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AuthorityKeyIdentifierExtension", "(Lsun/security/x509/KeyIdentifier;Lsun/security/x509/GeneralNames;Lsun/security/x509/SerialNumber;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getEncodedKeyIdentifier", "()[B"));
	}
	...
	[JniSignatureAttribute("Ljava/lang/String;", "public static final")]
	public static Dova.JDK.java.lang.String AUTH_NAME_Property
	{
		get
		{
	...
	public static byte TAG_ID_Property
	{
		get
		{
	...
	[JniSignatureAttribute("B", "private static final")]
	public static byte TAG_NAMES_Property
	{
		get
		{
	...
	[JniSignatureAttribute("B", "private static final")]
	public static byte TAG_SERIAL_NUM_Property
	{
		get
		{
	...
	public Dova.JDK.sun.security.x509.KeyIdentifier id_Property
	{
		get
		{
	...
	public Dova.JDK.sun.security.x509.SerialNumber serialNum_Property
	{
		get
		{
	...
	public AuthorityKeyIdentifierExtension(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/Boolean;Ljava/lang/Object;)V", "public")]
	public AuthorityKeyIdentifierExtension(Dova.JDK.java.lang.Boolean arg0, Dova.JDK.java.lang.Object arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Lsun/security/x509/KeyIdentifier;Lsun/security/x509/GeneralNames;Lsun/security/x509/SerialNumber;)V", "public")]
	public AuthorityKeyIdentifierExtension(Dova.JDK.sun.security.x509.KeyIdentifier arg0, Dova.JDK.sun.security.x509.GeneralNames arg1, Dova.JDK.sun.security.x509.SerialNumber arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1, arg2))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/x509/AuthorityKeyIdentifierExtension;";
	...
	public JavaArray<byte> getEncodedKeyIdentifier()
	{
