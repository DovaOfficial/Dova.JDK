...
[JniSignatureAttribute("Lsun/security/x509/CertAttrSet;", "public abstract interface")]
public partial interface CertAttrSet
	: IJavaObject
{
	...
	static CertAttrSet()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/x509/CertAttrSet;");
	...
	void set(Dova.JDK.java.lang.String arg0, Dova.JDK.java.lang.Object arg1)
	{
	...
	Dova.JDK.java.util.Enumeration getElements()
	{
