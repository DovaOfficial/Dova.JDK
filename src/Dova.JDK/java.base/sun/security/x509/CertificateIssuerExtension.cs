...
[JniSignatureAttribute("Lsun/security/x509/CertificateIssuerExtension;", "public")]
	...
	, Dova.JDK.sun.security.x509.CertAttrSet
{
	...
	static CertificateIssuerExtension()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/x509/CertificateIssuerExtension;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CertificateIssuerExtension", "(Ljava/lang/Boolean;Ljava/lang/Object;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CertificateIssuerExtension", "(Lsun/security/x509/GeneralNames;)V"));
	...
	public CertificateIssuerExtension(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Ljava/lang/Boolean;Ljava/lang/Object;)V", "public")]
	public CertificateIssuerExtension(Dova.JDK.java.lang.Boolean arg0, Dova.JDK.java.lang.Object arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Lsun/security/x509/GeneralNames;)V", "public")]
	public CertificateIssuerExtension(Dova.JDK.sun.security.x509.GeneralNames arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/x509/CertificateIssuerExtension;";
