	...
	, Dova.JDK.sun.security.x509.CertAttrSet
{
	...
	static SubjectAlternativeNameExtension()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SUBJECT_NAME", "Ljava/lang/String;"));
	...
	public SubjectAlternativeNameExtension(Dova.JDK.java.lang.Boolean arg0, Dova.JDK.java.lang.Object arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public SubjectAlternativeNameExtension() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1]))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/Boolean;Lsun/security/x509/GeneralNames;)V", "public")]
	public SubjectAlternativeNameExtension(Dova.JDK.java.lang.Boolean arg0, Dova.JDK.sun.security.x509.GeneralNames arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[2], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Lsun/security/x509/GeneralNames;)V", "public")]
	public SubjectAlternativeNameExtension(Dova.JDK.sun.security.x509.GeneralNames arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[3], arg0))
	{
	}
