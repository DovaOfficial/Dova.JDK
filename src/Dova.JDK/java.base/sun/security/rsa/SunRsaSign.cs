	...
	: Dova.JDK.java.security.Provider
{
	...
	static SunRsaSign()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/rsa/SunRsaSign;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "SunRsaSign", "()V"));
	...
	public SunRsaSign() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
