	...
	: Dova.JDK.java.security.AlgorithmParametersSpi
{
	...
	static PSSParameters()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "getEncoded", "(Ljava/security/spec/PSSParameterSpec;)[B"));
	...
	public PSSParameters() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
