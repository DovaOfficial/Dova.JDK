	...
	: Dova.JDK.java.security.Provider
{
	...
	static VerificationProvider()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "putEntries", "(Ljava/util/Iterator;)V"));
	}
	...
	public VerificationProvider() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
