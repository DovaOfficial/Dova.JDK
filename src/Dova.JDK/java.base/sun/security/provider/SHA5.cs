	...
	: Dova.JDK.sun.security.provider.DigestBase
{
	...
	static SHA5()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/provider/SHA5;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "ITERATION", "I"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "ROUND_CONSTS", "[J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "W", "[J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "state", "[J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "initialHashes", "[J"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SHA5", "(Ljava/lang/String;I[J)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "lf_S", "(JI)J"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "lf_R", "(JI)J"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "lf_delta1", "(J)J"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "lf_delta0", "(J)J"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "lf_sigma1", "(J)J"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "lf_ch", "(JJJ)J"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "lf_sigma0", "(J)J"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "lf_maj", "(JJJ)J"));
	}
	...
	public SHA5(Dova.JDK.java.lang.String arg0, int arg1, JavaArray<long> arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}
		...
		: Dova.JDK.sun.security.provider.SHA5
	{
		...
		static SHA512_256()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/provider/SHA5$SHA512_256;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "INITIAL_HASHES", "[J"));
		...
		: Dova.JDK.sun.security.provider.SHA5
	{
		...
		static SHA512_224()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/provider/SHA5$SHA512_224;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "INITIAL_HASHES", "[J"));
		...
		: Dova.JDK.sun.security.provider.SHA5
	{
		...
		static SHA384()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/provider/SHA5$SHA384;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "INITIAL_HASHES", "[J"));
		...
		: Dova.JDK.sun.security.provider.SHA5
	{
		...
		static SHA512()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/provider/SHA5$SHA512;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "INITIAL_HASHES", "[J"));
