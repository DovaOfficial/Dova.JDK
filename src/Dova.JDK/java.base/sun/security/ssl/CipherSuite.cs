	...
	: Dova.JDK.java.lang.Enum
{
	...
	static CipherSuite()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/ssl/CipherSuite;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_AES_256_GCM_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_AES_128_GCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_CHACHA20_POLY1305_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_RSA_WITH_AES_256_GCM_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_DSS_WITH_AES_256_GCM_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_RSA_WITH_AES_128_GCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_DSS_WITH_AES_128_GCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_DSS_WITH_AES_128_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_RSA_WITH_AES_256_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_DSS_WITH_AES_256_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_RSA_WITH_AES_128_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DHE_DSS_WITH_AES_128_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_RSA_WITH_AES_256_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_RSA_WITH_AES_128_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_RSA_WITH_AES_256_GCM_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_RSA_WITH_AES_128_GCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_RSA_WITH_AES_256_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_RSA_WITH_AES_128_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_RSA_WITH_AES_256_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_RSA_WITH_AES_128_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DHE_RSA_WITH_3DES_EDE_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DHE_DSS_WITH_3DES_EDE_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_RSA_WITH_3DES_EDE_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_EMPTY_RENEGOTIATION_INFO_SCSV", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DH_anon_WITH_AES_256_GCM_SHA384", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DH_anon_WITH_AES_128_GCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DH_anon_WITH_AES_256_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_anon_WITH_AES_256_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DH_anon_WITH_AES_256_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DH_anon_WITH_AES_128_CBC_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_anon_WITH_AES_128_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_DH_anon_WITH_AES_128_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DH_anon_WITH_3DES_EDE_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_RC4_128_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_RC4_128_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_RSA_WITH_RC4_128_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_ECDSA_WITH_RC4_128_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_RSA_WITH_RC4_128_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_RSA_WITH_RC4_128_MD5", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_anon_WITH_RC4_128_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DH_anon_WITH_RC4_128_MD5", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_RSA_WITH_DES_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DHE_RSA_WITH_DES_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DHE_DSS_WITH_DES_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DH_anon_WITH_DES_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_RSA_EXPORT_WITH_DES40_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DH_anon_EXPORT_WITH_DES40_CBC_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_RSA_EXPORT_WITH_RC4_40_MD5", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_DH_anon_EXPORT_WITH_RC4_40_MD5", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_RSA_WITH_NULL_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_ECDSA_WITH_NULL_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDHE_RSA_WITH_NULL_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_RSA_WITH_NULL_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_ECDSA_WITH_NULL_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_RSA_WITH_NULL_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_ECDH_anon_WITH_NULL_SHA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "SSL_RSA_WITH_NULL_MD5", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_AES_128_CCM_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "TLS_AES_128_CCM_8_SHA256", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0006", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0007", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_000B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_000C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_000D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_000E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_000F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0010", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_001C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_001D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0062", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0063", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0064", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0065", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0066", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_FFE0", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_FFE1", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_FEFE", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_FEFF", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_001E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_001F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0020", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0021", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0022", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0023", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0024", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0025", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0026", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0027", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0028", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0029", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_002A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_002B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0096", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0097", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0098", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0099", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_009A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_009B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_008A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_008B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_008C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_008D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_008E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_008F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0090", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0091", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0092", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0093", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0094", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0095", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_002C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_002D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_002E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0030", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0031", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0036", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0037", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_003E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_003F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0068", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0069", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00A0", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00A1", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00A4", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00A5", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00A8", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00A9", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00AA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00AB", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00AC", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00AD", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00AE", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00AF", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B0", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B1", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B2", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B3", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B4", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B5", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B6", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B7", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B8", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00B9", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0041", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0042", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0043", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0044", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0045", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0046", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0084", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0085", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0086", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0087", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0088", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_0089", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00BA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00BB", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00BC", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00BD", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00BE", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00BF", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00C0", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00C1", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00C2", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00C3", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00C4", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_00C5", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_5600", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C01A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C01B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C01C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C01D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C01E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C01F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C020", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C021", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C022", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C033", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C034", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C035", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C036", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C037", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C038", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C039", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C03A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C03B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C03C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C03D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C03E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C03F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C040", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C041", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C042", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C043", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C044", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C045", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C046", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C047", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C048", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C049", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C04A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C04B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C04C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C04D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C04E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C04F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C050", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C051", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C052", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C053", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C054", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C055", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C056", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C057", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C058", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C059", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C05A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C05B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C05C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C05D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C05E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C05F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C060", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C061", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C062", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C063", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C064", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C065", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C066", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C067", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C068", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C069", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C06A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C06B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C06C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C06D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C06E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C06F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C070", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C071", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C072", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C073", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C074", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C075", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C076", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C077", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C078", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C079", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C07A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C07B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C07C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C07D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C07E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C07F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C080", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C081", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C082", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C083", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C084", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C085", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C086", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C087", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C088", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C089", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C08A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C08B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C08C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C08D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C08E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C08F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C090", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C091", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C092", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C093", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C094", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C095", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C096", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C097", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C098", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C099", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C09A", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C09B", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C09C", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C09D", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C09E", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C09F", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A0", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A1", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A2", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A3", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A4", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A5", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A6", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A7", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A8", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0A9", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0AA", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0AB", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0AC", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0AD", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0AE", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "CS_C0AF", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "C_NULL", "Lsun/security/ssl/CipherSuite;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "id", "I"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "isDefaultEnabled", "Z"));
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "keyExchange", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "bulkCipher", "Lsun/security/ssl/SSLCipher;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "macAlg", "Lsun/security/ssl/CipherSuite$MacAlg;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "hashAlg", "Lsun/security/ssl/CipherSuite$HashAlg;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "exportable", "Z"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "cipherSuiteIds", "Ljava/util/Map;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "cipherSuiteNames", "Ljava/util/Map;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "allowedCipherSuites", "Ljava/util/List;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "defaultCipherSuites", "Ljava/util/List;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "$VALUES", "[Lsun/security/ssl/CipherSuite;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CipherSuite", "(Ljava/lang/String;IIZLjava/lang/String;[Lsun/security/ssl/ProtocolVersion;Lsun/security/ssl/SSLCipher;Lsun/security/ssl/CipherSuite$HashAlg;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CipherSuite", "(Ljava/lang/String;IIZLjava/lang/String;Ljava/lang/String;[Lsun/security/ssl/ProtocolVersion;Lsun/security/ssl/CipherSuite$KeyExchange;Lsun/security/ssl/SSLCipher;Lsun/security/ssl/CipherSuite$MacAlg;Lsun/security/ssl/CipherSuite$HashAlg;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "CipherSuite", "(Ljava/lang/String;ILjava/lang/String;I)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "values", "()[Lsun/security/ssl/CipherSuite;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "valueOf", "(Ljava/lang/String;)Lsun/security/ssl/CipherSuite;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "valueOf", "(I)Lsun/security/ssl/CipherSuite;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "$values", "()[Lsun/security/ssl/CipherSuite;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "nameOf", "(Ljava/lang/String;)Lsun/security/ssl/CipherSuite;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "nameOf", "(I)Ljava/lang/String;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isNegotiable", "()Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "namesOf", "(Ljava/util/List;)[Ljava/lang/String;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "supports", "(Lsun/security/ssl/ProtocolVersion;)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isAnonymous", "()Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "allowedCipherSuites", "()Ljava/util/Collection;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "defaultCipherSuites", "()Ljava/util/Collection;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "validValuesOf", "([Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "calculatePacketSize", "(ILsun/security/ssl/ProtocolVersion;Z)I"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "calculateFragSize", "(ILsun/security/ssl/ProtocolVersion;Z)I"));
	...
	public int id_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetIntField(CurrentRefPtr, FieldPtrs[338]);
			return ret;
		}
		set => DovaJvm.Vm.Runtime.SetIntField(CurrentRefPtr, FieldPtrs[338], value);
	}
	...
	public bool isDefaultEnabled_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetBooleanField(CurrentRefPtr, FieldPtrs[339]);
			return ret;
		}
		set => DovaJvm.Vm.Runtime.SetBooleanField(CurrentRefPtr, FieldPtrs[339], value);
	}
	...
	public Dova.JDK.java.lang.String name_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[340]);
			return DovaInterfaceFactory.Get<Dova.JDK.java.lang.String>(ret);
		}
		set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[340], value.CurrentRefPtr);
	}
	...
	public Dova.JDK.java.util.List aliases_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[341]);
			return DovaInterfaceFactory.Get<Dova.JDK.java.util.List>(ret);
		}
		set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[341], value.CurrentRefPtr);
	}
	...
	public Dova.JDK.java.util.List supportedProtocols_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[342]);
			return DovaInterfaceFactory.Get<Dova.JDK.java.util.List>(ret);
		}
		set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[342], value.CurrentRefPtr);
	}
	...
	public Dova.JDK.sun.security.ssl.CipherSuite.KeyExchange keyExchange_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[343]);
			return DovaInterfaceFactory.Get<Dova.JDK.sun.security.ssl.CipherSuite.KeyExchange>(ret);
		}
		set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[343], value.CurrentRefPtr);
	}
	...
	public Dova.JDK.sun.security.ssl.SSLCipher bulkCipher_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[344]);
			return DovaInterfaceFactory.Get<Dova.JDK.sun.security.ssl.SSLCipher>(ret);
		}
		set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[344], value.CurrentRefPtr);
	}
	...
	public Dova.JDK.sun.security.ssl.CipherSuite.MacAlg macAlg_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[345]);
			return DovaInterfaceFactory.Get<Dova.JDK.sun.security.ssl.CipherSuite.MacAlg>(ret);
		}
		set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[345], value.CurrentRefPtr);
	}
	...
	public Dova.JDK.sun.security.ssl.CipherSuite.HashAlg hashAlg_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[346]);
			return DovaInterfaceFactory.Get<Dova.JDK.sun.security.ssl.CipherSuite.HashAlg>(ret);
		}
		set => DovaJvm.Vm.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[346], value.CurrentRefPtr);
	}
	...
	public bool exportable_Property
	{
		get
		{
			var ret = DovaJvm.Vm.Runtime.GetBooleanField(CurrentRefPtr, FieldPtrs[347]);
			return ret;
		}
		set => DovaJvm.Vm.Runtime.SetBooleanField(CurrentRefPtr, FieldPtrs[347], value);
	}
	...
	public CipherSuite(Dova.JDK.java.lang.String arg0, int arg1, int arg2, bool arg3, Dova.JDK.java.lang.String arg4, JavaArray<Dova.JDK.sun.security.ssl.ProtocolVersion> arg5, Dova.JDK.sun.security.ssl.SSLCipher arg6, Dova.JDK.sun.security.ssl.CipherSuite.HashAlg arg7) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7))
	{
	}
	...
	public CipherSuite(Dova.JDK.java.lang.String arg0, int arg1, int arg2, bool arg3, Dova.JDK.java.lang.String arg4, Dova.JDK.java.lang.String arg5, JavaArray<Dova.JDK.sun.security.ssl.ProtocolVersion> arg6, Dova.JDK.sun.security.ssl.CipherSuite.KeyExchange arg7, Dova.JDK.sun.security.ssl.SSLCipher arg8, Dova.JDK.sun.security.ssl.CipherSuite.MacAlg arg9, Dova.JDK.sun.security.ssl.CipherSuite.HashAlg arg10) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;ILjava/lang/String;I)V", "private")]
	public CipherSuite(Dova.JDK.java.lang.String arg0, int arg1, Dova.JDK.java.lang.String arg2, int arg3) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[2], arg0, arg1, arg2, arg3))
	{
	}
		...
		: Dova.JDK.java.lang.Enum
	{
		...
		static KeyExchange()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/ssl/CipherSuite$KeyExchange;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_NULL", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_RSA", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_RSA_EXPORT", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_DH_RSA", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_DH_DSS", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_DHE_DSS", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_DHE_DSS_EXPORT", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_DHE_RSA", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_DHE_RSA_EXPORT", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_DH_ANON", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_DH_ANON_EXPORT", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_ECDH_ECDSA", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_ECDH_RSA", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_ECDHE_ECDSA", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_ECDHE_RSA", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_ECDH_ANON", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "K_SCSV", "Lsun/security/ssl/CipherSuite$KeyExchange;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "name", "Ljava/lang/String;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "allowed", "Z"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "groupTypes", "[Lsun/security/ssl/NamedGroup$NamedGroupSpec;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "alwaysAvailable", "Z"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "isAnonymous", "Z"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "$VALUES", "[Lsun/security/ssl/CipherSuite$KeyExchange;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "KeyExchange", "(Ljava/lang/String;ILjava/lang/String;ZZ[Lsun/security/ssl/NamedGroup$NamedGroupSpec;)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "toString", "()Ljava/lang/String;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "values", "()[Lsun/security/ssl/CipherSuite$KeyExchange;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "valueOf", "(Ljava/lang/String;)Lsun/security/ssl/CipherSuite$KeyExchange;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "$values", "()[Lsun/security/ssl/CipherSuite$KeyExchange;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isAvailable", "()Z"));
		}
		...
		public KeyExchange(Dova.JDK.java.lang.String arg0, int arg1, Dova.JDK.java.lang.String arg2, bool arg3, bool arg4, JavaArray<Dova.JDK.sun.security.ssl.NamedGroup.NamedGroupSpec> arg5) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4, arg5))
		{
		}
		...
		: Dova.JDK.java.lang.Enum
	{
		...
		static MacAlg()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/ssl/CipherSuite$MacAlg;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "M_NULL", "Lsun/security/ssl/CipherSuite$MacAlg;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "M_MD5", "Lsun/security/ssl/CipherSuite$MacAlg;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "M_SHA", "Lsun/security/ssl/CipherSuite$MacAlg;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "M_SHA256", "Lsun/security/ssl/CipherSuite$MacAlg;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "M_SHA384", "Lsun/security/ssl/CipherSuite$MacAlg;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "name", "Ljava/lang/String;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "size", "I"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "hashBlockSize", "I"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "minimalPaddingSize", "I"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "$VALUES", "[Lsun/security/ssl/CipherSuite$MacAlg;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "MacAlg", "(Ljava/lang/String;ILjava/lang/String;III)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "toString", "()Ljava/lang/String;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "values", "()[Lsun/security/ssl/CipherSuite$MacAlg;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "valueOf", "(Ljava/lang/String;)Lsun/security/ssl/CipherSuite$MacAlg;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "$values", "()[Lsun/security/ssl/CipherSuite$MacAlg;"));
		}
		...
		public MacAlg(Dova.JDK.java.lang.String arg0, int arg1, Dova.JDK.java.lang.String arg2, int arg3, int arg4, int arg5) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4, arg5))
		{
		}
		...
		: Dova.JDK.java.lang.Enum
	{
		...
		static HashAlg()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/ssl/CipherSuite$HashAlg;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "H_NONE", "Lsun/security/ssl/CipherSuite$HashAlg;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "H_SHA256", "Lsun/security/ssl/CipherSuite$HashAlg;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "H_SHA384", "Lsun/security/ssl/CipherSuite$HashAlg;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "name", "Ljava/lang/String;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "hashLength", "I"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "blockSize", "I"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "$VALUES", "[Lsun/security/ssl/CipherSuite$HashAlg;"));
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "HashAlg", "(Ljava/lang/String;ILjava/lang/String;II)V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "toString", "()Ljava/lang/String;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "values", "()[Lsun/security/ssl/CipherSuite$HashAlg;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "valueOf", "(Ljava/lang/String;)Lsun/security/ssl/CipherSuite$HashAlg;"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "$values", "()[Lsun/security/ssl/CipherSuite$HashAlg;"));
		}
		...
		public HashAlg(Dova.JDK.java.lang.String arg0, int arg1, Dova.JDK.java.lang.String arg2, int arg3, int arg4) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4))
		{
		}
