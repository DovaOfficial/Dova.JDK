	...
	: Dova.JDK.javax.net.ssl.X509ExtendedKeyManager
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/ssl/AbstractKeyManagerWrapper;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "km", "Ljavax/net/ssl/X509KeyManager;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AbstractKeyManagerWrapper", "(Ljavax/net/ssl/X509KeyManager;)V"));
	...
	public AbstractKeyManagerWrapper(Dova.JDK.javax.net.ssl.X509KeyManager arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
