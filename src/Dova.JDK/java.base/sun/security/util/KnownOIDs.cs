	...
	: Dova.JDK.java.lang.Enum
{
	...
	static KnownOIDs()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CommonName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "Surname", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SerialNumber", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CountryName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "LocalityName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "StateName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "StreetAddress", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OrgName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OrgUnitName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "Title", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "GivenName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "Initials", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "GenerationQualifier", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "DNQualifier", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SubjectDirectoryAttributes", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SubjectKeyID", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "KeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PrivateKeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SubjectAlternativeName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "IssuerAlternativeName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "BasicConstraints", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CRLNumber", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ReasonCode", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HoldInstructionCode", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "InvalidityDate", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "DeltaCRLIndicator", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "IssuingDistributionPoint", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CertificateIssuer", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "NameConstraints", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CRLDistributionPoints", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CertificatePolicies", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CE_CERT_POLICIES_ANY", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PolicyMappings", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AuthorityKeyID", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PolicyConstraints", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "extendedKeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "anyExtendedKeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "FreshestCRL", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "InhibitAnyPolicy", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AuthInfoAccess", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SubjectInfoAccess", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "serverAuth", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "clientAuth", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "codeSigning", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "emailProtection", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ipsecEndSystem", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ipsecTunnel", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ipsecUser", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "KP_TimeStamping", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OCSPSigning", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OCSP", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OCSPBasicResponse", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OCSPNonceExt", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OCSPNoCheck", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "caIssuers", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AD_TimeStamping", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "caRepository", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_128$ECB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_128$CBC$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_128$OFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_128$CFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_128$KW$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_128$GCM$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_128$KWP$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_192$ECB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_192$CBC$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_192$OFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_192$CFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_192$KW$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_192$GCM$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_192$KWP$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_256$ECB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_256$CBC$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_256$OFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_256$CFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_256$KW$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_256$GCM$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "AES_256$KWP$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA_256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA_384", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA_512", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA_224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA_512$224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA_512$256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_384", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_512", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHAKE128", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHAKE256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA3_224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA3_256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA3_384", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA3_512", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHAKE128_LEN", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHAKE256_LEN", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA224withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA256withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA384withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA512withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_224withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_256withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_384withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_512withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_224withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_256withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_384withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_512withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_224withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_256withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_384withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA3_512withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PKCS1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "RSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "MD2withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "MD5withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA1withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OAEP", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "MGF1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PSpecified", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "RSASSA_PSS", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA256withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA384withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA512withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA224withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA512$224withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA512$256withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "DiffieHellman", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBEWithMD5AndDES", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBEWithMD5AndRC2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBEWithSHA1AndDES", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBEWithSHA1AndRC2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBKDF2WithHmacSHA1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBES2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PKCS7", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "Data", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SignedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "JDK_OLD_Data", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "JDK_OLD_SignedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "EnvelopedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SignedAndEnvelopedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "DigestedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "EncryptedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "EmailAddress", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "UnstructuredName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ContentType", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "MessageDigest", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SigningTime", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CounterSignature", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ChallengePassword", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "UnstructuredAddress", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ExtendedCertificateAttributes", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "IssuerAndSerialNumber", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ExtensionRequest", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SMIMECapability", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TimeStampTokenInfo", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SigningCertificate", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SignatureTimestampToken", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CHACHA20_POLY1305", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "FriendlyName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "LocalKeyID", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CertTypeX509", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CMSAlgorithmProtection", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBEWithSHA1AndRC4_128", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBEWithSHA1AndRC4_40", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBEWithSHA1AndDESede", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBEWithSHA1AndRC2_128", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PBEWithSHA1AndRC2_40", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "PKCS8ShroudedKeyBag", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CertBag", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SecretBag", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "MD2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "MD5", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA384", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA512", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA512$224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "HmacSHA512$256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "RC2$CBC$PKCS5Padding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ARCFOUR", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "DESede$CBC$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "RC5$CBC$PKCS5Padding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "DSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA1withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "EC", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "c2tnb191v1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "c2tnb191v2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "c2tnb191v3", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "c2tnb239v1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "c2tnb239v2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "c2tnb239v3", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "c2tnb359v1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "c2tnb431r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp192r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "prime192v2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "prime192v3", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "prime239v1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "prime239v2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "prime239v3", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp256r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA1withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA224withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA256withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA384withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA512withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SpecifiedSHA2withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "X942_DH", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "brainpoolP160r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "brainpoolP192r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "brainpoolP224r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "brainpoolP256r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "brainpoolP320r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "brainpoolP384r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "brainpoolP512r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect163k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect163r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect239k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect113r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect113r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp112r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp112r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp160r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp160k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp256k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect163r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect283k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect283r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect131r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect131r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect193r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect193r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect233k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect233r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp128r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp128r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp160r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp192k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp224k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp224r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp384r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "secp521r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect409k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect409r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect571k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "sect571r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ECDH", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OIW_DES_CBC", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OIW_DSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OIW_JDK_SHA1withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OIW_SHA1withRSA_Odd", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "DESede", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SHA_1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OIW_SHA1withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "OIW_SHA1withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "X25519", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "X448", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "Ed25519", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "Ed448", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "UCL_UserID", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "UCL_DomainComponent", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "NETSCAPE_CertType", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "NETSCAPE_CertSequence", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "NETSCAPE_ExportApproved", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ORACLE_TrustedKeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "ITUX509_RSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SkipIPAddress", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "JAVASOFT_JDKKeyProtector", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "JAVASOFT_JCEKeyProtector", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "MICROSOFT_ExportApproved", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "stdName", "Ljava/lang/String;"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "name2enum", "Ljava/util/concurrent/ConcurrentHashMap;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "$VALUES", "[Lsun/security/util/KnownOIDs;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "values", "()[Lsun/security/util/KnownOIDs;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "valueOf", "(Ljava/lang/String;)Lsun/security/util/KnownOIDs;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "register", "(Lsun/security/util/KnownOIDs;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "aliases", "()[Ljava/lang/String;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "$values", "()[Lsun/security/util/KnownOIDs;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "registerNames", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "findMatch", "(Ljava/lang/String;)Lsun/security/util/KnownOIDs;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "stdName", "()Ljava/lang/String;"));
	}
	...
	public KnownOIDs(Dova.JDK.java.lang.String arg0, int arg1, Dova.JDK.java.lang.String arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V", "private transient")]
	public KnownOIDs(Dova.JDK.java.lang.String arg0, int arg1, Dova.JDK.java.lang.String arg2, Dova.JDK.java.lang.String arg3, JavaArray<Dova.JDK.java.lang.String> arg4) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1, arg2, arg3, arg4))
	{
	}
