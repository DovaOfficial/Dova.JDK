	...
	: Dova.JDK.java.lang.Enum
{
	...
	static KnownOIDs()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/util/KnownOIDs;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CommonName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "Surname", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SerialNumber", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CountryName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "LocalityName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "StateName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "StreetAddress", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OrgName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OrgUnitName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "Title", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "GivenName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "Initials", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "GenerationQualifier", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "DNQualifier", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SubjectDirectoryAttributes", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SubjectKeyID", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "KeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PrivateKeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SubjectAlternativeName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "IssuerAlternativeName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "BasicConstraints", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CRLNumber", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ReasonCode", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HoldInstructionCode", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "InvalidityDate", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "DeltaCRLIndicator", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "IssuingDistributionPoint", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CertificateIssuer", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "NameConstraints", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CRLDistributionPoints", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CertificatePolicies", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CE_CERT_POLICIES_ANY", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PolicyMappings", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AuthorityKeyID", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PolicyConstraints", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "extendedKeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "anyExtendedKeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "FreshestCRL", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "InhibitAnyPolicy", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AuthInfoAccess", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SubjectInfoAccess", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "serverAuth", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "clientAuth", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "codeSigning", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "emailProtection", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ipsecEndSystem", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ipsecTunnel", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ipsecUser", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "KP_TimeStamping", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OCSPSigning", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OCSP", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OCSPBasicResponse", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OCSPNonceExt", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OCSPNoCheck", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "caIssuers", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AD_TimeStamping", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "caRepository", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_128$ECB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_128$CBC$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_128$OFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_128$CFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_128$KW$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_128$GCM$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_128$KWP$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_192$ECB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_192$CBC$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_192$OFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_192$CFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_192$KW$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_192$GCM$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_192$KWP$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_256$ECB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_256$CBC$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_256$OFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_256$CFB$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_256$KW$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_256$GCM$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "AES_256$KWP$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA_256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA_384", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA_512", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA_224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA_512$224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA_512$256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_384", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_512", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHAKE128", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHAKE256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA3_224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA3_256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA3_384", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA3_512", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHAKE128_LEN", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHAKE256_LEN", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA224withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA256withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA384withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA512withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_224withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_256withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_384withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_512withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_224withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_256withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_384withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_512withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_224withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_256withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_384withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA3_512withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PKCS1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "RSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "MD2withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "MD5withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA1withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OAEP", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "MGF1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PSpecified", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "RSASSA_PSS", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA256withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA384withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA512withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA224withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA512$224withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA512$256withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "DiffieHellman", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBEWithMD5AndDES", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBEWithMD5AndRC2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBEWithSHA1AndDES", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBEWithSHA1AndRC2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBKDF2WithHmacSHA1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBES2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PKCS7", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "Data", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SignedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "JDK_OLD_Data", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "JDK_OLD_SignedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "EnvelopedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SignedAndEnvelopedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "DigestedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "EncryptedData", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "EmailAddress", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "UnstructuredName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ContentType", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "MessageDigest", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SigningTime", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CounterSignature", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ChallengePassword", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "UnstructuredAddress", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ExtendedCertificateAttributes", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "IssuerAndSerialNumber", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ExtensionRequest", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SMIMECapability", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "TimeStampTokenInfo", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SigningCertificate", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SignatureTimestampToken", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CHACHA20_POLY1305", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "FriendlyName", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "LocalKeyID", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CertTypeX509", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CMSAlgorithmProtection", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBEWithSHA1AndRC4_128", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBEWithSHA1AndRC4_40", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBEWithSHA1AndDESede", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBEWithSHA1AndRC2_128", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PBEWithSHA1AndRC2_40", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "PKCS8ShroudedKeyBag", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "CertBag", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SecretBag", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "MD2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "MD5", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA384", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA512", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA512$224", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "HmacSHA512$256", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "RC2$CBC$PKCS5Padding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ARCFOUR", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "DESede$CBC$NoPadding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "RC5$CBC$PKCS5Padding", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "DSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA1withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "EC", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "c2tnb191v1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "c2tnb191v2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "c2tnb191v3", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "c2tnb239v1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "c2tnb239v2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "c2tnb239v3", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "c2tnb359v1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "c2tnb431r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp192r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "prime192v2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "prime192v3", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "prime239v1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "prime239v2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "prime239v3", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp256r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA1withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA224withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA256withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA384withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA512withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SpecifiedSHA2withECDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "X942_DH", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "brainpoolP160r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "brainpoolP192r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "brainpoolP224r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "brainpoolP256r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "brainpoolP320r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "brainpoolP384r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "brainpoolP512r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect163k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect163r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect239k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect113r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect113r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp112r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp112r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp160r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp160k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp256k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect163r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect283k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect283r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect131r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect131r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect193r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect193r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect233k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect233r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp128r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp128r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp160r2", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp192k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp224k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp224r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp384r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "secp521r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect409k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect409r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect571k1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "sect571r1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ECDH", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OIW_DES_CBC", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OIW_DSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OIW_JDK_SHA1withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OIW_SHA1withRSA_Odd", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "DESede", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SHA_1", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OIW_SHA1withDSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "OIW_SHA1withRSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "X25519", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "X448", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "Ed25519", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "Ed448", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "UCL_UserID", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "UCL_DomainComponent", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "NETSCAPE_CertType", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "NETSCAPE_CertSequence", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "NETSCAPE_ExportApproved", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ORACLE_TrustedKeyUsage", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "ITUX509_RSA", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SkipIPAddress", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "JAVASOFT_JDKKeyProtector", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "JAVASOFT_JCEKeyProtector", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "MICROSOFT_ExportApproved", "Lsun/security/util/KnownOIDs;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "stdName", "Ljava/lang/String;"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "name2enum", "Ljava/util/concurrent/ConcurrentHashMap;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "$VALUES", "[Lsun/security/util/KnownOIDs;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "KnownOIDs", "(Ljava/lang/String;ILjava/lang/String;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "KnownOIDs", "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "value", "()Ljava/lang/String;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "values", "()[Lsun/security/util/KnownOIDs;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "valueOf", "(Ljava/lang/String;)Lsun/security/util/KnownOIDs;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "register", "(Lsun/security/util/KnownOIDs;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "aliases", "()[Ljava/lang/String;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "$values", "()[Lsun/security/util/KnownOIDs;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "registerNames", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "findMatch", "(Ljava/lang/String;)Lsun/security/util/KnownOIDs;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "stdName", "()Ljava/lang/String;"));
	}
	...
	public Dova.JDK.java.lang.String stdName_Property
	{
		get
		{
			var ret = DovaVM.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[272]);
			return DovaInterfaceFactory.Get<Dova.JDK.java.lang.String>(ret);
		}
		set => DovaVM.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[272], value.CurrentRefPtr);
	}
	...
	public Dova.JDK.java.lang.String oid_Property
	{
		get
		{
			var ret = DovaVM.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[273]);
			return DovaInterfaceFactory.Get<Dova.JDK.java.lang.String>(ret);
		}
		set => DovaVM.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[273], value.CurrentRefPtr);
	}
	...
	public JavaArray<Dova.JDK.java.lang.String> aliases_Property
	{
		get
		{
			var ret = DovaVM.Runtime.GetObjectField(CurrentRefPtr, FieldPtrs[274]);
			return DovaInterfaceFactory.Get<JavaArray<Dova.JDK.java.lang.String>>(ret);
		}
		set => DovaVM.Runtime.SetObjectField(CurrentRefPtr, FieldPtrs[274], value.CurrentRefPtr);
	}
	...
	public KnownOIDs(Dova.JDK.java.lang.String arg0, int arg1, Dova.JDK.java.lang.String arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V", "private transient")]
	public KnownOIDs(Dova.JDK.java.lang.String arg0, int arg1, Dova.JDK.java.lang.String arg2, Dova.JDK.java.lang.String arg3, JavaArray<Dova.JDK.java.lang.String> arg4) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1, arg2, arg3, arg4))
	{
	}
