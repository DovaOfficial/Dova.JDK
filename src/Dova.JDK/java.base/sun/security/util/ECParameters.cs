	...
	: Dova.JDK.java.security.AlgorithmParametersSpi
{
	...
	static ECParameters()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/util/ECParameters;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "namedCurve", "Lsun/security/util/NamedCurve;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ECParameters", "()V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getAlgorithmParameters", "(Ljava/security/spec/ECParameterSpec;)Ljava/security/AlgorithmParameters;"));
	...
	public ECParameters() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
