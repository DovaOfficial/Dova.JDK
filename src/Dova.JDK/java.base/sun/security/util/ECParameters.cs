	...
	: Dova.JDK.java.security.AlgorithmParametersSpi
{
	...
	static ECParameters()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "namedCurve", "Lsun/security/util/NamedCurve;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ECParameters", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "getAlgorithmParameters", "(Ljava/security/spec/ECParameterSpec;)Ljava/security/AlgorithmParameters;"));
	...
	public ECParameters() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
