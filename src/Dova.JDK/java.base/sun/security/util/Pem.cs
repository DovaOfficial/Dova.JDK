	...
	: Dova.JDK.java.lang.Object
{
	...
	static Pem()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/util/Pem;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Pem", "()V"));
	...
	public Pem() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
