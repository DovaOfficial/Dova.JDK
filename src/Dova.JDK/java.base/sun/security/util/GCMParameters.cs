...
[JniSignatureAttribute("Lsun/security/util/GCMParameters;", "public final")]
	...
	: Dova.JDK.java.security.AlgorithmParametersSpi
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/util/GCMParameters;");
	...
	public override string GetJavaClassSignature() => "Lsun/security/util/GCMParameters;";
