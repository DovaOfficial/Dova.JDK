	...
	: Dova.JDK.sun.security.util.math.intpoly.IntegerPolynomial
{
	...
	static IntegerPolynomialP384()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "IntegerPolynomialP384", "()V"));
	...
	public IntegerPolynomialP384() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
