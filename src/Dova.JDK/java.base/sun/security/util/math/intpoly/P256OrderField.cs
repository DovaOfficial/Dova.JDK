	...
	: Dova.JDK.sun.security.util.math.intpoly.IntegerPolynomial
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/util/math/intpoly/P256OrderField;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "P256OrderField", "()V"));
	...
	public P256OrderField() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
