	...
	: Dova.JDK.sun.security.util.math.intpoly.IntegerPolynomial
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/util/math/intpoly/IntegerPolynomialModBinP;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "reduceLimbs", "[J"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "bitOffset", "I"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "limbMask", "I"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "rightBitOffset", "I"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "power", "I"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "IntegerPolynomialModBinP", "(IIILjava/math/BigInteger;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "modReduceInBits", "([JIIJ)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "multOnly", "([J[J[J)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "carryReduce", "([J[J)V"));
	...
	public IntegerPolynomialModBinP(int arg0, int arg1, int arg2, Dova.JDK.java.math.BigInteger arg3) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3))
	{
	}
		...
		: Dova.JDK.sun.security.util.math.intpoly.IntegerPolynomialModBinP
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/util/math/intpoly/IntegerPolynomialModBinP$Curve448OrderField;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Curve448OrderField", "()V"));
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getElement", "([BIIB)Lsun/security/util/math/ImmutableIntegerModuloP;"));
		}
		...
		: Dova.JDK.sun.security.util.math.intpoly.IntegerPolynomialModBinP
	{
		...
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/util/math/intpoly/IntegerPolynomialModBinP$Curve25519OrderField;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
