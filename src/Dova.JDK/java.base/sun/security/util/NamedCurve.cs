	...
	: Dova.JDK.java.security.spec.ECParameterSpec
{
	...
	static NamedCurve()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/util/NamedCurve;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "nameAndAliases", "[Ljava/lang/String;"));
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "NamedCurve", "(Lsun/security/util/KnownOIDs;Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;I)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "toString", "()Ljava/lang/String;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getEncoded", "()[B"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getNameAndAliases", "()[Ljava/lang/String;"));
	...
	public NamedCurve(Dova.JDK.sun.security.util.KnownOIDs arg0, Dova.JDK.java.security.spec.EllipticCurve arg1, Dova.JDK.java.security.spec.ECPoint arg2, Dova.JDK.java.math.BigInteger arg3, int arg4) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3, arg4))
	{
	}
