...
[JniSignatureAttribute("Lsun/security/util/Resources;", "public")]
	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static Resources()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/util/Resources;");
	...
	public override string GetJavaClassSignature() => "Lsun/security/util/Resources;";
