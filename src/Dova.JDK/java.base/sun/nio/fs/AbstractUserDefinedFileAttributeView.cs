	...
	, Dova.JDK.sun.nio.fs.DynamicFileAttributeView
{
	...
	static AbstractUserDefinedFileAttributeView()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "checkAccess", "(Ljava/lang/String;ZZ)V"));
	...
	public AbstractUserDefinedFileAttributeView() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
