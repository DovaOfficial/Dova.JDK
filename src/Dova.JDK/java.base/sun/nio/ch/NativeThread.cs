	...
	: Dova.JDK.java.lang.Object
{
	...
	static NativeThread()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "current", "()J"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "signal", "(J)V"));
	}
	...
	public NativeThread() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
