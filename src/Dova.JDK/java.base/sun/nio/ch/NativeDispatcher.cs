	...
	: Dova.JDK.java.lang.Object
{
	...
	static NativeDispatcher()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "needsPositionLock", "()Z"));
	...
	public NativeDispatcher() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
