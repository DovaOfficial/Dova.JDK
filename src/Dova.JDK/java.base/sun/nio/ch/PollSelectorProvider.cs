...
[JniSignatureAttribute("Lsun/nio/ch/PollSelectorProvider;", "public")]
public partial class PollSelectorProvider
	: Dova.JDK.sun.nio.ch.SelectorProviderImpl
{
	...
	static PollSelectorProvider()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/ch/PollSelectorProvider;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "PollSelectorProvider", "()V"));
	...
	public PollSelectorProvider(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public PollSelectorProvider() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/nio/ch/PollSelectorProvider;";
