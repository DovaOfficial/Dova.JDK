	...
	: Dova.JDK.java.lang.Object
{
	...
	static UnixDomainSocketsUtil()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "getCharset", "()Ljava/nio/charset/Charset;"));
	...
	public UnixDomainSocketsUtil() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
