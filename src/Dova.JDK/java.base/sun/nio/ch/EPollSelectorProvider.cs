	...
	: Dova.JDK.sun.nio.ch.SelectorProviderImpl
{
	...
	static EPollSelectorProvider()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "EPollSelectorProvider", "()V"));
	...
	public EPollSelectorProvider() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
