	...
	: Dova.JDK.java.lang.Object
{
	...
	static ExtendedSocketOption()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "SO_OOBINLINE", "Ljava/net/SocketOption;"));
	...
	public ExtendedSocketOption() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
