	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static KOI8_U()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/KOI8_U;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "KOI8_U", "()V"));
	...
	public KOI8_U() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/KOI8_U$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
