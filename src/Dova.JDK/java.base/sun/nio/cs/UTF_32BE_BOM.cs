	...
	: Dova.JDK.sun.nio.cs.Unicode
{
	...
	static UTF_32BE_BOM()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/UTF_32BE_BOM;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UTF_32BE_BOM", "()V"));
	...
	public UTF_32BE_BOM() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
