...
[JniSignatureAttribute("Lsun/nio/cs/UTF_32BE_BOM;", "public")]
public partial class UTF_32BE_BOM
	: Dova.JDK.sun.nio.cs.Unicode
{
	...
	static UTF_32BE_BOM()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/UTF_32BE_BOM;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UTF_32BE_BOM", "()V"));
	...
	public UTF_32BE_BOM(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public UTF_32BE_BOM() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/nio/cs/UTF_32BE_BOM;";
