	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static Big5_Solaris()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/Big5_Solaris;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Big5_Solaris", "()V"));
	...
	public Big5_Solaris() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/Big5_Solaris$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
