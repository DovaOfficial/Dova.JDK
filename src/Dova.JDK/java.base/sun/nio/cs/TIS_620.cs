	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static TIS_620()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/TIS_620;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "TIS_620", "()V"));
	...
	public TIS_620() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/TIS_620$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
