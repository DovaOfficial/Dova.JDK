	...
	: Dova.JDK.sun.nio.cs.Unicode
{
	...
	static UTF_16()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/UTF_16;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UTF_16", "()V"));
	...
	public UTF_16() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.sun.nio.cs.UnicodeDecoder
	{
		...
		static Decoder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/UTF_16$Decoder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		...
		: Dova.JDK.sun.nio.cs.UnicodeEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/UTF_16$Encoder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
