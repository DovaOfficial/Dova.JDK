	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static ISO_8859_15()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ISO_8859_15;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ISO_8859_15", "()V"));
	...
	public ISO_8859_15() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/ISO_8859_15$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
