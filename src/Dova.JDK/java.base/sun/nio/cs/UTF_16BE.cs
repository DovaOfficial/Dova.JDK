...
[JniSignatureAttribute("Lsun/nio/cs/UTF_16BE;", "public")]
public partial class UTF_16BE
	: Dova.JDK.sun.nio.cs.Unicode
{
	...
	static UTF_16BE()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/UTF_16BE;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UTF_16BE", "()V"));
	...
	public UTF_16BE(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public UTF_16BE() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/nio/cs/UTF_16BE;";
	...
	[JniSignatureAttribute("Lsun/nio/cs/UTF_16BE$Decoder;", "private static")]
		...
		: Dova.JDK.sun.nio.cs.UnicodeDecoder
	{
		...
		static Decoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/UTF_16BE$Decoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		...
		public override string GetJavaClassSignature() => "Lsun/nio/cs/UTF_16BE$Decoder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
	}

	[JniSignatureAttribute("Lsun/nio/cs/UTF_16BE$Encoder;", "private static")]
		...
		: Dova.JDK.sun.nio.cs.UnicodeEncoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/UTF_16BE$Encoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		...
		public override string GetJavaClassSignature() => "Lsun/nio/cs/UTF_16BE$Encoder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
	}
}
