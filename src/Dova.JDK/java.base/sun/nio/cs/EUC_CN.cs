	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static EUC_CN()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/EUC_CN;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "EUC_CN", "()V"));
	...
	public EUC_CN() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static DecodeHolder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/EUC_CN$DecodeHolder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static EncodeHolder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/EUC_CN$EncodeHolder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
