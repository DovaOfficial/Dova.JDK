	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static GBK()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/GBK;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "GBK", "()V"));
	...
	public GBK() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static DecodeHolder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/GBK$DecodeHolder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static EncodeHolder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/GBK$EncodeHolder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
