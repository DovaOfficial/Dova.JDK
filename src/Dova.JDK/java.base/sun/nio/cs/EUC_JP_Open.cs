	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static EUC_JP_Open()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/EUC_JP_Open;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "EUC_JP_Open", "()V"));
	...
	public EUC_JP_Open() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.sun.nio.cs.EUC_JP.Decoder
	{
		...
		static Decoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/EUC_JP_Open$Decoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "DEC0208_Solaris", "Lsun/nio/cs/DoubleByte$Decoder;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "DEC0212_Solaris", "Lsun/nio/cs/DoubleByte$Decoder;"));
		...
		: Dova.JDK.sun.nio.cs.EUC_JP.Encoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/EUC_JP_Open$Encoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "ENC0208_Solaris", "Lsun/nio/cs/DoubleByte$Encoder;"));
			FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "ENC0212_Solaris", "Lsun/nio/cs/DoubleByte$Encoder;"));
