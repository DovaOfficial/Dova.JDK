...
[JniSignatureAttribute("Lsun/nio/cs/EUC_JP_LINUX;", "public")]
public partial class EUC_JP_LINUX
	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static EUC_JP_LINUX()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/EUC_JP_LINUX;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "EUC_JP_LINUX", "()V"));
	...
	public EUC_JP_LINUX(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public EUC_JP_LINUX() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/nio/cs/EUC_JP_LINUX;";
	...
	[JniSignatureAttribute("Lsun/nio/cs/EUC_JP_LINUX$Decoder;", "private static")]
		...
		: Dova.JDK.sun.nio.cs.EUC_JP.Decoder
	{
		...
		static Decoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/EUC_JP_LINUX$Decoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		...
		public override string GetJavaClassSignature() => "Lsun/nio/cs/EUC_JP_LINUX$Decoder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
	}

	[JniSignatureAttribute("Lsun/nio/cs/EUC_JP_LINUX$Encoder;", "private static")]
		...
		: Dova.JDK.sun.nio.cs.EUC_JP.Encoder
	{
		...
		static Encoder()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/EUC_JP_LINUX$Encoder;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		...
		public override string GetJavaClassSignature() => "Lsun/nio/cs/EUC_JP_LINUX$Encoder;";
		public override IntPtr GetJavaClassRaw() => ClassPtr;
		public override IntPtr GetJavaClassRefRaw() => ClassRefPtr;
	}
}
