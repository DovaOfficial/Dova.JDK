	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static KOI8_R()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/KOI8_R;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "KOI8_R", "()V"));
	...
	public KOI8_R() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/KOI8_R$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
