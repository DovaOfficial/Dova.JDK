	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static MS1257()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/MS1257;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MS1257", "()V"));
	...
	public MS1257() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/MS1257$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
