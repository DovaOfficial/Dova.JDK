	...
	: Dova.JDK.sun.nio.cs.Unicode
{
	...
	static UTF_32()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/UTF_32;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UTF_32", "()V"));
	...
	public UTF_32() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
