	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static Johab()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/Johab;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Johab", "()V"));
	...
	public Johab() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static DecodeHolder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/Johab$DecodeHolder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static EncodeHolder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/Johab$EncodeHolder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
