	...
	: Dova.JDK.sun.nio.cs.Unicode
{
	...
	static UTF_32LE_BOM()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/UTF_32LE_BOM;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "UTF_32LE_BOM", "()V"));
	...
	public UTF_32LE_BOM() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
