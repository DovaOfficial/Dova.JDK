...
[JniSignatureAttribute("Lsun/nio/cs/UTF_32LE_BOM;", "public")]
	...
	: Dova.JDK.sun.nio.cs.Unicode
{
	...
	static UTF_32LE_BOM()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/nio/cs/UTF_32LE_BOM;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UTF_32LE_BOM", "()V"));
	...
	public UTF_32LE_BOM(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public UTF_32LE_BOM() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/nio/cs/UTF_32LE_BOM;";
