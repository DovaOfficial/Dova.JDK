	...
	, Dova.JDK.sun.nio.cs.HistoricallyNamedCharset
{
	...
	static JIS_X_0201()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/JIS_X_0201;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "JIS_X_0201", "()V"));
	...
	public JIS_X_0201() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static Holder()
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lsun/nio/cs/JIS_X_0201$Holder;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
