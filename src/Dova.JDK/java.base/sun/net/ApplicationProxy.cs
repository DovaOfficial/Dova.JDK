	...
	: Dova.JDK.java.net.Proxy
{
	...
	static ApplicationProxy()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "create", "(Ljava/net/Proxy;)Lsun/net/ApplicationProxy;"));
	}
	...
	public ApplicationProxy(Dova.JDK.java.net.Proxy arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}
