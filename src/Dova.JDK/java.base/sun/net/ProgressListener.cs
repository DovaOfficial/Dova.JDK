	...
	, Dova.JDK.java.util.EventListener
{
	...
	static ProgressListener()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "progressStart", "(Lsun/net/ProgressEvent;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "progressUpdate", "(Lsun/net/ProgressEvent;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "progressFinish", "(Lsun/net/ProgressEvent;)V"));
	}
