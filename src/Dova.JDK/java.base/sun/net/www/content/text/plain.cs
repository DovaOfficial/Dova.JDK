	...
	: Dova.JDK.java.net.ContentHandler
{
	...
	static plain()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/net/www/content/text/plain;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "plain", "()V"));
	...
	public plain() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
