	...
	: Dova.JDK.javax.net.ssl.HttpsURLConnection
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/net/www/protocol/https/HttpsURLConnectionImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "delegate", "Lsun/net/www/protocol/https/DelegateHttpsURLConnection;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "HttpsURLConnectionImpl", "(Ljava/net/URL;Ljava/net/Proxy;Lsun/net/www/protocol/https/Handler;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "HttpsURLConnectionImpl", "(Ljava/net/URL;Lsun/net/www/protocol/https/Handler;)V"));
	...
	public HttpsURLConnectionImpl(Dova.JDK.java.net.URL arg0, Dova.JDK.java.net.Proxy arg1, Dova.JDK.sun.net.www.protocol.https.Handler arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(Ljava/net/URL;Lsun/net/www/protocol/https/Handler;)V", "")]
	public HttpsURLConnectionImpl(Dova.JDK.java.net.URL arg0, Dova.JDK.sun.net.www.protocol.https.Handler arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
	...
	{
		var ret = DovaJvm.Vm.Runtime.CallLongMethodA(CurrentRefPtr, MethodPtrs[51], arg0, arg1);
		return ret;
	}
	...
	{
		var ret = DovaJvm.Vm.Runtime.CallLongMethodA(CurrentRefPtr, MethodPtrs[52], arg0, arg1);
		return ret;
	}
