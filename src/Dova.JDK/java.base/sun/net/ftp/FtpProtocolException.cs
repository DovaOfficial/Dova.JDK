	...
	: Dova.JDK.java.lang.Exception
{
	...
	static FtpProtocolException()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "code", "Lsun/net/ftp/FtpReplyCode;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FtpProtocolException", "(Ljava/lang/String;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "FtpProtocolException", "(Ljava/lang/String;Lsun/net/ftp/FtpReplyCode;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getReplyCode", "()Lsun/net/ftp/FtpReplyCode;"));
	}
	...
	public FtpProtocolException(Dova.JDK.java.lang.String arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;Lsun/net/ftp/FtpReplyCode;)V", "public")]
	public FtpProtocolException(Dova.JDK.java.lang.String arg0, Dova.JDK.sun.net.ftp.FtpReplyCode arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
