	...
	, Dova.JDK.sun.reflect.generics.visitor.TypeTreeVisitor
{
	...
	static Visitor()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/reflect/generics/visitor/Visitor;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "visitClassSignature", "(Lsun/reflect/generics/tree/ClassSignature;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "visitMethodTypeSignature", "(Lsun/reflect/generics/tree/MethodTypeSignature;)V"));
	}
