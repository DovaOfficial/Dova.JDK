	...
	, Dova.JDK.sun.reflect.generics.tree.ReturnType
{
	...
	static VoidDescriptor()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "singleton", "Lsun/reflect/generics/tree/VoidDescriptor;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "make", "()Lsun/reflect/generics/tree/VoidDescriptor;"));
	...
	public VoidDescriptor() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
