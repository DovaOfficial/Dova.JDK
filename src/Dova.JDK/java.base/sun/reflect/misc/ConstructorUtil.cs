	...
	: Dova.JDK.java.lang.Object
{
	...
	static ConstructorUtil()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ConstructorUtil", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassRefPtr, "getConstructors", "(Ljava/lang/Class;)[Ljava/lang/reflect/Constructor;"));
	...
	public ConstructorUtil() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
