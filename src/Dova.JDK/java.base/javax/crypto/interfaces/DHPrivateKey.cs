...
[JniSignatureAttribute("Ljavax/crypto/interfaces/DHPrivateKey;", "public abstract interface")]
public partial interface DHPrivateKey
	: IJavaObject
	...
	, Dova.JDK.java.security.PrivateKey
{
	...
	static DHPrivateKey()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/crypto/interfaces/DHPrivateKey;");
