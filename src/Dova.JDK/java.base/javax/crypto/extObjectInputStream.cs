	...
	: Dova.JDK.java.io.ObjectInputStream
{
	...
	static extObjectInputStream()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "extObjectInputStream", "(Ljava/io/InputStream;)V"));
	...
	public extObjectInputStream(Dova.JDK.java.io.InputStream arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
