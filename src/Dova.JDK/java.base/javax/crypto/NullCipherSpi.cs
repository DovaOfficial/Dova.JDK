...
[JniSignatureAttribute("Ljavax/crypto/NullCipherSpi;", "final")]
public partial class NullCipherSpi
	: Dova.JDK.javax.crypto.CipherSpi
{
	...
	static NullCipherSpi()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/crypto/NullCipherSpi;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "NullCipherSpi", "()V"));
	...
	public NullCipherSpi(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "protected")]
	public NullCipherSpi() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/crypto/NullCipherSpi;";
