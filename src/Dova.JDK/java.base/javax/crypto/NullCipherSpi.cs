	...
	: Dova.JDK.javax.crypto.CipherSpi
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/crypto/NullCipherSpi;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "NullCipherSpi", "()V"));
	...
	public NullCipherSpi() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
