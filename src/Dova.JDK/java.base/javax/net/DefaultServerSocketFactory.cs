	...
	: Dova.JDK.javax.net.ServerSocketFactory
{
	...
	static DefaultServerSocketFactory()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DefaultServerSocketFactory", "()V"));
	...
	public DefaultServerSocketFactory() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
