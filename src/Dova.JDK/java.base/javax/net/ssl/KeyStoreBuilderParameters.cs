	...
	, Dova.JDK.javax.net.ssl.ManagerFactoryParameters
{
	...
	static KeyStoreBuilderParameters()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "KeyStoreBuilderParameters", "(Ljava/security/KeyStore$Builder;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "KeyStoreBuilderParameters", "(Ljava/util/List;)V"));
	...
	public KeyStoreBuilderParameters(Dova.JDK.java.security.KeyStore.Builder arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Ljava/util/List;)V", "public")]
	public KeyStoreBuilderParameters(Dova.JDK.java.util.List arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}
