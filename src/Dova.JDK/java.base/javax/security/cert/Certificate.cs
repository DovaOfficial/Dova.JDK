	...
	: Dova.JDK.java.lang.Object
{
	...
	static Certificate()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/security/cert/Certificate;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Certificate", "()V"));
	...
	public Certificate() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
