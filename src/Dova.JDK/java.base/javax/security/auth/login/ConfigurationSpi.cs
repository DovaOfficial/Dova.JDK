	...
	: Dova.JDK.java.lang.Object
{
	...
	static ConfigurationSpi()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ConfigurationSpi", "()V"));
	...
	public ConfigurationSpi() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
