	...
	, Dova.JDK.javax.lang.model.type.TypeMirror
{
	...
	static WildcardType()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getExtendsBound", "()Ljavax/lang/model/type/TypeMirror;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getSuperBound", "()Ljavax/lang/model/type/TypeMirror;"));
	}
