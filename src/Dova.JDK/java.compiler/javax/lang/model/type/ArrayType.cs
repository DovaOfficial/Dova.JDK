	...
	, Dova.JDK.javax.lang.model.type.ReferenceType
{
	...
	static ArrayType()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/lang/model/type/ArrayType;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getComponentType", "()Ljavax/lang/model/type/TypeMirror;"));
	}
