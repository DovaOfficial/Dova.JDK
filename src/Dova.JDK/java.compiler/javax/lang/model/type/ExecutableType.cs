...
[JniSignatureAttribute("Ljavax/lang/model/type/ExecutableType;", "public abstract interface")]
public partial interface ExecutableType
	: IJavaObject
	, Dova.JDK.javax.lang.model.type.TypeMirror
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/lang/model/type/ExecutableType;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "getTypeVariables", "()Ljava/util/List;"));
	...
	[JniSignatureAttribute("()Ljava/util/List;", "public abstract")]
	Dova.JDK.java.util.List getTypeVariables()
	{
