	...
	, Dova.JDK.javax.lang.model.type.TypeMirror
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/lang/model/type/ExecutableType;");
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getTypeVariables", "()Ljava/util/List;"));
