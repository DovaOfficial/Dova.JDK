	...
	: Dova.JDK.javax.lang.model.util.AbstractTypeVisitor8
{
	...
	static AbstractTypeVisitor9()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AbstractTypeVisitor9", "()V"));
	}
	...
	public AbstractTypeVisitor9() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
