	...
	: Dova.JDK.javax.lang.model.util.AbstractAnnotationValueVisitor9
{
	...
	static AbstractAnnotationValueVisitor14()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AbstractAnnotationValueVisitor14", "()V"));
	}
	...
	public AbstractAnnotationValueVisitor14() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
