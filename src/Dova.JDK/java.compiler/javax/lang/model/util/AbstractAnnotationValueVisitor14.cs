	...
	: Dova.JDK.javax.lang.model.util.AbstractAnnotationValueVisitor9
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/lang/model/util/AbstractAnnotationValueVisitor14;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AbstractAnnotationValueVisitor14", "()V"));
	}
	...
	public AbstractAnnotationValueVisitor14() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
