	...
	, Dova.JDK.javax.lang.model.element.AnnotationValueVisitor
{
	...
	static AbstractAnnotationValueVisitor6()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "AbstractAnnotationValueVisitor6", "()V"));
	...
	public AbstractAnnotationValueVisitor6() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
