	...
	, Dova.JDK.javax.tools.JavaFileManager
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/tools/StandardJavaFileManager;");
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "asCollection", "(Ljava/lang/Iterable;)Ljava/util/Collection;"));
		...
		: IJavaObject
	{
		...
		static PathFactory()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/tools/StandardJavaFileManager$PathFactory;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
