...
[JniSignatureAttribute("Ljavax/annotation/processing/Completion;", "public abstract interface")]
public partial interface Completion
	: IJavaObject
{
	...
	static Completion()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/annotation/processing/Completion;");
