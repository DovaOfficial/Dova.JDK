	...
	: Dova.JDK.java.lang.Object
{
	...
	static ContentSigner()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ContentSigner", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "generateSignedData", "(Lcom/sun/jarsigner/ContentSignerParameters;ZZ)[B"));
	}
	...
	public ContentSigner() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
