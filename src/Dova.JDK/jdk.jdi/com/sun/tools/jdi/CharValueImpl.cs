	...
	, Dova.JDK.com.sun.jdi.CharValue
{
	...
	static CharValueImpl()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CharValueImpl", "(Lcom/sun/jdi/VirtualMachine;C)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "compareTo", "(Lcom/sun/jdi/CharValue;)I"));
	...
	public CharValueImpl(Dova.JDK.com.sun.jdi.VirtualMachine arg0, char arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
