...
[JniSignatureAttribute("Lcom/sun/tools/jdi/VMModifiers;", "public abstract interface")]
public partial interface VMModifiers
	: IJavaObject
{
	...
	static VMModifiers()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/tools/jdi/VMModifiers;");
