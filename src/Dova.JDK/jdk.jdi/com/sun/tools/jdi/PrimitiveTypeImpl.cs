	...
	, Dova.JDK.com.sun.jdi.PrimitiveType
{
	...
	static PrimitiveTypeImpl()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "PrimitiveTypeImpl", "(Lcom/sun/jdi/VirtualMachine;)V"));
	...
	public PrimitiveTypeImpl(Dova.JDK.com.sun.jdi.VirtualMachine arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
