	...
	, Dova.JDK.com.sun.tools.jdi.ThreadListener
{
	...
	static VirtualMachineImpl()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "sizeofFieldRef", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "sizeofMethodRef", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "sizeofObjectRef", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "sizeofClassRef", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "sizeofFrameRef", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "sizeofModuleRef", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "sequenceNumber", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "target", "Lcom/sun/tools/jdi/TargetVM;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "eventQueue", "Lcom/sun/tools/jdi/EventQueueImpl;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "internalEventRequestManager", "Lcom/sun/tools/jdi/EventRequestManagerImpl;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "eventRequestManager", "Lcom/sun/tools/jdi/EventRequestManagerImpl;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "vmManager", "Lcom/sun/tools/jdi/VirtualMachineManagerImpl;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "threadGroupForJDI", "Ljava/lang/ThreadGroup;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "traceFlags", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TRACE_RAW_SENDS", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "TRACE_RAW_RECEIVES", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "traceReceives", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "typesByID", "Ljava/util/Map;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "typesBySignature", "Ljava/util/Set;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "retrievedAllTypes", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "modulesByID", "Ljava/util/Map;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "defaultStratum", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "objectsByID", "Ljava/util/Map;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "referenceQueue", "Ljava/lang/ref/ReferenceQueue;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "DISPOSE_THRESHOLD", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "batchedDisposeRequests", "Ljava/util/List;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "versionInfo", "Lcom/sun/tools/jdi/JDWP$VirtualMachine$Version;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "pathInfo", "Lcom/sun/tools/jdi/JDWP$VirtualMachine$ClassPaths;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "capabilities", "Lcom/sun/tools/jdi/JDWP$VirtualMachine$Capabilities;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "capabilitiesNew", "Lcom/sun/tools/jdi/JDWP$VirtualMachine$CapabilitiesNew;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "theBooleanType", "Lcom/sun/jdi/BooleanType;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "theByteType", "Lcom/sun/jdi/ByteType;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "theCharType", "Lcom/sun/jdi/CharType;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "theShortType", "Lcom/sun/jdi/ShortType;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "theIntegerType", "Lcom/sun/jdi/IntegerType;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "theLongType", "Lcom/sun/jdi/LongType;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "theFloatType", "Lcom/sun/jdi/FloatType;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "theDoubleType", "Lcom/sun/jdi/DoubleType;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "theVoidType", "Lcom/sun/jdi/VoidType;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "voidVal", "Lcom/sun/jdi/VoidValue;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "process", "Ljava/lang/Process;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "state", "Lcom/sun/tools/jdi/VMState;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "initMonitor", "Ljava/lang/Object;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "initComplete", "Z"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "shutdown", "Z"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lcom/sun/jdi/VirtualMachineManager;Lcom/sun/jdi/connect/spi/Connection;Ljava/lang/Process;I)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getModule", "(J)Lcom/sun/jdi/ModuleReference;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "hashCode", "()I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "arrayType", "(J)Lcom/sun/tools/jdi/ArrayTypeImpl;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "state", "()Lcom/sun/tools/jdi/VMState;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "classPath", "()Ljava/util/List;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "versionInfo", "()Lcom/sun/tools/jdi/JDWP$VirtualMachine$Version;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "referenceType", "(JB)Lcom/sun/tools/jdi/ReferenceTypeImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "referenceType", "(JILjava/lang/String;)Lcom/sun/tools/jdi/ReferenceTypeImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "capabilities", "()Lcom/sun/tools/jdi/JDWP$VirtualMachine$Capabilities;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "theByteType", "()Lcom/sun/jdi/ByteType;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "waitInitCompletion", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "theFloatType", "()Lcom/sun/jdi/FloatType;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "theIntegerType", "()Lcom/sun/jdi/IntegerType;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "classType", "(J)Lcom/sun/tools/jdi/ClassTypeImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "printTrace", "(Ljava/lang/String;)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "notifySuspend", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "threadResumable", "(Lcom/sun/tools/jdi/ThreadAction;)Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "sendToTarget", "(Lcom/sun/tools/jdi/Packet;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "waitForTargetReply", "(Lcom/sun/tools/jdi/Packet;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "objectMirror", "(JI)Lcom/sun/tools/jdi/ObjectReferenceImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "objectMirror", "(J)Lcom/sun/tools/jdi/ObjectReferenceImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "stringMirror", "(J)Lcom/sun/tools/jdi/StringReferenceImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "arrayMirror", "(J)Lcom/sun/tools/jdi/ArrayReferenceImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "threadMirror", "(J)Lcom/sun/tools/jdi/ThreadReferenceImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "threadGroupMirror", "(J)Lcom/sun/tools/jdi/ThreadGroupReferenceImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "classLoaderMirror", "(J)Lcom/sun/tools/jdi/ClassLoaderReferenceImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "classObjectMirror", "(J)Lcom/sun/tools/jdi/ClassObjectReferenceImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "moduleMirror", "(J)Lcom/sun/tools/jdi/ModuleReferenceImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "printReceiveTrace", "(ILjava/lang/String;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "notifyInitCompletion", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "validateVM", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "retrieveAllModules", "()Ljava/util/List;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "findReferenceTypes", "(Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "retrieveClassesBySignature", "(Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "retrieveAllClasses", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "capabilitiesNew", "()Lcom/sun/tools/jdi/JDWP$VirtualMachine$CapabilitiesNew;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "removeReferenceType", "(Ljava/lang/String;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "threadGroupForJDI", "()Ljava/lang/ThreadGroup;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "hasNewCapabilities", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "initReferenceTypes", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addReferenceType", "(JILjava/lang/String;)Lcom/sun/tools/jdi/ReferenceTypeImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "retrieveAllClasses1_4", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "processBatchedDisposes", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "theShortType", "()Lcom/sun/jdi/ShortType;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "theLongType", "()Lcom/sun/jdi/LongType;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "batchForDispose", "(Lcom/sun/tools/jdi/VirtualMachineImpl$SoftObjectReference;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getClasspath", "()Lcom/sun/tools/jdi/JDWP$VirtualMachine$ClassPaths;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "getInternalEventRequestManager", "()Lcom/sun/tools/jdi/EventRequestManagerImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "eventRequestManagerImpl", "()Lcom/sun/tools/jdi/EventRequestManagerImpl;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "bootClassPath", "()Ljava/util/List;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "baseDirectory", "()Ljava/lang/String;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "addModule", "(J)Lcom/sun/jdi/ModuleReference;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "canGet1_5LanguageFeatures", "()Z"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "forEachClass", "(Ljava/util/function/Consumer;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "theVoidType", "()Lcom/sun/jdi/VoidType;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "primitiveTypeMirror", "(B)Lcom/sun/jdi/PrimitiveType;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "findBootType", "(Ljava/lang/String;)Lcom/sun/jdi/Type;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "classesBySignature", "(Ljava/lang/String;)Ljava/util/List;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "theCharType", "()Lcom/sun/jdi/CharType;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "theBooleanType", "()Lcom/sun/jdi/BooleanType;"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "removeObjectMirror", "(Lcom/sun/tools/jdi/VirtualMachineImpl$SoftObjectReference;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "removeObjectMirror", "(Lcom/sun/tools/jdi/ObjectReferenceImpl;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "theDoubleType", "()Lcom/sun/jdi/DoubleType;"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "interfaceType", "(J)Lcom/sun/tools/jdi/InterfaceTypeImpl;"));
	}
	...
	public VirtualMachineImpl(Dova.JDK.com.sun.jdi.VirtualMachineManager arg0, Dova.JDK.com.sun.jdi.connect.spi.Connection arg1, Dova.JDK.java.lang.Process arg2, int arg3) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3))
	{
	}
		...
		: Dova.JDK.java.lang.@ref.SoftReference
	{
		...
		static SoftObjectReference()
		{
			...
			FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "key", "Ljava/lang/Long;"));
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/lang/Long;Lcom/sun/tools/jdi/ObjectReferenceImpl;Ljava/lang/ref/ReferenceQueue;)V"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "count", "()I"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "key", "()Ljava/lang/Long;"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "object", "()Lcom/sun/tools/jdi/ObjectReferenceImpl;"));
			MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "incrementCount", "()V"));
		}
		...
		public SoftObjectReference(Dova.JDK.java.lang.Long arg0, Dova.JDK.com.sun.tools.jdi.ObjectReferenceImpl arg1, Dova.JDK.java.lang.@ref.ReferenceQueue arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
		{
		}
