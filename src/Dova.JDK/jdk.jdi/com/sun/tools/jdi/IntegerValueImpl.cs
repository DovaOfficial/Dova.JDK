	...
	, Dova.JDK.com.sun.jdi.IntegerValue
{
	...
	static IntegerValueImpl()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "IntegerValueImpl", "(Lcom/sun/jdi/VirtualMachine;I)V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "compareTo", "(Lcom/sun/jdi/IntegerValue;)I"));
	...
	public IntegerValueImpl(Dova.JDK.com.sun.jdi.VirtualMachine arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
