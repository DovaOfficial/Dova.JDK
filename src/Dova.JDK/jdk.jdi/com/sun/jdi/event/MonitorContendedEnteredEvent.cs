...
[JniSignatureAttribute("Lcom/sun/jdi/event/MonitorContendedEnteredEvent;", "public abstract interface")]
public partial interface MonitorContendedEnteredEvent
	: IJavaObject
	, Dova.JDK.com.sun.jdi.@event.LocatableEvent
{
	...
	static MonitorContendedEnteredEvent()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/jdi/event/MonitorContendedEnteredEvent;");
