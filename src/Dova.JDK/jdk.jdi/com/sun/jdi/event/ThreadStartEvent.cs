...
[JniSignatureAttribute("Lcom/sun/jdi/event/ThreadStartEvent;", "public abstract interface")]
public partial interface ThreadStartEvent
	: IJavaObject
	, Dova.JDK.com.sun.jdi.@event.Event
{
	...
	static ThreadStartEvent()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/jdi/event/ThreadStartEvent;");
