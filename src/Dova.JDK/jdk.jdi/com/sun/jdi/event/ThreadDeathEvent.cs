...
[JniSignatureAttribute("Lcom/sun/jdi/event/ThreadDeathEvent;", "public abstract interface")]
public partial interface ThreadDeathEvent
	: IJavaObject
	, Dova.JDK.com.sun.jdi.@event.Event
{
	...
	static ThreadDeathEvent()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/jdi/event/ThreadDeathEvent;");
