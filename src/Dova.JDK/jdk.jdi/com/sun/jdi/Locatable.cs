...
[JniSignatureAttribute("Lcom/sun/jdi/Locatable;", "public abstract interface")]
public partial interface Locatable
	: IJavaObject
{
	...
	static Locatable()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/jdi/Locatable;");
