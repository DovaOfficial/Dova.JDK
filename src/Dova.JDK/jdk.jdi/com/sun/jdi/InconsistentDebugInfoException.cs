	...
	: Dova.JDK.java.lang.RuntimeException
{
	...
	static InconsistentDebugInfoException()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "InconsistentDebugInfoException", "()V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "InconsistentDebugInfoException", "(Ljava/lang/String;)V"));
	}
	...
	public InconsistentDebugInfoException() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	[JniSignatureAttribute("(Ljava/lang/String;)V", "public")]
	public InconsistentDebugInfoException(Dova.JDK.java.lang.String arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
	{
	}
