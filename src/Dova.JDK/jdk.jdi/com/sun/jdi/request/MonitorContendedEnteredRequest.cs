...
[JniSignatureAttribute("Lcom/sun/jdi/request/MonitorContendedEnteredRequest;", "public abstract interface")]
public partial interface MonitorContendedEnteredRequest
	: IJavaObject
	, Dova.JDK.com.sun.jdi.request.EventRequest
{
	...
	static MonitorContendedEnteredRequest()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/jdi/request/MonitorContendedEnteredRequest;");
