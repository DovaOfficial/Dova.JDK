...
[JniSignatureAttribute("Lcom/sun/jdi/request/MethodExitRequest;", "public abstract interface")]
public partial interface MethodExitRequest
	: IJavaObject
	, Dova.JDK.com.sun.jdi.request.EventRequest
{
	...
	static MethodExitRequest()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/jdi/request/MethodExitRequest;");
