...
[JniSignatureAttribute("Lcom/sun/jdi/request/MonitorWaitRequest;", "public abstract interface")]
public partial interface MonitorWaitRequest
	: IJavaObject
	, Dova.JDK.com.sun.jdi.request.EventRequest
{
	...
	static MonitorWaitRequest()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/jdi/request/MonitorWaitRequest;");
