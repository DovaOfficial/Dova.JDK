...
[JniSignatureAttribute("Lcom/sun/jdi/ModuleReference;", "public abstract interface")]
public partial interface ModuleReference
	: IJavaObject
	, Dova.JDK.com.sun.jdi.ObjectReference
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/jdi/ModuleReference;");
