	...
	, Dova.JDK.sun.jvmstat.monitor.MonitoredHostService
{
	...
	static MonitoredHostRmiService()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "MonitoredHostRmiService", "()V"));
	...
	public MonitoredHostRmiService() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
