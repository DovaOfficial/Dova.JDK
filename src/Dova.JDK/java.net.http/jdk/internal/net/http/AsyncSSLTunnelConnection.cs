	...
	: Dova.JDK.jdk.@internal.net.http.AbstractAsyncSSLConnection
{
	...
	static AsyncSSLTunnelConnection()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "plainConnection", "Ljdk/internal/net/http/PlainTunnelingConnection;"));
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Ljava/net/InetSocketAddress;Ljdk/internal/net/http/HttpClientImpl;[Ljava/lang/String;Ljava/net/InetSocketAddress;Ljdk/internal/net/http/common/Utils$ProxyHeaders;)V"));
