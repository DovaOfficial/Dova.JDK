	...
	: Dova.JDK.jdk.@internal.net.http.hpack.IndexNameValueWriter
{
	...
	static LiteralNeverIndexedWriter()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "LiteralNeverIndexedWriter", "()V"));
	}
	...
	public LiteralNeverIndexedWriter() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
