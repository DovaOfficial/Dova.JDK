	...
	: IJavaObject
{
	...
	static SignalHandler()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SIG_DFL", "Lsun/misc/SignalHandler;"));
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "SIG_IGN", "Lsun/misc/SignalHandler;"));
