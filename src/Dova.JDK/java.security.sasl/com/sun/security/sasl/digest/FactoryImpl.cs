...
[JniSignatureAttribute("Lcom/sun/security/sasl/digest/FactoryImpl;", "public final")]
	...
	, Dova.JDK.javax.security.sasl.SaslServerFactory
{
	...
	static FactoryImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/security/sasl/digest/FactoryImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "myMechs", "[Ljava/lang/String;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "DIGEST_MD5", "I"));
	...
	public static int DIGEST_MD5_Property
	{
		get
		{
	...
	public override string GetJavaClassSignature() => "Lcom/sun/security/sasl/digest/FactoryImpl;";
