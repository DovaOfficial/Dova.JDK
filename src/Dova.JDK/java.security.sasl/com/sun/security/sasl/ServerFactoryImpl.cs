...
[JniSignatureAttribute("Lcom/sun/security/sasl/ServerFactoryImpl;", "public final")]
public partial class ServerFactoryImpl
	...
	, Dova.JDK.javax.security.sasl.SaslServerFactory
{
	...
	static ServerFactoryImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/security/sasl/ServerFactoryImpl;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ServerFactoryImpl", "()V"));
	...
	public ServerFactoryImpl(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public ServerFactoryImpl() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lcom/sun/security/sasl/ServerFactoryImpl;";
