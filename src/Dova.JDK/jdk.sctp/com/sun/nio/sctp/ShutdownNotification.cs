	...
	, Dova.JDK.com.sun.nio.sctp.Notification
{
	...
	static ShutdownNotification()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ShutdownNotification", "()V"));
	...
	public ShutdownNotification() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
