	...
	: Dova.JDK.java.lang.Object
{
	...
	static GSSManager()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "getInstance", "()Lorg/ietf/jgss/GSSManager;"));
	...
	public GSSManager() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
