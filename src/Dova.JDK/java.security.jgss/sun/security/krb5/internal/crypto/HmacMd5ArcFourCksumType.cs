	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.CksumType
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/krb5/internal/crypto/HmacMd5ArcFourCksumType;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "HmacMd5ArcFourCksumType", "()V"));
	...
	public HmacMd5ArcFourCksumType() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
