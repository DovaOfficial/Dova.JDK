	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.EType
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/krb5/internal/crypto/Aes128CtsHmacSha1EType;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Aes128CtsHmacSha1EType", "()V"));
	...
	public Aes128CtsHmacSha1EType() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
