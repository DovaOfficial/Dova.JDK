...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/Aes128CtsHmacSha1EType;", "public final")]
public partial class Aes128CtsHmacSha1EType
	: Dova.JDK.sun.security.krb5.@internal.crypto.EType
{
	...
	static Aes128CtsHmacSha1EType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/Aes128CtsHmacSha1EType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Aes128CtsHmacSha1EType", "()V"));
	...
	public Aes128CtsHmacSha1EType(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public Aes128CtsHmacSha1EType() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/Aes128CtsHmacSha1EType;";
