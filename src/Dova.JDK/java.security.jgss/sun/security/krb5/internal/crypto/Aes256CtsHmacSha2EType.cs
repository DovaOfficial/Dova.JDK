	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.EType
{
	...
	static Aes256CtsHmacSha2EType()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Aes256CtsHmacSha2EType", "()V"));
	...
	public Aes256CtsHmacSha2EType() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
