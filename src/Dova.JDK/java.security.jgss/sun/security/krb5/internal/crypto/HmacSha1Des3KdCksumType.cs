	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.CksumType
{
	...
	static HmacSha1Des3KdCksumType()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "HmacSha1Des3KdCksumType", "()V"));
	...
	public HmacSha1Des3KdCksumType() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
