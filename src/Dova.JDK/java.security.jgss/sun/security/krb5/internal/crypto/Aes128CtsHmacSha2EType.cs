...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/Aes128CtsHmacSha2EType;", "public final")]
public partial class Aes128CtsHmacSha2EType
	: Dova.JDK.sun.security.krb5.@internal.crypto.EType
{
	...
	static Aes128CtsHmacSha2EType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/Aes128CtsHmacSha2EType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Aes128CtsHmacSha2EType", "()V"));
	...
	public Aes128CtsHmacSha2EType(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public Aes128CtsHmacSha2EType() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/Aes128CtsHmacSha2EType;";
