...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/DesMacKCksumType;", "public")]
public partial class DesMacKCksumType
	: Dova.JDK.sun.security.krb5.@internal.crypto.CksumType
{
	...
	static DesMacKCksumType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/DesMacKCksumType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DesMacKCksumType", "()V"));
	...
	public DesMacKCksumType(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public DesMacKCksumType() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/DesMacKCksumType;";
