...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/RsaMd5CksumType;", "public final")]
	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.CksumType
{
	...
	static RsaMd5CksumType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/RsaMd5CksumType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "RsaMd5CksumType", "()V"));
	...
	public RsaMd5CksumType(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public RsaMd5CksumType() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/RsaMd5CksumType;";
