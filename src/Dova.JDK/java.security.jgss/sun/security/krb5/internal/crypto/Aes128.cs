...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/Aes128;", "public")]
	...
	: Dova.JDK.java.lang.Object
{
	...
	static Aes128()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/krb5/internal/crypto/Aes128;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassPtr, "CRYPTO", "Lsun/security/krb5/internal/crypto/dk/AesDkCrypto;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "calculateChecksum", "([BI[BII)[B"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "stringToKey", "([CLjava/lang/String;[B)[B"));
	...
	[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/dk/AesDkCrypto;", "private static final")]
	public static Dova.JDK.sun.security.krb5.@internal.crypto.dk.AesDkCrypto CRYPTO_Property
	{
		get
		{
			var ret = DovaVM.Runtime.GetStaticObjectField(ClassRefPtr, FieldPtrs[0]);
			return DovaInterfaceFactory.Get<Dova.JDK.sun.security.krb5.@internal.crypto.dk.AesDkCrypto>(ret);
		}
		set
		{
	...
	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/Aes128;";
