...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/HmacSha1Aes128CksumType;", "public")]
	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.CksumType
{
	...
	static HmacSha1Aes128CksumType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/HmacSha1Aes128CksumType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "HmacSha1Aes128CksumType", "()V"));
	...
	public HmacSha1Aes128CksumType(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public HmacSha1Aes128CksumType() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/HmacSha1Aes128CksumType;";
