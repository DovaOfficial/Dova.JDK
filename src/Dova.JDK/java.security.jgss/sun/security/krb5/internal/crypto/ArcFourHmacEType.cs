...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/ArcFourHmacEType;", "public final")]
	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.EType
{
	...
	static ArcFourHmacEType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/ArcFourHmacEType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ArcFourHmacEType", "()V"));
	...
	public ArcFourHmacEType(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public ArcFourHmacEType() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/ArcFourHmacEType;";
