...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/HmacSha2Aes256CksumType;", "public")]
public partial class HmacSha2Aes256CksumType
	: Dova.JDK.sun.security.krb5.@internal.crypto.CksumType
{
	...
	static HmacSha2Aes256CksumType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/HmacSha2Aes256CksumType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "HmacSha2Aes256CksumType", "()V"));
	...
	public HmacSha2Aes256CksumType(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public HmacSha2Aes256CksumType() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/HmacSha2Aes256CksumType;";
