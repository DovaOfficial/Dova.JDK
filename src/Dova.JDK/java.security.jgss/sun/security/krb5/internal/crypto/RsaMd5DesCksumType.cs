	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.CksumType
{
	...
	static RsaMd5DesCksumType()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "RsaMd5DesCksumType", "()V"));
		...
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "calculateRawChecksum", "([BI)[B"));
	...
	public RsaMd5DesCksumType() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
