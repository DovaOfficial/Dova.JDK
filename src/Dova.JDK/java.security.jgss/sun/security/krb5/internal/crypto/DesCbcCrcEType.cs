	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.DesCbcEType
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/krb5/internal/crypto/DesCbcCrcEType;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "DesCbcCrcEType", "()V"));
	...
	public DesCbcCrcEType() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
