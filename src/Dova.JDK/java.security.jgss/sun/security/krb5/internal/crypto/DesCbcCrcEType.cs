...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/DesCbcCrcEType;", "public")]
public partial class DesCbcCrcEType
	: Dova.JDK.sun.security.krb5.@internal.crypto.DesCbcEType
{
	...
	static DesCbcCrcEType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/DesCbcCrcEType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DesCbcCrcEType", "()V"));
	...
	public DesCbcCrcEType(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public DesCbcCrcEType() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/DesCbcCrcEType;";
