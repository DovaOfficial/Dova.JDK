	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.dk.DkCrypto
{
	...
	static AesDkCrypto()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/dk/AesDkCrypto;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "AesDkCrypto", "(I)V"));
	...
	public AesDkCrypto(int arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
