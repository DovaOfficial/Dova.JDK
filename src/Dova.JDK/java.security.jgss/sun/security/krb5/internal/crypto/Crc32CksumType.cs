	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.CksumType
{
	...
	static Crc32CksumType()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "bytes2long", "([B)J"));
	...
	public Crc32CksumType() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
