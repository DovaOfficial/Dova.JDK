...
[JniSignatureAttribute("Lsun/security/krb5/internal/crypto/Des3CbcHmacSha1KdEType;", "public final")]
	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.EType
{
	...
	static Des3CbcHmacSha1KdEType()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/krb5/internal/crypto/Des3CbcHmacSha1KdEType;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "Des3CbcHmacSha1KdEType", "()V"));
	...
	public Des3CbcHmacSha1KdEType(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public Des3CbcHmacSha1KdEType() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Lsun/security/krb5/internal/crypto/Des3CbcHmacSha1KdEType;";
