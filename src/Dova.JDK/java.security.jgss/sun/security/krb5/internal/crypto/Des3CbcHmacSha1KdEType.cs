	...
	: Dova.JDK.sun.security.krb5.@internal.crypto.EType
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/krb5/internal/crypto/Des3CbcHmacSha1KdEType;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Des3CbcHmacSha1KdEType", "()V"));
	...
	public Des3CbcHmacSha1KdEType() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
