	...
	: Dova.JDK.sun.security.krb5.KrbException
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/security/krb5/KrbCryptoException;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "KrbCryptoException", "(Ljava/lang/String;)V"));
	}
	...
	public KrbCryptoException(Dova.JDK.java.lang.String arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
