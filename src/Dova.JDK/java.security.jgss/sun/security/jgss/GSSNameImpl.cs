	...
	, Dova.JDK.org.ietf.jgss.GSSName
{
	...
	static GSSNameImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/jgss/GSSNameImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "oldHostbasedServiceName", "Lorg/ietf/jgss/Oid;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "gssManager", "Lsun/security/jgss/GSSManagerImpl;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "appNameStr", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "appNameBytes", "[B"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "appNameType", "Lorg/ietf/jgss/Oid;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "printableName", "Ljava/lang/String;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "printableNameType", "Lorg/ietf/jgss/Oid;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "elements", "Ljava/util/HashMap;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "mechElement", "Lsun/security/jgss/spi/GSSNameSpi;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "GSSNameImpl", "(Lsun/security/jgss/GSSManagerImpl;Ljava/lang/Object;Lorg/ietf/jgss/Oid;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "GSSNameImpl", "(Lsun/security/jgss/GSSManagerImpl;Lsun/security/jgss/spi/GSSNameSpi;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "GSSNameImpl", "(Lsun/security/jgss/GSSManagerImpl;Ljava/lang/Object;Lorg/ietf/jgss/Oid;Lorg/ietf/jgss/Oid;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "init", "(Lsun/security/jgss/GSSManagerImpl;Ljava/lang/Object;Lorg/ietf/jgss/Oid;Lorg/ietf/jgss/Oid;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getElement", "(Lorg/ietf/jgss/Oid;)Lsun/security/jgss/spi/GSSNameSpi;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "getNameTypeStr", "(Lorg/ietf/jgss/Oid;)Ljava/lang/String;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "importName", "(Lsun/security/jgss/GSSManagerImpl;Ljava/lang/Object;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "wrapElement", "(Lsun/security/jgss/GSSManagerImpl;Lsun/security/jgss/spi/GSSNameSpi;)Lsun/security/jgss/GSSNameImpl;"));
	}
	...
	public GSSNameImpl(Dova.JDK.sun.security.jgss.GSSManagerImpl arg0, Dova.JDK.java.lang.Object arg1, Dova.JDK.org.ietf.jgss.Oid arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(Lsun/security/jgss/GSSManagerImpl;Lsun/security/jgss/spi/GSSNameSpi;)V", "")]
	public GSSNameImpl(Dova.JDK.sun.security.jgss.GSSManagerImpl arg0, Dova.JDK.sun.security.jgss.spi.GSSNameSpi arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Lsun/security/jgss/GSSManagerImpl;Ljava/lang/Object;Lorg/ietf/jgss/Oid;Lorg/ietf/jgss/Oid;)V", "")]
	public GSSNameImpl(Dova.JDK.sun.security.jgss.GSSManagerImpl arg0, Dova.JDK.java.lang.Object arg1, Dova.JDK.org.ietf.jgss.Oid arg2, Dova.JDK.org.ietf.jgss.Oid arg3) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[2], arg0, arg1, arg2, arg3))
	{
	}
