	...
	, Dova.JDK.sun.security.jgss.spi.GSSContextSpi
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/security/jgss/spnego/SpNegoContext;");
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "peerName", "Lsun/security/jgss/spi/GSSNameSpi;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "myName", "Lsun/security/jgss/spi/GSSNameSpi;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "myCred", "Lsun/security/jgss/spnego/SpNegoCredElement;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "mechContext", "Lorg/ietf/jgss/GSSContext;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "DER_mechTypes", "[B"));
		...
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "internal_mech", "Lorg/ietf/jgss/Oid;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "factory", "Lsun/security/jgss/spnego/SpNegoMechFactory;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetStaticFieldId(ClassRefPtr, "DEBUG", "Z"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SpNegoContext", "(Lsun/security/jgss/spnego/SpNegoMechFactory;[B)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SpNegoContext", "(Lsun/security/jgss/spnego/SpNegoMechFactory;Lsun/security/jgss/spi/GSSCredentialSpi;)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "SpNegoContext", "(Lsun/security/jgss/spnego/SpNegoMechFactory;Lsun/security/jgss/spi/GSSNameSpi;Lsun/security/jgss/spi/GSSCredentialSpi;I)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getNegotiatedMech", "()Lorg/ietf/jgss/Oid;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getAvailableMechs", "()[Lorg/ietf/jgss/Oid;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getEncodedMechs", "([Lorg/ietf/jgss/Oid;)[B"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "GSS_initSecContext", "([B)[B"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getContextFlags", "()Lsun/security/util/BitArray;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "isMechContextEstablished", "()Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "verifyMechListMIC", "([B[B)Z"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetStaticMethodId(ClassRefPtr, "negotiate_mech_type", "([Lorg/ietf/jgss/Oid;[Lorg/ietf/jgss/Oid;)Lorg/ietf/jgss/Oid;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "GSS_acceptSecContext", "([B)[B"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "setContextFlags", "()V"));
	...
	public SpNegoContext(Dova.JDK.sun.security.jgss.spnego.SpNegoMechFactory arg0, JavaArray<byte> arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Lsun/security/jgss/spnego/SpNegoMechFactory;Lsun/security/jgss/spi/GSSCredentialSpi;)V", "public")]
	public SpNegoContext(Dova.JDK.sun.security.jgss.spnego.SpNegoMechFactory arg0, Dova.JDK.sun.security.jgss.spi.GSSCredentialSpi arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
	...
	public SpNegoContext(Dova.JDK.sun.security.jgss.spnego.SpNegoMechFactory arg0, Dova.JDK.sun.security.jgss.spi.GSSNameSpi arg1, Dova.JDK.sun.security.jgss.spi.GSSCredentialSpi arg2, int arg3) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[2], arg0, arg1, arg2, arg3))
	{
	}
