...
[JniSignatureAttribute("Ljavax/security/auth/kerberos/KrbDelegationPermissionCollection;", "final")]
public partial class KrbDelegationPermissionCollection
	...
	, Dova.JDK.java.io.Serializable
{
	...
	static KrbDelegationPermissionCollection()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/security/auth/kerberos/KrbDelegationPermissionCollection;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "KrbDelegationPermissionCollection", "()V"));
	...
	public KrbDelegationPermissionCollection(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public KrbDelegationPermissionCollection() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/security/auth/kerberos/KrbDelegationPermissionCollection;";
