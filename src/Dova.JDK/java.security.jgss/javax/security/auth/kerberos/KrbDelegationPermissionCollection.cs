	...
	, Dova.JDK.java.io.Serializable
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Ljavax/security/auth/kerberos/KrbDelegationPermissionCollection;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "KrbDelegationPermissionCollection", "()V"));
	...
	public KrbDelegationPermissionCollection() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
