...
[JniSignatureAttribute("Ljavax/security/auth/kerberos/KrbServicePermissionCollection;", "final")]
public partial class KrbServicePermissionCollection
	...
	, Dova.JDK.java.io.Serializable
{
	...
	static KrbServicePermissionCollection()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/security/auth/kerberos/KrbServicePermissionCollection;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "KrbServicePermissionCollection", "()V"));
	...
	public KrbServicePermissionCollection(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("()V", "public")]
	public KrbServicePermissionCollection() : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}

	public override string GetJavaClassSignature() => "Ljavax/security/auth/kerberos/KrbServicePermissionCollection;";
