	...
	, Dova.JDK.java.io.Serializable
{
	...
	static KeyImpl()
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Ljavax/security/auth/kerberos/KeyImpl;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "KeyImpl", "([BI)V"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "KeyImpl", "(Ljavax/security/auth/kerberos/KerberosPrincipal;[CLjava/lang/String;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getAlgorithmName", "(I)Ljava/lang/String;"));
	...
	public KeyImpl(JavaArray<byte> arg0, int arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Ljavax/security/auth/kerberos/KerberosPrincipal;[CLjava/lang/String;)V", "public")]
	public KeyImpl(Dova.JDK.javax.security.auth.kerberos.KerberosPrincipal arg0, JavaArray<char> arg1, Dova.JDK.java.lang.String arg2) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1, arg2))
	{
	}
