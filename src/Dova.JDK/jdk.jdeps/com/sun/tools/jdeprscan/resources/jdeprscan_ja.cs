	...
	: Dova.JDK.java.util.ListResourceBundle
{
	...
	static jdeprscan_ja()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/tools/jdeprscan/resources/jdeprscan_ja;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "jdeprscan_ja", "()V"));
	...
	public jdeprscan_ja() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
