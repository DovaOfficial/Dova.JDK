	...
	: Dova.JDK.java.lang.Object
{
	...
	static Main()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/tools/javap/Main;");
		...
		, Dova.JDK.java.util.spi.ToolProvider
	{
		...
		{
			ClassPtr = DovaVM.Runtime.FindClass("Lcom/sun/tools/javap/Main$JavapToolProvider;");
			ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "JavapToolProvider", "()V"));
		...
		[JniSignatureAttribute("()V", "public")]
		public JavapToolProvider() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
		{
		}
