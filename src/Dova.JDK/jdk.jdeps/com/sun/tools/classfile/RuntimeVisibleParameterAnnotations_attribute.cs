	...
	: Dova.JDK.com.sun.tools.classfile.RuntimeParameterAnnotations_attribute
{
	...
	public RuntimeVisibleParameterAnnotations_attribute(int arg0, JavaArray<JavaArray<Dova.JDK.com.sun.tools.classfile.Annotation>> arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Lcom/sun/tools/classfile/ConstantPool;[[Lcom/sun/tools/classfile/Annotation;)V", "public")]
	public RuntimeVisibleParameterAnnotations_attribute(Dova.JDK.com.sun.tools.classfile.ConstantPool arg0, JavaArray<JavaArray<Dova.JDK.com.sun.tools.classfile.Annotation>> arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	[JniSignatureAttribute("(Lcom/sun/tools/classfile/ClassReader;II)V", "")]
	public RuntimeVisibleParameterAnnotations_attribute(Dova.JDK.com.sun.tools.classfile.ClassReader arg0, int arg1, int arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[2], arg0, arg1, arg2))
	{
	}
