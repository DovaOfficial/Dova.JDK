	...
	: Dova.JDK.com.sun.tools.classfile.Attribute
{
	...
	static Record_attribute()
	{
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "component_count", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassRefPtr, "component_info_arr", "[Lcom/sun/tools/classfile/Record_attribute$ComponentInfo;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Record_attribute", "(Lcom/sun/tools/classfile/ClassReader;II)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "Record_attribute", "(I[Lcom/sun/tools/classfile/Record_attribute$ComponentInfo;)V"));
	...
	public Record_attribute(Dova.JDK.com.sun.tools.classfile.ClassReader arg0, int arg1, int arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	[JniSignatureAttribute("(I[Lcom/sun/tools/classfile/Record_attribute$ComponentInfo;)V", "public")]
	public Record_attribute(int arg0, JavaArray<Dova.JDK.com.sun.tools.classfile.Record_attribute.ComponentInfo> arg1) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}
		...
		: Dova.JDK.java.lang.Object
	{
		...
		static ComponentInfo()
		{
			...
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ComponentInfo", "(ILcom/sun/tools/classfile/Descriptor;Lcom/sun/tools/classfile/Attributes;)V"));
			ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "ComponentInfo", "(Lcom/sun/tools/classfile/ClassReader;)V"));
		...
		public ComponentInfo(int arg0, Dova.JDK.com.sun.tools.classfile.Descriptor arg1, Dova.JDK.com.sun.tools.classfile.Attributes arg2) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1, arg2))
		{
		}

		[JniSignatureAttribute("(Lcom/sun/tools/classfile/ClassReader;)V", "")]
		public ComponentInfo(Dova.JDK.com.sun.tools.classfile.ClassReader arg0) : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[1], arg0))
		{
		}
