	...
	: Dova.JDK.java.lang.Object
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/tools/classfile/ReferenceFinder;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "filter", "Lcom/sun/tools/classfile/ReferenceFinder$Filter;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "visitor", "Lcom/sun/tools/classfile/ReferenceFinder$Visitor;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "cpVisitor", "Lcom/sun/tools/classfile/ConstantPool$Visitor;"));
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "codeVisitor", "Lcom/sun/tools/classfile/Instruction$KindVisitor;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "ReferenceFinder", "(Lcom/sun/tools/classfile/ReferenceFinder$Filter;Lcom/sun/tools/classfile/ReferenceFinder$Visitor;)V"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "parse", "(Lcom/sun/tools/classfile/ClassFile;)Z"));
	}
	...
	public ReferenceFinder(Dova.JDK.com.sun.tools.classfile.ReferenceFinder.Filter arg0, Dova.JDK.com.sun.tools.classfile.ReferenceFinder.Visitor arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
		...
		: IJavaObject
	{
		...
		static Filter()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/tools/classfile/ReferenceFinder$Filter;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "accept", "(Lcom/sun/tools/classfile/ConstantPool;Lcom/sun/tools/classfile/ConstantPool$CPRefInfo;)Z"));
		}
		...
		: IJavaObject
	{
		...
		static Visitor()
		{
			ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lcom/sun/tools/classfile/ReferenceFinder$Visitor;");
			ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
			MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "visit", "(Lcom/sun/tools/classfile/ClassFile;Lcom/sun/tools/classfile/Method;Ljava/util/List;)V"));
		}
