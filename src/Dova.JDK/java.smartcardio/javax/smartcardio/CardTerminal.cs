	...
	: Dova.JDK.java.lang.Object
{
	...
	static CardTerminal()
	{
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "CardTerminal", "()V"));
	...
	public CardTerminal() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
