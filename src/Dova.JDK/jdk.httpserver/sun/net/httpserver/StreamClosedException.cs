	...
	: Dova.JDK.java.io.IOException
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lsun/net/httpserver/StreamClosedException;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetStaticFieldId(ClassRefPtr, "serialVersionUID", "J"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassRefPtr, "StreamClosedException", "()V"));
	}
	...
	public StreamClosedException() : base(DovaVM.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0]))
	{
	}
