	...
	: Dova.JDK.com.sun.net.httpserver.HttpsExchange
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/net/httpserver/HttpsExchangeImpl;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "impl", "Lsun/net/httpserver/ExchangeImpl;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "HttpsExchangeImpl", "(Lsun/net/httpserver/ExchangeImpl;)V"));
		...
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getHttpContext_0", "()Lcom/sun/net/httpserver/HttpContext;"));
		MethodPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "getHttpContext_1", "()Lsun/net/httpserver/HttpContextImpl;"));
	...
	public HttpsExchangeImpl(Dova.JDK.sun.net.httpserver.ExchangeImpl arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
