	...
	: Dova.JDK.java.io.FilterOutputStream
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/net/httpserver/UndefLengthOutputStream;");
		...
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "UndefLengthOutputStream", "(Lsun/net/httpserver/ExchangeImpl;Ljava/io/OutputStream;)V"));
	...
	public UndefLengthOutputStream(Dova.JDK.sun.net.httpserver.ExchangeImpl arg0, Dova.JDK.java.io.OutputStream arg1) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}
