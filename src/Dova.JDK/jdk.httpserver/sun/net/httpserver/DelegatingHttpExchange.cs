	...
	: Dova.JDK.com.sun.net.httpserver.HttpExchange
{
	...
	{
		ClassPtr = DovaJvm.Vm.Runtime.FindClass("Lsun/net/httpserver/DelegatingHttpExchange;");
		ClassRefPtr = DovaJvm.Vm.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaJvm.Vm.Runtime.GetFieldId(ClassRefPtr, "exchange", "Lcom/sun/net/httpserver/HttpExchange;"));
		ConstructorPtrs.Add(DovaJvm.Vm.Runtime.GetMethodId(ClassRefPtr, "DelegatingHttpExchange", "(Lcom/sun/net/httpserver/HttpExchange;)V"));
	...
	public DelegatingHttpExchange(Dova.JDK.com.sun.net.httpserver.HttpExchange arg0) : base(DovaJvm.Vm.Runtime.NewObjectA(ClassRefPtr, ConstructorPtrs[0], arg0))
	{
	}
