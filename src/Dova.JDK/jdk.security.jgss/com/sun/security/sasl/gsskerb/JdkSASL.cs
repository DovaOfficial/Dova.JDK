	...
	: Dova.JDK.java.security.Provider
{
	...
	static JdkSASL()
	{
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "access$000", "(Lcom/sun/security/sasl/gsskerb/JdkSASL;Ljava/security/Provider$Service;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "access$100", "(Lcom/sun/security/sasl/gsskerb/JdkSASL;Ljava/security/Provider$Service;)V"));
	}
	...
	public JdkSASL() : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0]))
	{
	}
